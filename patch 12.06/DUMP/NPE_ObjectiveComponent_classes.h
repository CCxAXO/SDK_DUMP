...
struct UNPE_ObjectiveComponent_C : UBaseObjectiveComponent_C {
	...
	void OnObjectiveActivated_PlatformVisibility(struct UObjectiveComponent* ChangedObjective, enum class EObjectiveType Type, enum class EObjectiveStatus OldStatus, enum class EObjectiveStatus NewStatus, int32_t OldProgress, int32_t NewProgress); // Function NPE_ObjectiveComponent.NPE_ObjectiveComponent_C.OnObjectiveActivated_PlatformVisibility // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void AutoCompleteOnServer(); // Function NPE_ObjectiveComponent.NPE_ObjectiveComponent_C.AutoCompleteOnServer // (Net|NetReliableNetServer|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ReceiveBeginPlay(); // Function NPE_ObjectiveComponent.NPE_ObjectiveComponent_C.ReceiveBeginPlay // (Event|Public|BlueprintEvent) // @ game+0x1b42740
	void UpdateActionTextWithNotify(struct FName InputActionNameConsole, struct FText BeforeActionTextConsole, struct FText AfterActionTextConsole, struct FName InputActionNameDesktop, struct FText BeforeActionNameDesktop, struct FText AfterActionNameDesktop); // Function NPE_ObjectiveComponent.NPE_ObjectiveComponent_C.UpdateActionTextWithNotify // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_NPE_ObjectiveComponent(int32_t EntryPoint); // Function NPE_ObjectiveComponent.NPE_ObjectiveComponent_C.ExecuteUbergraph_NPE_ObjectiveComponent // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
	void OnPromptTextUpdated__DelegateSignature(); // Function NPE_ObjectiveComponent.NPE_ObjectiveComponent_C.OnPromptTextUpdated__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

...
struct UGenericProgressionTooltip_C : UUserWidget {
	...
	void Set Body(struct UImage* Background, struct FText Text); // Function GenericProgressionTooltip.GenericProgressionTooltip_C.Set Body // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Set Header(struct UImage* Background, struct FText Text); // Function GenericProgressionTooltip.GenericProgressionTooltip_C.Set Header // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

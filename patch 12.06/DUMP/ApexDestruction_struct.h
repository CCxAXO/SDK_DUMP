...
struct FFractureMaterial {
	struct FVector2D UVScale; // 0x00(0x10)
	struct FVector2D UVOffset; // 0x10(0x10)
	struct FVector Tangent; // 0x20(0x18)
	float UAngle; // 0x38(0x04)
	int32_t InteriorElementIndex; // 0x3c(0x04)
};
...
struct FDestructibleDebrisParameters {
	...
	struct FBox ValidBounds; // 0x10(0x38)
};
...
struct FDestructibleParameters {
	...
	struct FDestructibleDebrisParameters DebrisParameters; // 0x20(0x48)
	struct FDestructibleAdvancedParameters AdvancedParameters; // 0x68(0x10)
	struct FDestructibleSpecialHierarchyDepths SpecialHierarchyDepths; // 0x78(0x14)
	char pad_8C[0x4]; // 0x8c(0x04)
	struct TArray<struct FDestructibleDepthParameters> DepthParameters; // 0x90(0x10)
	struct FDestructibleParametersFlag Flags; // 0xa0(0x04)

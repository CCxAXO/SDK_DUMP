...
struct UMatchFoundScreenV2_C : UMatchFoundScreen_Base_C {
	...
	void SequenceEvent__ENTRYPOINTMatchFoundScreenV2(); // Function MatchFoundScreenV2.MatchFoundScreenV2_C.SequenceEvent__ENTRYPOINTMatchFoundScreenV2 // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void UpdateTimerText(); // Function MatchFoundScreenV2.MatchFoundScreenV2_C.UpdateTimerText // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SFX(); // Function MatchFoundScreenV2.MatchFoundScreenV2_C.SFX // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void PreConstruct(bool IsDesignTime); // Function MatchFoundScreenV2.MatchFoundScreenV2_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function MatchFoundScreenV2.MatchFoundScreenV2_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void OnEventTimer(); // Function MatchFoundScreenV2.MatchFoundScreenV2_C.OnEventTimer // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_MatchFoundScreenV2(int32_t EntryPoint); // Function MatchFoundScreenV2.MatchFoundScreenV2_C.ExecuteUbergraph_MatchFoundScreenV2 // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
};

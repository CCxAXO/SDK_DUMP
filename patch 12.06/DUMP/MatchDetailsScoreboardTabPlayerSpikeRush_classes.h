...
struct UMatchDetailsScoreboardTabPlayerSpikeRush_C : UUserWidget {
	...
	void GetColors(struct FLinearColor& IndicatorColor, struct FLinearColor& NameColor, struct FLinearColor& ScoreColor, struct FLinearColor& StatColor, struct FLinearColor& LocalPlayerTriangleColor); // Function MatchDetailsScoreboardTabPlayerSpikeRush.MatchDetailsScoreboardTabPlayerSpikeRush_C.GetColors // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetPlayerType(); // Function MatchDetailsScoreboardTabPlayerSpikeRush.MatchDetailsScoreboardTabPlayerSpikeRush_C.SetPlayerType // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetDataFields(); // Function MatchDetailsScoreboardTabPlayerSpikeRush.MatchDetailsScoreboardTabPlayerSpikeRush_C.SetDataFields // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetBackgroundAndBorder(); // Function MatchDetailsScoreboardTabPlayerSpikeRush.MatchDetailsScoreboardTabPlayerSpikeRush_C.SetBackgroundAndBorder // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Init(struct FProcessedPlayerDetails ProcessedPlayerDetailsDTO, struct FProcessedMatchDetails ProcessedMatchDetailsDTO, struct FString TeamColor, struct FString TargetSubject, bool IsEndOfGame); // Function MatchDetailsScoreboardTabPlayerSpikeRush.MatchDetailsScoreboardTabPlayerSpikeRush_C.Init // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void PreConstruct(bool IsDesignTime); // Function MatchDetailsScoreboardTabPlayerSpikeRush.MatchDetailsScoreboardTabPlayerSpikeRush_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_MatchDetailsScoreboardTabPlayerSpikeRush(int32_t EntryPoint); // Function MatchDetailsScoreboardTabPlayerSpikeRush.MatchDetailsScoreboardTabPlayerSpikeRush_C.ExecuteUbergraph_MatchDetailsScoreboardTabPlayerSpikeRush // (Final|UbergraphFunction) // @ game+0x1b42740
};

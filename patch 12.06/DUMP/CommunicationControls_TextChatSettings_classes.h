...
struct UCommunicationControls_TextChatSettings_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function CommunicationControls_TextChatSettings.CommunicationControls_TextChatSettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_CommunicationControls_TextChatSettings(int32_t EntryPoint); // Function CommunicationControls_TextChatSettings.CommunicationControls_TextChatSettings_C.ExecuteUbergraph_CommunicationControls_TextChatSettings // (Final|UbergraphFunction) // @ game+0x1b42740
};

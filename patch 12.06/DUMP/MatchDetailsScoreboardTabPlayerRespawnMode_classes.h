...
struct UMatchDetailsScoreboardTabPlayerRespawnMode_C : UUserWidget {
	...
	void SetDataFields(); // Function MatchDetailsScoreboardTabPlayerRespawnMode.MatchDetailsScoreboardTabPlayerRespawnMode_C.SetDataFields // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetBackgroundAndBorder(); // Function MatchDetailsScoreboardTabPlayerRespawnMode.MatchDetailsScoreboardTabPlayerRespawnMode_C.SetBackgroundAndBorder // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Init(struct FProcessedPlayerDetails ProcessedPlayerDetailsDTO, struct FProcessedMatchDetails ProcessedMatchDetailsDTO, struct FString TeamColor, struct FString TargetSubject, bool IsEndOfGame); // Function MatchDetailsScoreboardTabPlayerRespawnMode.MatchDetailsScoreboardTabPlayerRespawnMode_C.Init // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

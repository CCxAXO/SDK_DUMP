...
struct UWBP_Panel_PickemPlayoffHeader_C : UAresCommonUserWidget {
	...
	void SwitchBracketView(); // Function WBP_Panel_PickemPlayoffHeader.WBP_Panel_PickemPlayoffHeader_C.SwitchBracketView // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ClearPicks(); // Function WBP_Panel_PickemPlayoffHeader.WBP_Panel_PickemPlayoffHeader_C.ClearPicks // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnClientChoiceCountChanged(int32_t NewValue); // Function WBP_Panel_PickemPlayoffHeader.WBP_Panel_PickemPlayoffHeader_C.OnClientChoiceCountChanged // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnNumSavedPicksChanged(int32_t NewValue); // Function WBP_Panel_PickemPlayoffHeader.WBP_Panel_PickemPlayoffHeader_C.OnNumSavedPicksChanged // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void InitializeViewModel(struct UPickemBlockModel* PickemBlockModel, enum class EAresPickemStage CurrentStage); // Function WBP_Panel_PickemPlayoffHeader.WBP_Panel_PickemPlayoffHeader_C.InitializeViewModel // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void BindOrUnbindEvents(bool Bind); // Function WBP_Panel_PickemPlayoffHeader.WBP_Panel_PickemPlayoffHeader_C.BindOrUnbindEvents // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnPickCloseTimeChanged(struct FDateTime& InDateTime); // Function WBP_Panel_PickemPlayoffHeader.WBP_Panel_PickemPlayoffHeader_C.OnPickCloseTimeChanged // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Destruct(); // Function WBP_Panel_PickemPlayoffHeader.WBP_Panel_PickemPlayoffHeader_C.Destruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	...
	void BndEvt__WBP_Panel_PickemPlayoffHeader_ClearButton_V2_K2Node_ComponentBoundEvent_1_CommonButtonBaseClicked__DelegateSignature(struct UCommonButtonBase* Button); // Function WBP_Panel_PickemPlayoffHeader.WBP_Panel_PickemPlayoffHeader_C.BndEvt__WBP_Panel_PickemPlayoffHeader_ClearButton_V2_K2Node_ComponentBoundEvent_1_CommonButtonBaseClicked__DelegateSignature // (BlueprintEvent) // @ game+0x1b42740
	...
	void OnInitialized(); // Function WBP_Panel_PickemPlayoffHeader.WBP_Panel_PickemPlayoffHeader_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_WBP_Panel_PickemPlayoffHeader(int32_t EntryPoint); // Function WBP_Panel_PickemPlayoffHeader.WBP_Panel_PickemPlayoffHeader_C.ExecuteUbergraph_WBP_Panel_PickemPlayoffHeader // (Final|UbergraphFunction) // @ game+0x1b42740
	void OnToggleBracketView__DelegateSignature(bool ShouldShowStaticBracket); // Function WBP_Panel_PickemPlayoffHeader.WBP_Panel_PickemPlayoffHeader_C.OnToggleBracketView__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnClear__DelegateSignature(); // Function WBP_Panel_PickemPlayoffHeader.WBP_Panel_PickemPlayoffHeader_C.OnClear__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

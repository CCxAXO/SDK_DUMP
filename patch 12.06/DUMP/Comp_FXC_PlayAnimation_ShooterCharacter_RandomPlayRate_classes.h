...
struct UComp_FXC_PlayAnimation_ShooterCharacter_RandomPlayRate_C : UComp_FXC_PlayAnimation_ShooterCharacter_C {
	...
	void StartEffect(struct AActor* Target, struct UObject* Context, float StartTime, bool FirstPerson); // Function Comp_FXC_PlayAnimation_ShooterCharacter_RandomPlayRate.Comp_FXC_PlayAnimation_ShooterCharacter_RandomPlayRate_C.StartEffect // (Event|Public|BlueprintEvent) // @ game+0x1b42740

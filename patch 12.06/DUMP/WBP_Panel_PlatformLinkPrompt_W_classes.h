...
struct UWBP_Panel_PlatformLinkPrompt_W_C : UAresCommonUserWidget {
	...
	void UpdateAppearance(); // Function WBP_Panel_PlatformLinkPrompt_W.WBP_Panel_PlatformLinkPrompt_W_C.UpdateAppearance // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnLinkStateChanged(bool bNewValue); // Function WBP_Panel_PlatformLinkPrompt_W.WBP_Panel_PlatformLinkPrompt_W_C.OnLinkStateChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnAddFriendPermissionChanged(bool HasPermission); // Function WBP_Panel_PlatformLinkPrompt_W.WBP_Panel_PlatformLinkPrompt_W_C.OnAddFriendPermissionChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnSocialExperienceIsOpenChanged(bool bIsOpen); // Function WBP_Panel_PlatformLinkPrompt_W.WBP_Panel_PlatformLinkPrompt_W_C.OnSocialExperienceIsOpenChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_WBP_Panel_PlatformLinkPrompt_W(int32_t EntryPoint); // Function WBP_Panel_PlatformLinkPrompt_W.WBP_Panel_PlatformLinkPrompt_W_C.ExecuteUbergraph_WBP_Panel_PlatformLinkPrompt_W // (Final|UbergraphFunction) // @ game+0x1b42740
};

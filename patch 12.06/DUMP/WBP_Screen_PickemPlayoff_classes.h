...
struct UWBP_Screen_PickemPlayoff_C : UEsportsHubScreenV2 {
	...
	void InitFromNavigationParam(); // Function WBP_Screen_PickemPlayoff.WBP_Screen_PickemPlayoff_C.InitFromNavigationParam // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void InitializeViewModel(struct UPickemBlockModel* PickemBlockModel, enum class EAresPickemStage CurrentStage); // Function WBP_Screen_PickemPlayoff.WBP_Screen_PickemPlayoff_C.InitializeViewModel // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	...
	void OnInitialized(); // Function WBP_Screen_PickemPlayoff.WBP_Screen_PickemPlayoff_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void BP_OnActivated(); // Function WBP_Screen_PickemPlayoff.WBP_Screen_PickemPlayoff_C.BP_OnActivated // (Event|Protected|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_WBP_Screen_PickemPlayoff(int32_t EntryPoint); // Function WBP_Screen_PickemPlayoff.WBP_Screen_PickemPlayoff_C.ExecuteUbergraph_WBP_Screen_PickemPlayoff // (Final|UbergraphFunction) // @ game+0x1b42740
};

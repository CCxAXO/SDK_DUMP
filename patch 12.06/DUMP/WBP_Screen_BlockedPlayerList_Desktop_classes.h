...
struct UWBP_Screen_BlockedPlayerList_Desktop_C : UAresScreenBase {
	...
	void BP_OnActivated(); // Function WBP_Screen_BlockedPlayerList_Desktop.WBP_Screen_BlockedPlayerList_Desktop_C.BP_OnActivated // (Event|Protected|BlueprintEvent) // @ game+0x1b42740
	void OnInitialized(); // Function WBP_Screen_BlockedPlayerList_Desktop.WBP_Screen_BlockedPlayerList_Desktop_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void HandleOpenAnimationFinished(); // Function WBP_Screen_BlockedPlayerList_Desktop.WBP_Screen_BlockedPlayerList_Desktop_C.HandleOpenAnimationFinished // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_WBP_Screen_BlockedPlayerList_Desktop(int32_t EntryPoint); // Function WBP_Screen_BlockedPlayerList_Desktop.WBP_Screen_BlockedPlayerList_Desktop_C.ExecuteUbergraph_WBP_Screen_BlockedPlayerList_Desktop // (Final|UbergraphFunction) // @ game+0x1b42740
};

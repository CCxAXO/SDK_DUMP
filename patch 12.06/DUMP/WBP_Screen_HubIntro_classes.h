...
struct UWBP_Screen_HubIntro_C : UAresScreenBase {
	...
	void StyleForIntroAnimation(enum class E2024VCTEvent In Event Type); // Function WBP_Screen_HubIntro.WBP_Screen_HubIntro_C.StyleForIntroAnimation // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnIntroAnimationFinished(); // Function WBP_Screen_HubIntro.WBP_Screen_HubIntro_C.OnIntroAnimationFinished // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function WBP_Screen_HubIntro.WBP_Screen_HubIntro_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_WBP_Screen_HubIntro(int32_t EntryPoint); // Function WBP_Screen_HubIntro.WBP_Screen_HubIntro_C.ExecuteUbergraph_WBP_Screen_HubIntro // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
};

...
struct USpectatorWidget_C : USpectatorWidget_Base_C {
	...
	void HandleIntroAnimation(); // Function SpectatorWidget.SpectatorWidget_C.HandleIntroAnimation // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void HandleCheckObserver(struct FDelegate event); // Function SpectatorWidget.SpectatorWidget_C.HandleCheckObserver // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function SpectatorWidget.SpectatorWidget_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void Toggle Spectator Portrait(enum class EAresBoolSettingName SettingName, bool OldValue, bool NewValue); // Function SpectatorWidget.SpectatorWidget_C.Toggle Spectator Portrait // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_SpectatorWidget(int32_t EntryPoint); // Function SpectatorWidget.SpectatorWidget_C.ExecuteUbergraph_SpectatorWidget // (Final|UbergraphFunction) // @ game+0x1b42740
};

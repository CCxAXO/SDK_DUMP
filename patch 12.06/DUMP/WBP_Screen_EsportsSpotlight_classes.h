...
struct UWBP_Screen_EsportsSpotlight_C : UAresScreenBase {
	...
	void Style Spotlight Page(); // Function WBP_Screen_EsportsSpotlight.WBP_Screen_EsportsSpotlight_C.Style Spotlight Page // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Setup Pickems Box(); // Function WBP_Screen_EsportsSpotlight.WBP_Screen_EsportsSpotlight_C.Setup Pickems Box // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void On Event IDs Changed(struct FString NewLeagueID, struct FString NewTournamentID); // Function WBP_Screen_EsportsSpotlight.WBP_Screen_EsportsSpotlight_C.On Event IDs Changed // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void BindToOrUnbindFromViewModel(bool Should Bind); // Function WBP_Screen_EsportsSpotlight.WBP_Screen_EsportsSpotlight_C.BindToOrUnbindFromViewModel // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function WBP_Screen_EsportsSpotlight.WBP_Screen_EsportsSpotlight_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void K2_BindToViewModel(); // Function WBP_Screen_EsportsSpotlight.WBP_Screen_EsportsSpotlight_C.K2_BindToViewModel // (Event|Public|BlueprintEvent) // @ game+0x1b42740
	void Destruct(); // Function WBP_Screen_EsportsSpotlight.WBP_Screen_EsportsSpotlight_C.Destruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_WBP_Screen_EsportsSpotlight(int32_t EntryPoint); // Function WBP_Screen_EsportsSpotlight.WBP_Screen_EsportsSpotlight_C.ExecuteUbergraph_WBP_Screen_EsportsSpotlight // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
};

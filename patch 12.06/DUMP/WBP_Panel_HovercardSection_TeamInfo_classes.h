...
struct UWBP_Panel_HovercardSection_TeamInfo_C : UWBP_Panel_HovercardSection_SocialPanelPlayer_Base_C {
	...
	void SetObservedPlayer(struct FString InPlayerSubject); // Function WBP_Panel_HovercardSection_TeamInfo.WBP_Panel_HovercardSection_TeamInfo_C.SetObservedPlayer // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void GetConfigValues(bool& bSectionIsEnabled, bool& bHideIfNotInTeam); // Function WBP_Panel_HovercardSection_TeamInfo.WBP_Panel_HovercardSection_TeamInfo_C.GetConfigValues // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void UpdateVisibility(); // Function WBP_Panel_HovercardSection_TeamInfo.WBP_Panel_HovercardSection_TeamInfo_C.UpdateVisibility // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnRosterTypeChanged(enum class EPremierRosterType RosterType); // Function WBP_Panel_HovercardSection_TeamInfo.WBP_Panel_HovercardSection_TeamInfo_C.OnRosterTypeChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_WBP_Panel_HovercardSection_TeamInfo(int32_t EntryPoint); // Function WBP_Panel_HovercardSection_TeamInfo.WBP_Panel_HovercardSection_TeamInfo_C.ExecuteUbergraph_WBP_Panel_HovercardSection_TeamInfo // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
};

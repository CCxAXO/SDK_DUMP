...
struct UGameMapsSettings : UObject {
	...
	struct FSoftObjectPath TransitionMap; // 0x40(0x28)
	...
	enum class EFourPlayerSplitScreenType FourPlayerSplitscreenLayout; // 0x6b(0x01)
	bool bOffsetPlayerGamepadIds; // 0x6c(0x01)
	char pad_6D[0x3]; // 0x6d(0x03)
	struct FSoftClassPath GameInstanceClass; // 0x70(0x28)
	struct FSoftObjectPath GameDefaultMap; // 0x98(0x28)
	struct FSoftObjectPath ServerDefaultMap; // 0xc0(0x28)
	struct FSoftClassPath GlobalDefaultGameMode; // 0xe8(0x28)
	struct FSoftClassPath GlobalDefaultServerGameMode; // 0x110(0x28)
	struct TArray<struct FGameModeName> GameModeMapPrefixes; // 0x138(0x10)
	struct TArray<struct FGameModeName> GameModeClassAliases; // 0x148(0x10)

	void SetSkipAssigningGamepadToPlayer1(bool bSkipFirstPlayer); // Function EngineSettings.GameMapsSettings.SetSkipAssigningGamepadToPlayer1 // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x2011ea0
	bool GetSkipAssigningGamepadToPlayer1(); // Function EngineSettings.GameMapsSettings.GetSkipAssigningGamepadToPlayer1 // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2011e80
	struct UGameMapsSettings* GetGameMapsSettings(); // Function EngineSettings.GameMapsSettings.GetGameMapsSettings // (Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x2011f90
};
...
struct UGeneralProjectSettings : UObject {
	...
	float EyeOffsetForFakeStereoRenderingDevice; // 0x118(0x04)
	float FOVForFakeStereoRenderingDevice; // 0x11c(0x04)
};

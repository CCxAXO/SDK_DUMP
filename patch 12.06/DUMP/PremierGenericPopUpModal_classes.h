...
struct UPremierGenericPopUpModal_C : UUserWidget {
	...
	void SetContents(struct FText Title Text, struct FText Main Text, struct FText Confirm Button Text, bool Show Cancel Button, struct FText Cancel Button Text); // Function PremierGenericPopUpModal.PremierGenericPopUpModal_C.SetContents // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void BndEvt__JoiningQueuePendingInvitesModal_SharedBackButton_K2Node_ComponentBoundEvent_2_OnBackRequested__DelegateSignature(); // Function PremierGenericPopUpModal.PremierGenericPopUpModal_C.BndEvt__JoiningQueuePendingInvitesModal_SharedBackButton_K2Node_ComponentBoundEvent_2_OnBackRequested__DelegateSignature // (BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_PremierGenericPopUpModal(int32_t EntryPoint); // Function PremierGenericPopUpModal.PremierGenericPopUpModal_C.ExecuteUbergraph_PremierGenericPopUpModal // (Final|UbergraphFunction) // @ game+0x1b42740
	void CancelClicked__DelegateSignature(); // Function PremierGenericPopUpModal.PremierGenericPopUpModal_C.CancelClicked__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ConfirmClicked__DelegateSignature(); // Function PremierGenericPopUpModal.PremierGenericPopUpModal_C.ConfirmClicked__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

...
struct USubscriptionRewards_DetailsModal_C : UUserWidget {
	...
	struct FAresMainMenuNavBarData GetNavBarData(); // Function SubscriptionRewards_DetailsModal.SubscriptionRewards_DetailsModal_C.GetNavBarData // (Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1b42740
	bool HandleBackRequest(); // Function SubscriptionRewards_DetailsModal.SubscriptionRewards_DetailsModal_C.HandleBackRequest // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Update_SubscriptionRewardItem(enum class ESubscriptionRewardType SubscriptionRewardType, struct FText Title, struct FText Details); // Function SubscriptionRewards_DetailsModal.SubscriptionRewards_DetailsModal_C.Update_SubscriptionRewardItem // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Update_ActiveProgramsSubtitle(struct FText SubscriptionsList); // Function SubscriptionRewards_DetailsModal.SubscriptionRewards_DetailsModal_C.Update_ActiveProgramsSubtitle // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function SubscriptionRewards_DetailsModal.SubscriptionRewards_DetailsModal_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_SubscriptionRewards_DetailsModal(int32_t EntryPoint); // Function SubscriptionRewards_DetailsModal.SubscriptionRewards_DetailsModal_C.ExecuteUbergraph_SubscriptionRewards_DetailsModal // (Final|UbergraphFunction) // @ game+0x1b42740
};

...
struct ABP_Sky_Sphere_C : AActor {
	...
	void UpdateSunDirection(); // Function BP_Sky_Sphere.BP_Sky_Sphere_C.UpdateSunDirection // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void UserConstructionScript(); // Function BP_Sky_Sphere.BP_Sky_Sphere_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

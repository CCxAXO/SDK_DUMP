...
struct ADS_Gun_C : AGun_Sniper_C {
	...
	void GetIdleFiringState(struct UFiringStateComponent*& FiringState); // Function DS_Gun.DS_Gun_C.GetIdleFiringState // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1b42740
	void GetIdleReloadState(struct UReloadStateComponent*& ReloadState); // Function DS_Gun.DS_Gun_C.GetIdleReloadState // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1b42740
	void GetZoomedFiringState(struct UFiringStateComponent*& FiringState); // Function DS_Gun.DS_Gun_C.GetZoomedFiringState // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1b42740
	void ReceiveBeginPlay(); // Function DS_Gun.DS_Gun_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_DS_Gun(int32_t EntryPoint); // Function DS_Gun.DS_Gun_C.ExecuteUbergraph_DS_Gun // (Final|UbergraphFunction) // @ game+0x1b42740
};

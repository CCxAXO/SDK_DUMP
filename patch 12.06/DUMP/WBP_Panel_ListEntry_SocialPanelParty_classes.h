...
struct UWBP_Panel_ListEntry_SocialPanelParty_C : UWBP_Panel_ListEntry_Social_Base_C {
	...
	void UpdateLeavePartyVisibility(); // Function WBP_Panel_ListEntry_SocialPanelParty.WBP_Panel_ListEntry_SocialPanelParty_C.UpdateLeavePartyVisibility // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void InitializeListEntry(struct UObject* InListItemObject); // Function WBP_Panel_ListEntry_SocialPanelParty.WBP_Panel_ListEntry_SocialPanelParty_C.InitializeListEntry // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnCanLeavePartyChanged(bool bInCanLeaveParty); // Function WBP_Panel_ListEntry_SocialPanelParty.WBP_Panel_ListEntry_SocialPanelParty_C.OnCanLeavePartyChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_WBP_Panel_ListEntry_SocialPanelParty(int32_t EntryPoint); // Function WBP_Panel_ListEntry_SocialPanelParty.WBP_Panel_ListEntry_SocialPanelParty_C.ExecuteUbergraph_WBP_Panel_ListEntry_SocialPanelParty // (Final|UbergraphFunction) // @ game+0x1b42740
};

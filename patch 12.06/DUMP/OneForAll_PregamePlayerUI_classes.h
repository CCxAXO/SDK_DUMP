...
struct UOneForAll_PregamePlayerUI_C : UUserWidget {
	...
	void Construct(); // Function OneForAll_PregamePlayerUI.OneForAll_PregamePlayerUI_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void OnIsLocalPlayerCoachChanged(bool NewValue); // Function OneForAll_PregamePlayerUI.OneForAll_PregamePlayerUI_C.OnIsLocalPlayerCoachChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_OneForAll_PregamePlayerUI(int32_t EntryPoint); // Function OneForAll_PregamePlayerUI.OneForAll_PregamePlayerUI_C.ExecuteUbergraph_OneForAll_PregamePlayerUI // (Final|UbergraphFunction) // @ game+0x1b42740
};

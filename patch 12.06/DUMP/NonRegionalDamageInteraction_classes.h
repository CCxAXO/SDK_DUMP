...
struct UNonRegionalDamageInteraction_C : UUserWidget {
	...
	void Construct(); // Function NonRegionalDamageInteraction.NonRegionalDamageInteraction_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_NonRegionalDamageInteraction(int32_t EntryPoint); // Function NonRegionalDamageInteraction.NonRegionalDamageInteraction_C.ExecuteUbergraph_NonRegionalDamageInteraction // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
};

...
struct UWBP_Panel_EsportsSpotlightNavigationArea_C : UAresCommonUserWidget {
	...
	void On Configs Updated(struct FName& ConfigName); // Function WBP_Panel_EsportsSpotlightNavigationArea.WBP_Panel_EsportsSpotlightNavigationArea_C.On Configs Updated // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Bind Events(bool Should Bind); // Function WBP_Panel_EsportsSpotlightNavigationArea.WBP_Panel_EsportsSpotlightNavigationArea_C.Bind Events // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Update Button Visibility(); // Function WBP_Panel_EsportsSpotlightNavigationArea.WBP_Panel_EsportsSpotlightNavigationArea_C.Update Button Visibility // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetOverviewViewModel(struct UEsportsOverviewViewModel* OverviewVM); // Function WBP_Panel_EsportsSpotlightNavigationArea.WBP_Panel_EsportsSpotlightNavigationArea_C.SetOverviewViewModel // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	struct UWidget* BP_GetDesiredFocusTarget(); // Function WBP_Panel_EsportsSpotlightNavigationArea.WBP_Panel_EsportsSpotlightNavigationArea_C.BP_GetDesiredFocusTarget // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1b42740
	void Init(struct TArray<enum class E2024VCTEvent>& SpotlightEvents); // Function WBP_Panel_EsportsSpotlightNavigationArea.WBP_Panel_EsportsSpotlightNavigationArea_C.Init // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void PreConstruct(bool IsDesignTime); // Function WBP_Panel_EsportsSpotlightNavigationArea.WBP_Panel_EsportsSpotlightNavigationArea_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function WBP_Panel_EsportsSpotlightNavigationArea.WBP_Panel_EsportsSpotlightNavigationArea_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_WBP_Panel_EsportsSpotlightNavigationArea(int32_t EntryPoint); // Function WBP_Panel_EsportsSpotlightNavigationArea.WBP_Panel_EsportsSpotlightNavigationArea_C.ExecuteUbergraph_WBP_Panel_EsportsSpotlightNavigationArea // (Final|UbergraphFunction) // @ game+0x1b42740
};

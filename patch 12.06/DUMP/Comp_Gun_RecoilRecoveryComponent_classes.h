...
struct UComp_Gun_RecoilRecoveryComponent_C : URecoilRecoveryComponent {
	...
	void ReceiveBeginPlay(); // Function Comp_Gun_RecoilRecoveryComponent.Comp_Gun_RecoilRecoveryComponent_C.ReceiveBeginPlay // (Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ReceiveTick(float DeltaSeconds); // Function Comp_Gun_RecoilRecoveryComponent.Comp_Gun_RecoilRecoveryComponent_C.ReceiveTick // (Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_Comp_Gun_RecoilRecoveryComponent(int32_t EntryPoint); // Function Comp_Gun_RecoilRecoveryComponent.Comp_Gun_RecoilRecoveryComponent_C.ExecuteUbergraph_Comp_Gun_RecoilRecoveryComponent // (Final|UbergraphFunction) // @ game+0x1b42740
};

...
struct UWBP_Flyout_Hovercard_SocialPanelPlayer_C : UWBP_Flyout_Base_C {
	...
	void Set Observed Player(struct FString InPlayerSubject); // Function WBP_Flyout_Hovercard_SocialPanelPlayer.WBP_Flyout_Hovercard_SocialPanelPlayer_C.Set Observed Player // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnInitialized(); // Function WBP_Flyout_Hovercard_SocialPanelPlayer.WBP_Flyout_Hovercard_SocialPanelPlayer_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function WBP_Flyout_Hovercard_SocialPanelPlayer.WBP_Flyout_Hovercard_SocialPanelPlayer_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void OnPlayerPartyIdChanged(struct FString InPartyId); // Function WBP_Flyout_Hovercard_SocialPanelPlayer.WBP_Flyout_Hovercard_SocialPanelPlayer_C.OnPlayerPartyIdChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_WBP_Flyout_Hovercard_SocialPanelPlayer(int32_t EntryPoint); // Function WBP_Flyout_Hovercard_SocialPanelPlayer.WBP_Flyout_Hovercard_SocialPanelPlayer_C.ExecuteUbergraph_WBP_Flyout_Hovercard_SocialPanelPlayer // (Final|UbergraphFunction) // @ game+0x1b42740
};

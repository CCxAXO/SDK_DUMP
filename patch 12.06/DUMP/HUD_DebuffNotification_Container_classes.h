...
struct UHUD_DebuffNotification_Container_C : UCoordinatedHUDElement {
	...
	void ResetPortraits(); // Function HUD_DebuffNotification_Container.HUD_DebuffNotification_Container_C.ResetPortraits // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void InitializePortraits(int32_t& NumActivePortraits); // Function HUD_DebuffNotification_Container.HUD_DebuffNotification_Container_C.InitializePortraits // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetHUDModel(struct UCoordinatedHUDModel* HUDModel); // Function HUD_DebuffNotification_Container.HUD_DebuffNotification_Container_C.SetHUDModel // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function HUD_DebuffNotification_Container.HUD_DebuffNotification_Container_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_HUD_DebuffNotification_Container(int32_t EntryPoint); // Function HUD_DebuffNotification_Container.HUD_DebuffNotification_Container_C.ExecuteUbergraph_HUD_DebuffNotification_Container // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
};

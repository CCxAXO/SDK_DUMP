...
struct UWBP_View_CustomLobbyParty_C : UAresCommonUserWidget {
	...
	void UpdateForTournamentMode(bool bIsTournamentModeEnabled); // Function WBP_View_CustomLobbyParty.WBP_View_CustomLobbyParty_C.UpdateForTournamentMode // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	struct UWidget* BP_GetDesiredFocusTarget(); // Function WBP_View_CustomLobbyParty.WBP_View_CustomLobbyParty_C.BP_GetDesiredFocusTarget // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1b42740
	...
	void ExecuteUbergraph_WBP_View_CustomLobbyParty(int32_t EntryPoint); // Function WBP_View_CustomLobbyParty.WBP_View_CustomLobbyParty_C.ExecuteUbergraph_WBP_View_CustomLobbyParty // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
};

...
struct UMatchDetailsScoreboardTabPlayer_C : UUserWidget {
	...
	void SetDataFields(); // Function MatchDetailsScoreboardTabPlayer.MatchDetailsScoreboardTabPlayer_C.SetDataFields // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetBackgroundAndBorder(); // Function MatchDetailsScoreboardTabPlayer.MatchDetailsScoreboardTabPlayer_C.SetBackgroundAndBorder // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740

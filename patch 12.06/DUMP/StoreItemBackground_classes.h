...
struct UStoreItemBackground_C : UUserWidget {
	...
	void UpdateColor(struct FLinearColor ColorAndOpacity); // Function StoreItemBackground.StoreItemBackground_C.UpdateColor // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void PlayUnHoverAnim(); // Function StoreItemBackground.StoreItemBackground_C.PlayUnHoverAnim // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void PlayHoverAnim(); // Function StoreItemBackground.StoreItemBackground_C.PlayHoverAnim // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Set Active Background(enum class EPurchaseSource PurchaseSource); // Function StoreItemBackground.StoreItemBackground_C.Set Active Background // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void PreConstruct(bool IsDesignTime); // Function StoreItemBackground.StoreItemBackground_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function StoreItemBackground.StoreItemBackground_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_StoreItemBackground(int32_t EntryPoint); // Function StoreItemBackground.StoreItemBackground_C.ExecuteUbergraph_StoreItemBackground // (Final|UbergraphFunction) // @ game+0x1b42740
};

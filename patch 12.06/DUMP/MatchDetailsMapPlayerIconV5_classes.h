...
struct UMatchDetailsMapPlayerIconV5_C : UUserWidget {
	...
	void Construct(); // Function MatchDetailsMapPlayerIconV5.MatchDetailsMapPlayerIconV5_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_MatchDetailsMapPlayerIconV5(int32_t EntryPoint); // Function MatchDetailsMapPlayerIconV5.MatchDetailsMapPlayerIconV5_C.ExecuteUbergraph_MatchDetailsMapPlayerIconV5 // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
};

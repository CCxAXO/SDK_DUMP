...
struct UPlayerFacingPerfTextGroup_C : UUserWidget {
	...
	void Initialize Text Boxes Array(); // Function PlayerFacingPerfTextGroup.PlayerFacingPerfTextGroup_C.Initialize Text Boxes Array // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Update All Textbox Settings(); // Function PlayerFacingPerfTextGroup.PlayerFacingPerfTextGroup_C.Update All Textbox Settings // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Set Text Box Is Enabled(struct UPlayerFacingPerfText_C* Text Box); // Function PlayerFacingPerfTextGroup.PlayerFacingPerfTextGroup_C.Set Text Box Is Enabled // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Fill Grid(); // Function PlayerFacingPerfTextGroup.PlayerFacingPerfTextGroup_C.Fill Grid // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void On Settings Changed(enum class EAresIntSettingName Setting, int32_t Old Value, int32_t New Value); // Function PlayerFacingPerfTextGroup.PlayerFacingPerfTextGroup_C.On Settings Changed // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnInitialized(); // Function PlayerFacingPerfTextGroup.PlayerFacingPerfTextGroup_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_PlayerFacingPerfTextGroup(int32_t EntryPoint); // Function PlayerFacingPerfTextGroup.PlayerFacingPerfTextGroup_C.ExecuteUbergraph_PlayerFacingPerfTextGroup // (Final|UbergraphFunction) // @ game+0x1b42740
};

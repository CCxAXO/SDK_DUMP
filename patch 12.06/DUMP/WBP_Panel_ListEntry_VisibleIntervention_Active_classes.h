...
struct UWBP_Panel_ListEntry_VisibleIntervention_Active_C : UWBP_Panel_ListEntry_Social_Base_C {
	...
	void CloseHoverMessage(); // Function WBP_Panel_ListEntry_VisibleIntervention_Active.WBP_Panel_ListEntry_VisibleIntervention_Active_C.CloseHoverMessage // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OpenHoverMessage(); // Function WBP_Panel_ListEntry_VisibleIntervention_Active.WBP_Panel_ListEntry_VisibleIntervention_Active_C.OpenHoverMessage // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void HandleExperimentAssignmentChanged(struct UGroupExperimentAssignment* Group); // Function WBP_Panel_ListEntry_VisibleIntervention_Active.WBP_Panel_ListEntry_VisibleIntervention_Active_C.HandleExperimentAssignmentChanged // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	struct UWidget* BP_GetDesiredFocusTarget(); // Function WBP_Panel_ListEntry_VisibleIntervention_Active.WBP_Panel_ListEntry_VisibleIntervention_Active_C.BP_GetDesiredFocusTarget // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1b42740
	struct UWidget* OnHoverMessageMenuAnchorGetMenuContent(); // Function WBP_Panel_ListEntry_VisibleIntervention_Active.WBP_Panel_ListEntry_VisibleIntervention_Active_C.OnHoverMessageMenuAnchorGetMenuContent // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1b42740
	void InitializeListEntry(struct UObject* InListItemObject); // Function WBP_Panel_ListEntry_VisibleIntervention_Active.WBP_Panel_ListEntry_VisibleIntervention_Active_C.InitializeListEntry // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnInitialized(); // Function WBP_Panel_ListEntry_VisibleIntervention_Active.WBP_Panel_ListEntry_VisibleIntervention_Active_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	...
	void Construct(); // Function WBP_Panel_ListEntry_VisibleIntervention_Active.WBP_Panel_ListEntry_VisibleIntervention_Active_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void BP_OnEntryReleased(); // Function WBP_Panel_ListEntry_VisibleIntervention_Active.WBP_Panel_ListEntry_VisibleIntervention_Active_C.BP_OnEntryReleased // (Event|Protected|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_WBP_Panel_ListEntry_VisibleIntervention_Active(int32_t EntryPoint); // Function WBP_Panel_ListEntry_VisibleIntervention_Active.WBP_Panel_ListEntry_VisibleIntervention_Active_C.ExecuteUbergraph_WBP_Panel_ListEntry_VisibleIntervention_Active // (Final|UbergraphFunction) // @ game+0x1b42740
};

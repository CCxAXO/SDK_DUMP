...
struct UMeshTopologySelectionMechanicProperties : UInteractiveToolPropertySet {
	...
	void SelectAll(); // Function ModelingComponents.MeshTopologySelectionMechanicProperties.SelectAll // (Final|Native|Public) // @ game+0x5667990
	void InvertSelection(); // Function ModelingComponents.MeshTopologySelectionMechanicProperties.InvertSelection // (Final|Native|Public) // @ game+0x56679e0
};
...
struct UOctreeDynamicMeshComponent : UBaseDynamicMeshComponent {
	...
	void SetDynamicMesh(struct UDynamicMesh* NewMesh); // Function ModelingComponents.OctreeDynamicMeshComponent.SetDynamicMesh // (Final|Native|Public|BlueprintCallable) // @ game+0x5675790
};
...
struct UPreviewGeometry : UObject {
	...
	bool SetPointSetVisibility(struct FString PointSetIdentifier, bool bVisible); // Function ModelingComponents.PreviewGeometry.SetPointSetVisibility // (Final|Native|Public) // @ game+0x5693da0
	bool SetPointSetMaterial(struct FString PointSetIdentifier, struct UMaterialInterface* NewMaterial); // Function ModelingComponents.PreviewGeometry.SetPointSetMaterial // (Final|Native|Public) // @ game+0x5693b50
	bool SetLineSetVisibility(struct FString LineSetIdentifier, bool bVisible); // Function ModelingComponents.PreviewGeometry.SetLineSetVisibility // (Final|Native|Public) // @ game+0x5694990
	bool SetLineSetMaterial(struct FString LineSetIdentifier, struct UMaterialInterface* NewMaterial); // Function ModelingComponents.PreviewGeometry.SetLineSetMaterial // (Final|Native|Public) // @ game+0x5694740
	void SetAllPointSetsMaterial(struct UMaterialInterface* Material); // Function ModelingComponents.PreviewGeometry.SetAllPointSetsMaterial // (Final|Native|Public) // @ game+0x5693a60
	void SetAllLineSetsMaterial(struct UMaterialInterface* Material); // Function ModelingComponents.PreviewGeometry.SetAllLineSetsMaterial // (Final|Native|Public) // @ game+0x5694650
	bool RemovePointSet(struct FString PointSetIdentifier, bool bDestroy); // Function ModelingComponents.PreviewGeometry.RemovePointSet // (Final|Native|Public) // @ game+0x56940f0
	bool RemoveLineSet(struct FString LineSetIdentifier, bool bDestroy); // Function ModelingComponents.PreviewGeometry.RemoveLineSet // (Final|Native|Public) // @ game+0x5694ce0
	void RemoveAllPointSets(bool bDestroy); // Function ModelingComponents.PreviewGeometry.RemoveAllPointSets // (Final|Native|Public) // @ game+0x5693ff0
	void RemoveAllLineSets(bool bDestroy); // Function ModelingComponents.PreviewGeometry.RemoveAllLineSets // (Final|Native|Public) // @ game+0x5694be0
	struct APreviewGeometryActor* GetActor(); // Function ModelingComponents.PreviewGeometry.GetActor // (Final|Native|Public|Const) // @ game+0x5695500
	struct UTriangleSetComponent* FindTriangleSet(struct FString TriangleSetIdentifier); // Function ModelingComponents.PreviewGeometry.FindTriangleSet // (Final|Native|Public) // @ game+0x5695240
	struct UPointSetComponent* FindPointSet(struct FString PointSetIdentifier); // Function ModelingComponents.PreviewGeometry.FindPointSet // (Final|Native|Public) // @ game+0x5694380
	struct ULineSetComponent* FindLineSet(struct FString LineSetIdentifier); // Function ModelingComponents.PreviewGeometry.FindLineSet // (Final|Native|Public) // @ game+0x5694f70
	void Disconnect(); // Function ModelingComponents.PreviewGeometry.Disconnect // (Final|Native|Public) // @ game+0x5695520
	void CreateInWorld(struct UWorld* World, struct FTransform& WithTransform); // Function ModelingComponents.PreviewGeometry.CreateInWorld // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x5695570
	struct UTriangleSetComponent* AddTriangleSet(struct FString TriangleSetIdentifier); // Function ModelingComponents.PreviewGeometry.AddTriangleSet // (Final|Native|Public) // @ game+0x56953c0
	struct UPointSetComponent* AddPointSet(struct FString PointSetIdentifier); // Function ModelingComponents.PreviewGeometry.AddPointSet // (Final|Native|Public) // @ game+0x5694510
	struct ULineSetComponent* AddLineSet(struct FString LineSetIdentifier); // Function ModelingComponents.PreviewGeometry.AddLineSet // (Final|Native|Public) // @ game+0x5695100
};
...
struct UModelingObjectsCreationAPI : UObject {
	...
	struct FCreateTextureObjectResult CreateTextureObject(struct FCreateTextureObjectParams& CreateTexParams); // Function ModelingComponents.ModelingObjectsCreationAPI.CreateTextureObject // (Native|Public|HasOutParms|BlueprintCallable) // @ game+0x56c10d0
	struct FCreateActorResult CreateNewActor(struct FCreateActorParams& CreateActorParams); // Function ModelingComponents.ModelingObjectsCreationAPI.CreateNewActor // (Native|Public|HasOutParms|BlueprintCallable) // @ game+0x56c0da0
	struct FCreateMeshObjectResult CreateMeshObject(struct FCreateMeshObjectParams& CreateMeshParams); // Function ModelingComponents.ModelingObjectsCreationAPI.CreateMeshObject // (Native|Public|HasOutParms|BlueprintCallable) // @ game+0x56c1230
	struct FCreateMaterialObjectResult CreateMaterialObject(struct FCreateMaterialObjectParams& CreateMaterialParams); // Function ModelingComponents.ModelingObjectsCreationAPI.CreateMaterialObject // (Native|Public|HasOutParms|BlueprintCallable) // @ game+0x56c0f70
};
...
struct UCreateMeshObjectTypeProperties : UInteractiveToolPropertySet {
	...
	bool ShouldShowPropertySet(); // Function ModelingComponents.CreateMeshObjectTypeProperties.ShouldShowPropertySet // (Final|Native|Public|Const) // @ game+0x56c7d70
	struct TArray<struct FString> GetOutputTypeNamesFunc(); // Function ModelingComponents.CreateMeshObjectTypeProperties.GetOutputTypeNamesFunc // (Final|Native|Public) // @ game+0x56c7dc0
	enum class ECreateObjectTypeHint GetCurrentCreateMeshType(); // Function ModelingComponents.CreateMeshObjectTypeProperties.GetCurrentCreateMeshType // (Final|Native|Public|Const) // @ game+0x56c7d40
};
...
struct UPolygroupLayersProperties : UInteractiveToolPropertySet {
	...
	struct TArray<struct FString> GetGroupLayersFunc(); // Function ModelingComponents.PolygroupLayersProperties.GetGroupLayersFunc // (Final|Native|Public) // @ game+0x56c8d20
};
...
struct UWeightMapSetProperties : UInteractiveToolPropertySet {
	...
	struct TArray<struct FString> GetWeightMapsFunc(); // Function ModelingComponents.WeightMapSetProperties.GetWeightMapsFunc // (Final|Native|Public) // @ game+0x56c8d20
};

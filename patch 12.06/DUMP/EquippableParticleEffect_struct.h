...
struct FEquippableParticleEffect {
	...
	struct FTransform SpawnTransform_27_94C3828247D8E101703B23BF7F84E58E; // 0x60(0x60)
	enum class EAresParticleVariantColor VariantColor_32_3825E2234C0E6F665069D2B810BC484C; // 0xc0(0x01)
};

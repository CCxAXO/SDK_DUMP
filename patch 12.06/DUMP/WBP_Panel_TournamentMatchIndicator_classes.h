...
struct UWBP_Panel_TournamentMatchIndicator_C : UAresCommonUserWidget {
	...
	void SetIndicatorDirection(enum class E_TournamentMatchIndicatorDirection InDirection); // Function WBP_Panel_TournamentMatchIndicator.WBP_Panel_TournamentMatchIndicator_C.SetIndicatorDirection // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

...
struct UMatchDetailsScoreboardTabPlayerDeathmatch_C : UUserWidget {
	...
	void SetDataFields(); // Function MatchDetailsScoreboardTabPlayerDeathmatch.MatchDetailsScoreboardTabPlayerDeathmatch_C.SetDataFields // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetBackgroundAndBorder(); // Function MatchDetailsScoreboardTabPlayerDeathmatch.MatchDetailsScoreboardTabPlayerDeathmatch_C.SetBackgroundAndBorder // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740

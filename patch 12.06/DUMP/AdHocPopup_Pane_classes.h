...
struct UAdHocPopup_Pane_C : UUserWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function AdHocPopup_Pane.AdHocPopup_Pane_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_AdHocPopup_Pane(int32_t EntryPoint); // Function AdHocPopup_Pane.AdHocPopup_Pane_C.ExecuteUbergraph_AdHocPopup_Pane // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
};

...
struct UWBP_View_CharacterSelectTeamState_PC_C : UWBP_View_CharacterSelectTeamState_C {
	...
	void GetTeamMemberStatesLeftToRight(struct TArray<struct UWBP_View_CharacterSelectTeamMemberState_C*>& TeamMembers); // Function WBP_View_CharacterSelectTeamState_PC.WBP_View_CharacterSelectTeamState_PC_C.GetTeamMemberStatesLeftToRight // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1b42740
	void GetTeamMemberStates(struct TArray<struct UWBP_View_CharacterSelectTeamMemberState_C*>& TeamMembers); // Function WBP_View_CharacterSelectTeamState_PC.WBP_View_CharacterSelectTeamState_PC_C.GetTeamMemberStates // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1b42740
};

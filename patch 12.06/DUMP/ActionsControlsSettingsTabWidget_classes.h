...
struct UActionsControlsSettingsTabWidget_C : USettingsSubsectionWrapperBase_C {
	...
	void UpdateCharacterForSettings(struct UCharacterHandle* CharacterHandle); // Function ActionsControlsSettingsTabWidget.ActionsControlsSettingsTabWidget_C.UpdateCharacterForSettings // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

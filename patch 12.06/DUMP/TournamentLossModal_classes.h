...
struct UTournamentLossModal_C : UUserWidget {
	...
	void ExecuteUbergraph_TournamentLossModal(int32_t EntryPoint); // Function TournamentLossModal.TournamentLossModal_C.ExecuteUbergraph_TournamentLossModal // (Final|UbergraphFunction) // @ game+0x1b42740
	void On Close__DelegateSignature(); // Function TournamentLossModal.TournamentLossModal_C.On Close__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

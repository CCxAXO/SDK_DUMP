...
struct UGameplay_MouseSettingsWidget_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function Gameplay_MouseSettingsWidget.Gameplay_MouseSettingsWidget_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_Gameplay_MouseSettingsWidget(int32_t EntryPoint); // Function Gameplay_MouseSettingsWidget.Gameplay_MouseSettingsWidget_C.ExecuteUbergraph_Gameplay_MouseSettingsWidget // (Final|UbergraphFunction) // @ game+0x1b42740
};

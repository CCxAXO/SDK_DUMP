...
struct UTournamentConsolationBracketModal_C : UUserWidget {
	...
	void ExecuteUbergraph_TournamentConsolationBracketModal(int32_t EntryPoint); // Function TournamentConsolationBracketModal.TournamentConsolationBracketModal_C.ExecuteUbergraph_TournamentConsolationBracketModal // (Final|UbergraphFunction) // @ game+0x1b42740
	void On Show Consolation Bracket__DelegateSignature(); // Function TournamentConsolationBracketModal.TournamentConsolationBracketModal_C.On Show Consolation Bracket__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void On Close__DelegateSignature(); // Function TournamentConsolationBracketModal.TournamentConsolationBracketModal_C.On Close__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

...
struct UInterfaceControls_ReplayOnlySettings_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function InterfaceControls_ReplayOnlySettings.InterfaceControls_ReplayOnlySettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_InterfaceControls_ReplayOnlySettings(int32_t EntryPoint); // Function InterfaceControls_ReplayOnlySettings.InterfaceControls_ReplayOnlySettings_C.ExecuteUbergraph_InterfaceControls_ReplayOnlySettings // (Final|UbergraphFunction) // @ game+0x1b42740
};

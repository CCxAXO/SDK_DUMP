...
struct UInterfaceControls_VoteSettings_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function InterfaceControls_VoteSettings.InterfaceControls_VoteSettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_InterfaceControls_VoteSettings(int32_t EntryPoint); // Function InterfaceControls_VoteSettings.InterfaceControls_VoteSettings_C.ExecuteUbergraph_InterfaceControls_VoteSettings // (Final|UbergraphFunction) // @ game+0x1b42740
};

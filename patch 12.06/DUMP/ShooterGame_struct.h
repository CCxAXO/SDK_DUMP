...
enum class EAresBoolSettingName : uint8 {
	...
	TempWConnectButtonDismissed = 191,
	MatureContentFilter = 192,
	ShowBloodVisual = 193,
	ShowCorpsesVisual = 194,
	AllowCrossPlay = 195,
	ShowCrossPlayWarning = 196,
	ShowNewPlayerTips = 197,
	ContextAwareModuleComplete = 198,
	EnableToggleableUsables = 199,
	GamepadRiftCosmicDivideOffset = 200,
	GamepadClayAutomatedBackthrow = 201,
	GamepadHapticsEnabled = 202,
	ShowReplayTimeInMs = 203,
	ShowKeyboardShortcutsOnButtons = 204,
	ShowFinalStatsInScoreboard = 205,
	ShowDeathMarkersOnTimeline = 206,
	ShowUltimateMarkersOnTimeline = 207,
	NvidiaReflexLatewarpSetting = 208,
	PremierTeamForceRenameNoticeShown = 209,
	AllyLoadoutInfoAlwaysVisibleInReplays = 210,
	SpectateDeadPlayersDuringReplayPlayback = 211,
	Count = 212,
	EAresBoolSettingName_MAX = 213
};
...
enum class EAresFriendRequestResponseErrors : uint8 {
	...
	NoParentalPermission = 10,
	InternalError = 11,
	EAresFriendRequestResponseErrors_MAX = 12
};
...
// Enum ShooterGame.EAresBlockUnblockResponse
enum class EAresBlockUnblockResponse : uint8 {
	None = 0,
	Block = 1,
	Unblock = 2,
	EAresBlockUnblockResponse_MAX = 3
};
...
// Enum ShooterGame.EInboxEntryState
enum class EInboxEntryState : uint8 {
	Unread = 0,
	Read = 1,
	EInboxEntryState_MAX = 2
};
...
enum class EAresIntSettingName : uint8 {
	...
	GamepadMapCursorCurveMiksSmokes = 90,
	GamepadMapCursorCurveMegamap = 91,
	TouchDoubleTapRight = 92,
	TouchHUDPreset = 93,
	TouchDoubleTapLeft = 94,
	TouchJoystickStyle = 95,
	TouchSniperZoomLevelSetting = 96,
	TouchOperatorZoomCycleStyle = 97,
	TouchOperatorZoomCycleStyle_CachedAllLevels = 98,
	TouchOperatorZoomCycleStyle_CachedLevelOne = 99,
	TouchOperatorZoomCycleStyle_CachedLevelTwo = 100,
	TouchAimSensitivityPreset = 101,
	...
	LastAcceptedCodeOfConductVersion = 121,
	VoiceSpeakingChannel = 122,
	PreferredVoiceSpeakingChannel = 123,
	Count = 124,
	EAresIntSettingName_MAX = 125
};
...
// Enum ShooterGame.ENewsTileNavigationType
enum class ENewsTileNavigationType : uint8 {
	MenuNavigation = 0,
	WWWNavigation = 1,
	ENewsTileNavigationType_MAX = 2
};
...
enum class EPartyErrorEnum : uint8 {
	...
	ErrAffinityMismatch = 70,
	ErrInvalid = 71,
	EPartyErrorEnum_MAX = 72
};
...
enum class EGameFeatureToggleName : uint8 {
	...
	EnableStopAudioOnProjectileEndPlay = 174,
	FoWSkipCacheOptimization = 175,
	DisarmedEquippablePermissionRespectRestrictions = 176,
	CalculateFoWRelevanceOptimization = 177,
	FoWSupportMaxRelevantDistance = 178,
	FoWSupportMaxRelevantDistanceLongCache = 179,
	FoWMaxRelevantDistanceBeforeOverrides = 180,
	ProjectileThrowRemoveDelay = 181,
	CancelUsableOnEndPlay = 182,
	SkipHiddenUntickedRemoteTransformUpdates = 183,
	CloveStopOverhealOnDamaged = 184,
	AllowTemporaryCharacterOverlaps = 185,
	ReynaOverhealCleanupOnEquippableSetOwner = 186,
	EnableOverhealRefactor = 187,
	ZeroRadiusProjectiles = 188,
	YoruCloneSendsDeathEvent = 189,
	AllowTargetViewLandmarkMaterialSwap = 190,
	AIPerceptionIncreasedTimeSlicePerTick = 191,
	AIPerceptionIncreasedTracesPerTick = 192,
	AlarmbotLOSImprovements = 193,
	EnableSecondCameraTick = 194,
	UseCapsuleForPruneComplexRewind = 195,
	ViperUltPatchTechV2 = 196,
	TargetViewModeIgnoreFirstPerson = 197,
	FoWEnableEnhancedMetrics = 198,
	AudioBypassMaxDurationCheck = 199,
	CameraShakeConcussReapply = 200,
	UseAwakeReplicationFrequencyGFC = 201,
	ClipAfterBoneTransformsUpdated = 202,
	ControllerDrivenSpectateTargets = 203,
	AlwaysUseClipPlaneForHiddenCharacters = 204,
	EnableRGIMetrics = 205,
	ForceSendCorrectionIndexAck = 206,
	AudioEnableDoorOcclusion = 207,
	UsableComponentControlledHighlighting = 208,
	UseNewBestUsableTargetingLogic = 209,
	RemoveAllDebuffsOnCleanse = 210,
	EnablePlacementFixes = 211,
	AudioEnableStopSoundCleanupChecks = 212,
	PhysXSphereTriangleTraceParity = 213,
	AudioEnableStopSoundEndPlay = 214,
	ShouldMarkMatchesAsRecorded = 215,
	ShouldMarkMatchesAsRecordedConsole = 216,
	DynamicContentEnabled = 217,
	UseNewBuffDebuffTagHUD = 218,
	EnableSpikePlacementRestrictions = 219,
	EnableTopHUDHealthbarHealUIChange = 220,
	AudioEnableSoundBlockerChecks = 221,
	AltModeTelemetryEnabled = 222,
	AssistBannersEnabled = 223,
	SharedSerializationReconnectReset = 224,
	NegatedDamageNotify = 225,
	HudBlueprintLibraryV2 = 226,
	NavAreaClassChange = 227,
	JumpBoostingFixesEnabled = 228,
	RewindPlayerCapsuleHeight = 229,
	EnableTeamNumber = 230,
	SendFullInventoryEvents = 231,
	ShowLocalViewTargetBuffs = 232,
	KillfeedAssistAbilityIconsEnabled = 233,
	ServerAnimOnlyUpdatesPhysBodiesOnEval = 234,
	ControlBonusMovespeedRunWithCurve = 235,
	Count = 236,
	Invalid = 254,
...
enum class EGameRuleBoolName : uint8 {
	...
	FillWithBots = 14,
	AllowDropIn = 15,
	DestroyAbilitiesOnDeath = 16,
	PreventAbilityRecharge = 17,
	ReplayRecordMatch = 18,
	UseMapPicksAndBans = 19,
	AllowMatchTimeouts = 20,
	AllowAutomaticRemakeVote = 21,
	AimToolingModule = 22,
	AimToolingBending = 23,
	AimToolingPullToCenter = 24,
	AimToolingDeceleration = 25,
	AimToolingFrameOfReference = 26,
	AimToolingStrafeAssist = 27,
	AimToolingTargetFriction = 28,
	AimToolingGuardrails = 29,
	MovementToolingModule = 30,
	MovementToolingShotRooting = 31,
	MovementToolingFastStrafing = 32,
	MovementToolingFastRelease = 33,
	PipAbilityCasting = 34,
	CombatReportOnlyShowLastLife = 35,
	UsePrototypePurchasables = 36,
	MobileGunStability = 37,
	MobileDesignPrototype = 38,
	FootstepABTest = 39,
	UseAllAbilityCooldowns = 40,
	DownedCharactersCanGiveUp = 41,
	SpawnTurtleProtection = 42,
	PrototypeStability = 43,
	AccoladesEnabled = 44,
	PremierTournamentMode = 45,
	UseInDevWeapons = 46,
	DisableShopSelling = 47,
	ContextAwareModuleEnabled = 48,
	SkipMatchDetails = 49,
	AssignPreferredAgents = 50,
	AllowQueueInGame = 51,
	TempChargesAsReclaimed = 52,
	SlidesNoFallDamage = 53,
	SkipUltimateAbilityReadyVO = 54,
	AllowUnownedAgents = 55,
	FillWithClientBots = 56,
	MarsClientBotsShouldSpectate = 57,
	FlexibleWeaponSlots = 58,
	UseGameStateTargetServerTickRate = 59,
	UseTargetFixedMoveTimeStepsPerSecond = 60,
	RoundOvertimeEnabled = 61,
	UseTeamNumbers = 62,
	UseViewTargetForFresnelColors = 63,
	Count = 64,
	Invalid = 254,
...
enum class ECustomGameRuleDisabledReason : uint8 {
	...
	SkipMatchHistoryEnabled = 3,
	InvalidGameMode = 4,
	IsNotPartyOwner = 5,
	ECustomGameRuleDisabledReason_MAX = 6
};
...
// Enum ShooterGame.EAresTextChatPermission
enum class EAresTextChatPermission : uint8 {
	Everyone = 0,
	FriendsOnly = 1,
	None = 2,
	EAresTextChatPermission_MAX = 3
};
...
// Enum ShooterGame.EUINavigationBarPosition
enum class EUINavigationBarPosition : uint8 {
	Standard = 0,
	StandardWithTitle = 1,
	TopFlush = 2,
	COUNT = 3,
	EUINavigationBarPosition_MAX = 4
};
...
// Enum ShooterGame.EOverhealHealType
enum class EOverhealHealType : uint8 {
	Heal = 0,
	Overheal = 1,
	EOverhealHealType_MAX = 2
};
...
enum class EAresSocialStatusTemplate : uint8 {
	...
	Blocked = 10,
	InReplay = 11,
	ActivePlatformStatus = 12,
	WStatus = 13,
	EAresSocialStatusTemplate_MAX = 14
};
...
// Enum ShooterGame.EAresRemoveFriendErrors
enum class EAresRemoveFriendErrors : uint8 {
	FriendNotFound = 0,
	InternalError = 1,
	EAresRemoveFriendErrors_MAX = 2
};
...
enum class EStoreOfferType : uint8 {
	...
	STOREOFFERTYPE_BLOOMLINE = 7,
	STOREOFFERTYPE_CTA = 8,
	STOREOFFERTYPE_MAX = 9
};
...
enum class EUITelemetryActionType : uint8 {
	...
	Count = 4,
	Invalid = 5,
	EUITelemetryActionType_MAX = 6
};

// Enum ShooterGame.ETencentLoginPlatform
enum class ETencentLoginPlatform : uint8 {
	Invalid = 0,
	WeChat = 1,
	QQ = 2,
	ETencentLoginPlatform_MAX = 3
};
...
enum class EPostAudioEventResult : uint8 {
	Success = 0,
	Fail_LocalController = 1,
	Fail_PlayerState = 2,
	Fail_AudioEvent = 3,
	Fail_AudioEmitter = 4,
	Fail_AudioEventOverride = 5,
	Fail_ShouldPlaySound = 6,
	Fail_ShouldPlaySoundAlliance = 7,
	Fail_ShouldPlaySoundPerspective = 8,
	Fail_UpdateCurrentPerspective = 9,
	Fail_UpdateFogOfWarExposure = 10,
	Fail_PlayingId = 11,
	EPostAudioEventResult_MAX = 12
};
...
enum class EOfferDTOType : uint8 {
	...
	VIRTUAL_CURRENCY = 14,
	BLOOMLINE_TRACK = 15,
	BLOOMLINE_TRACK_ITEM = 16,
	CTA = 17,
	COUNT = 18,
	EOfferDTOType_MAX = 19
};
...
// Enum ShooterGame.EAudioAttenuationVisualizationType
enum class EAudioAttenuationVisualizationType : uint8 {
	OneShot = 0,
	Continuous = 1,
	EAudioAttenuationVisualizationType_MAX = 2
};
...
// Enum ShooterGame.EAresMosaicFocusReturnType
enum class EAresMosaicFocusReturnType : uint8 {
	None = 0,
	Selection = 1,
	DirectionalNavigation = 2,
	ZeroIndex = 3,
	Count = 4,
	EAresMosaicFocusReturnType_MAX = 5
};
...
enum class EListenerTrackerHeightOverride : uint8 {
	...
	Listener = 1,
	TrackerObject = 2,
	EListenerTrackerHeightOverride_MAX = 3
};
...
// Enum ShooterGame.EAresMosaicType
enum class EAresMosaicType : uint8 {
	None = 0,
	Flexible = 1,
	COUNT = 2,
	EAresMosaicType_MAX = 3
};

// Enum ShooterGame.EAresFlexibleMosaicElementType
enum class EAresFlexibleMosaicElementType : uint8 {
	None = 0,
	Container = 1,
	Widget = 2,
	EAresFlexibleMosaicElementType_MAX = 3
};
...
enum class ESettingsPageVisibilityConditions : uint8 {
	None = 0,
	ReplaysEnabled = 1,
	ParentalControlsEnabled = 2,
	All = 1,
	Count = 1,
	ESettingsPageVisibilityConditions_MAX = 3
};
...
enum class EUINavigationTabListPriority : uint8 {
	...
	Tertiary = 4,
	COUNT = 5,
	EUINavigationTabListPriority_MAX = 6
};
...
// Enum ShooterGame.EBloomlineStageDisplayWidth
enum class EBloomlineStageDisplayWidth : uint8 {
	SMALL = 0,
	MEDIUM = 1,
	LARGE = 2,
	EBloomlineStageDisplayWidth_MAX = 3
};
...
enum class ECapID : uint8 {
	...
	BloomlinePlankBackgroundTypeID = 22,
	BloomlineHypeTypeID = 23,
	BloomlinePlankNumberTypeID = 24,
	BloomlinePlankBorderTypeID = 25,
	BloomlineClipTypeID = 26,
	PermanentEntitlementTypeID = 27,
	LoyaltyEntitlementTypeID = 28,
	XGPEntitlementTypeID = 29,
	CurrencyRewardTypeID = 30,
	ContractXPCurrencyID = 31,
	F2PEntitlementTypeID = 32,
	Count = 33,
	ECapID_MAX = 34
};
...
// Enum ShooterGame.ECharacterAbilityStatisticList
enum class ECharacterAbilityStatisticList : uint8 {
	...
	AlliesSlowed = 56,
	EnemiesJammed = 57,
	KilledWhileDisarmed = 58,
	KillsWhileDisarmed = 59,
	HasLineOfSight = 60,
	UtilsDamaged = 61,
	UtilsDestroyed = 62,
	DamageDoneToUtils = 63,
	TargetKills = 64,
	DebuffResisted = 65,
	InitialAffectedRoundTime = 66,
	AlliesHealed = 67,
	EnemiesHealed = 68,
	StimDuration = 69,
	StimRefresh = 70,
	KilledWhileStimmed = 71,
	AlliesSaved = 72,
	ECharacterAbilityStatisticList_MAX = 73
};
...
enum class EAresContentType : uint8 {
	...
	BTE = 42,
	EsportsTeam = 43,
	BloomlineFlourish = 44,
	BloomlineTrack = 45,
	BloomlineShortTrack = 46,
	BloomlinePlankBackground = 47,
	BloomlineHype = 48,
	BloomlinePlankNumber = 49,
	BloomlinePlankBorder = 50,
	BloomlineClip = 51,
	NewsItem = 52,
	Invalid = 53,
	Count = 54,
	EAresContentType_MAX = 55
};
...
// Enum ShooterGame.EPostAudioEventsType
enum class EPostAudioEventsType : uint8 {
	PostImmediately = 0,
	PostManually = 1,
	LifetimeThreshold = 2,
	EPostAudioEventsType_MAX = 3
};

// Enum ShooterGame.EAudioEventsPlaybackType
enum class EAudioEventsPlaybackType : uint8 {
	OneShot = 0,
	Looping = 1,
	EAudioEventsPlaybackType_MAX = 2
};
...
// Enum ShooterGame.EPostAssociatedAudioEventsType
enum class EPostAssociatedAudioEventsType : uint8 {
	AudioEvents = 0,
	StopAudioEvents = 1,
	EPostAssociatedAudioEventsType_MAX = 2
};

// Enum ShooterGame.ERefreshAudioEmitterResult
enum class ERefreshAudioEmitterResult : uint8 {
	Success = 0,
	Fail_AudioEvent = 1,
	Fail_AudioEmitter = 2,
	Fail_AudioEventOverride = 3,
	Fail_ClassValidForRefresh = 4,
	Fail_StopAudioEventsTriggered = 5,
	Fail_UpdateCurrentPerspective = 6,
	Fail_EffectContainer = 7,
	ERefreshAudioEmitterResult_MAX = 8
};

// Enum ShooterGame.EPerspectiveObjectType
enum class EPerspectiveObjectType : uint8 {
	FXC_Owner = 0,
	FXC_ContextObject = 1,
	FXC_EffectDataObject = 2,
	FXC_MAX = 3
};

// Enum ShooterGame.EPerspectiveObjectScope
enum class EPerspectiveObjectScope : uint8 {
	Object = 0,
	Instigator = 1,
	ParentInstigator = 2,
	EPerspectiveObjectScope_MAX = 3
};

// Enum ShooterGame.EPerspectiveType
enum class EPerspectiveType : uint8 {
	None = 0,
	FirstPerson = 1,
	ThirdPersonAlly = 2,
	ThirdPersonEnemy = 3,
	EPerspectiveType_MAX = 4
};

// Enum ShooterGame.EAudioDataSourceType
enum class EAudioDataSourceType : uint8 {
	AudioEvent = 0,
	UserDefined = 1,
	EAudioDataSourceType_MAX = 2
};

// Enum ShooterGame.EDataSourceType
enum class EDataSourceType : uint8 {
	EffectData = 0,
	UserDefined = 1,
	EDataSourceType_MAX = 2
};

// Enum ShooterGame.ERatioOrValue
enum class ERatioOrValue : uint8 {
	Ratio = 0,
	Value = 1,
	ERatioOrValue_MAX = 2
};
...
// Enum ShooterGame.EGunAttachmentType
enum class EGunAttachmentType : uint8 {
	Reflex = 0,
	Silencer = 1,
	Magazine = 2,
	EGunAttachmentType_MAX = 3
};
...
// Enum ShooterGame.EParticleAllyVisibility
enum class EParticleAllyVisibility : uint8 {
	All = 0,
	InstigatorOnly = 1,
	AllExceptInstigator = 2,
	None = 3,
	EParticleAllyVisibility_MAX = 4
};
...
// Enum ShooterGame.EEsportsSplit
enum class EEsportsSplit : uint8 {
	VCTKickoff = 0,
	VCTMasters1 = 1,
	VCTStage1 = 2,
	VCTMasters2 = 3,
...
// Enum ShooterGame.EEsportsSeason
enum class EEsportsSeason : uint8 {
	VCT = 0,
	GC = 1,
	Count = 2,
	Invalid = 3,
	EEsportsSeason_MAX = 4
};
...
enum class EEsportsModelType : uint8 {
	...
	Season = 10,
	Split = 11,
	GlobalPowerRankings = 12,
	None = 13,
	EEsportsModelType_MAX = 14
};
...
// Enum ShooterGame.ECompactEventType
enum class ECompactEventType : uint8 {
	None = 0,
	BTE = 1,
	EventPass = 2,
	RecruitmentEvent = 3,
	ECompactEventType_MAX = 4
};

// Enum ShooterGame.EExplosionExplodeCompleteAction
enum class EExplosionExplodeCompleteAction : uint8 {
	Destroy = 0,
	Idle = 1,
	Count = 2,
	EExplosionExplodeCompleteAction_MAX = 3
};
...
// Enum ShooterGame.EInboxEnabledState
enum class EInboxEnabledState : uint8 {
	Disabled = 0,
	PendingSubscribe = 1,
	Enabled = 2,
	EInboxEnabledState_MAX = 3
};
...
enum class EModalContextType : uint8 {
	Contains = 0,
	ContainsNonBlocking = 1,
	Exact = 2,
	RestrictiveContains = 3,
	RestrictiveExact = 4,
	Block = 5,
	EModalContextType_MAX = 6
};
...
// Enum ShooterGame.ENewsItemSize
enum class ENewsItemSize : uint8 {
	Large = 0,
	Medium = 1,
	Small = 2,
	ENewsItemSize_MAX = 3
...
// Enum ShooterGame.ENewsLinkType
...
enum class EOutOfGameConfigurationConfigBool : uint8 {
	...
	PROGRESSION_ADHOC_BANNER_ENABLED = 2,
	PROGRESSION_CONVERGENCE_BATTLEPASS = 3,
	PROGRESSION_CONVERGENCE_EOG = 4,
	PROGRESSION_CONVERGENCE_EVENTPASS = 5,
	EOutOfGameConfigurationConfigBool_MAX = 6
};

// Enum ShooterGame.ELeaveMatchmakingReason
enum class ELeaveMatchmakingReason : uint8 {
	Unknown = 0,
	Manual = 1,
	Hotfix = 2,
	TitleUpdate = 3,
	Count = 4,
	ELeaveMatchmakingReason_MAX = 5
};
...
enum class EPlatformInitErrorReason : uint8 {
	...
	BloomlineInitFailure = 94,
	RecruitmentInitConfigurationFailure = 95,
	Count = 96,
	EPlatformInitErrorReason_MAX = 97
};
...
enum class EPremierMatchmakingStrategy : uint8 {
	...
	SCHEDULED_ROUND = 3,
	Count = 4,
	EPremierMatchmakingStrategy_MAX = 5
};
...
// Enum ShooterGame.EPremierScheduledEventType
enum class EPremierScheduledEventType : uint8 {
	INVALID = 0,
	LEAGUE = 1,
	TOURNAMENT = 2,
	SCRIM = 3,
	ROUND = 4,
	Count = 5,
	EPremierScheduledEventType_MAX = 6
};
...
enum class EPurchaseType : uint8 {
	...
	PurchaseType_BloomlineTrackSnack = 16,
	Count = 17,
	EPurchaseType_MAX = 18
};
...
// Enum ShooterGame.EAxisBindingVerticalPosition
enum class EAxisBindingVerticalPosition : uint8 {
	Above = 0,
	Below = 1,
	EAxisBindingVerticalPosition_MAX = 2
};
...
// Enum ShooterGame.EPitchOffsetOverrideType
enum class EPitchOffsetOverrideType : uint8 {
	Plus600 = 0,
	Plus500 = 1,
	Plus400 = 2,
	Plus300 = 3,
	...
	Negative500 = 11,
	Negative600 = 12,
	EPitchOffsetOverrideType_MAX = 13
};
...
enum class EAresIdentityDisplay : uint8 {
	...
	Alternative_P = 5,
	Alternative_W = 6,
	PriorityLinkedIdentitySource = 7,
	EAresIdentityDisplay_MAX = 8
};
...
// Enum ShooterGame.EAresActivePlatformPresenceState
enum class EAresActivePlatformPresenceState : uint8 {
	Online = 0,
	Offline = 1,
	EAresActivePlatformPresenceState_MAX = 2
};

// Enum ShooterGame.EAresWPresenceState
enum class EAresWPresenceState : uint8 {
	Online = 0,
	Idle = 1,
	DoNotDisturb = 2,
	Offline = 3,
	EAresWPresenceState_MAX = 4
};
...
enum class ESocialIntegrationPlatform : uint8 {
	...
	TempW = 2,
	Count = 3,
	ESocialIntegrationPlatform_MAX = 4
};
...
// Enum ShooterGame.ECTAType
enum class ECTAType : uint8 {
	NONE = 0,
	ESPORTS = 1,
	COUNT = 2,
	ECTAType_MAX = 3
...
// Enum ShooterGame.EFeaturedTileType
enum class EFeaturedTileType : uint8 {
	BUNDLE = 0,
	CTA = 1,
	EFeaturedTileType_MAX = 2
};
...
// Enum ShooterGame.EContentDisplayType
enum class EContentDisplayType : uint8 {
	NONE = 0,
	HORIZONTAL = 1,
	VERTICAL = 2,
	EContentDisplayType_MAX = 3
};
...
// Enum ShooterGame.ELastAliveOutcome
enum class ELastAliveOutcome : uint8 {
	None = 0,
	Death = 1,
	Revive = 2,
	RoundWin = 3,
	ELastAliveOutcome_MAX = 4
};
...
// Enum ShooterGame.EUINavigationIntent
enum class EUINavigationIntent : uint8 {
	Automatic = 0,
	UserInitiated = 1,
	Invalid = 2,
	EUINavigationIntent_MAX = 3
};
...
// Enum ShooterGame.EBitflagInputStreamBits
enum class EBitflagInputStreamBits : int32 {
	None = 0,
	Forward = 1,
	Backward = 2,
	Left = 4,
	...
	Jump = 4096,
	Shop = 8192,
	ActivatePrimary = 16384,
	ActivateSecondary = 32768,
	ActivateMelee = 65536,
	ActivateAbilityGrenade = 131072,
	ActivateAbility1 = 262144,
	ActivateAbility2 = 524288,
	ActivateAbilityUltimate = 1048576,
	ActivateLevel = 2097152,
	EBitflagInputStreamBits_MAX = 2097153
};

// Enum ShooterGame.ELineTraceDirection
enum class ELineTraceDirection : uint8 {
	CrosshairDirection = 0,
	BodyDirection = 1,
	FixedWorldDirection = 2,
	ELineTraceDirection_MAX = 3
};
...
struct FAresAssist {
	...
	struct AAresEquippable* AssistingEquippableClass; // 0x10(0x08)
};
...
struct FLeaderboardPlayer {
	...
	enum class EPremierRosterType PremierRosterType; // 0x40(0x01)
	char pad_41[0x3]; // 0x41(0x03)
	struct FGuid PlayerCardId; // 0x44(0x10)
	struct FGuid TitleId; // 0x54(0x10)
	int32_t RankedRating; // 0x64(0x04)
	int32_t CompetitiveTier; // 0x68(0x04)
	int32_t LeaderboardRank; // 0x6c(0x04)
	int32_t NumberOfWins; // 0x70(0x04)
	bool IsAnonymized; // 0x74(0x01)
	bool IsBanned; // 0x75(0x01)
	bool IsSeparator; // 0x76(0x01)
...
// ScriptStruct ShooterGame.BloomlineClipHandles
// Size: 0x50 (Inherited: 0x00)
struct FBloomlineClipHandles {
	struct TMap<struct UBloomlineClipDataAsset*, struct UBloomlineClipHandle*> Handles; // 0x00(0x50)
};

// ScriptStruct ShooterGame.BloomlineFlourishHandles
// Size: 0x50 (Inherited: 0x00)
struct FBloomlineFlourishHandles {
	struct TMap<struct UBloomlineFlourishDataAsset*, struct UBloomlineFlourishHandle*> Handles; // 0x00(0x50)
};

// ScriptStruct ShooterGame.BloomlineHypeHandles
// Size: 0x50 (Inherited: 0x00)
struct FBloomlineHypeHandles {
	struct TMap<struct UBloomlineHypeDataAsset*, struct UBloomlineHypeHandle*> Handles; // 0x00(0x50)
};

// ScriptStruct ShooterGame.BloomlinePlankBackgroundHandles
// Size: 0x50 (Inherited: 0x00)
struct FBloomlinePlankBackgroundHandles {
	struct TMap<struct UBloomlinePlankBackgroundDataAsset*, struct UBloomlinePlankBackgroundHandle*> Handles; // 0x00(0x50)
};

// ScriptStruct ShooterGame.BloomlinePlankBorderHandles
// Size: 0x50 (Inherited: 0x00)
struct FBloomlinePlankBorderHandles {
	struct TMap<struct UBloomlinePlankBorderDataAsset*, struct UBloomlinePlankBorderHandle*> Handles; // 0x00(0x50)
};

// ScriptStruct ShooterGame.BloomlinePlankNumberHandles
// Size: 0x50 (Inherited: 0x00)
struct FBloomlinePlankNumberHandles {
	struct TMap<struct UBloomlinePlankNumberDataAsset*, struct UBloomlinePlankNumberHandle*> Handles; // 0x00(0x50)
};

// ScriptStruct ShooterGame.BloomlineShortTrackHandles
// Size: 0x50 (Inherited: 0x00)
struct FBloomlineShortTrackHandles {
	struct TMap<struct UBloomlineShortTrackDataAsset*, struct UBloomlineShortTrackHandle*> Handles; // 0x00(0x50)
};

// ScriptStruct ShooterGame.BloomlineTrackHandles
// Size: 0x50 (Inherited: 0x00)
struct FBloomlineTrackHandles {
	struct TMap<struct UBloomlineTrackDataAsset*, struct UBloomlineTrackHandle*> Handles; // 0x00(0x50)
};
...
struct FPremierPrestigeDetailsDTO {
	...
	enum class EPremierRosterType RosterType; // 0x30(0x01)
	bool ShowTag; // 0x31(0x01)
	bool ShowPlating; // 0x32(0x01)
...
// ScriptStruct ShooterGame.NewsItemHandles
// Size: 0x50 (Inherited: 0x00)
struct FNewsItemHandles {
	struct TMap<struct UNewsItemDataAsset*, struct UNewsItemHandle*> Handles; // 0x00(0x50)
};
...
struct FPremierRosterV2 {
	...
	struct FPremierRosterV2SeasonData Season; // 0xb0(0x100)
	struct TMap<struct FString, struct FPremierRosterV2SeasonData> SeasonalInfoBySeasonID; // 0x1b0(0x50)
	struct FPremierRosterPrestige Prestige; // 0x200(0x18)
	int32_t MinimumRequiredMembersForEnrollment; // 0x218(0x04)
	int32_t MatchesSinceReset; // 0x21c(0x04)
	int32_t TournamentsSinceReset; // 0x220(0x04)
	char pad_224[0x4]; // 0x224(0x04)
	struct FPremierRosterV2Version Version; // 0x228(0x10)
	int64_t UpdatedAt; // 0x238(0x08)
	int64_t CreatedAt; // 0x240(0x08)
...
struct FPremierRosterV2SeasonData {
	...
	enum class EPremierRosterType RosterType; // 0x2c(0x01)
	bool IsProvisionalDivision; // 0x2d(0x01)
	bool PromotionApplied; // 0x2e(0x01)
	char pad_2F[0x1]; // 0x2f(0x01)
	int64_t Points; // 0x30(0x08)
	int32_t Wins; // 0x38(0x04)
	int32_t GamesPlayed; // 0x3c(0x04)
	enum class EPremierCrestType Crest; // 0x40(0x01)
	enum class EPremierPrestigePlating Plating; // 0x41(0x01)
	char pad_42[0x6]; // 0x42(0x06)
	struct TMap<struct FString, struct FPremierMatch> Matches; // 0x48(0x50)
	struct TMap<struct FString, struct FPremierTournament> Tournaments; // 0x98(0x50)
	struct TArray<struct FPremierBye> Byes; // 0xe8(0x10)
	bool HasEarnedPromotionForNextSeason; // 0xf8(0x01)
	bool HasEarnedPrestige; // 0xf9(0x01)
...
// Size: 0x18 (Inherited: 0x00)
struct FRoundConfig {
	int64_t ScheduledStartDateEpochSeconds; // 0x00(0x08)
	int64_t ScheduledEndDateEpochSeconds; // 0x08(0x08)
	int32_t RoundNumber; // 0x10(0x04)
	int32_t BestOfN; // 0x14(0x04)
};
...
struct FOrderResponse {
	...
	struct FOrderRewards OrderRewards; // 0x20(0x100)
};
...
struct FOrderRewards {
	...
	struct TArray<struct FOrderReward> BloomlineClips; // 0x60(0x10)
	struct TArray<struct FOrderReward> BloomlineHypes; // 0x70(0x10)
	struct TArray<struct FOrderReward> BloomlinePlankBackgrounds; // 0x80(0x10)
	struct TArray<struct FOrderReward> BloomlinePlankBorders; // 0x90(0x10)
	struct TArray<struct FOrderReward> BloomlinePlankNumbers; // 0xa0(0x10)
	struct TArray<struct FOrderReward> GunShards; // 0xb0(0x10)
	struct TArray<struct FOrderReward> Titles; // 0xc0(0x10)
	struct TArray<struct FOrderReward> Characters; // 0xd0(0x10)
	struct TArray<struct FOrderReward> JuiceBoxes; // 0xe0(0x10)
	struct TArray<struct FOrderReward> Currencies; // 0xf0(0x10)
};
...
// ScriptStruct ShooterGame.CatalogPurchaseResponse
// Size: 0x138 (Inherited: 0x00)
struct FCatalogPurchaseResponse {
	struct FGuid PurchaseID; // 0x00(0x10)
	struct FString Status; // 0x10(0x10)
	struct FPluginStoreOffer StoreOffer; // 0x20(0x118)
};
...
struct FTournamentData {
	...
	bool IsInMultiEventTournament; // 0x60(0x01)
	char pad_61[0x7]; // 0x61(0x07)
	struct TArray<struct FString> RosterEventIneligibilities; // 0x68(0x10)
	struct FPremierScheduledEventDTO PremierScheduledEvent; // 0x78(0x60)
};
...
struct FShellWidgetVisibilityOptions {
	enum class EWidgetVisibilityOption ShellBackgroundVisible; // 0x00(0x01)
	enum class EWidgetVisibilityOption BreadcrumbsVisible; // 0x01(0x01)
	enum class EWidgetVisibilityOption TopNavBarQueueTimerVisible; // 0x02(0x01)
	enum class EWidgetVisibilityOption PlayButtonVisible; // 0x03(0x01)
	enum class EWidgetVisibilityOption NavigationBarVisible; // 0x04(0x01)
	enum class EWidgetVisibilityOption PersistentNavigationBarVisible; // 0x05(0x01)
	enum class EWidgetVisibilityOption RewardsVisibile; // 0x06(0x01)
	enum class EWidgetVisibilityOption GeneralAlertStatusVisible; // 0x07(0x01)
	enum class EWidgetVisibilityOption SocialEntranceVisible; // 0x08(0x01)
	enum class EWidgetVisibilityOption OptionsButtonVisible; // 0x09(0x01)
	enum class EWidgetVisibilityOption WalletVisible; // 0x0a(0x01)
	enum class EWidgetVisibilityOption BonusStoreVisible; // 0x0b(0x01)
	enum class EWidgetVisibilityOption MissionProgressionVisible; // 0x0c(0x01)
};
...
// ScriptStruct ShooterGame.PostAudioEventResultData
// Size: 0x08 (Inherited: 0x00)
struct FPostAudioEventResultData {
	enum class EPostAudioEventResult PostAudioEventResult; // 0x00(0x01)
	bool bPostAudioEventEncounteredError; // 0x01(0x01)
	char pad_2[0x2]; // 0x02(0x02)
	int32_t PostAudioEventPlayingId; // 0x04(0x04)
};
...
// ScriptStruct ShooterGame.ValActivityInviteRequest
// Size: 0x30 (Inherited: 0x00)
struct FValActivityInviteRequest {
	struct FString ActivityId; // 0x00(0x10)
	struct FString ID; // 0x10(0x10)
	struct FString RequesterSubject; // 0x20(0x10)
};

// ScriptStruct ShooterGame.ValActivitiesJoinedPayload
// Size: 0x50 (Inherited: 0x00)
struct FValActivitiesJoinedPayload {
	struct FString Type; // 0x00(0x10)
	struct FString ActivityId; // 0x10(0x10)
	struct FString Product; // 0x20(0x10)
	struct FString ID; // 0x30(0x10)
	struct FString Version; // 0x40(0x10)
};

// ScriptStruct ShooterGame.ActivityLookupResponse
// Size: 0x10 (Inherited: 0x00)
struct FActivityLookupResponse {
	struct FString ActivityId; // 0x00(0x10)
};

// ScriptStruct ShooterGame.ActivityLookupRequest
// Size: 0x20 (Inherited: 0x00)
struct FActivityLookupRequest {
	struct FString Product; // 0x00(0x10)
	struct FString Party; // 0x10(0x10)
};

// ScriptStruct ShooterGame.AresActivityGatewayJoinCode
// Size: 0x30 (Inherited: 0x00)
struct FAresActivityGatewayJoinCode {
	struct FString JoinCode; // 0x00(0x10)
	struct FString SmartURL; // 0x10(0x10)
	struct FDateTime ExpiresAt; // 0x20(0x08)
...
struct FAresDebugLinePersistent {
	...
	float TimeLastUpdated; // 0x38(0x04)
	float LifeTime; // 0x3c(0x04)
...
struct FAllInitSystems {
	...
	struct UBloomlineManager* BloomlineManager; // 0x1f8(0x08)
	struct UCrosshairManager* CrosshairManager; // 0x200(0x08)
	struct URewardGrantModelFactory* RewardGrantModelFactory; // 0x208(0x08)
	struct UVanguardManager* VanguardManager; // 0x210(0x08)
	struct UDropInLoadingManager* DropInLoadingManager; // 0x218(0x08)
	struct UChatSessionManager* ChatSessionManager; // 0x220(0x08)
	struct UPurchaseManager* PurchaseManager; // 0x228(0x08)
	struct UPlatformOffersManager* PlatformOffersManager; // 0x230(0x08)
	struct UStoreManager* StoreManager; // 0x238(0x08)
	struct UStoreConfigurationManager* StoreConfigurationManager; // 0x240(0x08)
	struct UStoreUITelemetryManager* StoreUITelemetryManager; // 0x248(0x08)
	struct UStoreViewControllerV2* StoreViewController; // 0x250(0x08)
	struct UGiftingManager* GiftingManager; // 0x258(0x08)
	struct UPlayerFeedbackToolViewController* PlayerFeedbackToolViewController; // 0x260(0x08)
	struct UAresClientEvents* AresClientEvents; // 0x268(0x08)
	struct UCompetitiveTierUpdater* CompetitiveTierUpdater; // 0x270(0x08)
	struct UPlayerIdentityUpdater* PlayerIdentityUpdater; // 0x278(0x08)
	struct UProvisioningErrorNotificationManager* ProvisioningErrorNotificationManager; // 0x280(0x08)
	struct ULegalInfoManager* LegalInfoManager; // 0x288(0x08)
	struct UMapLoadModel* MapLoadModel; // 0x290(0x08)
	struct UMenuStackManager* MenuStackManager; // 0x298(0x08)
	struct UUINavigationManager* UINavigationManager; // 0x2a0(0x08)
	struct UModalManager* ModalManager; // 0x2a8(0x08)
	struct UFlyoutManager* FlyoutManager; // 0x2b0(0x08)
	struct UPlayerAliasManager* PlayerAliasManager; // 0x2b8(0x08)
	struct UPaymentsManager* PaymentsManager; // 0x2c0(0x08)
	struct UPingManager* PingManager; // 0x2c8(0x08)
	struct UOnlineIdentityManager* OnlineIdentityManager; // 0x2d0(0x08)
	struct UPlayerSettingsTelemetry* PlayerSettingsTelemetry; // 0x2d8(0x08)
	struct UReplayTelemetry* ReplayTelemetry; // 0x2e0(0x08)
	struct UUITelemetryManager* UITelemetryManager; // 0x2e8(0x08)
	struct UActionTraitsManager* ActionTraitsManager; // 0x2f0(0x08)
	struct UActionBindingsManager* ActionBindingsManager; // 0x2f8(0x08)
	struct UPlayerFacingPerfManager* PlayerFacingPerfManager; // 0x300(0x08)
	struct UApplicationRepairManager* ApplicationRepairManager; // 0x308(0x08)
	struct UArsenalViewController* ArsenalViewController; // 0x310(0x08)
	struct UPlayerAffinityManager* PlayerAffinityManager; // 0x318(0x08)
	struct UPatchAvailabilityManager* PatchAvailabilityManager; // 0x320(0x08)
	struct URiotClientConfigManager* RiotClientConfigManager; // 0x328(0x08)
	struct UNPELoader* NPELoader; // 0x330(0x08)
	struct UTransitionModelManager* TransitionModelManager; // 0x338(0x08)
	struct UTutorialManager* TutorialManager; // 0x340(0x08)
	struct ULoginQueueManager* LoginQueueManager; // 0x348(0x08)
	struct URiotClientHeartbeatManager* RiotClientHeartbeatManager; // 0x350(0x08)
	struct ULocalePreferenceManager* LocalePreferenceManager; // 0x358(0x08)
	struct UVNGManager* VNGManager; // 0x360(0x08)
	struct UMassRewardsManager* MassRewardsManager; // 0x368(0x08)
	struct UPlayerLoginLocationHistoryManager* PlayerLoginLocationHistoryManager; // 0x370(0x08)
	struct URestrictionsManager* RestrictionsManager; // 0x378(0x08)
	struct UAccountXPManager* AccountXPManager; // 0x380(0x08)
	struct UReporterFeedbackManager* ReporterFeedbackManager; // 0x388(0x08)
	struct URiotWarningManager* RiotWarningManager; // 0x390(0x08)
	struct URosterManager* RosterManager; // 0x398(0x08)
	struct UPremierRosterManager* PremierRosterManager; // 0x3a0(0x08)
	struct UPremierSeasonManager* PremierSeasonManager; // 0x3a8(0x08)
	struct UTournamentsManager* TournamentsManager; // 0x3b0(0x08)
	struct UTournamentViewController* TournamentViewController; // 0x3b8(0x08)
	struct UPremierTournamentsManager* PremierTournamentsManager; // 0x3c0(0x08)
	struct UPremierManagerOld* PremierManagerOld; // 0x3c8(0x08)
	struct UPremierRosterManagerOld* PremierRosterManagerOld; // 0x3d0(0x08)
	struct UPremierRosterViewController* PremierRosterViewController; // 0x3d8(0x08)
	struct ULeaderboardManager* LeaderboardManager; // 0x3e0(0x08)
	struct UPremierLeaderboardManager* PremierLeaderboardManager; // 0x3e8(0x08)
	struct ULeaderboardViewController* LeaderboardViewController; // 0x3f0(0x08)
	struct UMainMenuTelemetryManager* MainMenuTelemetryManager; // 0x3f8(0x08)
	struct UHovercardCacheManager* HovercardCacheManager; // 0x400(0x08)
	struct UEULAManager* EULAManager; // 0x408(0x08)
	struct UAVSManager* AVSManager; // 0x410(0x08)
	struct UDailyRewardsManager* DailyRewardsManager; // 0x418(0x08)
	struct UJuiceScreenViewController* JuiceScreenViewController; // 0x420(0x08)
	struct UFavoritesManager* FavoritesManager; // 0x428(0x08)
	struct UContentFilterViewController* ContentFilterViewController; // 0x430(0x08)
	struct UContentFilterUITelemetryManager* ContentFilterUITelemetryManager; // 0x438(0x08)
	struct UUserInfoNotificationManager* UserInfoNotificationManager; // 0x440(0x08)
	struct UClientTelemetryPersistence* TelemetryPersistence; // 0x448(0x08)
	struct ULatencyService* LatencyService; // 0x450(0x08)
	struct UPlatformEnvironmentManager* PlatformEnvironmentManager; // 0x458(0x08)
	struct UConfigManager* ConfigManager; // 0x460(0x08)
	struct URSOManager* RSOManager; // 0x468(0x08)
	struct UPlatformSessionManager* SessionManager; // 0x470(0x08)
	struct URMSManager* RMSManager; // 0x478(0x08)
	struct UPersonalizationManagerV2* PersonalizationManagerV2; // 0x480(0x08)
	struct UPartyManager* PartyManager; // 0x488(0x08)
	struct UPlayerReportManager* PlayerReportManager; // 0x490(0x08)
	struct UGlobalAudioManager* GlobalAudioManager; // 0x498(0x08)
	struct UEsportsManager* EsportsManager; // 0x4a0(0x08)
	struct UEsportsTelemetryManager* EsportsTelemetryManager; // 0x4a8(0x08)
	struct UReplayDataManager* ReplayDataManager; // 0x4b0(0x08)
	struct UAresRGIFriendsClient* RGIFriendsClient; // 0x4b8(0x08)
	struct UMainMenuParentWidget* MainMenuParent; // 0x4c0(0x08)
	struct UNativePlatformAuthManager* NativePlatformAuthManager; // 0x4c8(0x08)
	struct UClientExperimentationManager* ClientExperimentationManager; // 0x4d0(0x08)
	struct UOutOfGameConfigurationManager* OutOfGameConfigurationManager; // 0x4d8(0x08)
	struct UPlatformUILinkManager* PlatformUILinkManager; // 0x4e0(0x08)
	struct UActivityGatewayManager* ActivityGatewayManager; // 0x4e8(0x08)
	struct UInboxManager* InboxManager; // 0x4f0(0x08)
};
...
struct FAresCommonTabListConfiguration {
	...
	enum class ESlateVisibility WidgetVisibilityOnSingleEntry; // 0x8f(0x01)
	enum class ESlateVisibility WidgetVisibilityOnNoEntries; // 0x90(0x01)
	char pad_91[0x3]; // 0x91(0x03)
	float EnabledRenderOpacity; // 0x94(0x04)
	float DisabledRenderOpacity; // 0x98(0x04)
};
...
// ScriptStruct ShooterGame.AresMosaicConfiguration
// Size: 0x18 (Inherited: 0x00)
struct FAresMosaicConfiguration {
	bool bAllowFocus; // 0x00(0x01)
	bool bNavigationIsSelection; // 0x01(0x01)
	bool bClearSelectionOnClick; // 0x02(0x01)
	enum class EAresMosaicFocusReturnType FocusReturnType; // 0x03(0x01)
	char pad_4[0x4]; // 0x04(0x04)
	struct UAresCommonButton* EntryWidgetClass; // 0x08(0x08)
	float EntrySpacing; // 0x10(0x04)
	bool bShouldMosaicRegenerateWithIdenticalItemsSet; // 0x14(0x01)
	bool bShouldSelectByDefault; // 0x15(0x01)
	bool bAllowLayoutItemMismatch; // 0x16(0x01)
	bool bUseSpaceForMismatch; // 0x17(0x01)
};
...
struct FDamageLogEvent {
	...
	struct FGameEventCharacterState DealerCharacterState; // 0x150(0x1d0)
	struct FGameEventCharacterState ReceiverCharacterState; // 0x320(0x1d0)
	struct FString DamageSource; // 0x4f0(0x10)
	struct FString DamageSourceId; // 0x500(0x10)
	float DamageAmount; // 0x510(0x04)
	float DamageTaken; // 0x514(0x04)
	struct FString DamageRegion; // 0x518(0x10)
	bool IsPenetration; // 0x528(0x01)
	bool IsKill; // 0x529(0x01)
	char pad_52A[0x6]; // 0x52a(0x06)
	struct FAimReport AimReport; // 0x530(0x78)
	bool IsZoomed; // 0x5a8(0x01)
	bool IsFocusMode; // 0x5a9(0x01)
	bool DamageReceiverIsPlayer; // 0x5aa(0x01)
	char pad_5AB[0x5]; // 0x5ab(0x05)
	struct FString DamageEquippableInventoryTransactionType; // 0x5b0(0x10)
};
...
struct FGameEventCharacterState {
	...
	struct FGameEventInventory Inventory; // 0x60(0x158)
	struct FString StabilityType; // 0x1b8(0x10)
	float StabilityFiringError; // 0x1c8(0x04)
	float StabilityMovementError; // 0x1cc(0x04)
};
...
struct FGameEventInventory {
	...
	struct TArray<struct FGameEventItem> LevelItems; // 0x138(0x10)
	struct TArray<struct FGameEventItem> Passives; // 0x148(0x10)
};
...
struct FShotProjectileInfo {
	...
	struct FGameEventCharacterState DealerCharacterState; // 0x88(0x1d0)
	int32_t NumberProjectiles; // 0x258(0x04)
	int32_t ZoomLevel; // 0x25c(0x04)
	bool IsFocusMode; // 0x260(0x01)
	char pad_261[0x3]; // 0x261(0x03)
	struct FStabilityValues StabilityValues; // 0x264(0x18)
	char pad_27C[0x4]; // 0x27c(0x04)
	struct FString DamageEquippableInventoryTransactionType; // 0x280(0x10)
};
...
struct FShotProjectileOnHitInfo : FShotProjectileInfo {
	struct FString DamageSource; // 0x290(0x10)
	struct FString DamageSourceId; // 0x2a0(0x10)
	struct TArray<struct FShotProjectileDamageInfo> DamageEvents; // 0x2b0(0x10)
};
...
// ScriptStruct ShooterGame.SlotModifier
// Size: 0x02 (Inherited: 0x00)
struct FSlotModifier {
	enum class EAresItemSlot TargetSlot; // 0x00(0x01)
	enum class EAresItemSlot AddedCompatibility; // 0x01(0x01)
};
...
// ScriptStruct ShooterGame.AresMosaicElementBase
// Size: 0x01 (Inherited: 0x00)
struct FAresMosaicElementBase {
	char pad_0[0x1]; // 0x00(0x01)
};

// ScriptStruct ShooterGame.AresFlexibleMosaicElement
// Size: 0x08 (Inherited: 0x01)
struct FAresFlexibleMosaicElement : FAresMosaicElementBase {
	float Fill; // 0x00(0x04)
	enum class EAresFlexibleMosaicElementType Type; // 0x04(0x01)
	char pad_6[0x2]; // 0x06(0x02)
};

// ScriptStruct ShooterGame.AresFlexibleMosaicElement_Container
// Size: 0x20 (Inherited: 0x08)
struct FAresFlexibleMosaicElement_Container : FAresFlexibleMosaicElement {
	enum class EOrientation LayoutFlow; // 0x08(0x01)
	char pad_9[0x7]; // 0x09(0x07)
	struct TArray<struct FInstancedStruct> SubElements; // 0x10(0x10)
};

// ScriptStruct ShooterGame.AresFlexibleMosaicElement_Widget
// Size: 0x0c (Inherited: 0x08)
struct FAresFlexibleMosaicElement_Widget : FAresFlexibleMosaicElement {
	int32_t DataIndex; // 0x08(0x04)
};
...
// ScriptStruct ShooterGame.RiotProfileUsage
// Size: 0x48 (Inherited: 0x00)
struct FRiotProfileUsage {
	struct FString InstanceId; // 0x00(0x10)
	bool IsServer; // 0x10(0x01)
	char pad_11[0x7]; // 0x11(0x07)
	struct FString UserName; // 0x18(0x10)
	struct FString PlatformType; // 0x28(0x10)
	struct FString ProfileUsageTimestamp; // 0x38(0x10)
};
...
// ScriptStruct ShooterGame.BonsaiBloomline
// Size: 0x18 (Inherited: 0x00)
struct FBonsaiBloomline {
	struct FString BloomlineFlourishID; // 0x00(0x10)
	int32_t BloomlineShortLevel; // 0x10(0x04)
	char pad_14[0x4]; // 0x14(0x04)
};
...
// ScriptStruct ShooterGame.BoolToTextMap
// Size: 0x50 (Inherited: 0x00)
struct FBoolToTextMap {
	struct TMap<bool, struct FText> BoolToTextMap; // 0x00(0x50)
};
...
struct FSettingsUIHierarchySectionData {
	...
	char pad_41[0x3]; // 0x41(0x03)
	uint32_t PageVisibilityConditions; // 0x44(0x04)
};
...
// ScriptStruct ShooterGame.StorefrontItemCatalogData
// Size: 0x120 (Inherited: 0x110)
struct FStorefrontItemCatalogData : FContentData {
	struct FGuid ContentEditionID; // 0x110(0x10)
};
...
struct FGameModeCatalogData : FContentData {
	...
	bool AllowsCustomGameReplays; // 0x170(0x01)
	char pad_171[0x7]; // 0x171(0x07)
};
...
// ScriptStruct ShooterGame.BloomlinePlankBackgroundCatalogData
// Size: 0x120 (Inherited: 0x110)
struct FBloomlinePlankBackgroundCatalogData : FContentData {
	struct FGuid RestrictedToBonsaiID; // 0x110(0x10)
};

// ScriptStruct ShooterGame.BloomlineHypeCatalogData
// Size: 0x120 (Inherited: 0x110)
struct FBloomlineHypeCatalogData : FContentData {
	struct FGuid RestrictedToBonsaiID; // 0x110(0x10)
};

// ScriptStruct ShooterGame.BloomlinePlankNumberCatalogData
// Size: 0x130 (Inherited: 0x110)
struct FBloomlinePlankNumberCatalogData : FContentData {
	struct FGuid RestrictedToBonsaiID; // 0x110(0x10)
	struct FString PlankNumberTypeName; // 0x120(0x10)
};

// ScriptStruct ShooterGame.BloomlinePlankBorderCatalogData
// Size: 0x120 (Inherited: 0x110)
struct FBloomlinePlankBorderCatalogData : FContentData {
	struct FGuid RestrictedToBonsaiID; // 0x110(0x10)
};

// ScriptStruct ShooterGame.BloomlineClipCatalogData
// Size: 0x120 (Inherited: 0x110)
struct FBloomlineClipCatalogData : FContentData {
	struct FGuid RestrictedToBonsaiID; // 0x110(0x10)
};

// ScriptStruct ShooterGame.OfferCostCatalogData
// Size: 0x1c (Inherited: 0x00)
struct FOfferCostCatalogData {
	struct FGuid CurrencyID; // 0x00(0x10)
	int32_t BaseCost; // 0x10(0x04)
	int32_t DiscountedCost; // 0x14(0x04)
	int32_t DiscountPercent; // 0x18(0x04)
};

// ScriptStruct ShooterGame.OfferCatalogData
// Size: 0x40 (Inherited: 0x00)
struct FOfferCatalogData {
	struct FGuid OfferId; // 0x00(0x10)
	int32_t OfferType; // 0x10(0x04)
	char pad_14[0x4]; // 0x14(0x04)
	struct TArray<struct FOfferCostCatalogData> Cost; // 0x18(0x10)
	struct TArray<struct FRewardGrant> Rewards; // 0x28(0x10)
	int32_t IsGiftable; // 0x38(0x04)
	char pad_3C[0x4]; // 0x3c(0x04)
};

// ScriptStruct ShooterGame.BloomlineTrackStageCatalogData
// Size: 0x18 (Inherited: 0x00)
struct FBloomlineTrackStageCatalogData {
	int32_t BloomlineTrackRequirement; // 0x00(0x04)
	char pad_4[0x4]; // 0x04(0x04)
	struct TArray<struct FOfferCatalogData> Offers; // 0x08(0x10)
};

// ScriptStruct ShooterGame.BloomlineTrackCatalogData
// Size: 0x130 (Inherited: 0x110)
struct FBloomlineTrackCatalogData : FContentData {
	struct TArray<struct FBloomlineTrackStageCatalogData> TrackStages; // 0x110(0x10)
	struct FGuid BonsaiID; // 0x120(0x10)
};

// ScriptStruct ShooterGame.BloomlineShortTrackStageCatalogData
// Size: 0x14 (Inherited: 0x00)
struct FBloomlineShortTrackStageCatalogData {
	int32_t BloomlineShortTrackLevelRequirement; // 0x00(0x04)
	struct FGuid FlourishItemId; // 0x04(0x10)
};

// ScriptStruct ShooterGame.BloomlineShortTrackVersionCatalogData
// Size: 0x40 (Inherited: 0x00)
struct FBloomlineShortTrackVersionCatalogData {
	struct FGuid StartSeasonId; // 0x00(0x10)
	struct FString VersionId; // 0x10(0x10)
	struct TArray<int32_t> Thresholds; // 0x20(0x10)
	struct TArray<struct FBloomlineShortTrackStageCatalogData> BloomlineShortTrackStages; // 0x30(0x10)
};

// ScriptStruct ShooterGame.BloomlineShortTrackCatalogData
// Size: 0x140 (Inherited: 0x110)
struct FBloomlineShortTrackCatalogData : FContentData {
	struct FGuid BonsaiID; // 0x110(0x10)
	int32_t BloomlineShortTrackMaxLevel; // 0x120(0x04)
	char pad_124[0x4]; // 0x124(0x04)
	struct TArray<struct FBloomlineShortTrackVersionCatalogData> Versions; // 0x128(0x10)
	bool IsEnabled; // 0x138(0x01)
...
struct FContentListing {
	...
	struct TArray<struct FStorefrontItemCatalogData> StorefrontItems; // 0x110(0x10)
	...
	struct TArray<struct FBloomlineTrackCatalogData> BloomlineTracks; // 0x390(0x10)
	struct TArray<struct FBloomlineShortTrackCatalogData> BloomlineShortTracks; // 0x3a0(0x10)
	struct TArray<struct FBloomlinePlankBackgroundCatalogData> BloomlinePlankBackgrounds; // 0x3b0(0x10)
	struct TArray<struct FBloomlineHypeCatalogData> BloomlineHypes; // 0x3c0(0x10)
	struct TArray<struct FBloomlinePlankNumberCatalogData> BloomlinePlankNumbers; // 0x3d0(0x10)
	struct TArray<struct FBloomlinePlankBorderCatalogData> BloomlinePlankBorders; // 0x3e0(0x10)
	struct TArray<struct FBloomlineClipCatalogData> BloomlineClips; // 0x3f0(0x10)
};
...
struct FUINavigationGlobalsEntry {
	...
	struct FShellWidgetVisibilityOptions ShellWidgetVisibilityOptions; // 0x1f2(0x0d)
	bool bIsLandingScreen; // 0x1ff(0x01)
	bool bIsDynamicallyGeneratingChildren; // 0x200(0x01)
	char pad_201[0x7]; // 0x201(0x07)
	struct TArray<struct FName> ValidDynamicChildScreens; // 0x208(0x10)
	struct TSoftClassPtr<UObject> NavigationButtonClass; // 0x218(0x30)
	struct TMap<struct FName, struct TSoftClassPtr<UObject>> ChildScreensNavigationButtonOverrides; // 0x248(0x50)
	struct TArray<struct FName> ValidChildScreens; // 0x298(0x10)
	int32_t NavigationBarIndex; // 0x2a8(0x04)
	enum class EUINavigationTabListPriority NavigationTabListPriority; // 0x2ac(0x01)
	enum class EUINavigationBarPosition NavigationBarPosition; // 0x2ad(0x01)
	char pad_2AE[0x2]; // 0x2ae(0x02)
	struct FString NavigationTabTelemetryTarget; // 0x2b0(0x10)
	struct TArray<struct FModalContextInfo> ModalContext; // 0x2c0(0x10)
	uint32_t PreloadContexts; // 0x2d0(0x04)
	char pad_2D4[0x4]; // 0x2d4(0x04)
	struct TArray<struct TSoftClassPtr<UObject>> TargetPreloadGameModes; // 0x2d8(0x10)
...
struct FActiveBlind {
	...
	struct FEffectID BlindEffectID; // 0x10(0x18)
	float InitialDuration; // 0x28(0x04)
	float StartNetMovementTime; // 0x2c(0x04)
	struct UBlindConfig* BlindConfig; // 0x30(0x08)
	struct AActor* CausingActor; // 0x38(0x08)
};

// ScriptStruct ShooterGame.EffectID
// Size: 0x18 (Inherited: 0x00)
struct FEffectID {
	int64_t EffectID; // 0x00(0x08)
	struct FName SourceID; // 0x08(0x0c)
	bool bLocalEffect; // 0x14(0x01)
	bool bTransient; // 0x15(0x01)
	char pad_16[0x2]; // 0x16(0x02)
};
...
// ScriptStruct ShooterGame.BloomlineFetchOptions
// Size: 0x20 (Inherited: 0x00)
struct FBloomlineFetchOptions {
	struct FGuid ShortId; // 0x00(0x10)
	struct FGuid BonsaiID; // 0x10(0x10)
};

// ScriptStruct ShooterGame.BloomlinePlankModuleInfo
// Size: 0x18 (Inherited: 0x00)
struct FBloomlinePlankModuleInfo {
	struct UAresBasePrimaryDataAsset* AssetClass; // 0x00(0x08)
	struct UTexture* Icon; // 0x08(0x08)
	float Width; // 0x10(0x04)
	float Height; // 0x14(0x04)
};

// ScriptStruct ShooterGame.BloomlineMatchRMSPayload
// Size: 0x10 (Inherited: 0x00)
struct FBloomlineMatchRMSPayload {
	struct FGuid MatchID; // 0x00(0x10)
};

// ScriptStruct ShooterGame.BloomlineNumberModuleData
// Size: 0x28 (Inherited: 0x00)
struct FBloomlineNumberModuleData {
	struct FGuid ModuleID; // 0x00(0x10)
	struct FGuid NumberID; // 0x10(0x10)
	double Value; // 0x20(0x08)
};

// ScriptStruct ShooterGame.BloomlineModules
// Size: 0x20 (Inherited: 0x00)
struct FBloomlineModules {
	struct FGuid ShortId; // 0x00(0x10)
	struct TArray<struct FBloomlineNumberModuleData> NumberModules; // 0x10(0x10)
};

// ScriptStruct ShooterGame.BloomlineFlourish
// Size: 0x48 (Inherited: 0x00)
struct FBloomlineFlourish {
	struct FGuid BonsaiID; // 0x00(0x10)
	struct FGuid ShortId; // 0x10(0x10)
	int32_t ShortLevel; // 0x20(0x04)
	int32_t LongLevel; // 0x24(0x04)
	struct FGuid FlourishID; // 0x28(0x10)
	int64_t Points; // 0x38(0x08)
	int64_t PointsVersion; // 0x40(0x08)
};

// ScriptStruct ShooterGame.BloomlineShortData
// Size: 0x68 (Inherited: 0x00)
struct FBloomlineShortData {
	struct FBloomlineFlourish Flourish; // 0x00(0x48)
	struct FBloomlineModules Modules; // 0x48(0x20)
};

// ScriptStruct ShooterGame.BloomlineTrackProgress
// Size: 0x24 (Inherited: 0x00)
struct FBloomlineTrackProgress {
	struct FGuid BonsaiID; // 0x00(0x10)
	struct FGuid TrackID; // 0x10(0x10)
	int32_t TrackLevel; // 0x20(0x04)
};

// ScriptStruct ShooterGame.BloomlineProcessedMatchDelta
// Size: 0x38 (Inherited: 0x00)
struct FBloomlineProcessedMatchDelta {
	struct FGuid BonsaiID; // 0x00(0x10)
	int32_t PointsBefore; // 0x10(0x04)
	int32_t PointsAfter; // 0x14(0x04)
	int32_t LongLevelBefore; // 0x18(0x04)
	int32_t ShortLevelBefore; // 0x1c(0x04)
	int32_t ShortLevelAfter; // 0x20(0x04)
	int32_t LongLevelAfter; // 0x24(0x04)
	struct FGuid NewFlourishID; // 0x28(0x10)
};

// ScriptStruct ShooterGame.BloomlineProcessedMatch
// Size: 0x60 (Inherited: 0x00)
struct FBloomlineProcessedMatch {
	struct FGuid MatchID; // 0x00(0x10)
	struct FDateTime CreatedAt; // 0x10(0x08)
	struct FGuid ShortId; // 0x18(0x10)
	struct FBloomlineProcessedMatchDelta Delta; // 0x28(0x38)
};

// ScriptStruct ShooterGame.BloomlineBonsai
// Size: 0xc8 (Inherited: 0x00)
struct FBloomlineBonsai {
	struct FGuid BonsaiID; // 0x00(0x10)
	struct FGuid HypeID; // 0x10(0x10)
	struct FGuid BackgroundID; // 0x20(0x10)
	struct FGuid ClipID; // 0x30(0x10)
	struct FGuid BorderID; // 0x40(0x10)
	struct FBloomlineShortData ShortData; // 0x50(0x68)
	struct TArray<struct FBloomlineTrackProgress> TrackProgressList; // 0xb8(0x10)
};

// ScriptStruct ShooterGame.BloomlinePlayer
// Size: 0x28 (Inherited: 0x00)
struct FBloomlinePlayer {
	struct FGuid Subject; // 0x00(0x10)
	struct TArray<struct FBloomlineBonsai> Bonsais; // 0x10(0x10)
	int64_t LongGroupVersion; // 0x20(0x08)
};

// ScriptStruct ShooterGame.BloomlineModuleUpdate
// Size: 0x30 (Inherited: 0x00)
struct FBloomlineModuleUpdate {
	struct FGuid ID; // 0x00(0x10)
	struct FGuid Type; // 0x10(0x10)
	struct FGuid Item; // 0x20(0x10)
};

// ScriptStruct ShooterGame.BloomlineUpdateRecipeRequest
// Size: 0x70 (Inherited: 0x00)
struct FBloomlineUpdateRecipeRequest {
	struct FGuid Subject; // 0x00(0x10)
	struct FGuid BonsaiID; // 0x10(0x10)
	struct FGuid HypeID; // 0x20(0x10)
	struct FGuid BackgroundID; // 0x30(0x10)
	struct FGuid ClipID; // 0x40(0x10)
	struct FGuid BorderID; // 0x50(0x10)
	struct TArray<struct FBloomlineModuleUpdate> ModuleUpdates; // 0x60(0x10)
};

// ScriptStruct ShooterGame.BloomlinePlayerBonsaiNumbersRequest
// Size: 0x40 (Inherited: 0x00)
struct FBloomlinePlayerBonsaiNumbersRequest {
	struct FGuid Subject; // 0x00(0x10)
	struct FGuid BonsaiID; // 0x10(0x10)
	struct FGuid ShortId; // 0x20(0x10)
	struct TArray<struct FGuid> NumbersFilter; // 0x30(0x10)
};

// ScriptStruct ShooterGame.BloomlinePlayerBonsaiNumbers
// Size: 0x80 (Inherited: 0x00)
struct FBloomlinePlayerBonsaiNumbers {
	struct FGuid Subject; // 0x00(0x10)
	struct FGuid BonsaiID; // 0x10(0x10)
	struct FGuid ShortId; // 0x20(0x10)
	struct TMap<struct FGuid, float> UnlockedNumbers; // 0x30(0x50)
};

// ScriptStruct ShooterGame.MatchPlayerBonsaiBloomlineData
// Size: 0x18 (Inherited: 0x00)
struct FMatchPlayerBonsaiBloomlineData {
	struct FString BloomlineFlourishID; // 0x00(0x10)
	int32_t BloomlineShortLevel; // 0x10(0x04)
	char pad_14[0x4]; // 0x14(0x04)
};

// ScriptStruct ShooterGame.BloomlineShortTrackStage
// Size: 0x38 (Inherited: 0x00)
struct FBloomlineShortTrackStage {
	int32_t BloomlineShortTrackLevelRequirement; // 0x00(0x04)
	char pad_4[0x4]; // 0x04(0x04)
	struct TSoftClassPtr<UObject> FlourishItem; // 0x08(0x30)
};

// ScriptStruct ShooterGame.BloomlinePointsVersion
// Size: 0x50 (Inherited: 0x00)
struct FBloomlinePointsVersion {
	struct FString VersionId; // 0x00(0x10)
	struct TSoftClassPtr<UObject> StartSeason; // 0x10(0x30)
	struct TArray<int32_t> Thresholds; // 0x40(0x10)
};

// ScriptStruct ShooterGame.BloomlineTrackStage
// Size: 0x18 (Inherited: 0x00)
struct FBloomlineTrackStage {
	int32_t BloomlineTrackRequirement; // 0x00(0x04)
	enum class EBloomlineStageDisplayWidth DisplayWidth; // 0x04(0x01)
	char pad_5[0x3]; // 0x05(0x03)
	struct TArray<struct UEditableBloomlineTrackSign*> BloomlineTrackSigns; // 0x08(0x10)
};
...
struct FBracketLineConfig {
	...
	bool EliminationInitialLeadOffUsePercentage; // 0x18(0x01)
	char pad_19[0x3]; // 0x19(0x03)
	float EliminationCornerDiagonalLength; // 0x1c(0x04)
	struct FBracketLineConnectionPadding EliminationConnectionPadding; // 0x20(0x08)
	struct FLinearColor SwissLineColor; // 0x28(0x10)
	float SwissLineThickness; // 0x38(0x04)
	float SwissInitialLeadOff; // 0x3c(0x04)
	float SwissLineOverlapPadding; // 0x40(0x04)
	struct FBracketLineConnectionPadding SwissConnectionPadding; // 0x44(0x08)
};
...
struct FCAPProgressionConfigV2 {
	...
	struct FConfigurationAvailability Availability; // 0x40(0x20)
	struct FCAPProgressionConfigGroup Configuration; // 0x60(0x40)
};
...
// ScriptStruct ShooterGame.CatalogPayment
// Size: 0x18 (Inherited: 0x00)
struct FCatalogPayment {
	int64_t Delta; // 0x00(0x08)
	struct FGuid CurrencyID; // 0x08(0x10)
};

// ScriptStruct ShooterGame.CatalogPaymentOption
// Size: 0x10 (Inherited: 0x00)
struct FCatalogPaymentOption {
	struct TArray<struct FCatalogPayment> payments; // 0x00(0x10)
};

// ScriptStruct ShooterGame.CatalogFulfillment
// Size: 0x24 (Inherited: 0x00)
struct FCatalogFulfillment {
	int32_t Delta; // 0x00(0x04)
	struct FGuid ItemId; // 0x04(0x10)
	struct FGuid ItemTypeID; // 0x14(0x10)
};

// ScriptStruct ShooterGame.CatalogPurchaseUnit
// Size: 0x38 (Inherited: 0x00)
struct FCatalogPurchaseUnit {
	struct FCatalogFulfillment fulfillment; // 0x00(0x24)
	char pad_24[0x4]; // 0x24(0x04)
	struct TArray<struct FCatalogPaymentOption> paymentOptions; // 0x28(0x10)
};

// ScriptStruct ShooterGame.CatalogPrerequisite
// Size: 0x14 (Inherited: 0x00)
struct FCatalogPrerequisite {
	struct FGuid CounterID; // 0x00(0x10)
	int32_t requiredQuantity; // 0x10(0x04)
};

// ScriptStruct ShooterGame.CatalogEntryConfiguration
// Size: 0x80 (Inherited: 0x00)
struct FCatalogEntryConfiguration {
	struct FString Name; // 0x00(0x10)
	struct TArray<struct FCatalogPurchaseUnit> purchaseUnits; // 0x10(0x10)
	struct TArray<struct FCatalogPrerequisite> Prerequisites; // 0x20(0x10)
	struct TMap<struct FString, struct FString> displayMetadata; // 0x30(0x50)
};

// ScriptStruct ShooterGame.CAPAuthoredCatalogEntryDto
// Size: 0xe0 (Inherited: 0x00)
struct FCAPAuthoredCatalogEntryDto {
	struct FGuid ConfigurationId; // 0x00(0x10)
	struct FString Name; // 0x10(0x10)
	struct FString VariantId; // 0x20(0x10)
	struct FString Discriminator; // 0x30(0x10)
	struct FCatalogEntryConfiguration Configuration; // 0x40(0x80)
	struct FConfigurationAvailability Availability; // 0xc0(0x20)
};

// ScriptStruct ShooterGame.CatalogStoreConfiguration
// Size: 0x20 (Inherited: 0x00)
struct FCatalogStoreConfiguration {
	struct FString Name; // 0x00(0x10)
	struct TArray<struct FGuid> catalogEntryIds; // 0x10(0x10)
};

// ScriptStruct ShooterGame.CAPAuthoredStoreDto
// Size: 0x80 (Inherited: 0x00)
struct FCAPAuthoredStoreDto {
	struct FGuid ConfigurationId; // 0x00(0x10)
	struct FString Name; // 0x10(0x10)
	struct FString VariantId; // 0x20(0x10)
	struct FString Discriminator; // 0x30(0x10)
	struct FCatalogStoreConfiguration Configuration; // 0x40(0x20)
	struct FConfigurationAvailability Availability; // 0x60(0x20)
};
...
struct FCAPProgressionRMSPayload {
	...
	struct TArray<struct FGuid> updatedGroups; // 0x08(0x10)
	bool playerStateDeleted; // 0x18(0x01)
	char pad_19[0x7]; // 0x19(0x07)
};
...
struct FGroupAssignment {
	...
	struct TMap<struct FString, struct FString> Parameters; // 0x20(0x50)
};
...
// ScriptStruct ShooterGame.NewsItemData
// Size: 0x08 (Inherited: 0x00)
struct FNewsItemData {
	struct UNewsItemDataAsset* DataAsset; // 0x00(0x08)
};
...
// ScriptStruct ShooterGame.BloomlineFlourishData
// Size: 0x08 (Inherited: 0x00)
struct FBloomlineFlourishData {
	struct UBloomlineFlourishDataAsset* DataAsset; // 0x00(0x08)
};

// ScriptStruct ShooterGame.BloomlineTrackData
// Size: 0x08 (Inherited: 0x00)
struct FBloomlineTrackData {
	struct UBloomlineTrackDataAsset* DataAsset; // 0x00(0x08)
};

// ScriptStruct ShooterGame.BloomlineShortTrackData
// Size: 0x08 (Inherited: 0x00)
struct FBloomlineShortTrackData {
	struct UBloomlineShortTrackDataAsset* DataAsset; // 0x00(0x08)
};

// ScriptStruct ShooterGame.BloomlinePlankBackgroundData
// Size: 0x08 (Inherited: 0x00)
struct FBloomlinePlankBackgroundData {
	struct UBloomlinePlankBackgroundDataAsset* DataAsset; // 0x00(0x08)
};

// ScriptStruct ShooterGame.BloomlineHypeData
// Size: 0x08 (Inherited: 0x00)
struct FBloomlineHypeData {
	struct UBloomlineHypeDataAsset* DataAsset; // 0x00(0x08)
};

// ScriptStruct ShooterGame.BloomlinePlankNumberData
// Size: 0x08 (Inherited: 0x00)
struct FBloomlinePlankNumberData {
	struct UBloomlinePlankNumberDataAsset* DataAsset; // 0x00(0x08)
};

// ScriptStruct ShooterGame.BloomlinePlankBorderData
// Size: 0x08 (Inherited: 0x00)
struct FBloomlinePlankBorderData {
	struct UBloomlinePlankBorderDataAsset* DataAsset; // 0x00(0x08)
};

// ScriptStruct ShooterGame.BloomlineClipData
// Size: 0x08 (Inherited: 0x00)
struct FBloomlineClipData {
	struct UBloomlineClipDataAsset* DataAsset; // 0x00(0x08)
};
...
// ScriptStruct ShooterGame.NewsItemHandleLoadOptions
// Size: 0x01 (Inherited: 0x00)
struct FNewsItemHandleLoadOptions {
	char pad_0[0x1]; // 0x00(0x01)
};
...
// ScriptStruct ShooterGame.BloomlineFlourishHandleLoadOptions
// Size: 0x01 (Inherited: 0x00)
struct FBloomlineFlourishHandleLoadOptions {
	char pad_0[0x1]; // 0x00(0x01)
};

// ScriptStruct ShooterGame.BloomlineTrackHandleLoadOptions
// Size: 0x01 (Inherited: 0x00)
struct FBloomlineTrackHandleLoadOptions {
	char pad_0[0x1]; // 0x00(0x01)
};

// ScriptStruct ShooterGame.BloomlineShortTrackHandleLoadOptions
// Size: 0x01 (Inherited: 0x00)
struct FBloomlineShortTrackHandleLoadOptions {
	char pad_0[0x1]; // 0x00(0x01)
};

// ScriptStruct ShooterGame.BloomlinePlankBackgroundHandleLoadOptions
// Size: 0x0a (Inherited: 0x00)
struct FBloomlinePlankBackgroundHandleLoadOptions {
	bool bLoadInventoryModel; // 0x00(0x01)
	bool bLoadBonsai; // 0x01(0x01)
	bool bLoadPlankBackgroundImage; // 0x02(0x01)
	struct FCharacterHandleLoadOptions BonsaiLoadOptions; // 0x03(0x07)
};

// ScriptStruct ShooterGame.BloomlineHypeHandleLoadOptions
// Size: 0x0a (Inherited: 0x00)
struct FBloomlineHypeHandleLoadOptions {
	bool bLoadInventoryModel; // 0x00(0x01)
	bool bLoadBonsai; // 0x01(0x01)
	bool bLoadHypeImage; // 0x02(0x01)
	struct FCharacterHandleLoadOptions BonsaiLoadOptions; // 0x03(0x07)
};

// ScriptStruct ShooterGame.BloomlinePlankNumberHandleLoadOptions
// Size: 0x09 (Inherited: 0x00)
struct FBloomlinePlankNumberHandleLoadOptions {
	bool bLoadInventoryModel; // 0x00(0x01)
	bool bLoadBonsai; // 0x01(0x01)
	struct FCharacterHandleLoadOptions BonsaiLoadOptions; // 0x02(0x07)
};

// ScriptStruct ShooterGame.BloomlinePlankBorderHandleLoadOptions
// Size: 0x0a (Inherited: 0x00)
struct FBloomlinePlankBorderHandleLoadOptions {
	bool bLoadInventoryModel; // 0x00(0x01)
	bool bLoadBonsai; // 0x01(0x01)
	bool bLoadPlankBorderImage; // 0x02(0x01)
	struct FCharacterHandleLoadOptions BonsaiLoadOptions; // 0x03(0x07)
};

// ScriptStruct ShooterGame.BloomlineClipHandleLoadOptions
// Size: 0x0a (Inherited: 0x00)
struct FBloomlineClipHandleLoadOptions {
	bool bLoadInventoryModel; // 0x00(0x01)
	bool bLoadBonsai; // 0x01(0x01)
	bool bLoadCatchphraseAudio; // 0x02(0x01)
	struct FCharacterHandleLoadOptions BonsaiLoadOptions; // 0x03(0x07)
};
...
struct FContract {
	...
	struct FContractProgression ContractProgression; // 0x10(0x10)
	uint32_t ProgressionLevelReached; // 0x20(0x04)
	uint32_t ProgressionTowardsNextLevel; // 0x24(0x04)
};

// ScriptStruct ShooterGame.ContractProgression
// Size: 0x10 (Inherited: 0x00)
struct FContractProgression {
	int64_t Version; // 0x00(0x08)
	uint32_t TotalProgressionEarned; // 0x08(0x04)
	char pad_C[0x4]; // 0x0c(0x04)
};
...
struct FRecruitmentProgress {
	...
	struct FGuid CounterID; // 0x18(0x10)
	uint64_t ProgressionEarned; // 0x28(0x08)
};
...
struct FContracts {
	...
	struct FRecruitmentProgress ActiveRecruitmentEventProgress; // 0x28(0x30)
	struct TArray<struct FMissionDTO> Missions; // 0x58(0x10)
	struct FMissionMetadata MissionMetadata; // 0x68(0x18)
	int32_t BTEMilestone; // 0x80(0x04)
	char pad_84[0x4]; // 0x84(0x04)
};
...
// ScriptStruct ShooterGame.CrouchSnapshot
// Size: 0x08 (Inherited: 0x00)
struct FCrouchSnapshot {
...
struct FActiveOverhealEntry {
	float HealRate; // 0x00(0x04)
	float MaxHealAmount; // 0x04(0x04)
	float DecayRate; // 0x08(0x04)
	bool bHealIntoOverheal; // 0x0c(0x01)
	bool bIsPermanentOverheal; // 0x0d(0x01)
	char pad_E[0x2]; // 0x0e(0x02)
	struct AActor* HealSource; // 0x10(0x08)
	struct AController* HealInstigator; // 0x18(0x08)
	char pad_20[0x8]; // 0x20(0x08)
	enum class EOverhealPhase HealPhase; // 0x28(0x01)
	char pad_29[0x17]; // 0x29(0x17)
};
...
// ScriptStruct ShooterGame.DisplayNameResults
// Size: 0x50 (Inherited: 0x00)
struct FDisplayNameResults {
	struct TMap<struct FString, struct FDisplayName> Results; // 0x00(0x50)
};
...
struct FMegapacketPlayer {
	...
	struct FMegapacketBonsaiBloomline BonsaiBloomline; // 0x1b0(0x18)
};

// ScriptStruct ShooterGame.MegapacketBonsaiBloomline
// Size: 0x18 (Inherited: 0x00)
struct FMegapacketBonsaiBloomline {
	struct FString BloomlineFlourishID; // 0x00(0x10)
	int32_t BloomlineShortLevel; // 0x10(0x04)
	char pad_14[0x4]; // 0x14(0x04)
};
...
// ScriptStruct ShooterGame.DynamicOptions
// Size: 0x18 (Inherited: 0x00)
struct FDynamicOptions {
	struct UAresBasePrimaryDataAsset* PrimaryDataAsset; // 0x00(0x08)
	struct TArray<struct UDynamicOptionDataAsset*> OPTIONS; // 0x08(0x10)
};

// ScriptStruct ShooterGame.AudioEventData
// Size: 0x10 (Inherited: 0x00)
struct FAudioEventData {
	struct UAkAudioEvent* AudioEvent; // 0x00(0x08)
	float InitialDelaySeconds; // 0x08(0x04)
	char pad_C[0x4]; // 0x0c(0x04)
};

// ScriptStruct ShooterGame.AudioEventPlaybackData
// Size: 0x10 (Inherited: 0x00)
struct FAudioEventPlaybackData {
	struct UAkAudioEvent* AudioEvent; // 0x00(0x08)
	char pad_8[0x8]; // 0x08(0x08)
};
...
// ScriptStruct ShooterGame.EffectPreviewHintGunAttachment
// Size: 0x01 (Inherited: 0x01)
struct FEffectPreviewHintGunAttachment : FEffectPreviewHint {
};
...
struct FActiveEffectInfo {
	struct FEffectID EffectID; // 0x00(0x18)
	struct AEffectContainer* EffectType; // 0x18(0x08)
	struct FEffectData EffectData; // 0x20(0x58)
...
struct FPendingStopEffect {
	struct FEffectID EffectID; // 0x00(0x18)
	float MovementTime; // 0x18(0x04)
	bool bHasStarted; // 0x1c(0x01)
	char pad_1D[0x3]; // 0x1d(0x03)
};
...
struct FPendingReplicationEffect {
	char pad_0[0x8]; // 0x00(0x08)
	struct FEffectID EffectID; // 0x08(0x18)
...
struct FParticleAttachToSelf : FParticleAttachLocation {
	struct FBlueprintComponentReference Component; // 0x70(0x10)
	struct FName bone; // 0x80(0x0c)
	char pad_8C[0x4]; // 0x8c(0x04)
};
...
// ScriptStruct ShooterGame.ParticleAttachToMelee
// Size: 0x80 (Inherited: 0x70)
struct FParticleAttachToMelee : FParticleAttachLocation {
	struct FName bone; // 0x70(0x0c)
	char pad_7C[0x4]; // 0x7c(0x04)
};
...
struct FParticleAttachToGun : FParticleAttachLocation {
	bool bUseAttachmentMesh; // 0x70(0x01)
	enum class EGunAttachmentType Attachment; // 0x71(0x01)
	char pad_72[0x2]; // 0x72(0x02)
	struct FName bone; // 0x74(0x0c)
};
...
// ScriptStruct ShooterGame.EffectParticlesAddOnMeleeState
// Size: 0x18 (Inherited: 0x08)
struct FEffectParticlesAddOnMeleeState : FEffectParticlesAddOn {
	char pad_8[0x8]; // 0x08(0x08)
	enum class EParticlesBehavior IdleStateBehavior; // 0x10(0x01)
	enum class EParticlesBehavior EquippingStateBehavior; // 0x11(0x01)
	enum class EParticlesBehavior InspectStateBehavior; // 0x12(0x01)
	enum class EParticlesBehavior AttackingStateBehavior; // 0x13(0x01)
	char pad_14[0x4]; // 0x14(0x04)
};
...
struct FEffectParticlesAddOnGunState : FEffectParticlesAddOn {
	...
	enum class EParticlesBehavior EquippingStateBehavior; // 0x11(0x01)
	enum class EParticlesBehavior InspectStateBehavior; // 0x12(0x01)
	enum class EParticlesBehavior FiringStateBehavior; // 0x13(0x01)
	enum class EParticlesBehavior ReloadStateBehavior; // 0x14(0x01)
	enum class EParticlesBehavior ADSIdleStateBehavior; // 0x15(0x01)
	enum class EParticlesBehavior ADSFireStateBehavior; // 0x16(0x01)
	char pad_17[0x1]; // 0x17(0x01)
};
...
// ScriptStruct ShooterGame.EsportsCurrentTeamGPRDTO
// Size: 0x20 (Inherited: 0x01)
struct FEsportsCurrentTeamGPRDTO : FEsportsDTOBase {
	struct FString DateCalculated; // 0x00(0x10)
	int32_t Elo; // 0x10(0x04)
	int32_t GPRScore; // 0x14(0x04)
	int32_t Rank; // 0x18(0x04)
	char pad_1D[0x3]; // 0x1d(0x03)
};

// ScriptStruct ShooterGame.EsportsTournamentRecordDTO
// Size: 0x08 (Inherited: 0x01)
struct FEsportsTournamentRecordDTO : FEsportsDTOBase {
	int32_t Wins; // 0x00(0x04)
	int32_t Losses; // 0x04(0x04)
};

// ScriptStruct ShooterGame.EsportsTournamentDetailsDTO
// Size: 0x40 (Inherited: 0x01)
struct FEsportsTournamentDetailsDTO : FEsportsDTOBase {
	struct FString ID; // 0x00(0x10)
	struct FString Name; // 0x10(0x10)
...
// ScriptStruct ShooterGame.EsportsTournamentGPRDTO
// Size: 0x68 (Inherited: 0x01)
struct FEsportsTournamentGPRDTO : FEsportsDTOBase {
	struct FString ID; // 0x00(0x10)
	struct FString TournamentType; // 0x10(0x10)
	struct FEsportsTournamentRecordDTO TournamentRecord; // 0x20(0x08)
	struct FEsportsTournamentDetailsDTO TournamentDetails; // 0x28(0x40)
};

// ScriptStruct ShooterGame.EsportsGlobalPowerRankingDTO
// Size: 0x108 (Inherited: 0x01)
struct FEsportsGlobalPowerRankingDTO : FEsportsDTOBase {
	struct FString ID; // 0x00(0x10)
	struct FEsportsTeamDTOV2 Team; // 0x10(0xb0)
	struct FEsportsTeamRecordDTOV2 TeamMatchRecord; // 0xc0(0x08)
	struct FEsportsTeamRecordDTOV2 TeamGameRecord; // 0xc8(0x08)
	struct FEsportsCurrentTeamGPRDTO CurrentTeamGPR; // 0xd0(0x20)
	int32_t AverageOpponentGPR; // 0xf0(0x04)
	char pad_F5[0x3]; // 0xf5(0x03)
	struct TArray<struct FEsportsTournamentGPRDTO> TournamentGPRs; // 0xf8(0x10)
};
...
// ScriptStruct ShooterGame.EsportsGlobalPowerRankingLeagueDTO
// Size: 0x38 (Inherited: 0x01)
struct FEsportsGlobalPowerRankingLeagueDTO : FEsportsDTOBase {
	struct FString ID; // 0x00(0x10)
	struct FString DateCalculated; // 0x10(0x10)
	int32_t LeagueElo; // 0x20(0x04)
	char pad_25[0x3]; // 0x25(0x03)
	struct FString LeagueID; // 0x28(0x10)
};

// ScriptStruct ShooterGame.EsportsGlobalPowerRankingsDTO
// Size: 0x20 (Inherited: 0x01)
struct FEsportsGlobalPowerRankingsDTO : FEsportsDTOBase {
	struct TArray<struct FEsportsGlobalPowerRankingLeagueDTO> Leagues; // 0x00(0x10)
	struct TArray<struct FEsportsGlobalPowerRankingDTO> GlobalPowerRankings; // 0x10(0x10)
};
...
// ScriptStruct ShooterGame.EsportsMatchIDsList
// Size: 0x10 (Inherited: 0x00)
struct FEsportsMatchIDsList {
	struct TArray<struct FString> MatchIDs; // 0x00(0x10)
};

// ScriptStruct ShooterGame.EsportsSeasonTournamentKey
// Size: 0x03 (Inherited: 0x00)
struct FEsportsSeasonTournamentKey {
	enum class EEsportsSeason Season; // 0x00(0x01)
	enum class EEsportsSplit Split; // 0x01(0x01)
	enum class EVCTLeague League; // 0x02(0x01)
};

// ScriptStruct ShooterGame.EsportsLeagueContainer
// Size: 0x30 (Inherited: 0x00)
struct FEsportsLeagueContainer {
	char pad_0[0x30]; // 0x00(0x30)
};

// ScriptStruct ShooterGame.EsportsSplitContainer
// Size: 0x50 (Inherited: 0x00)
struct FEsportsSplitContainer {
	struct TMap<enum class EVCTLeague, struct FEsportsLeagueContainer> LeagueMap; // 0x00(0x50)
};

// ScriptStruct ShooterGame.EsportsSeasonsContainer
// Size: 0x50 (Inherited: 0x00)
struct FEsportsSeasonsContainer {
	struct TMap<enum class EEsportsSplit, struct FEsportsSplitContainer> SplitMap; // 0x00(0x50)
};
...
// ScriptStruct ShooterGame.FresnelOverride
// Size: 0x0c (Inherited: 0x00)
struct FFresnelOverride {
...
struct FAresListConstructArgs {
	...
	bool bEnableRightClickScrolling; // 0x07(0x01)
	enum class EConsumeMouseWheel ConsumeMouseWheel; // 0x08(0x01)
	bool bReturnFocusToSelection; // 0x09(0x01)
	bool bReturnFocusWithDirectionalNavigation; // 0x0a(0x01)
	enum class EAresListFocusReturnType FocusReturnType; // 0x0b(0x01)
	enum class EOrientation Orientation; // 0x0c(0x01)
	enum class EListItemAlignment TileAlignment; // 0x0d(0x01)
	char pad_E[0x2]; // 0x0e(0x02)
...
struct FAresListConfiguration {
	...
	bool bShouldSelectByDefault; // 0x16(0x01)
	bool bAutoExpandAll; // 0x17(0x01)
...
// ScriptStruct ShooterGame.MapPerfToolingCameraData
// Size: 0x68 (Inherited: 0x00)
struct FMapPerfToolingCameraData {
	struct FString CameraLabel; // 0x00(0x10)
	bool bOverrideCameraID; // 0x10(0x01)
	char pad_11[0x7]; // 0x11(0x07)
	struct FString CameraID; // 0x18(0x10)
	bool bTakeScreenshotDefault4k; // 0x28(0x01)
	bool bTakeScreenshotDefault1440p; // 0x29(0x01)
	bool bTakeScreenshotMedium; // 0x2a(0x01)
	bool bTakeScreenshotLow; // 0x2b(0x01)
	bool bTakeStatsCaptureDefault4k; // 0x2c(0x01)
	bool bTakeStatsCaptureDefault1440p; // 0x2d(0x01)
	bool bTakeStatsCaptureMedium; // 0x2e(0x01)
	bool bTakeStatsCaptureLow; // 0x2f(0x01)
	bool bTakeCsvProfileDefault4k; // 0x30(0x01)
	bool bTakeCsvProfileDefault1440p; // 0x31(0x01)
	bool bTakeCsvProfileMedium; // 0x32(0x01)
	bool bTakeCsvProfileLow; // 0x33(0x01)
	bool bTakePixDefault4k; // 0x34(0x01)
	bool bTakePixDefault1440p; // 0x35(0x01)
	bool bTakePixMedium; // 0x36(0x01)
	bool bTakePixLow; // 0x37(0x01)
	struct FVector Location; // 0x38(0x18)
...
struct FActivePingData {
	struct FEffectID EffectID; // 0x00(0x18)
	struct FVector PingLocation; // 0x18(0x18)
...
// ScriptStruct ShooterGame.AltModePlayerInfo
// Size: 0x28 (Inherited: 0x00)
struct FAltModePlayerInfo {
	struct FString InventoryHash; // 0x00(0x10)
	struct FString AliveState; // 0x10(0x10)
...
struct FAltModeTeamInfo {
	...
	char pad_24[0x4]; // 0x24(0x04)
	struct TArray<struct FAltModePlayerInfo> Players; // 0x28(0x10)
	struct TArray<struct FAltModeUtilityEntry> AcquiredUtility; // 0x38(0x10)
};
...
struct FAltModeLifecycleEvent {
	...
	struct FAltModeTeamInfo TargetTeamInfo; // 0x160(0x48)
	struct FAltModeTeamInfo InstigatorTeamInfo; // 0x1a8(0x48)
	struct FTelemetryPlatformDetails clientPlatformDetails; // 0x1f0(0x20)
	struct FString PlatformType; // 0x210(0x10)
};

// ScriptStruct ShooterGame.AltModeTeamSnapshotEvent
// Size: 0x108 (Inherited: 0x00)
struct FAltModeTeamSnapshotEvent {
	struct FGameEventMatchInfo MatchInfo; // 0x00(0x68)
	struct FGameEventRoundInfo RoundInfo; // 0x68(0x28)
	struct FAltModeTeamInfo TeamState; // 0x90(0x48)
	struct FTelemetryPlatformDetails clientPlatformDetails; // 0xd8(0x20)
	struct FString PlatformType; // 0xf8(0x10)
};
...
struct FAresQueueStatus {
	...
	bool IsDebugOnDemandSweepEnabled; // 0x19(0x01)
	char pad_1A[0x6]; // 0x1a(0x06)
};
...
struct FGameMetadata {
	...
	struct TArray<struct FName> TeamIDs; // 0xa0(0x10)
	struct TArray<int32_t> TeamNumbers; // 0xb0(0x10)
};
...
struct FMegapacketMetadata {
	...
	struct FGameMetadata GameMetadata; // 0xe8(0xc0)
	struct FTournamentMetadata TournamentMetadata; // 0x1a8(0x88)
	struct FTournamentRosterMetadata RosterMetadata; // 0x230(0x70)
};
...
struct FMegapacket {
	...
	struct FMegapacketMetadata MetaData; // 0x90(0x2a0)
};

// ScriptStruct ShooterGame.StrippedMegapacketPlayer
// Size: 0xd0 (Inherited: 0x00)
struct FStrippedMegapacketPlayer {
	struct FString CharacterID; // 0x00(0x10)
	struct FMegapacketLoadout Loadout; // 0x10(0xc0)
};

// ScriptStruct ShooterGame.StrippedMegapacket
// Size: 0x10 (Inherited: 0x00)
struct FStrippedMegapacket {
	struct TArray<struct FStrippedMegapacketPlayer> Players; // 0x00(0x10)
};
...
struct FModalContextNavInfo {
	...
	struct FGameplayTagContainer NonBlocking; // 0x40(0x20)
};
...
// ScriptStruct ShooterGame.GameplayAreaToggledTelemetryEvent
// Size: 0x50 (Inherited: 0x00)
struct FGameplayAreaToggledTelemetryEvent {
	struct FString MatchID; // 0x00(0x10)
	int32_t RoundNumber; // 0x10(0x04)
	char pad_14[0x4]; // 0x14(0x04)
	struct FString AreaID; // 0x18(0x10)
	struct FString areaName; // 0x28(0x10)
	bool areaEnabled; // 0x38(0x01)
	char pad_39[0x7]; // 0x39(0x07)
	struct FString PlatformType; // 0x40(0x10)
};
...
// ScriptStruct ShooterGame.PlayerToIsEnabledPair
// Size: 0x10 (Inherited: 0x00)
struct FPlayerToIsEnabledPair {
	struct AAresPlayerStateBase* Player; // 0x00(0x08)
...
struct FAresParty {
	...
	struct FTournamentData TournamentData; // 0x180(0xd8)
	struct FString ClientVersion; // 0x258(0x10)
	int64_t Version; // 0x268(0x08)
	bool LookingForMore; // 0x270(0x01)
	char pad_271[0x7]; // 0x271(0x07)
	struct FCheatData CheatData; // 0x278(0x18)
	struct TArray<struct FString> EligibleQueues; // 0x290(0x10)
	struct TArray<struct FPartyXPBonus> XPBonuses; // 0x2a0(0x10)
	struct FString State; // 0x2b0(0x10)
	struct FString PreviousState; // 0x2c0(0x10)
	enum class EAresPartyAccessibility Accessibility; // 0x2d0(0x01)
	char pad_2D1[0x7]; // 0x2d1(0x07)
	struct FString StateTransitionReason; // 0x2d8(0x10)
	struct TArray<struct FPartyInvite> Invites; // 0x2e8(0x10)
	struct TArray<struct FPartyExternalInvite> ExternalInvites; // 0x2f8(0x10)
	struct TArray<struct FPartyRequest> Requests; // 0x308(0x10)
	struct FDateTime QueueEntryTime; // 0x318(0x08)
	struct FAresPartyErrorNotification ErrorNotification; // 0x320(0x20)
	int64_t RestrictedSeconds; // 0x340(0x08)
	struct TArray<struct FQueueIneligibility> QueueIneligibilities; // 0x348(0x10)
	struct FString InviteCode; // 0x358(0x10)
	bool IsCrossPlayEnabled; // 0x368(0x01)
	char pad_369[0x7]; // 0x369(0x07)
	struct TMap<struct FString, struct FString> PreferredAgents; // 0x370(0x50)
};
...
// ScriptStruct ShooterGame.LeaveMatchmakingEvent
// Size: 0x50 (Inherited: 0x00)
struct FLeaveMatchmakingEvent {
	char pad_0[0x50]; // 0x00(0x50)
};
...
// ScriptStruct ShooterGame.DynamicOptionMapping
// Size: 0x18 (Inherited: 0x00)
struct FDynamicOptionMapping {
	struct UAresBasePrimaryDataAsset* ParentDataAsset; // 0x00(0x08)
	struct TArray<struct FDynamicParamOptionPair> ParamOptionArray; // 0x08(0x10)
};
...
struct FPlayerMapping {
	...
	char pad_64[0x4]; // 0x64(0x04)
	struct TArray<struct FDynamicOptionMapping> OptionMappings; // 0x68(0x10)
	struct FGuid Subject; // 0x78(0x10)
	bool bIncognito; // 0x88(0x01)
	char pad_89[0x7]; // 0x89(0x07)
};
...
// ScriptStruct ShooterGame.DynamicOptionLoadout
// Size: 0x10 (Inherited: 0x00)
struct FDynamicOptionLoadout {
	struct TArray<struct FGuid> OptionAssetIDs; // 0x00(0x10)
};
...
struct FPlayerLoadout {
	...
	int32_t MaxExpressionSlots; // 0x98(0x04)
	bool Incognito; // 0x9c(0x01)
	char pad_9D[0x3]; // 0x9d(0x03)
	struct FLoadoutIdentity Identity; // 0xa0(0x34)
	char pad_D4[0x4]; // 0xd4(0x04)
};
...
// ScriptStruct ShooterGame.PickemSwissParams
// Size: 0x20 (Inherited: 0x00)
struct FPickemSwissParams {
	struct FString TournamentID; // 0x00(0x10)
	struct FString sectionid; // 0x10(0x10)
};
...
// ScriptStruct ShooterGame.FriendRequestFromPlatformTelemetryEvent
// Size: 0x40 (Inherited: 0x00)
struct FFriendRequestFromPlatformTelemetryEvent {
	struct FString Subject; // 0x00(0x10)
	struct FString SocialPlatform; // 0x10(0x10)
	struct FString TargetSubject; // 0x20(0x10)
	struct FString EventType; // 0x30(0x10)
};

// ScriptStruct ShooterGame.LaunchDevRiotClientSettings
// Size: 0x28 (Inherited: 0x00)
struct FLaunchDevRiotClientSettings {
	struct FString RSOUsername; // 0x00(0x10)
	struct FString RSOPassword; // 0x10(0x10)
	bool bHideRiotClientWindow; // 0x20(0x01)
	char pad_21[0x7]; // 0x21(0x07)
};
...
struct FPregameMatchPlayer {
	...
	struct FMatchPlayerBonsaiBloomlineData BonsaiBloomlineData; // 0x20(0x18)
	struct FString CharacterSelectionState; // 0x38(0x10)
	struct FString PregamePlayerState; // 0x48(0x10)
	int32_t CompetitiveTier; // 0x58(0x04)
	char pad_5C[0x4]; // 0x5c(0x04)
	struct FPlayerIdentity PlayerIdentity; // 0x60(0x48)
	struct FMMRSeasonBadgeInfo SeasonalBadgeInfo; // 0xa8(0x78)
	struct FPremierPrestigeInternal PremierPrestige; // 0x120(0x50)
	bool IsCaptain; // 0x170(0x01)
	char pad_171[0x7]; // 0x171(0x07)
};
...
struct FPremierRosterInfo {
	...
	enum class EPremierRosterType RosterType; // 0x30(0x01)
	char pad_31[0x3]; // 0x31(0x03)
	int32_t Division; // 0x34(0x04)
	int64_t Score; // 0x38(0x08)
};
...
struct FPremierPrestige {
	...
	struct FString RosterName; // 0x10(0x10)
	struct FString RosterTag; // 0x20(0x10)
	struct FString PrefixSeparator; // 0x30(0x10)
...
struct FPremierRoster {
	...
	enum class EPremierRosterType RosterType; // 0x30(0x01)
	char pad_31[0x3]; // 0x31(0x03)
	int32_t LeaguePoints; // 0x34(0x04)
	struct FString Conference; // 0x38(0x10)
	int32_t Division; // 0x48(0x04)
	bool IsProvisionalDivision; // 0x4c(0x01)
	bool PromotionApplied; // 0x4d(0x01)
	char pad_4E[0x2]; // 0x4e(0x02)
	int32_t LeaguePointsBonusMatchesRemaining; // 0x50(0x04)
	int32_t LeaguePointsBonusMatchesTotal; // 0x54(0x04)
	int32_t LeagueMatchesPlayed; // 0x58(0x04)
	int32_t TournamentsPlayed; // 0x5c(0x04)
	bool IsEnrolled; // 0x60(0x01)
	char pad_61[0x3]; // 0x61(0x03)
	int32_t MinimumRequiredMembersForEnrollment; // 0x64(0x04)
	int64_t Version; // 0x68(0x08)
	int32_t Wins; // 0x70(0x04)
	int32_t GamesPlayed; // 0x74(0x04)
	struct FPremierRosterCustomization CustomizationData; // 0x78(0x40)
	struct FPremierRosterV2SeasonData Season; // 0xb8(0x100)
	struct TMap<struct FString, struct FPremierRosterV2SeasonData> SeasonalInfoBySeasonID; // 0x1b8(0x50)
	struct FPremierRosterPrestige Prestige; // 0x208(0x18)
	bool IsForceRenamed; // 0x220(0x01)
	char pad_221[0x7]; // 0x221(0x07)
	struct TArray<struct FPremierRosterV2Member> Members; // 0x228(0x10)
};
...
struct FAresPresenceInfo {
	...
	struct FAresPresenceData Data; // 0xe8(0x228)
};
...
struct FAresPresenceData {
	...
	struct FAresPremierPresenceData PremierPresenceData; // 0x40(0x48)
	struct FAresMatchPresenceData MatchPresenceData; // 0x88(0x38)
	struct FAresPartyPresenceData PartyPresenceData; // 0xc0(0xf0)
	struct FAresPlayerPresenceData PlayerPresenceData; // 0x1b0(0x30)
	struct FAresActivityData ActivityData; // 0x1e0(0x48)
};

// ScriptStruct ShooterGame.AresActivityData
// Size: 0x48 (Inherited: 0x00)
struct FAresActivityData {
	struct FString ActivityId; // 0x00(0x10)
	struct FString ActorKey; // 0x10(0x10)
	struct FString ModeKey; // 0x20(0x10)
	struct FString LocationKey; // 0x30(0x10)
	bool bInMatch; // 0x40(0x01)
	char pad_41[0x7]; // 0x41(0x07)
};
...
struct FAresPremierPresenceData {
	...
	int32_t Division; // 0x34(0x04)
	int64_t Score; // 0x38(0x08)
	char Plating; // 0x40(0x01)
	bool ShowAura; // 0x41(0x01)
	bool ShowTag; // 0x42(0x01)
	bool ShowPlating; // 0x43(0x01)
	char pad_44[0x4]; // 0x44(0x04)
};
...
struct FAresPresenceDataWrapper {
	struct FAresPresenceData AresData; // 0x00(0x228)
};
...
// ScriptStruct ShooterGame.BookmarkEventDTO
// Size: 0x10 (Inherited: 0x10)
struct FBookmarkEventDTO : FBaseReplayEventDTO {
};
...
struct FAbilityUsageEvent {
	...
	struct FGameEventRoundInfo RoundInfo; // 0x68(0x28)
	struct FGameEventPlayerInfo PlayerInfo; // 0x90(0x60)
	struct FGameEventCharacterState PlayerState; // 0xf0(0x1d0)
	struct FAbilityUsageInfo AbilityInfo; // 0x2c0(0x68)
};
...
struct FInventoryChangeEvent {
	...
	char pad_FC[0x4]; // 0xfc(0x04)
	struct FGameEventInventory StartingInventory; // 0x100(0x158)
	struct FGameEventInventory EndingInventory; // 0x258(0x158)
	struct FString ItemId; // 0x3b0(0x10)
	struct FString ItemName; // 0x3c0(0x10)
	struct FString ReceiverId; // 0x3d0(0x10)
	struct FString SenderId; // 0x3e0(0x10)
	struct FString TransactionType; // 0x3f0(0x10)
	int32_t ItemCost; // 0x400(0x04)
	char pad_404[0x4]; // 0x404(0x04)
	struct FString InventoryHashKey; // 0x408(0x10)
};
...
struct FSessionDTO {
	...
	struct FString Ticket; // 0xc8(0x10)
	bool ShouldForceInvalidate; // 0xd8(0x01)
...
struct FAresAudioGlobals {
	...
	char pad_C[0x4]; // 0x0c(0x04)
	struct TArray<struct TSoftClassPtr<UObject>> PerspectiveUpdateExceptionClasses; // 0x10(0x10)
	struct UAkAudioEvent* ReplayPauseAudioEmitter; // 0x20(0x08)
	struct UAkRtpc* LifetimeRemainingPercent; // 0x28(0x08)
	struct UAkSwitchValue* LocalPlayerPerspective; // 0x30(0x08)
	struct UAkSwitchValue* ThirdPersonAllyPerspective; // 0x38(0x08)
	struct UAkSwitchValue* ThirdPersonEnemyPerspective; // 0x40(0x08)
	struct TMap<enum class EPitchOffsetOverrideType, struct UAkAudioEvent*> PitchOverrideOptions; // 0x48(0x50)
};
...
struct FAresDebugLineReplicated {
	...
	bool bPersistentLines; // 0x3d(0x01)
	char pad_3E[0x2]; // 0x3e(0x02)
};
...
struct FBurstPacketLossSettings {
	struct FNormalDistributionParameters DurationMs; // 0x00(0x08)
	struct FNormalDistributionParameters PeriodSeconds; // 0x08(0x08)
	struct FNormalDistributionParameters LossPercentage; // 0x10(0x08)
	float NextStartTime; // 0x18(0x04)
	float NextDurationMS; // 0x1c(0x04)
	float NextLossPercentage; // 0x20(0x04)
	bool bSimulateBurstLoss; // 0x24(0x01)
	bool bIsActive; // 0x25(0x01)
	char pad_26[0x2]; // 0x26(0x02)
};
...
struct FNetworkDegradationSettings {
	...
	struct FBurstPacketLossSettings BurstLoss; // 0x10(0x28)
};
...
struct FNamedNetworkPresets {
	struct FString Name; // 0x00(0x10)
	struct FNetworkDegradationSettings Mean; // 0x10(0x38)
	struct FNetworkDegradationSettings StdDev; // 0x48(0x38)
};
...
struct FYawDirectionManipulator {
	...
	float TimeToSwitchYaw; // 0x1c(0x04)
	float ProtectedBulletCount; // 0x20(0x04)
	enum class EStabilityInterpolationType YawSwitchChanceIncreaseInterpolationType; // 0x24(0x01)
	enum class EStabilityInterpolationType YawSwitchChanceRecoveryInterpolationType; // 0x25(0x01)
	enum class EStabilityInterpolationType YawSwitchOverInterpolationType; // 0x26(0x01)
...
struct FActiveScriptStateEffect {
	struct FEffectID EffectID; // 0x00(0x18)
	enum class EMovementSync MovementSync; // 0x18(0x01)
	char pad_19[0x7]; // 0x19(0x07)
	struct UEffectManagerComponent* TargetEffectManager; // 0x20(0x08)
};
...
// ScriptStruct ShooterGame.ConfigData
// Size: 0x20 (Inherited: 0x00)
struct FConfigData {
	struct FName ConfigName; // 0x00(0x0c)
	char pad_C[0x4]; // 0x0c(0x04)
	struct FString ConfigDefaultValue; // 0x10(0x10)
};
...
// ScriptStruct ShooterGame.StorefrontCTA
// Size: 0x28 (Inherited: 0x00)
struct FStorefrontCTA {
	struct FGuid ID; // 0x00(0x10)
	struct FGuid DataAssetID; // 0x10(0x10)
	enum class ECTAType CTAType; // 0x20(0x01)
	char pad_21[0x3]; // 0x21(0x03)
	int32_t DurationRemainingInSeconds; // 0x24(0x04)
};

// ScriptStruct ShooterGame.FeaturedTileEntryUnion
// Size: 0x128 (Inherited: 0x00)
struct FFeaturedTileEntryUnion {
	struct FStorefrontBundle Bundle; // 0x00(0x100)
	struct FStorefrontCTA CTA; // 0x100(0x28)
};

// ScriptStruct ShooterGame.FeaturedTileEntry
// Size: 0x130 (Inherited: 0x00)
struct FFeaturedTileEntry {
	enum class EFeaturedTileType Type; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct FFeaturedTileEntryUnion Entry; // 0x08(0x128)
};
...
struct FBundleLayout {
	...
	struct TArray<struct FFeaturedTileEntry> FeaturedTileEntries; // 0x110(0x10)
	int32_t BundleRemainingDurationInSeconds; // 0x120(0x04)
	char pad_124[0x4]; // 0x124(0x04)
};
...
struct FGetStorefrontResponseV3 {
	struct FBundleLayout FeaturedBundle; // 0x00(0x128)
	struct FSkinsPanelLayout SkinsPanelLayout; // 0x128(0x18)
	struct FBonusStoreStorefront BonusStore; // 0x140(0x18)
	struct FAccessoryStorefront AccessoryStore; // 0x158(0x28)
	struct FJuiceBoxStorefront JuiceBoxStore; // 0x180(0x18)
	struct FUpgradeCurrencyStorefront UpgradeCurrencyStore; // 0x198(0x10)
	struct TArray<struct FPluginStorefront> PluginStores; // 0x1a8(0x10)
	int32_t SecondsUntilRefreshNeeded; // 0x1b8(0x04)
...
// ScriptStruct ShooterGame.CatalogOfferAssociation
// Size: 0x34 (Inherited: 0x00)
struct FCatalogOfferAssociation {
...
struct FExecuteGiftRequest {
	...
	struct FCatalogOfferAssociation GiftOfferAssociation; // 0x10(0x34)
	char pad_44[0x4]; // 0x44(0x04)
...
struct FCheckGiftRecipientEligibilityRequest {
	struct TArray<struct FCatalogOfferAssociation> CatalogQueryItems; // 0x00(0x10)
};
...
// ScriptStruct ShooterGame.ExecutePurchaseRequest
// Size: 0x68 (Inherited: 0x00)
struct FExecutePurchaseRequest {
	struct FCatalogOfferAssociation CatalogOfferAssociation; // 0x00(0x34)
	char pad_34[0x4]; // 0x34(0x04)
	struct TArray<struct FPaymentInfo> ExpectedCosts; // 0x38(0x10)
	struct TArray<struct FEntitlementReward> ExpectedRewards; // 0x48(0x10)
	struct FGuid IdempotencyID; // 0x58(0x10)
};
...
// ScriptStruct ShooterGame.ContentImageDisplayData
// Size: 0xd8 (Inherited: 0x00)
struct FContentImageDisplayData {
	struct FWidgetTransform BaseTransform; // 0x00(0x38)
	struct TMap<struct TSoftClassPtr<UObject>, struct FWidgetTransform> TransformMap; // 0x38(0x50)
	struct TMap<struct TSoftClassPtr<UObject>, struct FWidgetTransform> IndividualItemTransformMap; // 0x88(0x50)
};
...
// ScriptStruct ShooterGame.DebuffRevealedActor
// Size: 0x10 (Inherited: 0x00)
struct FDebuffRevealedActor {
	struct AActor* Actor; // 0x00(0x08)
	float ExpectedEndTime; // 0x08(0x04)
	bool bIsInfiniteDuration; // 0x0c(0x01)
	char pad_D[0x3]; // 0x0d(0x03)
};
...
struct FQueuedMessage {
	...
	char pad_19[0x7]; // 0x19(0x07)
	struct FString EventId; // 0x20(0x10)
	struct FString MetricName; // 0x30(0x10)
	int32_t MetricValue; // 0x40(0x04)
	char pad_44[0x4]; // 0x44(0x04)
};
...
// ScriptStruct ShooterGame.GameEventInventoryCacheKey
// Size: 0x20 (Inherited: 0x00)
struct FGameEventInventoryCacheKey {
	int32_t TeamNumber; // 0x00(0x04)
	int32_t PlayerNumber; // 0x04(0x04)
	int32_t InventorySequenceNumber; // 0x08(0x04)
	char pad_C[0x4]; // 0x0c(0x04)
	struct FString Key; // 0x10(0x10)
};
...
// ScriptStruct ShooterGame.PushModelValidationInfo
// Size: 0x18 (Inherited: 0x00)
struct FPushModelValidationInfo {
	struct FString PropertyName; // 0x00(0x10)
	int32_t NumberOfFailedValidations; // 0x10(0x04)
	char pad_14[0x4]; // 0x14(0x04)
};

// ScriptStruct ShooterGame.PushModelValidationFailedEvent
// Size: 0x28 (Inherited: 0x00)
struct FPushModelValidationFailedEvent {
	struct FString MatchID; // 0x00(0x10)
	int32_t RoundNumber; // 0x10(0x04)
	char pad_14[0x4]; // 0x14(0x04)
	struct TArray<struct FPushModelValidationInfo> PushModelValidationInfo; // 0x18(0x10)
};

// ScriptStruct ShooterGame.WallPushEvent
// Size: 0xc8 (Inherited: 0x00)
struct FWallPushEvent {
	struct FString PlatformType; // 0x00(0x10)
	struct FGameEventMatchInfo MatchInfo; // 0x10(0x68)
	int32_t RoundNumber; // 0x78(0x04)
	float RoundTime; // 0x7c(0x04)
	struct FString PusherSubject; // 0x80(0x10)
	struct FVector StartingWallLocation; // 0x90(0x18)
	struct FVector DestinationWallLocation; // 0xa8(0x18)
	int32_t DestinationGameplayPosition; // 0xc0(0x04)
	char pad_C4[0x4]; // 0xc4(0x04)
};

// ScriptStruct ShooterGame.LastAliveOutcomeEvent
// Size: 0xa8 (Inherited: 0x00)
struct FLastAliveOutcomeEvent {
	struct FString PlatformType; // 0x00(0x10)
	struct FGameEventMatchInfo MatchInfo; // 0x10(0x68)
	int32_t RoundNumber; // 0x78(0x04)
	float RoundTime; // 0x7c(0x04)
	struct FString LastAliveSubject; // 0x80(0x10)
	int32_t LastAliveStartEnemyCount; // 0x90(0x04)
	float LastAliveSeconds; // 0x94(0x04)
	struct FString LastAliveOutcome; // 0x98(0x10)
};

// ScriptStruct ShooterGame.WallDebuffKillEvent
// Size: 0xb0 (Inherited: 0x00)
struct FWallDebuffKillEvent {
	struct FString PlatformType; // 0x00(0x10)
	struct FGameEventMatchInfo MatchInfo; // 0x10(0x68)
	int32_t RoundNumber; // 0x78(0x04)
	float RoundTime; // 0x7c(0x04)
	struct FString KillerSubject; // 0x80(0x10)
	bool KillerWasDebuffed; // 0x90(0x01)
	char pad_91[0x7]; // 0x91(0x07)
	struct FString VictimSubject; // 0x98(0x10)
	bool VictimWasDebuffed; // 0xa8(0x01)
	char pad_A9[0x7]; // 0xa9(0x07)
};
...
// ScriptStruct ShooterGame.TimeSlicedActionHandle
// Size: 0x08 (Inherited: 0x00)
struct FTimeSlicedActionHandle {
	uint64_t Handle; // 0x00(0x08)
};

// ScriptStruct ShooterGame.TimeSlicedAction
// Size: 0x40 (Inherited: 0x00)
struct FTimeSlicedAction {
	char pad_0[0x20]; // 0x00(0x20)
	struct UObject* OwningObject; // 0x20(0x08)
	struct UFunction* CompletionFunction; // 0x28(0x08)
	char pad_30[0x10]; // 0x30(0x10)
};
...
// ScriptStruct ShooterGame.UINavigationFlowEntry
// Size: 0x20 (Inherited: 0x00)
struct FUINavigationFlowEntry {
	struct FString URL; // 0x00(0x10)
	enum class EUINavigationIntent NavigationIntent; // 0x10(0x01)
	char pad_11[0x7]; // 0x11(0x07)
	int64_t TimeSpentOnPreviousScreenSeconds; // 0x18(0x08)
};
...
struct FShooterSnapshotMove : FShooterSnapshot {
	...
	struct FVector CharacterSpaceInputVector; // 0x70(0x18)
};

// ScriptStruct ShooterGame.ShooterSnapshotPlayerInput
// Size: 0x20 (Inherited: 0x10)
struct FShooterSnapshotPlayerInput : FShooterSnapshot {
	int32_t PlayerID; // 0x10(0x04)
	uint32_t ButtonPresses; // 0x14(0x04)
	float AimMovementYawRads; // 0x18(0x04)
	float AimMovementPitchRads; // 0x1c(0x04)
};
...
struct FShooterSnapshotPlayer : FShooterSnapshot {
	...
	int32_t AmmoReserves; // 0xac(0x04)
	bool bIsReloading; // 0xb0(0x01)
	char pad_B1[0x3]; // 0xb1(0x03)
	int32_t Kills; // 0xb4(0x04)
	int32_t Deaths; // 0xb8(0x04)
	int32_t Assists; // 0xbc(0x04)
...
struct FShooterWorldStateSnapshot : FShooterSnapshot {
	int32_t MatchTimeLeft; // 0x10(0x04)
	bool bHasWinner; // 0x14(0x01)
	char pad_15[0x3]; // 0x15(0x03)
	int32_t RoundID; // 0x18(0x04)
	enum class EAresGamePhase RoundPhase; // 0x1c(0x01)
	char pad_1D[0x3]; // 0x1d(0x03)
	struct TArray<struct FShooterSnapshotTeam> Teams; // 0x20(0x10)
	struct TArray<struct FShooterSnapshotPlayerInput> PlayerInputs; // 0x30(0x10)
};

// ScriptStruct ShooterGame.LineTraceRequest
// Size: 0x10 (Inherited: 0x00)
struct FLineTraceRequest {
	char pad_0[0x10]; // 0x00(0x10)
};

// ScriptStruct ShooterGame.LineTraceResult
// Size: 0x18 (Inherited: 0x00)
struct FLineTraceResult {
	char pad_0[0x18]; // 0x00(0x18)
};

// ScriptStruct ShooterGame.LineTraceHit
// Size: 0x38 (Inherited: 0x00)

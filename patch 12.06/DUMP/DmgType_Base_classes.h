...
struct UDmgType_Base_C : UShooterDamageType {
	...
	void PlayHitConfirmSound(struct AShooterCharacter* FirstPersonShooterCharacter, struct AShooterCharacter* ShooterCharacterInstigator, struct AActor* HitActor, enum class EAresHitConfirmLocality HitLocality, enum class EAresRegionalDamage RegionalDamage, bool bLocalPlayerCanSeeVictim, float FalloffMultiplier, struct UDamageResponse* DamageResponse, bool bDied); // Function DmgType_Base.DmgType_Base_C.PlayHitConfirmSound // (Event|Public|BlueprintCallable|BlueprintEvent|Const) // @ game+0x1b42740
	bool ShouldReportDamage(struct UObject* Instigator, struct UDamageResponse* Response); // Function DmgType_Base.DmgType_Base_C.ShouldReportDamage // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1b42740
	struct UCharacterAbilityStatisticsComponent_C* GetGameStatisticsComponent(struct UDamageResponse* Response, int32_t& CastIndex); // Function DmgType_Base.DmgType_Base_C.GetGameStatisticsComponent // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const) // @ game+0x1b42740
	void RespondToDamage(struct UDamageResponse* DamageResponse); // Function DmgType_Base.DmgType_Base_C.RespondToDamage // (Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent|Const) // @ game+0x1b42740
};

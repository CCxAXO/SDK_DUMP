...
struct UCreateTeamModal_C : UUserWidget {
	...
	struct FAresMainMenuNavBarData GetNavBarData(); // Function CreateTeamModal.CreateTeamModal_C.GetNavBarData // (Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1b42740
	bool HandleBackRequest(); // Function CreateTeamModal.CreateTeamModal_C.HandleBackRequest // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnSuccess(struct FRoster& Roster); // Function CreateTeamModal.CreateTeamModal_C.OnSuccess // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnError(enum class ERosterCreateErrorType& ErrorType); // Function CreateTeamModal.CreateTeamModal_C.OnError // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function CreateTeamModal.CreateTeamModal_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void BndEvt__TeamTag_K2Node_ComponentBoundEvent_2_OnEditableTextBoxChangedEvent__DelegateSignature(struct FText& Text); // Function CreateTeamModal.CreateTeamModal_C.BndEvt__TeamTag_K2Node_ComponentBoundEvent_2_OnEditableTextBoxChangedEvent__DelegateSignature // (HasOutParms|BlueprintEvent) // @ game+0x1b42740
	void BndEvt__CreateTeamModal_WBP_MenuButtonPrimary_K2Node_ComponentBoundEvent_3_OnUniversalButtonVoidEvent__DelegateSignature(); // Function CreateTeamModal.CreateTeamModal_C.BndEvt__CreateTeamModal_WBP_MenuButtonPrimary_K2Node_ComponentBoundEvent_3_OnUniversalButtonVoidEvent__DelegateSignature // (BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_CreateTeamModal(int32_t EntryPoint); // Function CreateTeamModal.CreateTeamModal_C.ExecuteUbergraph_CreateTeamModal // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
	void OnTeamCreated__DelegateSignature(); // Function CreateTeamModal.CreateTeamModal_C.OnTeamCreated__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

...
struct UWBP_Panel_StartGame_C : UAresCommonUserWidget {
	...
	void __Setter_bIsPlayAgain(bool NewValue); // Function WBP_Panel_StartGame.WBP_Panel_StartGame_C.__Setter_bIsPlayAgain // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void CreateQueueViewModel(); // Function WBP_Panel_StartGame.WBP_Panel_StartGame_C.CreateQueueViewModel // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void UpdateQueueTimer(struct FText QueueTimerText); // Function WBP_Panel_StartGame.WBP_Panel_StartGame_C.UpdateQueueTimer // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetInQueue(enum class ESlateVisibility InQueueVisibility); // Function WBP_Panel_StartGame.WBP_Panel_StartGame_C.SetInQueue // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void FormatExpiryText(struct TArray<struct FString>& QueueRestrictedPuuids); // Function WBP_Panel_StartGame.WBP_Panel_StartGame_C.FormatExpiryText // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void UpdateButtonText(bool bLocalPlayerUnverified); // Function WBP_Panel_StartGame.WBP_Panel_StartGame_C.UpdateButtonText // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	enum class ESlateVisibility __0e63eca5-427d-cd1a-42dc-958b181b7ac8_SourceToDest(); // Function WBP_Panel_StartGame.WBP_Panel_StartGame_C.__0e63eca5-427d-cd1a-42dc-958b181b7ac8_SourceToDest // (Final|Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1b42740
	void PreConstruct(bool IsDesignTime); // Function WBP_Panel_StartGame.WBP_Panel_StartGame_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_WBP_Panel_StartGame(int32_t EntryPoint); // Function WBP_Panel_StartGame.WBP_Panel_StartGame_C.ExecuteUbergraph_WBP_Panel_StartGame // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
};

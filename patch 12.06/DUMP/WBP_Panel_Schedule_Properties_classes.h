...
struct UWBP_Panel_Schedule_Properties_C : UAresCommonUserWidget {
	...
	void OnVCTFilterSelectionChanged(struct UObject* EntryObject, struct UUserWidget* EntryWidget, bool EntryState); // Function WBP_Panel_Schedule_Properties.WBP_Panel_Schedule_Properties_C.OnVCTFilterSelectionChanged // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void GetAllVCTLeagues(); // Function WBP_Panel_Schedule_Properties.WBP_Panel_Schedule_Properties_C.GetAllVCTLeagues // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void UpdateLeagues(enum class EVCTLeague League, bool IsChecked); // Function WBP_Panel_Schedule_Properties.WBP_Panel_Schedule_Properties_C.UpdateLeagues // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function WBP_Panel_Schedule_Properties.WBP_Panel_Schedule_Properties_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_WBP_Panel_Schedule_Properties(int32_t EntryPoint); // Function WBP_Panel_Schedule_Properties.WBP_Panel_Schedule_Properties_C.ExecuteUbergraph_WBP_Panel_Schedule_Properties // (Final|UbergraphFunction) // @ game+0x1b42740
	void LeagueFilterUpdated__DelegateSignature(struct TSet<enum class EVCTLeague> Leagues); // Function WBP_Panel_Schedule_Properties.WBP_Panel_Schedule_Properties_C.LeagueFilterUpdated__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

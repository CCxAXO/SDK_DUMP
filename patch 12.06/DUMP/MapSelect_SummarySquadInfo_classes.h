...
struct UMapSelect_SummarySquadInfo_C : UMapSelect_SquadInfoBase_C {
	...
	void SetSide(enum class EPregameTeamID Side); // Function MapSelect_SummarySquadInfo.MapSelect_SummarySquadInfo_C.SetSide // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Initialize(); // Function MapSelect_SummarySquadInfo.MapSelect_SummarySquadInfo_C.Initialize // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

...
struct UWBP_Panel_Folder_SocialPanelPlayer_C : UWBP_Panel_Folder_Social_C {
	...
	void InitializeListWidget(struct UWBP_Panel_List_Social_Base_C* InListWidget); // Function WBP_Panel_Folder_SocialPanelPlayer.WBP_Panel_Folder_SocialPanelPlayer_C.InitializeListWidget // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

...
struct UGameplay_OtherSettingsWidgetV2_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function Gameplay_OtherSettingsWidgetV2.Gameplay_OtherSettingsWidgetV2_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void MatureSettingUpdated(bool Value); // Function Gameplay_OtherSettingsWidgetV2.Gameplay_OtherSettingsWidgetV2_C.MatureSettingUpdated // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_Gameplay_OtherSettingsWidgetV2(int32_t EntryPoint); // Function Gameplay_OtherSettingsWidgetV2.Gameplay_OtherSettingsWidgetV2_C.ExecuteUbergraph_Gameplay_OtherSettingsWidgetV2 // (Final|UbergraphFunction) // @ game+0x1b42740
};

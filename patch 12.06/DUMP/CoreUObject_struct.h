...
struct FARFilter {
	struct TArray<None> PackageNames; // 0x00(0x10)
	struct TArray<None> PackagePaths; // 0x10(0x10)
...
struct FAssetBundleEntry {
	...
	struct TArray<None> AssetPaths; // 0x10(0x10)
};
...
struct FInterpCurveVector {
	struct TArray<StorefrontItem_VCTCaps25_100TThemeBundle_DataAsset> Points; // 0x00(0x10)
	bool bIsLooped; // 0x10(0x01)
	char pad_11[0x3]; // 0x11(0x03)
	float LoopKeyOffset; // 0x14(0x04)
};

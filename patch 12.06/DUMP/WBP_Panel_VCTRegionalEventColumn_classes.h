...
struct UWBP_Panel_VCTRegionalEventColumn_C : UAresCommonUserWidget {
	...
	struct TArray<None> Events; // 0x408(0x10)

	struct UWidget* BP_GetDesiredFocusTarget(); // Function WBP_Panel_VCTRegionalEventColumn.WBP_Panel_VCTRegionalEventColumn_C.BP_GetDesiredFocusTarget // (Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1b42740
	void Initialize(struct TArray<None>& InEvents); // Function WBP_Panel_VCTRegionalEventColumn.WBP_Panel_VCTRegionalEventColumn_C.Initialize // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

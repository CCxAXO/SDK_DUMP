...
struct AChaosCacheManager : AActor {
	...
	void TriggerComponentByCache(struct FName InCacheName); // Function ChaosCaching.ChaosCacheManager.TriggerComponentByCache // (Final|RequiredAPI|Native|Protected|BlueprintCallable) // @ game+0x7902590
	void TriggerComponent(struct UPrimitiveComponent* InComponent); // Function ChaosCaching.ChaosCacheManager.TriggerComponent // (Final|RequiredAPI|Native|Protected|BlueprintCallable) // @ game+0x7902700
	void TriggerAll(); // Function ChaosCaching.ChaosCacheManager.TriggerAll // (Final|RequiredAPI|Native|Protected|BlueprintCallable) // @ game+0x79024f0
	void SetStartTime(float InStartTime); // Function ChaosCaching.ChaosCacheManager.SetStartTime // (Final|RequiredAPI|Native|Public) // @ game+0x7902c70
	void SetCacheCollection(struct UChaosCacheCollection* InCacheCollection); // Function ChaosCaching.ChaosCacheManager.SetCacheCollection // (Final|RequiredAPI|Native|Protected|BlueprintCallable) // @ game+0x7902850
	void ResetSingleTransform(int32_t InIndex); // Function ChaosCaching.ChaosCacheManager.ResetSingleTransform // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x7902a10
	void ResetAllComponentTransforms(); // Function ChaosCaching.ChaosCacheManager.ResetAllComponentTransforms // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x7902b60
	void EnablePlaybackByCache(struct FName InCacheName, bool bEnable); // Function ChaosCaching.ChaosCacheManager.EnablePlaybackByCache // (Final|RequiredAPI|Native|Protected|BlueprintCallable) // @ game+0x7902310
	void EnablePlayback(int32_t Index, bool bEnable); // Function ChaosCaching.ChaosCacheManager.EnablePlayback // (Final|RequiredAPI|Native|Protected|BlueprintCallable) // @ game+0x7902160
};

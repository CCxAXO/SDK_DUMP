...
struct USharedBlurBg_C : UUserWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function SharedBlurBg.SharedBlurBg_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_SharedBlurBg(int32_t EntryPoint); // Function SharedBlurBg.SharedBlurBg_C.ExecuteUbergraph_SharedBlurBg // (Final|UbergraphFunction) // @ game+0x1b42740
};

...
struct URosterHistoryTournamentEntry_C : UUserWidget {
	...
	void SetColorForWinLossText(int32_t Wins, int32_t Losses); // Function RosterHistoryTournamentEntry.RosterHistoryTournamentEntry_C.SetColorForWinLossText // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function RosterHistoryTournamentEntry.RosterHistoryTournamentEntry_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void BndEvt__ViewBracketButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(); // Function RosterHistoryTournamentEntry.RosterHistoryTournamentEntry_C.BndEvt__ViewBracketButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature // (BlueprintEvent) // @ game+0x1b42740
	void OnMatchOpened(struct FString MatchID); // Function RosterHistoryTournamentEntry.RosterHistoryTournamentEntry_C.OnMatchOpened // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	...
	void BndEvt__RosterHistoryTournamentEntry_But_ViewBracket_K2Node_ComponentBoundEvent_1_OnButtonHoverEvent__DelegateSignature(); // Function RosterHistoryTournamentEntry.RosterHistoryTournamentEntry_C.BndEvt__RosterHistoryTournamentEntry_But_ViewBracket_K2Node_ComponentBoundEvent_1_OnButtonHoverEvent__DelegateSignature // (BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_RosterHistoryTournamentEntry(int32_t EntryPoint); // Function RosterHistoryTournamentEntry.RosterHistoryTournamentEntry_C.ExecuteUbergraph_RosterHistoryTournamentEntry // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
	void OnMatchClicked__DelegateSignature(struct FString MatchID); // Function RosterHistoryTournamentEntry.RosterHistoryTournamentEntry_C.OnMatchClicked__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnBracketClicked__DelegateSignature(struct FString TournamentID); // Function RosterHistoryTournamentEntry.RosterHistoryTournamentEntry_C.OnBracketClicked__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

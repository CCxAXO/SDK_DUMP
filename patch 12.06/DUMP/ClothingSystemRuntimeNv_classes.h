...
struct UClothingSimulationInteractorNv : UClothingSimulationInteractor {
	...
	void SetAnimDriveDamperStiffness(float InStiffness); // Function ClothingSystemRuntimeNv.ClothingSimulationInteractorNv.SetAnimDriveDamperStiffness // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x3ec3d70
};

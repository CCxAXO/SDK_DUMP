...
struct UCrosshairSettingsTab_General_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function CrosshairSettingsTab_General.CrosshairSettingsTab_General_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_CrosshairSettingsTab_General(int32_t EntryPoint); // Function CrosshairSettingsTab_General.CrosshairSettingsTab_General_C.ExecuteUbergraph_CrosshairSettingsTab_General // (Final|UbergraphFunction) // @ game+0x1b42740
};

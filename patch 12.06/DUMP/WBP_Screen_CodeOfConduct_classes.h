...
struct UWBP_Screen_CodeOfConduct_C : UWBP_Screen_CustomModal_Base_C {
	...
	void OnCIATriggered(struct FName ActionName); // Function WBP_Screen_CodeOfConduct.WBP_Screen_CodeOfConduct_C.OnCIATriggered // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnCustomActionsChanged(struct TArray<struct UModalCustomAction*>& CustomActions); // Function WBP_Screen_CodeOfConduct.WBP_Screen_CodeOfConduct_C.OnCustomActionsChanged // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void BindToCustomModalViewModel(struct UCustomModalViewModelBase* CustomModalViewModel, bool Bind); // Function WBP_Screen_CodeOfConduct.WBP_Screen_CodeOfConduct_C.BindToCustomModalViewModel // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	bool BP_OnHandleBackAction(); // Function WBP_Screen_CodeOfConduct.WBP_Screen_CodeOfConduct_C.BP_OnHandleBackAction // (Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	struct UWidget* BP_GetDesiredFocusTarget(); // Function WBP_Screen_CodeOfConduct.WBP_Screen_CodeOfConduct_C.BP_GetDesiredFocusTarget // (Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent|Const) // @ game+0x1b42740
	void Construct(); // Function WBP_Screen_CodeOfConduct.WBP_Screen_CodeOfConduct_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	...
	void K2_BindToViewModel(); // Function WBP_Screen_CodeOfConduct.WBP_Screen_CodeOfConduct_C.K2_BindToViewModel // (Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_WBP_Screen_CodeOfConduct(int32_t EntryPoint); // Function WBP_Screen_CodeOfConduct.WBP_Screen_CodeOfConduct_C.ExecuteUbergraph_WBP_Screen_CodeOfConduct // (Final|UbergraphFunction) // @ game+0x1b42740
};

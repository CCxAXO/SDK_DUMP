...
struct URGISentryEventSubmitter : UGameInstanceSubsystem {
	...
	void SubmitEventToSentry(struct URGIBaseSentryEvent* EventToSubmit); // Function RGISentryEventSubmitter.RGISentryEventSubmitter.SubmitEventToSentry // (Final|Native|Public|BlueprintCallable) // @ game+0x5530410
};

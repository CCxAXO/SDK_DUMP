...
struct UGamePodPreferenceOptions_Base_C : UUserWidget {
	...
	struct UWidget* OnGetMenuContent(); // Function GamePodPreferenceOptions_Base.GamePodPreferenceOptions_Base_C.OnGetMenuContent // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

...
struct UWBP_Screen_SocialPanelPage_QQFriends_Desktop_C : UWBP_Screen_SocialPage_Base_C {
	...
	void UpdateFriendsListVisibility(); // Function WBP_Screen_SocialPanelPage_QQFriends_Desktop.WBP_Screen_SocialPanelPage_QQFriends_Desktop_C.UpdateFriendsListVisibility // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function WBP_Screen_SocialPanelPage_QQFriends_Desktop.WBP_Screen_SocialPanelPage_QQFriends_Desktop_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void OnOpenInterpolationChanged(double OpenInterpolation); // Function WBP_Screen_SocialPanelPage_QQFriends_Desktop.WBP_Screen_SocialPanelPage_QQFriends_Desktop_C.OnOpenInterpolationChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_WBP_Screen_SocialPanelPage_QQFriends_Desktop(int32_t EntryPoint); // Function WBP_Screen_SocialPanelPage_QQFriends_Desktop.WBP_Screen_SocialPanelPage_QQFriends_Desktop_C.ExecuteUbergraph_WBP_Screen_SocialPanelPage_QQFriends_Desktop // (Final|UbergraphFunction) // @ game+0x1b42740
};

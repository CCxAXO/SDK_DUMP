...
struct UCrosshair_InnerLineSettings_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function Crosshair_InnerLineSettings.Crosshair_InnerLineSettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void OnInitialized(); // Function Crosshair_InnerLineSettings.Crosshair_InnerLineSettings_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void SetUseADSSettings(bool ForADS); // Function Crosshair_InnerLineSettings.Crosshair_InnerLineSettings_C.SetUseADSSettings // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_Crosshair_InnerLineSettings(int32_t EntryPoint); // Function Crosshair_InnerLineSettings.Crosshair_InnerLineSettings_C.ExecuteUbergraph_Crosshair_InnerLineSettings // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
};

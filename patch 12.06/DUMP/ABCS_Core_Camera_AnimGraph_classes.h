...
struct UABCS_Core_Camera_AnimGraph_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABCS_Core_Camera_AnimGraph.ABCS_Core_Camera_AnimGraph_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_ABCS_Core_Camera_AnimGraph(int32_t EntryPoint); // Function ABCS_Core_Camera_AnimGraph.ABCS_Core_Camera_AnimGraph_C.ExecuteUbergraph_ABCS_Core_Camera_AnimGraph // (Final|UbergraphFunction) // @ game+0x1b42740
};

...
struct UWBP_Panel_TopNavigation_InGame_PC_C : UWBP_Panel_TopNavigation_Base_C {
	...
	struct UUniversalProgressionWidget_C* UniversalProgressionWidget; // 0x418(0x08)
	struct UWBP_Button_NavShortcut_C* WBP_Button_OptionsShortcut; // 0x420(0x08)
	struct UWBP_TabList_Navigation_C* WBP_TabList_Navigation; // 0x428(0x08)

	void UpdateOptionsButtonVisibility(enum class EWidgetVisibilityOption InOption); // Function WBP_Panel_TopNavigation_InGame_PC.WBP_Panel_TopNavigation_InGame_PC_C.UpdateOptionsButtonVisibility // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_WBP_Panel_TopNavigation_InGame_PC(int32_t EntryPoint); // Function WBP_Panel_TopNavigation_InGame_PC.WBP_Panel_TopNavigation_InGame_PC_C.ExecuteUbergraph_WBP_Panel_TopNavigation_InGame_PC // (Final|UbergraphFunction) // @ game+0x1b42740
};

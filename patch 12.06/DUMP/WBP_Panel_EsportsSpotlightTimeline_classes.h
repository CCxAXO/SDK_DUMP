...
struct UWBP_Panel_EsportsSpotlightTimeline_C : UAresCommonUserWidget {
	...
	void SetOverviewViewModel(struct UEsportsOverviewViewModel* OverviewVM); // Function WBP_Panel_EsportsSpotlightTimeline.WBP_Panel_EsportsSpotlightTimeline_C.SetOverviewViewModel // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	struct UWidget* BP_GetDesiredFocusTarget(); // Function WBP_Panel_EsportsSpotlightTimeline.WBP_Panel_EsportsSpotlightTimeline_C.BP_GetDesiredFocusTarget // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1b42740
	void Construct(); // Function WBP_Panel_EsportsSpotlightTimeline.WBP_Panel_EsportsSpotlightTimeline_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_WBP_Panel_EsportsSpotlightTimeline(int32_t EntryPoint); // Function WBP_Panel_EsportsSpotlightTimeline.WBP_Panel_EsportsSpotlightTimeline_C.ExecuteUbergraph_WBP_Panel_EsportsSpotlightTimeline // (Final|UbergraphFunction) // @ game+0x1b42740
};

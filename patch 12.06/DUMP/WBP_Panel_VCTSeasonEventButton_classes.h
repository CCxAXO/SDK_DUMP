...
struct UWBP_Panel_VCTSeasonEventButton_C : UAresCommonUserWidget {
	...
	void On Event Status Changed(enum class EEsportsMatchStatus NewValue); // Function WBP_Panel_VCTSeasonEventButton.WBP_Panel_VCTSeasonEventButton_C.On Event Status Changed // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnEventDateChanged(struct FText& NewValue); // Function WBP_Panel_VCTSeasonEventButton.WBP_Panel_VCTSeasonEventButton_C.OnEventDateChanged // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnEventNameChanged(struct FText& NewValue); // Function WBP_Panel_VCTSeasonEventButton.WBP_Panel_VCTSeasonEventButton_C.OnEventNameChanged // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void BindToOrUnbindFromViewModel(struct UEsportsEventViewModel* ViewModel, bool ShouldBind); // Function WBP_Panel_VCTSeasonEventButton.WBP_Panel_VCTSeasonEventButton_C.BindToOrUnbindFromViewModel // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Set Event(enum class E2024VCTEvent InEvent); // Function WBP_Panel_VCTSeasonEventButton.WBP_Panel_VCTSeasonEventButton_C.Set Event // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Destruct(); // Function WBP_Panel_VCTSeasonEventButton.WBP_Panel_VCTSeasonEventButton_C.Destruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	...
	void K2_BindToViewModel(); // Function WBP_Panel_VCTSeasonEventButton.WBP_Panel_VCTSeasonEventButton_C.K2_BindToViewModel // (Event|Public|BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_WBP_Panel_VCTSeasonEventButton(int32_t EntryPoint); // Function WBP_Panel_VCTSeasonEventButton.WBP_Panel_VCTSeasonEventButton_C.ExecuteUbergraph_WBP_Panel_VCTSeasonEventButton // (Final|UbergraphFunction) // @ game+0x1b42740
	void ButtonPanelOnUnhover__DelegateSignature(); // Function WBP_Panel_VCTSeasonEventButton.WBP_Panel_VCTSeasonEventButton_C.ButtonPanelOnUnhover__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ButtonPanelOnHover__DelegateSignature(); // Function WBP_Panel_VCTSeasonEventButton.WBP_Panel_VCTSeasonEventButton_C.ButtonPanelOnHover__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

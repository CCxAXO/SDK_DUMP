...
struct UWBP_Panel_HovercardSection_RankInfo_C : UWBP_Panel_HovercardSection_SocialPanelPlayer_Base_C {
	...
	void SetObservedPlayer(struct FString InPlayerSubject); // Function WBP_Panel_HovercardSection_RankInfo.WBP_Panel_HovercardSection_RankInfo_C.SetObservedPlayer // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_WBP_Panel_HovercardSection_RankInfo(int32_t EntryPoint); // Function WBP_Panel_HovercardSection_RankInfo.WBP_Panel_HovercardSection_RankInfo_C.ExecuteUbergraph_WBP_Panel_HovercardSection_RankInfo // (Final|UbergraphFunction) // @ game+0x1b42740
};

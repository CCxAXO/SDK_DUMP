...
struct FMediaMetadataItemBPT {
	...
	struct FString MimeType; // 0x10(0x10)
	struct FString StringData; // 0x20(0x10)
	struct TArray<char> BinaryData; // 0x30(0x10)
};

// ScriptStruct MediaAssets.MediaMetadataItemsBPT
// Size: 0x10 (Inherited: 0x00)
struct FMediaMetadataItemsBPT {
	struct TArray<struct FMediaMetadataItemBPT> Items; // 0x00(0x10)
};

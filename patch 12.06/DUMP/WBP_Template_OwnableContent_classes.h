...
struct UWBP_Template_OwnableContent_C : UAresCommonUserWidget {
	...
	void SetIsLocked(bool bInIsLocked); // Function WBP_Template_OwnableContent.WBP_Template_OwnableContent_C.SetIsLocked // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetIsOwned(bool bInIsOwned); // Function WBP_Template_OwnableContent.WBP_Template_OwnableContent_C.SetIsOwned // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

...
struct UWBP_Button_Social_Intervention_C : UWBP_Button_Social_Base_C {
	...
	void ApplyInterventionAppearance(); // Function WBP_Button_Social_Intervention.WBP_Button_Social_Intervention_C.ApplyInterventionAppearance // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	struct TMap<struct FName, struct UMaterialInstanceDynamic*> GetAnimatableMaterialsMap(); // Function WBP_Button_Social_Intervention.WBP_Button_Social_Intervention_C.GetAnimatableMaterialsMap // (Event|Protected|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void PreConstruct(bool IsDesignTime); // Function WBP_Button_Social_Intervention.WBP_Button_Social_Intervention_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void SetIconAreaWidth(double InIconAreaWidth); // Function WBP_Button_Social_Intervention.WBP_Button_Social_Intervention_C.SetIconAreaWidth // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetInterventionType(enum class EInterventionType InInterventionType); // Function WBP_Button_Social_Intervention.WBP_Button_Social_Intervention_C.SetInterventionType // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_WBP_Button_Social_Intervention(int32_t EntryPoint); // Function WBP_Button_Social_Intervention.WBP_Button_Social_Intervention_C.ExecuteUbergraph_WBP_Button_Social_Intervention // (Final|UbergraphFunction) // @ game+0x1b42740
};

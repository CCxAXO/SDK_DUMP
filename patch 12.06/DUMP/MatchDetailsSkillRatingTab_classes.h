...
struct UMatchDetailsSkillRatingTab_C : UMatchDetailsTabBase_C {
	...
	void Construct(); // Function MatchDetailsSkillRatingTab.MatchDetailsSkillRatingTab_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void EventOnInit(); // Function MatchDetailsSkillRatingTab.MatchDetailsSkillRatingTab_C.EventOnInit // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void CustomEvent_2(struct FString Victim, int32_t RoundNum); // Function MatchDetailsSkillRatingTab.MatchDetailsSkillRatingTab_C.CustomEvent_2 // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_MatchDetailsSkillRatingTab(int32_t EntryPoint); // Function MatchDetailsSkillRatingTab.MatchDetailsSkillRatingTab_C.ExecuteUbergraph_MatchDetailsSkillRatingTab // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
	void OnInteractionClicked__DelegateSignature(struct FString Victim, int32_t RoundNum); // Function MatchDetailsSkillRatingTab.MatchDetailsSkillRatingTab_C.OnInteractionClicked__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

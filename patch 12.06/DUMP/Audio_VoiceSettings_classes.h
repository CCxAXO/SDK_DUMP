...
struct UAudio_VoiceSettings_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function Audio_VoiceSettings.Audio_VoiceSettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_Audio_VoiceSettings(int32_t EntryPoint); // Function Audio_VoiceSettings.Audio_VoiceSettings_C.ExecuteUbergraph_Audio_VoiceSettings // (Final|UbergraphFunction) // @ game+0x1b42740
};

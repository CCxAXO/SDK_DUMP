...
struct UWBP_ContextMenu_SocialPlayer_Desktop_C : UAresCommonActivatableWidget {
	...
	void Construct(); // Function WBP_ContextMenu_SocialPlayer_Desktop.WBP_ContextMenu_SocialPlayer_Desktop_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void OnIsRealPlayerChanged(bool bIsRealPlayer); // Function WBP_ContextMenu_SocialPlayer_Desktop.WBP_ContextMenu_SocialPlayer_Desktop_C.OnIsRealPlayerChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_WBP_ContextMenu_SocialPlayer_Desktop(int32_t EntryPoint); // Function WBP_ContextMenu_SocialPlayer_Desktop.WBP_ContextMenu_SocialPlayer_Desktop_C.ExecuteUbergraph_WBP_ContextMenu_SocialPlayer_Desktop // (Final|UbergraphFunction) // @ game+0x1b42740
	void CloseContextMenuRequested__DelegateSignature(); // Function WBP_ContextMenu_SocialPlayer_Desktop.WBP_ContextMenu_SocialPlayer_Desktop_C.CloseContextMenuRequested__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

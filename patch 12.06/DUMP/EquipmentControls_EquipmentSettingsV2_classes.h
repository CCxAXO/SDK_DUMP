...
struct UEquipmentControls_EquipmentSettingsV2_C : USettingsSubsectionBase_C {
	...
	struct FLinearColor Get_AutoRescopeWidget_ColorAndOpacity_1(); // Function EquipmentControls_EquipmentSettingsV2.EquipmentControls_EquipmentSettingsV2_C.Get_AutoRescopeWidget_ColorAndOpacity_1 // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1b42740
	struct FLinearColor Get_LeverSniperZoomInput_ColorAndOpacity_1(); // Function EquipmentControls_EquipmentSettingsV2.EquipmentControls_EquipmentSettingsV2_C.Get_LeverSniperZoomInput_ColorAndOpacity_1 // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1b42740
	void Construct(); // Function EquipmentControls_EquipmentSettingsV2.EquipmentControls_EquipmentSettingsV2_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_EquipmentControls_EquipmentSettingsV2(int32_t EntryPoint); // Function EquipmentControls_EquipmentSettingsV2.EquipmentControls_EquipmentSettingsV2_C.ExecuteUbergraph_EquipmentControls_EquipmentSettingsV2 // (Final|UbergraphFunction) // @ game+0x1b42740
};

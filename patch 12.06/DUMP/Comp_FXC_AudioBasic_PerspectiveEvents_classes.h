...
struct UComp_FXC_AudioBasic_PerspectiveEvents_C : UComp_FXC_AudioBasic_C {
	...
	void GetPlayOnStartEvent(bool FirstPerson, struct UAkAudioEvent*& PlayOnStart); // Function Comp_FXC_AudioBasic_PerspectiveEvents.Comp_FXC_AudioBasic_PerspectiveEvents_C.GetPlayOnStartEvent // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1b42740
};

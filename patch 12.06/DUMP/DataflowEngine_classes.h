...
struct UDataflowBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	void EvaluateTerminalNodeByName(struct UDataflow* Dataflow, struct FName TerminalNodeName, struct UObject* ResultAsset); // Function DataflowEngine.DataflowBlueprintLibrary.EvaluateTerminalNodeByName // (Final|RequiredAPI|Native|Static|Public|BlueprintCallable) // @ game+0x367a550
};

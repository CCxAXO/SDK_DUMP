...
struct UTournamentsInfoModal_C : UUserWidget {
	...
	void SwapContentOrder(); // Function TournamentsInfoModal.TournamentsInfoModal_C.SwapContentOrder // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void BndEvt__TournamentsInfoModal_CustomCloseButton_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature(); // Function TournamentsInfoModal.TournamentsInfoModal_C.BndEvt__TournamentsInfoModal_CustomCloseButton_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature // (BlueprintEvent) // @ game+0x1b42740
	...
	void Construct(); // Function TournamentsInfoModal.TournamentsInfoModal_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_TournamentsInfoModal(int32_t EntryPoint); // Function TournamentsInfoModal.TournamentsInfoModal_C.ExecuteUbergraph_TournamentsInfoModal // (Final|UbergraphFunction) // @ game+0x1b42740
};

...
struct UMatchDetailsRoundScreenScoreboardEntryV5_C : UUserWidget {
	...
	void Construct(); // Function MatchDetailsRoundScreenScoreboardEntryV5.MatchDetailsRoundScreenScoreboardEntryV5_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_MatchDetailsRoundScreenScoreboardEntryV5(int32_t EntryPoint); // Function MatchDetailsRoundScreenScoreboardEntryV5.MatchDetailsRoundScreenScoreboardEntryV5_C.ExecuteUbergraph_MatchDetailsRoundScreenScoreboardEntryV5 // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
};

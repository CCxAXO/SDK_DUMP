...
struct UIdentityAgentIcon_C : UUserWidget {
	...
	void Init Premier(bool IsLeft); // Function IdentityAgentIcon.IdentityAgentIcon_C.Init Premier // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void UpdateAllyAndMe(bool Ally, bool Me); // Function IdentityAgentIcon.IdentityAgentIcon_C.UpdateAllyAndMe // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

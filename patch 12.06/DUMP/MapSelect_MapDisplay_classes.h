...
struct UMapSelect_MapDisplay_C : UUserWidget {
	...
	void SetMap(struct UMapDataAsset* MapData, struct UMapUIData* MapUIData); // Function MapSelect_MapDisplay.MapSelect_MapDisplay_C.SetMap // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ShowSummary(); // Function MapSelect_MapDisplay.MapSelect_MapDisplay_C.ShowSummary // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

...
struct UAudio_PartyVoiceSettings_C : USettingsSubsectionBase_C {
	...
	void SetPartyVoiceChatBindPreview(); // Function Audio_PartyVoiceSettings.Audio_PartyVoiceSettings_C.SetPartyVoiceChatBindPreview // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function Audio_PartyVoiceSettings.Audio_PartyVoiceSettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_Audio_PartyVoiceSettings(int32_t EntryPoint); // Function Audio_PartyVoiceSettings.Audio_PartyVoiceSettings_C.ExecuteUbergraph_Audio_PartyVoiceSettings // (Final|UbergraphFunction) // @ game+0x1b42740
};

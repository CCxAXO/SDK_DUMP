...
struct UGameplay_PrivacySettingsWidget_C : USettingsSubsectionBase_C {
	...
	void HideBlockedPlayerList(bool& bResult); // Function Gameplay_PrivacySettingsWidget.Gameplay_PrivacySettingsWidget_C.HideBlockedPlayerList // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1b42740
	...
	void Construct(); // Function Gameplay_PrivacySettingsWidget.Gameplay_PrivacySettingsWidget_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_Gameplay_PrivacySettingsWidget(int32_t EntryPoint); // Function Gameplay_PrivacySettingsWidget.Gameplay_PrivacySettingsWidget_C.ExecuteUbergraph_Gameplay_PrivacySettingsWidget // (Final|UbergraphFunction) // @ game+0x1b42740
};

...
struct UMatchDetailsMapDeathIconV5_C : UUserWidget {
	...
	void Construct(); // Function MatchDetailsMapDeathIconV5.MatchDetailsMapDeathIconV5_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_MatchDetailsMapDeathIconV5(int32_t EntryPoint); // Function MatchDetailsMapDeathIconV5.MatchDetailsMapDeathIconV5_C.ExecuteUbergraph_MatchDetailsMapDeathIconV5 // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
};

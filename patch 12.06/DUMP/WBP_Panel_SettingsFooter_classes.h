...
struct UWBP_Panel_SettingsFooter_C : UAresCommonUserWidget {
	...
	void On Selected Agent Changed(struct FName InSelectedAgent); // Function WBP_Panel_SettingsFooter.WBP_Panel_SettingsFooter_C.On Selected Agent Changed // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnResetSuccessful(); // Function WBP_Panel_SettingsFooter.WBP_Panel_SettingsFooter_C.OnResetSuccessful // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnCopySuccessful(bool bWasDefaultProfile); // Function WBP_Panel_SettingsFooter.WBP_Panel_SettingsFooter_C.OnCopySuccessful // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function WBP_Panel_SettingsFooter.WBP_Panel_SettingsFooter_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	...
	void PreConstruct(bool IsDesignTime); // Function WBP_Panel_SettingsFooter.WBP_Panel_SettingsFooter_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_WBP_Panel_SettingsFooter(int32_t EntryPoint); // Function WBP_Panel_SettingsFooter.WBP_Panel_SettingsFooter_C.ExecuteUbergraph_WBP_Panel_SettingsFooter // (Final|UbergraphFunction) // @ game+0x1b42740
};

...
struct UVTSAuthorityPlayerTimelineSynchronizer : UVTSPlayerTimelineSynchronizer {
	...
	void Rebase(); // Function VTSPlugin.VTSAuthorityPlayerTimelineSynchronizer.Rebase // (Final|Native|Public|BlueprintCallable) // @ game+0x53a38c0
};
...
struct UVTSAutonomousPlayerTimelineSynchronizer : UVTSPlayerTimelineSynchronizer {
	...
	void Rebase(); // Function VTSPlugin.VTSAutonomousPlayerTimelineSynchronizer.Rebase // (Final|Native|Public|BlueprintCallable) // @ game+0x53a3e30
};
...
struct UVTSFixedTimeStepTimelineAPI : UObject {
	...
	void UnregisterTimeSynchronizedObjectBlueprint(struct UObject* TimeSynchronizedObjectBlueprint); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.UnregisterTimeSynchronizedObjectBlueprint // (Final|Native|Public|BlueprintCallable|Const) // @ game+0x53a4ac0
	bool SetTimeStampDelegateBlueprint(struct FVTSTimeStampIndex& TimeStampIndex, struct FDelegate TimeStampActionDynamicDelegate); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.SetTimeStampDelegateBlueprint // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x53a48e0
	void RegisterTimeSynchronizedObjectBlueprint(struct UObject* TimeSynchronizedObjectBlueprint); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.RegisterTimeSynchronizedObjectBlueprint // (Final|Native|Public|BlueprintCallable|Const) // @ game+0x53a4c90
	float GetRemainingRequiredSimulationTime(); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.GetRemainingRequiredSimulationTime // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x53a48a0
	float GetInterpolationValue(); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.GetInterpolationValue // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x53a4810
	float GetFixedTimeStepSize(); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.GetFixedTimeStepSize // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x53a4860
	struct FVTSTimeStampIndex GetCurrentTimeStampIndex(); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.GetCurrentTimeStampIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x53a4880
};
...
struct UVTSTimeSynchronizedInterfaceBlueprint : UInterface {
	...
	void OnRebaseBlueprint(); // Function VTSPlugin.VTSTimeSynchronizedInterfaceBlueprint.OnRebaseBlueprint // (Event|Public|BlueprintEvent) // @ game+0x1b42740
	void OnPreFixedTimeStepsBlueprint(float ResidualTimeSeconds); // Function VTSPlugin.VTSTimeSynchronizedInterfaceBlueprint.OnPreFixedTimeStepsBlueprint // (Event|Public|BlueprintEvent) // @ game+0x1b42740
	void OnPostFixedTimeStepsBlueprint(float ResidualTimeSeconds); // Function VTSPlugin.VTSTimeSynchronizedInterfaceBlueprint.OnPostFixedTimeStepsBlueprint // (Event|Public|BlueprintEvent) // @ game+0x1b42740
	void OnFixedTimeStepBlueprint(struct FVTSTimeStampIndex& TimeStampIndex); // Function VTSPlugin.VTSTimeSynchronizedInterfaceBlueprint.OnFixedTimeStepBlueprint // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0x1b42740
	int32_t GetFixedTimeStepPriorityBlueprint(); // Function VTSPlugin.VTSTimeSynchronizedInterfaceBlueprint.GetFixedTimeStepPriorityBlueprint // (Event|Public|BlueprintEvent|Const) // @ game+0x1b42740
};

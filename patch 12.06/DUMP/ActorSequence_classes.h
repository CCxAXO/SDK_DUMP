...
struct UActorSequenceComponent : UActorComponent {
	...
	void StopSequence(); // Function ActorSequence.ActorSequenceComponent.StopSequence // (Final|Native|Public|BlueprintCallable) // @ game+0x7cb9300
	void PlaySequence(); // Function ActorSequence.ActorSequenceComponent.PlaySequence // (Final|Native|Public|BlueprintCallable) // @ game+0x7cb9360
	void PauseSequence(); // Function ActorSequence.ActorSequenceComponent.PauseSequence // (Final|Native|Public|BlueprintCallable) // @ game+0x7cb9330
};

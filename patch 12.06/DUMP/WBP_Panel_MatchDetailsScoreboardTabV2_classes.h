...
struct UWBP_Panel_MatchDetailsScoreboardTabV2_C : UAresCommonUserWidget {
	...
	struct UWidget* BP_GetDesiredFocusTarget(); // Function WBP_Panel_MatchDetailsScoreboardTabV2.WBP_Panel_MatchDetailsScoreboardTabV2_C.BP_GetDesiredFocusTarget // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1b42740
	void HideColumns(struct FGameModeMatchDetailsScoreboardConfig ScoreboardConfig); // Function WBP_Panel_MatchDetailsScoreboardTabV2.WBP_Panel_MatchDetailsScoreboardTabV2_C.HideColumns // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnScoreboardConfigChanged(struct FGameModeMatchDetailsScoreboardConfig ScoreboardConfig); // Function WBP_Panel_MatchDetailsScoreboardTabV2.WBP_Panel_MatchDetailsScoreboardTabV2_C.OnScoreboardConfigChanged // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnPlayersSorted(); // Function WBP_Panel_MatchDetailsScoreboardTabV2.WBP_Panel_MatchDetailsScoreboardTabV2_C.OnPlayersSorted // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetMatchInfo(struct FString MatchID, struct FString Subject); // Function WBP_Panel_MatchDetailsScoreboardTabV2.WBP_Panel_MatchDetailsScoreboardTabV2_C.SetMatchInfo // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetMatchIDOverride(struct FString MatchIDOverride); // Function WBP_Panel_MatchDetailsScoreboardTabV2.WBP_Panel_MatchDetailsScoreboardTabV2_C.SetMatchIDOverride // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void K2_BindToViewModel(); // Function WBP_Panel_MatchDetailsScoreboardTabV2.WBP_Panel_MatchDetailsScoreboardTabV2_C.K2_BindToViewModel // (Event|Public|BlueprintEvent) // @ game+0x1b42740
	void PreConstruct(bool IsDesignTime); // Function WBP_Panel_MatchDetailsScoreboardTabV2.WBP_Panel_MatchDetailsScoreboardTabV2_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	...
	void Destruct(); // Function WBP_Panel_MatchDetailsScoreboardTabV2.WBP_Panel_MatchDetailsScoreboardTabV2_C.Destruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function WBP_Panel_MatchDetailsScoreboardTabV2.WBP_Panel_MatchDetailsScoreboardTabV2_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_WBP_Panel_MatchDetailsScoreboardTabV2(int32_t EntryPoint); // Function WBP_Panel_MatchDetailsScoreboardTabV2.WBP_Panel_MatchDetailsScoreboardTabV2_C.ExecuteUbergraph_WBP_Panel_MatchDetailsScoreboardTabV2 // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
};

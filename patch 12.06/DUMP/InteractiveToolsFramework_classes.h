...
struct UGizmoBaseComponent : UPrimitiveComponent {
	struct FLinearColor Color; // 0x690(0x10)
	float HoverSizeMultiplier; // 0x6a0(0x04)
	float PixelHitDistanceThreshold; // 0x6a4(0x04)
	char pad_6A8[0x8]; // 0x6a8(0x08)
	struct UGizmoViewContext* GizmoViewContext; // 0x6b0(0x08)
	char pad_6B8[0x8]; // 0x6b8(0x08)

	void UpdateWorldLocalState(bool bWorldIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState // (Final|Native|Public) // @ game+0x55c9b20
	void UpdateHoverState(bool bHoveringIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState // (Final|Native|Public) // @ game+0x55c9c20
};
...
struct UGizmoArrowComponent : UGizmoBaseComponent {
	struct FVector Direction; // 0x6c0(0x18)
	float Gap; // 0x6d8(0x04)
	float Length; // 0x6dc(0x04)
	float Thickness; // 0x6e0(0x04)
...
struct UGizmoBoxComponent : UGizmoBaseComponent {
	struct FVector Origin; // 0x6c0(0x18)
	char pad_6D8[0x8]; // 0x6d8(0x08)
	struct FQuat Rotation; // 0x6e0(0x20)
	struct FVector Dimensions; // 0x700(0x18)
	float LineThickness; // 0x718(0x04)
	bool bRemoveHiddenLines; // 0x71c(0x01)
	bool bEnableAxisFlip; // 0x71d(0x01)
...
struct UGizmoCircleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x6c0(0x18)
	float Radius; // 0x6d8(0x04)
	float Thickness; // 0x6dc(0x04)
	int32_t NumSides; // 0x6e0(0x04)
	bool bViewAligned; // 0x6e4(0x01)
	bool bDrawFullCircle; // 0x6e5(0x01)
	bool bOnlyAllowFrontFacingHits; // 0x6e6(0x01)
	char pad_6E7[0x9]; // 0x6e7(0x09)
};
...
struct UGizmoTransformSource : UInterface {
	...
	void SetTransform(struct FTransform& NewTransform); // Function InteractiveToolsFramework.GizmoTransformSource.SetTransform // (Native|Public|HasOutParms|HasDefaults) // @ game+0x55f7a70
	struct FTransform GetTransform(); // Function InteractiveToolsFramework.GizmoTransformSource.GetTransform // (Native|Public|HasDefaults|Const) // @ game+0x55f7be0
};
...
struct UGizmoAxisSource : UInterface {
	...
	bool HasTangentVectors(); // Function InteractiveToolsFramework.GizmoAxisSource.HasTangentVectors // (Native|Public|Const) // @ game+0x55f7ef0
	void GetTangentVectors(struct FVector& TangentXOut, struct FVector& TangentYOut); // Function InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors // (Native|Public|HasOutParms|HasDefaults|Const) // @ game+0x55f7d40
	struct FVector GetOrigin(); // Function InteractiveToolsFramework.GizmoAxisSource.GetOrigin // (Native|Public|HasDefaults|Const) // @ game+0x55f7f80
	struct FVector GetDirection(); // Function InteractiveToolsFramework.GizmoAxisSource.GetDirection // (Native|Public|HasDefaults|Const) // @ game+0x55f7f30
};
...
struct UGizmoClickTarget : UInterface {
	...
	void UpdateInteractingState(bool bInteracting); // Function InteractiveToolsFramework.GizmoClickTarget.UpdateInteractingState // (Native|Public) // @ game+0x55f8100
	void UpdateHoverState(bool bHovering); // Function InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState // (Native|Public) // @ game+0x55f8200
};
...
struct UGizmoClickMultiTarget : UInterface {
	...
	void UpdateInteractingState(bool bInteracting, uint32_t InPartIdentifier); // Function InteractiveToolsFramework.GizmoClickMultiTarget.UpdateInteractingState // (Native|Public) // @ game+0x55f8570
	void UpdateHoverState(bool bHovering, uint32_t InPartIdentifier); // Function InteractiveToolsFramework.GizmoClickMultiTarget.UpdateHoverState // (Native|Public) // @ game+0x55f8710
	void UpdateHittableState(bool bHittable, uint32_t InPartIdentifier); // Function InteractiveToolsFramework.GizmoClickMultiTarget.UpdateHittableState // (Native|Public) // @ game+0x55f83d0
};
...
struct UGizmoRenderMultiTarget : UInterface {
	...
	void UpdateVisibilityState(bool bVisible, uint32_t InPartIdentifier); // Function InteractiveToolsFramework.GizmoRenderMultiTarget.UpdateVisibilityState // (Native|Public) // @ game+0x55f8710
};
...
struct UGizmoStateTarget : UInterface {
	...
	void EndUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.EndUpdate // (Native|Public) // @ game+0x55f8a70
	void BeginUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.BeginUpdate // (Native|Public) // @ game+0x26f1410
};
...
struct UGizmoFloatParameterSource : UInterface {
	...
	void SetParameter(float NewValue); // Function InteractiveToolsFramework.GizmoFloatParameterSource.SetParameter // (Native|Public) // @ game+0x55f8ba0
	float GetParameter(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.GetParameter // (Native|Public|Const) // @ game+0x55f8ca0
	void EndModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.EndModify // (Native|Public) // @ game+0x55f8b70
	void BeginModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.BeginModify // (Native|Public) // @ game+0x55f8a70
};
...
struct UGizmoVec2ParameterSource : UInterface {
	...
	void SetParameter(struct FVector2D& NewValue); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.SetParameter // (Native|Public|HasOutParms|HasDefaults) // @ game+0x55f8e10
	struct FVector2D GetParameter(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter // (Native|Public|HasDefaults|Const) // @ game+0x55f8f00
	void EndModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.EndModify // (Native|Public) // @ game+0x55f8b70
	void BeginModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.BeginModify // (Native|Public) // @ game+0x55f8a70
};
...
struct UGizmoLineHandleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x6c0(0x18)
	float HandleSize; // 0x6d8(0x04)
	float Thickness; // 0x6dc(0x04)
	struct FVector Direction; // 0x6e0(0x18)
	float Length; // 0x6f8(0x04)
	bool bImageScale; // 0x6fc(0x01)
...
struct UGizmoRectangleComponent : UGizmoBaseComponent {
	struct FVector DirectionX; // 0x6c0(0x18)
	struct FVector DirectionY; // 0x6d8(0x18)
	bool bOrientYAccordingToCamera; // 0x6f0(0x01)
	char pad_6F1[0x3]; // 0x6f1(0x03)
	float OffsetX; // 0x6f4(0x04)
	float OffsetY; // 0x6f8(0x04)
	float LengthX; // 0x6fc(0x04)
	float LengthY; // 0x700(0x04)
	float Thickness; // 0x704(0x04)
	char SegmentFlags; // 0x708(0x01)

...
struct UEQ_Core_Melee_AnimGraph_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function EQ_Core_Melee_AnimGraph.EQ_Core_Melee_AnimGraph_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_EQ_Core_Melee_AnimGraph(int32_t EntryPoint); // Function EQ_Core_Melee_AnimGraph.EQ_Core_Melee_AnimGraph_C.ExecuteUbergraph_EQ_Core_Melee_AnimGraph // (Final|UbergraphFunction) // @ game+0x1b42740
};

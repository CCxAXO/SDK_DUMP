...
struct UAgentStoreTelemetryButton_C : UUserWidget {
	...
	void ExecuteUbergraph_AgentStoreTelemetryButton(int32_t EntryPoint); // Function AgentStoreTelemetryButton.AgentStoreTelemetryButton_C.ExecuteUbergraph_AgentStoreTelemetryButton // (Final|UbergraphFunction) // @ game+0x1b42740
	void OnUnHovered__DelegateSignature(); // Function AgentStoreTelemetryButton.AgentStoreTelemetryButton_C.OnUnHovered__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnHovered__DelegateSignature(); // Function AgentStoreTelemetryButton.AgentStoreTelemetryButton_C.OnHovered__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnClicked__DelegateSignature(); // Function AgentStoreTelemetryButton.AgentStoreTelemetryButton_C.OnClicked__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

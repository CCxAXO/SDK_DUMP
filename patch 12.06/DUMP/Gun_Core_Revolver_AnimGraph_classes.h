...
struct UGun_Core_Revolver_AnimGraph_C : UAresEquippableAnimInstance {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function Gun_Core_Revolver_AnimGraph.Gun_Core_Revolver_AnimGraph_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function Gun_Core_Revolver_AnimGraph.Gun_Core_Revolver_AnimGraph_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_Gun_Core_Revolver_AnimGraph(int32_t EntryPoint); // Function Gun_Core_Revolver_AnimGraph.Gun_Core_Revolver_AnimGraph_C.ExecuteUbergraph_Gun_Core_Revolver_AnimGraph // (Final|UbergraphFunction) // @ game+0x1b42740
};

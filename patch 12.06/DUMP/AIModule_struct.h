...
// Enum AIModule.EAILogicResuming
...
// Enum AIModule.EEnvQueryTraceResult
...
struct FActorPerceptionUpdateInfo {
	...
	struct FAIStimulus Stimulus; // 0x10(0x68)
};
...
struct FAIStimulus {
	...
	struct FName Tag; // 0x40(0x0c)
	float InitialSensedTime; // 0x4c(0x04)
	char pad_50[0x10]; // 0x50(0x10)
	char pad_60_0 : 1; // 0x60(0x01)
	char bSuccessfullySensed : 1; // 0x60(0x01)
...
struct FAIMoveRequest {
	struct TWeakObjectPtr<struct AActor> GoalActor; // 0x00(0x08)
...
struct FEnvTraceData {
	...
	struct FName TraceProfileName; // 0x2c(0x0c)
	enum class EEnvTraceShape TraceShape; // 0x38(0x01)
	enum class EEnvQueryTrace TraceMode; // 0x39(0x01)
	enum class EEnvQueryTraceResult TraceResult; // 0x3a(0x01)
	char pad_3B[0x1]; // 0x3b(0x01)
	char bTraceComplex : 1; // 0x3c(0x01)
	char bOnlyBlockingHits : 1; // 0x3c(0x01)
	char bCanTraceOnNavMesh : 1; // 0x3c(0x01)
	char bCanTraceOnGeometry : 1; // 0x3c(0x01)
	char bCanDisableTrace : 1; // 0x3c(0x01)
	char bCanProjectDown : 1; // 0x3c(0x01)
...
struct FEnvOverlapData {
	...
	enum class ECollisionChannel OverlapChannel; // 0x28(0x01)
	enum class EEnvOverlapShape OverlapShape; // 0x29(0x01)
	char pad_2A[0x2]; // 0x2a(0x02)
	char bOnlyBlockingHits : 1; // 0x2c(0x01)
	char bOverlapComplex : 1; // 0x2c(0x01)
	char bSkipOverlapQuerier : 1; // 0x2c(0x01)
...
struct FBlackboardKeySelector {
	...
	int32_t SelectedKeyID; // 0x28(0x04)
...
struct FAIDataProviderTypedValue : FAIDataProviderValue {
	ClassPtrProperty PropertyType; // 0x28(0x08)
...
struct FEnvQueryManagerConfig {
	float MaxAllowedTestingTime; // 0x00(0x04)
	bool bTestQueriesUsingBreadth; // 0x04(0x01)
	char pad_5[0x3]; // 0x05(0x03)
	int32_t QueryCountWarningThreshold; // 0x08(0x04)
	char pad_C[0x4]; // 0x0c(0x04)
	double QueryCountWarningInterval; // 0x10(0x08)
	double ExecutionTimeWarningSeconds; // 0x18(0x08)
	double HandlingResultTimeWarningSeconds; // 0x20(0x08)
	double GenerationTimeWarningSeconds; // 0x28(0x08)
};
...
struct FRecastGraphWrapper {
	struct ARecastNavMesh* RecastNavMeshActor; // 0x00(0x08)
...
struct FAINoiseEvent {
	...
	struct FVector NoiseLocation; // 0x08(0x18)
	float Loudness; // 0x20(0x04)
	float MaxRange; // 0x24(0x04)
	struct AActor* Instigator; // 0x28(0x08)
	struct FName Tag; // 0x30(0x0c)
	char pad_3C[0x4]; // 0x3c(0x04)
};
...
struct FAITeamStimulusEvent {
	...
	struct AActor* Broadcaster; // 0x40(0x08)
	struct AActor* Enemy; // 0x48(0x08)
};
...
struct FAITouchEvent {
	...
	struct AActor* TouchReceiver; // 0x18(0x08)
	struct AActor* OtherActor; // 0x20(0x08)
};

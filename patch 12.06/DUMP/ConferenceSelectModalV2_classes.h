...
struct UConferenceSelectModalV2_C : UUserWidget {
	...
	void InitForSelectConference(); // Function ConferenceSelectModalV2.ConferenceSelectModalV2_C.InitForSelectConference // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void InitForSetConference(); // Function ConferenceSelectModalV2.ConferenceSelectModalV2_C.InitForSetConference // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void InitForCreateTeam(); // Function ConferenceSelectModalV2.ConferenceSelectModalV2_C.InitForCreateTeam // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function ConferenceSelectModalV2.ConferenceSelectModalV2_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void OnSuccess(); // Function ConferenceSelectModalV2.ConferenceSelectModalV2_C.OnSuccess // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	...
	void OnError(); // Function ConferenceSelectModalV2.ConferenceSelectModalV2_C.OnError // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_ConferenceSelectModalV2(int32_t EntryPoint); // Function ConferenceSelectModalV2.ConferenceSelectModalV2_C.ExecuteUbergraph_ConferenceSelectModalV2 // (Final|UbergraphFunction) // @ game+0x1b42740
	void OnConferenceSelected__DelegateSignature(struct FString Conference); // Function ConferenceSelectModalV2.ConferenceSelectModalV2_C.OnConferenceSelected__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

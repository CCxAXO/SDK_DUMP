...
struct USeasonalRank_C : UUserWidget {
	...
	struct UWidget* OnGetMenuContent_1(); // Function SeasonalRank.SeasonalRank_C.OnGetMenuContent_1 // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetActRankTier(int32_t Tier); // Function SeasonalRank.SeasonalRank_C.SetActRankTier // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void UpdateSeasonDetails(struct UCompetitiveSeasonDataAsset* CompetitiveSeasonDataAsset); // Function SeasonalRank.SeasonalRank_C.UpdateSeasonDetails // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetTrianglesWithData(struct TArray<struct USeasonWinTriangle_C*>& TriangleWidgets); // Function SeasonalRank.SeasonalRank_C.SetTrianglesWithData // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetLevel(struct UTexture2D* BorderTexture); // Function SeasonalRank.SeasonalRank_C.SetLevel // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void GenerateTriangles(); // Function SeasonalRank.SeasonalRank_C.GenerateTriangles // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void PreConstruct(bool IsDesignTime); // Function SeasonalRank.SeasonalRank_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function SeasonalRank.SeasonalRank_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void Init(struct FProcessedSeasonInfo SeasonInfo, int32_t TotalGamesNeededForRating, int32_t CurrentSeasonGamesNeededForRating, int32_t AccountLevelsRemainingForRanked); // Function SeasonalRank.SeasonalRank_C.Init // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnActRankBorderData(struct UActRankBorderHandle* ActRankBorderHandle); // Function SeasonalRank.SeasonalRank_C.OnActRankBorderData // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void BndEvt__PreviewBadgeButton_K2Node_ComponentBoundEvent_4_OnButtonHoverEvent__DelegateSignature(); // Function SeasonalRank.SeasonalRank_C.BndEvt__PreviewBadgeButton_K2Node_ComponentBoundEvent_4_OnButtonHoverEvent__DelegateSignature // (BlueprintEvent) // @ game+0x1b42740
	void BndEvt__PreviewBadgeButton_K2Node_ComponentBoundEvent_5_OnButtonHoverEvent__DelegateSignature(); // Function SeasonalRank.SeasonalRank_C.BndEvt__PreviewBadgeButton_K2Node_ComponentBoundEvent_5_OnButtonHoverEvent__DelegateSignature // (BlueprintEvent) // @ game+0x1b42740
	void OnCompetitiveSeasonLoaded(struct UCompetitiveSeasonHandle* CompetitiveSeasonHandle); // Function SeasonalRank.SeasonalRank_C.OnCompetitiveSeasonLoaded // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_SeasonalRank(int32_t EntryPoint); // Function SeasonalRank.SeasonalRank_C.ExecuteUbergraph_SeasonalRank // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
	void OnSeasonLoaded__DelegateSignature(); // Function SeasonalRank.SeasonalRank_C.OnSeasonLoaded__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

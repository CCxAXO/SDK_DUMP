...
struct UCeremony_Generic_Default_C : UBaseAnnouncementWidget_C {
	...
	void GetTier(); // Function Ceremony_Generic_Default.Ceremony_Generic_Default_C.GetTier // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void GetNameFromPlayerState(struct AShooterPlayerState* State, struct FText& Name); // Function Ceremony_Generic_Default.Ceremony_Generic_Default_C.GetNameFromPlayerState // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1b42740
	void Construct(); // Function Ceremony_Generic_Default.Ceremony_Generic_Default_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void OnAnimatingIn(); // Function Ceremony_Generic_Default.Ceremony_Generic_Default_C.OnAnimatingIn // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnAnimatingOut(); // Function Ceremony_Generic_Default.Ceremony_Generic_Default_C.OnAnimatingOut // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void PlayOutroAnim(); // Function Ceremony_Generic_Default.Ceremony_Generic_Default_C.PlayOutroAnim // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_Ceremony_Generic_Default(int32_t EntryPoint); // Function Ceremony_Generic_Default.Ceremony_Generic_Default_C.ExecuteUbergraph_Ceremony_Generic_Default // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
};

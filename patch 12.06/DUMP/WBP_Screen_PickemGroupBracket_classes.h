...
struct UWBP_Screen_PickemGroupBracket_C : UEsportsHubScreenV2 {
	...
	void Init(); // Function WBP_Screen_PickemGroupBracket.WBP_Screen_PickemGroupBracket_C.Init // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	...
	void OnScreenReady(); // Function WBP_Screen_PickemGroupBracket.WBP_Screen_PickemGroupBracket_C.OnScreenReady // (Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_WBP_Screen_PickemGroupBracket(int32_t EntryPoint); // Function WBP_Screen_PickemGroupBracket.WBP_Screen_PickemGroupBracket_C.ExecuteUbergraph_WBP_Screen_PickemGroupBracket // (Final|UbergraphFunction) // @ game+0x1b42740
};

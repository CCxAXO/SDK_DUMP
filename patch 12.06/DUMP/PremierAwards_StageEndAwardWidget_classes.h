...
struct UPremierAwards_StageEndAwardWidget_C : UUserWidget {
	...
	void SetAwardStatus(bool IsUnlocked); // Function PremierAwards_StageEndAwardWidget.PremierAwards_StageEndAwardWidget_C.SetAwardStatus // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function PremierAwards_StageEndAwardWidget.PremierAwards_StageEndAwardWidget_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void PreConstruct(bool IsDesignTime); // Function PremierAwards_StageEndAwardWidget.PremierAwards_StageEndAwardWidget_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_PremierAwards_StageEndAwardWidget(int32_t EntryPoint); // Function PremierAwards_StageEndAwardWidget.PremierAwards_StageEndAwardWidget_C.ExecuteUbergraph_PremierAwards_StageEndAwardWidget // (Final|UbergraphFunction) // @ game+0x1b42740
	void OnButtonClicked__DelegateSignature(); // Function PremierAwards_StageEndAwardWidget.PremierAwards_StageEndAwardWidget_C.OnButtonClicked__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

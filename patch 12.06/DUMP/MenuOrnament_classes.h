...
struct UMenuOrnament_C : UUserWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function MenuOrnament.MenuOrnament_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function MenuOrnament.MenuOrnament_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_MenuOrnament(int32_t EntryPoint); // Function MenuOrnament.MenuOrnament_C.ExecuteUbergraph_MenuOrnament // (Final|UbergraphFunction) // @ game+0x1b42740
};

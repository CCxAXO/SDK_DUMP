...
struct FChaosCollisionEventData {
	...
	float Mass1; // 0x60(0x04)
	float Mass2; // 0x64(0x04)
...
struct FGeometryCollectionDamagePropagationData {
	...
	float BreakDamagePropagationFactor; // 0x04(0x04)
	float ShockDamagePropagationFactor; // 0x08(0x04)
};
...
struct FGeometryCollectionSource {
	struct FSoftObjectPath SourceGeometryObject; // 0x00(0x28)
	char pad_28[0x8]; // 0x28(0x08)
	struct FTransform LocalTransform; // 0x30(0x60)
	struct TArray<struct UMaterialInterface*> SourceMaterial; // 0x90(0x10)
	struct TArray<float> InstanceCustomData; // 0xa0(0x10)
	bool bAddInternalMaterials; // 0xb0(0x01)
	bool bSplitComponents; // 0xb1(0x01)
	bool bSetInternalFromMaterialIndex; // 0xb2(0x01)
...
struct FGeometryCollectionAutoInstanceMesh {
	...
	int32_t NumInstances; // 0x18(0x04)
	char pad_1C[0x4]; // 0x1c(0x04)
	struct TArray<float> CustomData; // 0x20(0x10)
};

// ScriptStruct GeometryCollectionEngine.GeometryCollectionEmbeddedExemplar
// Size: 0x38 (Inherited: 0x00)
struct FGeometryCollectionEmbeddedExemplar {
	struct FSoftObjectPath StaticMeshExemplar; // 0x00(0x28)
	float StartCullDistance; // 0x28(0x04)
	float EndCullDistance; // 0x2c(0x04)
...
struct FGeometryCollectionProxyMeshData {
	struct TArray<struct UStaticMesh*> ProxyMeshes; // 0x00(0x10)
};
...
struct FGeometryCollectionRenderResourceSizeInfo {
	uint64_t MeshResourcesSize; // 0x00(0x08)
	uint64_t NaniteResourcesSize; // 0x08(0x08)
};

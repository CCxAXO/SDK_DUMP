...
struct UQualityVideo_QualitySettings_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function QualityVideo_QualitySettings.QualityVideo_QualitySettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_QualityVideo_QualitySettings(int32_t EntryPoint); // Function QualityVideo_QualitySettings.QualityVideo_QualitySettings_C.ExecuteUbergraph_QualityVideo_QualitySettings // (Final|UbergraphFunction) // @ game+0x1b42740
};

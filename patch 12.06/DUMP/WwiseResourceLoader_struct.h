...
// Size: 0x58 (Inherited: 0x24)
struct FWwiseInitBankCookedData : FWwiseSoundBankCookedData {
	char pad_24[0x4]; // 0x24(0x04)
	struct TArray<struct FWwiseSoundBankCookedData> SoundBanks; // 0x28(0x10)
	struct TArray<struct FWwiseMediaCookedData> Media; // 0x38(0x10)
	struct TArray<struct FWwiseLanguageCookedData> Language; // 0x48(0x10)
};

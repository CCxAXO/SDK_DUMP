...
struct UTournamentsTeamCardWithScore_C : UUserWidget {
	...
	void HandleReportTeamClicked(); // Function TournamentsTeamCardWithScore.TournamentsTeamCardWithScore_C.HandleReportTeamClicked // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void StyleEntryBasedOnState(enum class E_TournamentBracketEntryState entryStatus); // Function TournamentsTeamCardWithScore.TournamentsTeamCardWithScore_C.StyleEntryBasedOnState // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetBye(); // Function TournamentsTeamCardWithScore.TournamentsTeamCardWithScore_C.SetBye // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetTeam(struct UMatchupParticipantModel* MatchupParticipant); // Function TournamentsTeamCardWithScore.TournamentsTeamCardWithScore_C.SetTeam // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function TournamentsTeamCardWithScore.TournamentsTeamCardWithScore_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void PreConstruct(bool IsDesignTime); // Function TournamentsTeamCardWithScore.TournamentsTeamCardWithScore_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	...
	void ExecuteUbergraph_TournamentsTeamCardWithScore(int32_t EntryPoint); // Function TournamentsTeamCardWithScore.TournamentsTeamCardWithScore_C.ExecuteUbergraph_TournamentsTeamCardWithScore // (Final|UbergraphFunction) // @ game+0x1b42740
};

...
struct UMatchDetailsSummaryTabV2_C : UMatchDetailsTabBase_C {
	...
	void LazyLoadPlaybackButton(); // Function MatchDetailsSummaryTabV2.MatchDetailsSummaryTabV2_C.LazyLoadPlaybackButton // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void DidMatchGoToOT(bool& Result); // Function MatchDetailsSummaryTabV2.MatchDetailsSummaryTabV2_C.DidMatchGoToOT // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1b42740
	void GetHalfForRound(int32_t Round Number, enum class MatchHalf& half); // Function MatchDetailsSummaryTabV2.MatchDetailsSummaryTabV2_C.GetHalfForRound // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1b42740
	void SetArrow(int32_t AlliedCount, int32_t OpponentCount, struct UImage* Arrow); // Function MatchDetailsSummaryTabV2.MatchDetailsSummaryTabV2_C.SetArrow // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void InitTeamStatsSection(); // Function MatchDetailsSummaryTabV2.MatchDetailsSummaryTabV2_C.InitTeamStatsSection // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void GetEarnedXP(); // Function MatchDetailsSummaryTabV2.MatchDetailsSummaryTabV2_C.GetEarnedXP // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void GetNextHighestHighlight(struct TMap<enum class MatchDetailsHighlightEnum, struct FMatchDetailsHighlight> HighlightsMap, struct FMatchDetailsHighlight& ReturnHighlight, bool& NewParam1); // Function MatchDetailsSummaryTabV2.MatchDetailsSummaryTabV2_C.GetNextHighestHighlight // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void InitPlayerHighlightsSection(); // Function MatchDetailsSummaryTabV2.MatchDetailsSummaryTabV2_C.InitPlayerHighlightsSection // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void PreConstruct(bool IsDesignTime); // Function MatchDetailsSummaryTabV2.MatchDetailsSummaryTabV2_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function MatchDetailsSummaryTabV2.MatchDetailsSummaryTabV2_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void EventOnInit(); // Function MatchDetailsSummaryTabV2.MatchDetailsSummaryTabV2_C.EventOnInit // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnBestRoundAwardClicked(); // Function MatchDetailsSummaryTabV2.MatchDetailsSummaryTabV2_C.OnBestRoundAwardClicked // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_MatchDetailsSummaryTabV2(int32_t EntryPoint); // Function MatchDetailsSummaryTabV2.MatchDetailsSummaryTabV2_C.ExecuteUbergraph_MatchDetailsSummaryTabV2 // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
	void ForceChangeTab__DelegateSignature(struct FString TabDisplayName); // Function MatchDetailsSummaryTabV2.MatchDetailsSummaryTabV2_C.ForceChangeTab__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

...
struct UMovieSceneTransformOrigin : UInterface {
	...
	struct FTransform BP_GetTransformOrigin(); // Function MovieSceneTracks.MovieSceneTransformOrigin.BP_GetTransformOrigin // (RequiredAPI|Event|Protected|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1b42740
};
...
struct UMovieScene3DConstraintSection : UMovieSceneSection {
	...
	void SetConstraintBindingID(struct FMovieSceneObjectBindingID& InConstraintBindingID); // Function MovieSceneTracks.MovieScene3DConstraintSection.SetConstraintBindingID // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x379e7f0
	struct FMovieSceneObjectBindingID GetConstraintBindingID(); // Function MovieSceneTracks.MovieScene3DConstraintSection.GetConstraintBindingID // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x379e910
};
...
struct UMovieSceneAudioSection : UMovieSceneSection {
	...
	void SetSuppressSubtitles(bool bInSuppressSubtitles); // Function MovieSceneTracks.MovieSceneAudioSection.SetSuppressSubtitles // (Final|Native|Public|BlueprintCallable) // @ game+0x37a6030
	void SetStartOffset(struct FFrameNumber InStartOffset); // Function MovieSceneTracks.MovieSceneAudioSection.SetStartOffset // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x37a6270
	void SetSound(struct USoundBase* InSound); // Function MovieSceneTracks.MovieSceneAudioSection.SetSound // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x37a6380
	void SetOverrideAttenuation(bool bInOverrideAttenuation); // Function MovieSceneTracks.MovieSceneAudioSection.SetOverrideAttenuation // (Final|Native|Public|BlueprintCallable) // @ game+0x37a5f20
	void SetLooping(bool bInLooping); // Function MovieSceneTracks.MovieSceneAudioSection.SetLooping // (Final|Native|Public|BlueprintCallable) // @ game+0x37a6140
	void SetAttenuationSettings(struct USoundAttenuation* InAttenuationSettings); // Function MovieSceneTracks.MovieSceneAudioSection.SetAttenuationSettings // (Final|Native|Public|BlueprintCallable) // @ game+0x37a5e10
	bool GetSuppressSubtitles(); // Function MovieSceneTracks.MovieSceneAudioSection.GetSuppressSubtitles // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x37a6120
	struct FFrameNumber GetStartOffset(); // Function MovieSceneTracks.MovieSceneAudioSection.GetStartOffset // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x37a6250
	struct USoundBase* GetSound(); // Function MovieSceneTracks.MovieSceneAudioSection.GetSound // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x37a6360
	bool GetOverrideAttenuation(); // Function MovieSceneTracks.MovieSceneAudioSection.GetOverrideAttenuation // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x37a6010
	bool GetLooping(); // Function MovieSceneTracks.MovieSceneAudioSection.GetLooping // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x37a6230
	struct USoundAttenuation* GetAttenuationSettings(); // Function MovieSceneTracks.MovieSceneAudioSection.GetAttenuationSettings // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x37a5f00
};
...
struct UMovieSceneCameraCutSection : UMovieSceneSection {
	...
	void SetCameraBindingID(struct FMovieSceneObjectBindingID& InCameraBindingID); // Function MovieSceneTracks.MovieSceneCameraCutSection.SetCameraBindingID // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x37ab180
	struct FMovieSceneObjectBindingID GetCameraBindingID(); // Function MovieSceneTracks.MovieSceneCameraCutSection.GetCameraBindingID // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x37ab2a0
};
...
struct UMovieSceneCinematicShotSection : UMovieSceneSubSection {
	...
	void SetShotDisplayName(struct FString InShotDisplayName); // Function MovieSceneTracks.MovieSceneCinematicShotSection.SetShotDisplayName // (Final|Native|Public|BlueprintCallable) // @ game+0x37abf50
	struct FString GetShotDisplayName(); // Function MovieSceneTracks.MovieSceneCinematicShotSection.GetShotDisplayName // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x37ac0e0
};
...
struct UMovieSceneCVarSection : UMovieSceneSection {
	...
	void SetFromString(struct FString InString); // Function MovieSceneTracks.MovieSceneCVarSection.SetFromString // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x37ad9f0
	struct FString GetString(); // Function MovieSceneTracks.MovieSceneCVarSection.GetString // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x37ad950
};
...
struct UMovieSceneDataLayerSection : UMovieSceneSection {
	...
	void SetPrerollState(enum class EDataLayerRuntimeState InPrerollState); // Function MovieSceneTracks.MovieSceneDataLayerSection.SetPrerollState // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x37aedf0
	void SetFlushOnUnload(bool bFlushOnUnload); // Function MovieSceneTracks.MovieSceneDataLayerSection.SetFlushOnUnload // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x37aece0
	void SetDesiredState(enum class EDataLayerRuntimeState InDesiredState); // Function MovieSceneTracks.MovieSceneDataLayerSection.SetDesiredState // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x37aef00
	void SetDataLayers(struct TArray<struct FActorDataLayer>& InDataLayers); // Function MovieSceneTracks.MovieSceneDataLayerSection.SetDataLayers // (Final|Native|Private|HasOutParms|BlueprintCallable) // @ game+0x37ae970
	void SetDataLayerAssets(struct TArray<struct UDataLayerAsset*>& InDataLayerAssets); // Function MovieSceneTracks.MovieSceneDataLayerSection.SetDataLayerAssets // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x37aead0
	enum class EDataLayerRuntimeState GetPrerollState(); // Function MovieSceneTracks.MovieSceneDataLayerSection.GetPrerollState // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x37aeee0
	bool GetFlushOnUnload(); // Function MovieSceneTracks.MovieSceneDataLayerSection.GetFlushOnUnload // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x37aedd0
	enum class EDataLayerRuntimeState GetDesiredState(); // Function MovieSceneTracks.MovieSceneDataLayerSection.GetDesiredState // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x37aeff0
	struct TArray<struct FActorDataLayer> GetDataLayers(); // Function MovieSceneTracks.MovieSceneDataLayerSection.GetDataLayers // (Final|Native|Private|BlueprintCallable|BlueprintPure|Const) // @ game+0x37aeaa0
	struct TArray<struct UDataLayerAsset*> GetDataLayerAssets(); // Function MovieSceneTracks.MovieSceneDataLayerSection.GetDataLayerAssets // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x37aec50
};
...
struct UMovieSceneLevelVisibilitySection : UMovieSceneSection {
	...
	void SetVisibility(enum class ELevelVisibility InVisibility); // Function MovieSceneTracks.MovieSceneLevelVisibilitySection.SetVisibility // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x384ad70
	void SetLevelNames(struct TArray<struct FName>& InLevelNames); // Function MovieSceneTracks.MovieSceneLevelVisibilitySection.SetLevelNames // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x384ac10
	enum class ELevelVisibility GetVisibility(); // Function MovieSceneTracks.MovieSceneLevelVisibilitySection.GetVisibility // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x384ae60
	struct TArray<struct FName> GetLevelNames(); // Function MovieSceneTracks.MovieSceneLevelVisibilitySection.GetLevelNames // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x384ad40
};
...
struct UMovieSceneParameterSection : UMovieSceneSection {
	...
	bool RemoveVectorParameter(struct FName InParameterName); // Function MovieSceneTracks.MovieSceneParameterSection.RemoveVectorParameter // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x384c760
	bool RemoveVector2DParameter(struct FName InParameterName); // Function MovieSceneTracks.MovieSceneParameterSection.RemoveVector2DParameter // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x384c8b0
	bool RemoveTransformParameter(struct FName InParameterName); // Function MovieSceneTracks.MovieSceneParameterSection.RemoveTransformParameter // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x384c4c0
	bool RemoveScalarParameter(struct FName InParameterName); // Function MovieSceneTracks.MovieSceneParameterSection.RemoveScalarParameter // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x384cb50
	bool RemoveColorParameter(struct FName InParameterName); // Function MovieSceneTracks.MovieSceneParameterSection.RemoveColorParameter // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x384c610
	bool RemoveBoolParameter(struct FName InParameterName); // Function MovieSceneTracks.MovieSceneParameterSection.RemoveBoolParameter // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x384ca00
	void GetParameterNames(struct TSet<struct FName>& ParameterNames); // Function MovieSceneTracks.MovieSceneParameterSection.GetParameterNames // (Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x384c200
	void AddVectorParameterKey(struct FName InParameterName, struct FFrameNumber InTime, struct FVector InValue); // Function MovieSceneTracks.MovieSceneParameterSection.AddVectorParameterKey // (Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x384d1b0
	void AddVector2DParameterKey(struct FName InParameterName, struct FFrameNumber InTime, struct FVector2D InValue); // Function MovieSceneTracks.MovieSceneParameterSection.AddVector2DParameterKey // (Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x384d410
	void AddTransformParameterKey(struct FName InParameterName, struct FFrameNumber InTime, struct FTransform& InValue); // Function MovieSceneTracks.MovieSceneParameterSection.AddTransformParameterKey // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x384cca0
	void AddScalarParameterKey(struct FName InParameterName, struct FFrameNumber InTime, float InValue); // Function MovieSceneTracks.MovieSceneParameterSection.AddScalarParameterKey // (Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x384d8b0
	void AddColorParameterKey(struct FName InParameterName, struct FFrameNumber InTime, struct FLinearColor InValue); // Function MovieSceneTracks.MovieSceneParameterSection.AddColorParameterKey // (Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x384cf60
	void AddBoolParameterKey(struct FName InParameterName, struct FFrameNumber InTime, bool InValue); // Function MovieSceneTracks.MovieSceneParameterSection.AddBoolParameterKey // (Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x384d660
};
...
struct UMovieSceneSkeletalAnimationTrack : UMovieSceneNameableTrack {
	...
	void SetSwapRootBone(enum class ESwapRootBone InValue); // Function MovieSceneTracks.MovieSceneSkeletalAnimationTrack.SetSwapRootBone // (Final|RequiredAPI|Native|Public) // @ game+0x392ccd0
	enum class ESwapRootBone GetSwapRootBone(); // Function MovieSceneTracks.MovieSceneSkeletalAnimationTrack.GetSwapRootBone // (Final|RequiredAPI|Native|Public|Const) // @ game+0x392ccb0
};

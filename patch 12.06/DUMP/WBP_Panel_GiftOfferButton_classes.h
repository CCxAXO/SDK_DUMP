...
struct UWBP_Panel_GiftOfferButton_C : UAresCommonUserWidget {
	...
	void UpdateSecondaryThumbnailVisuals(); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.UpdateSecondaryThumbnailVisuals // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void HandleGiftingEligibleStatusChanged(enum class EGiftingEligibleStatus GiftingEligibleStatus); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.HandleGiftingEligibleStatusChanged // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void BindEvents(bool Bind); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.BindEvents // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void InitViewModels(); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.InitViewModels // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetSelectedSubOfferDTO(struct UOfferDTO* SelectedSubOfferDTO); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.SetSelectedSubOfferDTO // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetBundleOfferDTO(struct UBundleViewModel* BundleOfferDTO); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.SetBundleOfferDTO // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void HandleClicked(); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.HandleClicked // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	...
	void K2_BindToViewModel(); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.K2_BindToViewModel // (Event|Public|BlueprintEvent) // @ game+0x1b42740
	void PreConstruct(bool IsDesignTime); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	...
	void BndEvt__WBP_Panel_GiftOfferButton_SecondaryThumbnailStyle_K2Node_ComponentBoundEvent_10_CommonButtonBaseClicked__DelegateSignature(struct UCommonButtonBase* Button); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.BndEvt__WBP_Panel_GiftOfferButton_SecondaryThumbnailStyle_K2Node_ComponentBoundEvent_10_CommonButtonBaseClicked__DelegateSignature // (BlueprintEvent) // @ game+0x1b42740
	void BndEvt__WBP_Panel_GiftOfferButton_SecondaryThumbnailStyle_K2Node_ComponentBoundEvent_11_CommonButtonBaseClicked__DelegateSignature(struct UCommonButtonBase* Button); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.BndEvt__WBP_Panel_GiftOfferButton_SecondaryThumbnailStyle_K2Node_ComponentBoundEvent_11_CommonButtonBaseClicked__DelegateSignature // (BlueprintEvent) // @ game+0x1b42740
	void BndEvt__WBP_Panel_GiftOfferButton_WBP_Button_Primary_K2Node_ComponentBoundEvent_8_CommonButtonBaseClicked__DelegateSignature(struct UCommonButtonBase* Button); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.BndEvt__WBP_Panel_GiftOfferButton_WBP_Button_Primary_K2Node_ComponentBoundEvent_8_CommonButtonBaseClicked__DelegateSignature // (BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_WBP_Panel_GiftOfferButton(int32_t EntryPoint); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.ExecuteUbergraph_WBP_Panel_GiftOfferButton // (Final|UbergraphFunction) // @ game+0x1b42740
	void OnClicked__DelegateSignature(struct UOfferDTOList* GiftOfferDTOList); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.OnClicked__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

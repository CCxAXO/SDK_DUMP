...
struct UParticipantCombatInteractionWidget_Desktop_C : UWBP_CombatReportInteractionWidget_Base_C {
	...
	bool IsPlayerSelfDamaging(); // Function ParticipantCombatInteractionWidget_Desktop.ParticipantCombatInteractionWidget_Desktop_C.IsPlayerSelfDamaging // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void SetInteractionData(struct FParticipantInteractions InData); // Function ParticipantCombatInteractionWidget_Desktop.ParticipantCombatInteractionWidget_Desktop_C.SetInteractionData // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void ResetCounters(); // Function ParticipantCombatInteractionWidget_Desktop.ParticipantCombatInteractionWidget_Desktop_C.ResetCounters // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void On_Mouse_Leave(); // Function ParticipantCombatInteractionWidget_Desktop.ParticipantCombatInteractionWidget_Desktop_C.On_Mouse_Leave // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	struct UWidget* CreateFlyoutDetailWidget(); // Function ParticipantCombatInteractionWidget_Desktop.ParticipantCombatInteractionWidget_Desktop_C.CreateFlyoutDetailWidget // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void Construct(); // Function ParticipantCombatInteractionWidget_Desktop.ParticipantCombatInteractionWidget_Desktop_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void Destruct(); // Function ParticipantCombatInteractionWidget_Desktop.ParticipantCombatInteractionWidget_Desktop_C.Destruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1b42740
	void New Round(int32_t RoundNumberBeginning); // Function ParticipantCombatInteractionWidget_Desktop.ParticipantCombatInteractionWidget_Desktop_C.New Round // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnUpdateData(); // Function ParticipantCombatInteractionWidget_Desktop.ParticipantCombatInteractionWidget_Desktop_C.OnUpdateData // (BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
	void OnMouseEnter(struct FGeometry MyGeometry, struct FPointerEvent& MouseEvent); // Function ParticipantCombatInteractionWidget_Desktop.ParticipantCombatInteractionWidget_Desktop_C.OnMouseEnter // (BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // @ game+0x1b42740
	void OnMouseLeave(struct FPointerEvent& MouseEvent); // Function ParticipantCombatInteractionWidget_Desktop.ParticipantCombatInteractionWidget_Desktop_C.OnMouseLeave // (BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // @ game+0x1b42740
	void ExecuteUbergraph_ParticipantCombatInteractionWidget_Desktop(int32_t EntryPoint); // Function ParticipantCombatInteractionWidget_Desktop.ParticipantCombatInteractionWidget_Desktop_C.ExecuteUbergraph_ParticipantCombatInteractionWidget_Desktop // (Final|UbergraphFunction|HasDefaults) // @ game+0x1b42740
};

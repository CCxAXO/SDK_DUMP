...
struct UJoiningQueuePendingInvitesModal_Dev_C : UUserWidget {
	...
	void ExecuteUbergraph_JoiningQueuePendingInvitesModal_Dev(int32_t EntryPoint); // Function JoiningQueuePendingInvitesModal_Dev.JoiningQueuePendingInvitesModal_Dev_C.ExecuteUbergraph_JoiningQueuePendingInvitesModal_Dev // (Final|UbergraphFunction) // @ game+0x1b42740
	void ContinueJoiningQueue__DelegateSignature(bool Continue); // Function JoiningQueuePendingInvitesModal_Dev.JoiningQueuePendingInvitesModal_Dev_C.ContinueJoiningQueue__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1b42740
};

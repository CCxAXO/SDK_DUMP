...
struct UPartyMemberDragWidget_C : UUserWidget {
	...
	void Init(); // Function PartyMemberDragWidget.PartyMemberDragWidget_C.Init // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function PartyMemberDragWidget.PartyMemberDragWidget_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_PartyMemberDragWidget(int32_t EntryPoint); // Function PartyMemberDragWidget.PartyMemberDragWidget_C.ExecuteUbergraph_PartyMemberDragWidget // (Final|UbergraphFunction) // @ game+0x1af5410
};

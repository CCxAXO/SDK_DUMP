...
struct UCrosshair_OuterLineSettings_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function Crosshair_OuterLineSettings.Crosshair_OuterLineSettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void OnInitialized(); // Function Crosshair_OuterLineSettings.Crosshair_OuterLineSettings_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void SetUseADSSettings(bool ForADS); // Function Crosshair_OuterLineSettings.Crosshair_OuterLineSettings_C.SetUseADSSettings // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_Crosshair_OuterLineSettings(int32_t EntryPoint); // Function Crosshair_OuterLineSettings.Crosshair_OuterLineSettings_C.ExecuteUbergraph_Crosshair_OuterLineSettings // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

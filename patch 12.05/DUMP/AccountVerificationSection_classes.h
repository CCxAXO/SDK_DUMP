...
struct UAccountVerificationSection_C : UUserWidget {
	...
	void Construct(); // Function AccountVerificationSection.AccountVerificationSection_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_AccountVerificationSection(int32_t EntryPoint); // Function AccountVerificationSection.AccountVerificationSection_C.ExecuteUbergraph_AccountVerificationSection // (Final|UbergraphFunction) // @ game+0x1af5410
};

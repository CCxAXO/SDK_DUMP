...
struct UXboxGamePass_DeactivationPane_C : UUserWidget {
	...
	void OnAllSubscriptionsLoaded(struct FSubscriptionHandles& SubscriptionHandles); // Function XboxGamePass_DeactivationPane.XboxGamePass_DeactivationPane_C.OnAllSubscriptionsLoaded // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnInitialized(); // Function XboxGamePass_DeactivationPane.XboxGamePass_DeactivationPane_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_XboxGamePass_DeactivationPane(int32_t EntryPoint); // Function XboxGamePass_DeactivationPane.XboxGamePass_DeactivationPane_C.ExecuteUbergraph_XboxGamePass_DeactivationPane // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

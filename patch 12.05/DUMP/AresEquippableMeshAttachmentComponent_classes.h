...
struct UAresEquippableMeshAttachmentComponent_C : UAresWeaponAttachmentComponent {
	...
	void Attach Component(struct UMeshComponent* Component, struct UMeshComponent* Parent, bool is3P); // Function AresEquippableMeshAttachmentComponent.AresEquippableMeshAttachmentComponent_C.Attach Component // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Detach Component(struct USceneComponent* Component); // Function AresEquippableMeshAttachmentComponent.AresEquippableMeshAttachmentComponent_C.Detach Component // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Add VFX Meshes(struct USkeletalMeshComponent* Mesh Component); // Function AresEquippableMeshAttachmentComponent.AresEquippableMeshAttachmentComponent_C.Add VFX Meshes // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void Get VFX Meshes And Materials(struct TArray<>& Meshes, struct TArray<struct UMaterialInstanceDynamic*>& Dynamic Materials); // Function AresEquippableMeshAttachmentComponent.AresEquippableMeshAttachmentComponent_C.Get VFX Meshes And Materials // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Setup Skeletal Mesh 3P(struct USceneComponent* Attach Parent, struct UMeshComponent* Mesh Parent, struct USkeletalMeshComponent*& Mesh Component 3P); // Function AresEquippableMeshAttachmentComponent.AresEquippableMeshAttachmentComponent_C.Setup Skeletal Mesh 3P // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Override Materials(struct TArray<struct UMaterialInterface*>& Material Array, struct USkeletalMeshComponent* Mesh Component); // Function AresEquippableMeshAttachmentComponent.AresEquippableMeshAttachmentComponent_C.Override Materials // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Setup Skeletal Mesh 1P(struct USceneComponent* Attach Parent, struct UMeshComponent* Mesh Parent, struct USkeletalMeshComponent*& Mesh Component 1P); // Function AresEquippableMeshAttachmentComponent.AresEquippableMeshAttachmentComponent_C.Setup Skeletal Mesh 1P // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ReceiveBeginPlay(); // Function AresEquippableMeshAttachmentComponent.AresEquippableMeshAttachmentComponent_C.ReceiveBeginPlay // (Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ReceiveEndPlay(enum class EEndPlayReason EndPlayReason); // Function AresEquippableMeshAttachmentComponent.AresEquippableMeshAttachmentComponent_C.ReceiveEndPlay // (Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_AresEquippableMeshAttachmentComponent(int32_t EntryPoint); // Function AresEquippableMeshAttachmentComponent.AresEquippableMeshAttachmentComponent_C.ExecuteUbergraph_AresEquippableMeshAttachmentComponent // (Final|UbergraphFunction) // @ game+0x1af5410
};

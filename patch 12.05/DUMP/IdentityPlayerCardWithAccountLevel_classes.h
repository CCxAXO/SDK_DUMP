...
struct UIdentityPlayerCardWithAccountLevel_C : UUserWidget {
	...
	void InitPremier(); // Function IdentityPlayerCardWithAccountLevel.IdentityPlayerCardWithAccountLevel_C.InitPremier // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Init(bool IsCompetativeMatch, struct FString Subject); // Function IdentityPlayerCardWithAccountLevel.IdentityPlayerCardWithAccountLevel_C.Init // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_IdentityPlayerCardWithAccountLevel(int32_t EntryPoint); // Function IdentityPlayerCardWithAccountLevel.IdentityPlayerCardWithAccountLevel_C.ExecuteUbergraph_IdentityPlayerCardWithAccountLevel // (Final|UbergraphFunction) // @ game+0x1af5410
};

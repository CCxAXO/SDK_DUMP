...
enum class EGameFeatureToggleName : uint8 {
	...
	EnableIndicatorPossessableUpdate = 211,
	EnablePlacementFixes = 212,
	AudioEnableStopSoundCleanupChecks = 213,
	PhysXSphereTriangleTraceParity = 214,
	AudioEnableStopSoundEndPlay = 215,
	ShouldMarkMatchesAsRecorded = 216,
	ShouldMarkMatchesAsRecordedConsole = 217,
	DynamicContentEnabled = 218,
	UseNewBuffDebuffTagHUD = 219,
	EnableSpikePlacementRestrictions = 220,
	EnableTopHUDHealthbarHealUIChange = 221,
	AudioEnableSoundBlockerChecks = 222,
	AltModeTelemetryEnabled = 223,
	AssistBannersEnabled = 224,
	SharedSerializationReconnectReset = 225,
	NegatedDamageNotify = 226,
	HudBlueprintLibraryV2 = 227,
	NavAreaClassChange = 228,
	JumpBoostingFixesEnabled = 229,
	RewindPlayerCapsuleHeight = 230,
	EnableTeamNumber = 231,
	SendFullInventoryEvents = 232,
	ShowLocalViewTargetBuffs = 233,
	KillfeedAssistAbilityIconsEnabled = 234,
	ServerAnimOnlyUpdatesPhysBodiesOnEval = 235,
	Count = 236,
	Invalid = 254,
...
// Enum ShooterGame.EBloomlineTrackType
enum class EBloomlineTrackType : uint8 {
	None = 0,
	Reward = 1,
	EBloomlineTrackType_MAX = 2
};
...
// Enum ShooterGame.ECurrentPerspectiveResult
enum class ECurrentPerspectiveResult : uint8 {
	None = 0,
	FirstPerson = 1,
	ThirdPersonAlly = 2,
	ThirdPersonEnemy = 3,
	ECurrentPerspectiveResult_MAX = 4
};
...
// ScriptStruct ShooterGame.ExecutePurchaseResponse
// Size: 0x138 (Inherited: 0x00)
struct FExecutePurchaseResponse {
...
struct FBloomlineShortData {
	struct FBloomlineFlourish Flourish; // 0x00(0x40)
	struct FBloomlineModules Modules; // 0x40(0x20)
};
...
struct FBloomlineBonsai {
	...
	struct FBloomlineShortData ShortData; // 0x50(0x60)
	struct TArray<struct FBloomlineTrackProgress> TrackProgressList; // 0xb0(0x10)
};
...
struct FCAPAuthoredCatalogEntryDto {
	...
	struct FConfigurationAvailability Availability; // 0xc0(0x10)
};
...
struct FCAPAuthoredStoreDto {
	...
	struct FConfigurationAvailability Availability; // 0x60(0x10)
};

...
struct UReplayCancelButton_C : UWBP_Button_ReplayButtonBase_C {
	...
	void UpdateButtonVisual(enum class EMatchHistoryReplayCancelStatus StatusEnum); // Function ReplayCancelButton.ReplayCancelButton_C.UpdateButtonVisual // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Init(struct FString Match ID); // Function ReplayCancelButton.ReplayCancelButton_C.Init // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void UpdateState(struct FReplayLocalFileMatchEntryUpdateInfo ReplayLocalUpdate); // Function ReplayCancelButton.ReplayCancelButton_C.UpdateState // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_ReplayCancelButton(int32_t EntryPoint); // Function ReplayCancelButton.ReplayCancelButton_C.ExecuteUbergraph_ReplayCancelButton // (Final|UbergraphFunction) // @ game+0x1af5410
	void OnReleased__DelegateSignature(); // Function ReplayCancelButton.ReplayCancelButton_C.OnReleased__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnPressed__DelegateSignature(); // Function ReplayCancelButton.ReplayCancelButton_C.OnPressed__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

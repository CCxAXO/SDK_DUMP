...
struct UWBP_Button_QueueSelect_C : UWBP_Button_ContentTileBase_C {
	...
	void SetViewModelDataAndSetup(struct UObject* Object); // Function WBP_Button_QueueSelect.WBP_Button_QueueSelect_C.SetViewModelDataAndSetup // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void UpdateNewModeElements(); // Function WBP_Button_QueueSelect.WBP_Button_QueueSelect_C.UpdateNewModeElements // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void UpdateFeaturedTileElements(); // Function WBP_Button_QueueSelect.WBP_Button_QueueSelect_C.UpdateFeaturedTileElements // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

...
struct UWBP_Panel_Battlepass_ChapterPip_C : UAresCommonUserWidget {
	...
	struct FString GetListItemTelemetryTarget(); // Function WBP_Panel_Battlepass_ChapterPip.WBP_Panel_Battlepass_ChapterPip_C.GetListItemTelemetryTarget // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetRightConnectorVisibility(int32_t NumChapters, int32_t ChapterIndex); // Function WBP_Panel_Battlepass_ChapterPip.WBP_Panel_Battlepass_ChapterPip_C.SetRightConnectorVisibility // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetLeftConnectorVisibility(int32_t ChapterIndex); // Function WBP_Panel_Battlepass_ChapterPip.WBP_Panel_Battlepass_ChapterPip_C.SetLeftConnectorVisibility // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Bind Chapter State Events(bool Bind); // Function WBP_Panel_Battlepass_ChapterPip.WBP_Panel_Battlepass_ChapterPip_C.Bind Chapter State Events // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Bind Contract State Events(bool Bind); // Function WBP_Panel_Battlepass_ChapterPip.WBP_Panel_Battlepass_ChapterPip_C.Bind Contract State Events // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Handle Display State Changed(enum class ContractChapterDisplayState Display State); // Function WBP_Panel_Battlepass_ChapterPip.WBP_Panel_Battlepass_ChapterPip_C.Handle Display State Changed // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Set Contract State VM(struct UVM_ContractState_C* Contract State VM); // Function WBP_Panel_Battlepass_ChapterPip.WBP_Panel_Battlepass_ChapterPip_C.Set Contract State VM // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Init Chapter State VM(struct UContractChapterViewModel* Chapter View Model); // Function WBP_Panel_Battlepass_ChapterPip.WBP_Panel_Battlepass_ChapterPip_C.Init Chapter State VM // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Set Chapter State VM(struct UVM_ContractChapterState_C* Chapter State View Model); // Function WBP_Panel_Battlepass_ChapterPip.WBP_Panel_Battlepass_ChapterPip_C.Set Chapter State VM // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void BP_OnEntryReleased(); // Function WBP_Panel_Battlepass_ChapterPip.WBP_Panel_Battlepass_ChapterPip_C.BP_OnEntryReleased // (Event|Protected|BlueprintEvent) // @ game+0x1af5410
	void BP_OnItemExpansionChanged(bool bIsExpanded); // Function WBP_Panel_Battlepass_ChapterPip.WBP_Panel_Battlepass_ChapterPip_C.BP_OnItemExpansionChanged // (Event|Protected|BlueprintEvent) // @ game+0x1af5410
	void Destruct(); // Function WBP_Panel_Battlepass_ChapterPip.WBP_Panel_Battlepass_ChapterPip_C.Destruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void OnListItemObjectSet(struct UObject* ListItemObject); // Function WBP_Panel_Battlepass_ChapterPip.WBP_Panel_Battlepass_ChapterPip_C.OnListItemObjectSet // (Event|Protected|BlueprintEvent) // @ game+0x1af5410
	void BP_OnItemSelectionChanged(bool bIsSelected); // Function WBP_Panel_Battlepass_ChapterPip.WBP_Panel_Battlepass_ChapterPip_C.BP_OnItemSelectionChanged // (Event|Protected|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_WBP_Panel_Battlepass_ChapterPip(int32_t EntryPoint); // Function WBP_Panel_Battlepass_ChapterPip.WBP_Panel_Battlepass_ChapterPip_C.ExecuteUbergraph_WBP_Panel_Battlepass_ChapterPip // (Final|UbergraphFunction) // @ game+0x1af5410
	void OnChapterPipClicked__DelegateSignature(struct UObject* Item); // Function WBP_Panel_Battlepass_ChapterPip.WBP_Panel_Battlepass_ChapterPip_C.OnChapterPipClicked__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

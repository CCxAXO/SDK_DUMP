...
struct UPartyInvitePanelListingWidget_C : UUserWidget {
	...
	void UpdateInteractionAppearance(); // Function PartyInvitePanelListingWidget.PartyInvitePanelListingWidget_C.UpdateInteractionAppearance // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetInvited(bool NewValue); // Function PartyInvitePanelListingWidget.PartyInvitePanelListingWidget_C.SetInvited // (Private|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void StartRemoval(); // Function PartyInvitePanelListingWidget.PartyInvitePanelListingWidget_C.StartRemoval // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnAnimationFinished_Event_1(); // Function PartyInvitePanelListingWidget.PartyInvitePanelListingWidget_C.OnAnimationFinished_Event_1 // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Initialize(); // Function PartyInvitePanelListingWidget.PartyInvitePanelListingWidget_C.Initialize // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnIsInvitedChanged(bool NewValue); // Function PartyInvitePanelListingWidget.PartyInvitePanelListingWidget_C.OnIsInvitedChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_PartyInvitePanelListingWidget(int32_t EntryPoint); // Function PartyInvitePanelListingWidget.PartyInvitePanelListingWidget_C.ExecuteUbergraph_PartyInvitePanelListingWidget // (Final|UbergraphFunction) // @ game+0x1af5410
	void InviteRequested__DelegateSignature(struct UPlatformPlayer* PlayerToInvite); // Function PartyInvitePanelListingWidget.PartyInvitePanelListingWidget_C.InviteRequested__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

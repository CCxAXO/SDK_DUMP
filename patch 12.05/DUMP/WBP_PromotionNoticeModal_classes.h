...
struct UWBP_PromotionNoticeModal_C : UUserWidget {
	...
	void SequenceEvent__ENTRYPOINTWBP_PromotionNoticeModal(); // Function WBP_PromotionNoticeModal.WBP_PromotionNoticeModal_C.SequenceEvent__ENTRYPOINTWBP_PromotionNoticeModal // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Audio_Event(); // Function WBP_PromotionNoticeModal.WBP_PromotionNoticeModal_C.Audio_Event // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function WBP_PromotionNoticeModal.WBP_PromotionNoticeModal_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_WBP_PromotionNoticeModal(int32_t EntryPoint); // Function WBP_PromotionNoticeModal.WBP_PromotionNoticeModal_C.ExecuteUbergraph_WBP_PromotionNoticeModal // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
	void On Close__DelegateSignature(struct FString PromotionNoticeConfig); // Function WBP_PromotionNoticeModal.WBP_PromotionNoticeModal_C.On Close__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

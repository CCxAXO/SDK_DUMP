...
struct UWBP_Panel_ContentImage_C : UAresCommonUserWidget {
	...
	void Apply Transform(struct TSoftClassPtr<UObject> InEquippable, struct TSoftClassPtr<UObject> InUIData, bool OverrideTransformData, struct TMap<enum class EContentDisplayType, struct FContentImageDisplayData>& TransformMapOverride, struct TMap<struct TSoftClassPtr<UObject>, struct TSoftClassPtr<UObject>>& EquippableDataAssetOverride); // Function WBP_Panel_ContentImage.WBP_Panel_ContentImage_C.Apply Transform // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void PreConstruct(bool IsDesignTime); // Function WBP_Panel_ContentImage.WBP_Panel_ContentImage_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_WBP_Panel_ContentImage(int32_t EntryPoint); // Function WBP_Panel_ContentImage.WBP_Panel_ContentImage_C.ExecuteUbergraph_WBP_Panel_ContentImage // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

...
struct UMainMenuAlertsMenu_C : UUserWidget {
	...
	void Construct(); // Function MainMenuAlertsMenu.MainMenuAlertsMenu_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void PreConstruct(bool IsDesignTime); // Function MainMenuAlertsMenu.MainMenuAlertsMenu_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_MainMenuAlertsMenu(int32_t EntryPoint); // Function MainMenuAlertsMenu.MainMenuAlertsMenu_C.ExecuteUbergraph_MainMenuAlertsMenu // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

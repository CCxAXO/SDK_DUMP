...
struct FStruct_GameplayTagAndHUD_Info {
	...
	bool EnableCustomColoring_23_11B75D584A5DCE7A3EA88085FCF5196D; // 0xa9(0x01)
	char pad_AA[0x2]; // 0xaa(0x02)
	struct FLinearColor CustomTagColor_26_2DB1A3914319546D2BA48B8099D1EB27; // 0xac(0x10)
	struct FLinearColor CustomBarColor_29_ECF28A704C59D4DBB0E78A83D6002E21; // 0xbc(0x10)
	bool PlayAnimationOnTimerRefresh_31_0B2245CC4C5DC394D2F2288183F4A745; // 0xcc(0x01)
};

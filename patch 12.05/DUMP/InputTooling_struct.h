...
struct FAimToolingTarget {
	...
	struct FVector AssistLocation; // 0x18(0x18)
	bool bInDirectVision; // 0x30(0x01)
...
struct FAimToolingTelemetryData {
	struct FVector2D StrafeAssist; // 0x00(0x10)
	struct FVector2D TargetFriction; // 0x10(0x10)
	struct FVector2D PullToCenter; // 0x20(0x10)
	struct FVector2D FrameOfReference; // 0x30(0x10)
	struct FVector2D Deceleration; // 0x40(0x10)
	struct FVector2D Guardrails; // 0x50(0x10)
	struct FVector2D LookInputVector; // 0x60(0x10)
	struct FVector2D MovementInputVector; // 0x70(0x10)
	struct FVector2D FinalLookInputDelta; // 0x80(0x10)
	int32_t ActiveAimToolingFeatures; // 0x90(0x04)
	float DistanceToTarget; // 0x94(0x04)
	struct FString WeaponTuningTag; // 0x98(0x10)
	struct FString Target; // 0xa8(0x10)
};

// ScriptStruct InputTooling.AimToolingDecelerationEntry
// Size: 0x18 (Inherited: 0x00)
struct FAimToolingDecelerationEntry {
	struct FVector2D Input; // 0x00(0x10)
...
struct FAimToolingDecelerationState {
	...
	struct FVector2D AverageInputRate; // 0x10(0x10)
	float TimeTotal; // 0x20(0x04)
	bool bIsDecelerating; // 0x24(0x01)
	char pad_25[0x3]; // 0x25(0x03)
	float DecelerationAmount; // 0x28(0x04)
	char pad_2C[0x4]; // 0x2c(0x04)
	struct FVector2D DecelerationStartDirection; // 0x30(0x10)
	struct FVector2D DecelerationLastKnownDirection; // 0x40(0x10)
	float DecelerationStartSize; // 0x50(0x04)
...
struct FAimToolingDecelerationSharedTuningSet {
	...
	float DecelerationMaxAngleDeg; // 0x04(0x04)
	float DecelerationAverageWindow; // 0x08(0x04)
	float DecelerationHalfAngle; // 0x0c(0x04)
	float DecelerationStartThreshold; // 0x10(0x04)
	float DecelerationVisionBlockedScale; // 0x14(0x04)
};

// ScriptStruct InputTooling.AimToolingDecelerationWeaponTuningSet
// Size: 0x08 (Inherited: 0x00)
struct FAimToolingDecelerationWeaponTuningSet {
	struct UCurveFloat* DecelerationWorldDistFromTargetCurve; // 0x00(0x08)
};
...
struct FAimToolingFrameOfReferenceFeatureTuningSet {
	...
	struct FVector2D AimToolingFrameOfReferenceScale; // 0x08(0x10)
	struct FVector2D AimToolingFrameOfReferenceMaxDelta; // 0x18(0x10)
	float AimToolingFrameOfReferenceHighVelocityStrengthMinBias; // 0x28(0x04)
	float AimToolingFrameOfReferenceHighVelocityStrengthMaxBias; // 0x2c(0x04)
	struct UCurveFloat* AimToolingFrameOfReferenceHighVelocityStrengthCurve; // 0x30(0x08)
};
...
struct FAimToolingTemporalBendingWeaponTuningSet {
	...
	float MaxBendingAngleDegs; // 0x18(0x04)
};

// ScriptStruct InputTooling.AimToolingGuardrailsSharedTuningSet
// Size: 0x18 (Inherited: 0x00)
struct FAimToolingGuardrailsSharedTuningSet {
	struct UCurveFloat* GuardrailsMaximumDeflectionAngleDegreesStickDeflectionCurve; // 0x00(0x08)
	struct UCurveFloat* GuardrailsMinimumLengthPercentStickDeflectionCurve; // 0x08(0x08)
	struct UCurveFloat* GuardrailsMaximumLengthPercentStickDeflectionCurve; // 0x10(0x08)
};

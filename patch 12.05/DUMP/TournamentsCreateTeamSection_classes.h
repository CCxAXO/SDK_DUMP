...
struct UTournamentsCreateTeamSection_C : UUserWidget {
	...
	void ExecuteUbergraph_TournamentsCreateTeamSection(int32_t EntryPoint); // Function TournamentsCreateTeamSection.TournamentsCreateTeamSection_C.ExecuteUbergraph_TournamentsCreateTeamSection // (Final|UbergraphFunction) // @ game+0x1af5410
	void BeginTeamCreation__DelegateSignature(); // Function TournamentsCreateTeamSection.TournamentsCreateTeamSection_C.BeginTeamCreation__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

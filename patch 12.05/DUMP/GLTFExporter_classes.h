...
struct UGLTFExportOptions : UObject {
	...
	void ResetToDefault(); // Function GLTFExporter.GLTFExportOptions.ResetToDefault // (Final|Native|Public|BlueprintCallable) // @ game+0x78215e0
};
...
struct UGLTFExporter : UExporter {
	...
	bool ExportToGLTF(struct UObject* Object, struct FString FilePath, struct UGLTFExportOptions* OPTIONS, struct TSet<struct AActor*>& SelectedActors, struct FGLTFExportMessages& OutMessages); // Function GLTFExporter.GLTFExporter.ExportToGLTF // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x78337b0
};
...
struct UGLTFProxyOptions : UObject {
	...
	void ResetToDefault(); // Function GLTFExporter.GLTFProxyOptions.ResetToDefault // (Final|Native|Public|BlueprintCallable) // @ game+0x7840ab0
};

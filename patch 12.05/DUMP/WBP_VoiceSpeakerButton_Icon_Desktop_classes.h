...
struct UWBP_VoiceSpeakerButton_Icon_Desktop_C : UWBP_VoiceSpeakerButton_Base_Desktop_C {
	...
	struct UUserWidget* On_Tooltip_GetUserMenuContent(); // Function WBP_VoiceSpeakerButton_Icon_Desktop.WBP_VoiceSpeakerButton_Icon_Desktop_C.On_Tooltip_GetUserMenuContent // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1af5410
	void OnInitialized(); // Function WBP_VoiceSpeakerButton_Icon_Desktop.WBP_VoiceSpeakerButton_Icon_Desktop_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_WBP_VoiceSpeakerButton_Icon_Desktop(int32_t EntryPoint); // Function WBP_VoiceSpeakerButton_Icon_Desktop.WBP_VoiceSpeakerButton_Icon_Desktop_C.ExecuteUbergraph_WBP_VoiceSpeakerButton_Icon_Desktop // (Final|UbergraphFunction) // @ game+0x1af5410
};

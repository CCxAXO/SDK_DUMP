...
struct UGameInfoHUD_Master_C : UCoordinatedHUDElement {
	...
	void SetHUDModel(struct UCoordinatedHUDModel* HUDModel); // Function GameInfoHUD_Master.GameInfoHUD_Master_C.SetHUDModel // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void BndEvt__GFTDynamicWidgetSwitcher_K2Node_ComponentBoundEvent_1_DisabledWidgetCreated__DelegateSignature(struct UUserWidget* NewWidget); // Function GameInfoHUD_Master.GameInfoHUD_Master_C.BndEvt__GFTDynamicWidgetSwitcher_K2Node_ComponentBoundEvent_1_DisabledWidgetCreated__DelegateSignature // (BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_GameInfoHUD_Master(int32_t EntryPoint); // Function GameInfoHUD_Master.GameInfoHUD_Master_C.ExecuteUbergraph_GameInfoHUD_Master // (Final|UbergraphFunction) // @ game+0x1af5410
};

...
struct UPlayerFacingPerfText_C : UDesignableUserWidget {
	...
	void OnDataUpdated(); // Function PlayerFacingPerfText.PlayerFacingPerfText_C.OnDataUpdated // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnInitialized(); // Function PlayerFacingPerfText.PlayerFacingPerfText_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void OnSynchronizeProperties(); // Function PlayerFacingPerfText.PlayerFacingPerfText_C.OnSynchronizeProperties // (Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_PlayerFacingPerfText(int32_t EntryPoint); // Function PlayerFacingPerfText.PlayerFacingPerfText_C.ExecuteUbergraph_PlayerFacingPerfText // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

...
struct USavingTooltip_Desc_C : UUserWidget {
	...
	void getEquippableDataForToolTip(struct UShopPurchasableModel* Model); // Function SavingTooltip_Desc.SavingTooltip_Desc_C.getEquippableDataForToolTip // (Public|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1af5410
	void Construct(); // Function SavingTooltip_Desc.SavingTooltip_Desc_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_SavingTooltip_Desc(int32_t EntryPoint); // Function SavingTooltip_Desc.SavingTooltip_Desc_C.ExecuteUbergraph_SavingTooltip_Desc // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

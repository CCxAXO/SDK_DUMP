...
struct UWBP_Panel_PickemAwardedPointsDisplay_C : UUserWidget {
	...
	void Set Displayed Points(int32_t InAwardedPoints, int32_t InPossiblePoints); // Function WBP_Panel_PickemAwardedPointsDisplay.WBP_Panel_PickemAwardedPointsDisplay_C.Set Displayed Points // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void PreConstruct(bool IsDesignTime); // Function WBP_Panel_PickemAwardedPointsDisplay.WBP_Panel_PickemAwardedPointsDisplay_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_WBP_Panel_PickemAwardedPointsDisplay(int32_t EntryPoint); // Function WBP_Panel_PickemAwardedPointsDisplay.WBP_Panel_PickemAwardedPointsDisplay_C.ExecuteUbergraph_WBP_Panel_PickemAwardedPointsDisplay // (Final|UbergraphFunction) // @ game+0x1af5410
};

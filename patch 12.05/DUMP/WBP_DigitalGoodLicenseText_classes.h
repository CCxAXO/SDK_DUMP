...
struct UWBP_DigitalGoodLicenseText_C : UAresCommonUserWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function WBP_DigitalGoodLicenseText.WBP_DigitalGoodLicenseText_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_WBP_DigitalGoodLicenseText(int32_t EntryPoint); // Function WBP_DigitalGoodLicenseText.WBP_DigitalGoodLicenseText_C.ExecuteUbergraph_WBP_DigitalGoodLicenseText // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

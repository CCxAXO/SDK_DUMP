...
struct ABombOutOfBoundsVolume_C : AActor {
	...
	void ExecuteUbergraph_BombOutOfBoundsVolume(int32_t EntryPoint); // Function BombOutOfBoundsVolume.BombOutOfBoundsVolume_C.ExecuteUbergraph_BombOutOfBoundsVolume // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

...
struct UWBP_Screen_TimelineOptions_PC_C : UWBP_Screen_TimelineOptionsBase_C {
	...
	void SetConsoleKeybindColumnSpacing(); // Function WBP_Screen_TimelineOptions_PC.WBP_Screen_TimelineOptions_PC_C.SetConsoleKeybindColumnSpacing // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	struct UWidget* BP_GetDesiredFocusTarget(); // Function WBP_Screen_TimelineOptions_PC.WBP_Screen_TimelineOptions_PC_C.BP_GetDesiredFocusTarget // (Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent|Const) // @ game+0x1af5410
	...
	struct FEventReply OnMouseButtonDown(struct FGeometry MyGeometry, struct FPointerEvent& MouseEvent); // Function WBP_Screen_TimelineOptions_PC.WBP_Screen_TimelineOptions_PC_C.OnMouseButtonDown // (BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void On Match Id Changed(struct FString NewValue); // Function WBP_Screen_TimelineOptions_PC.WBP_Screen_TimelineOptions_PC_C.On Match Id Changed // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void BindEvents(bool Bind); // Function WBP_Screen_TimelineOptions_PC.WBP_Screen_TimelineOptions_PC_C.BindEvents // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void InitViewModels(); // Function WBP_Screen_TimelineOptions_PC.WBP_Screen_TimelineOptions_PC_C.InitViewModels // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void BP_OnActivated(); // Function WBP_Screen_TimelineOptions_PC.WBP_Screen_TimelineOptions_PC_C.BP_OnActivated // (Event|Protected|BlueprintEvent) // @ game+0x1af5410
	void BP_OnDeactivated(); // Function WBP_Screen_TimelineOptions_PC.WBP_Screen_TimelineOptions_PC_C.BP_OnDeactivated // (Event|Protected|BlueprintEvent) // @ game+0x1af5410
	void K2_BindToViewModel(); // Function WBP_Screen_TimelineOptions_PC.WBP_Screen_TimelineOptions_PC_C.K2_BindToViewModel // (Event|Public|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function WBP_Screen_TimelineOptions_PC.WBP_Screen_TimelineOptions_PC_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_WBP_Screen_TimelineOptions_PC(int32_t EntryPoint); // Function WBP_Screen_TimelineOptions_PC.WBP_Screen_TimelineOptions_PC_C.ExecuteUbergraph_WBP_Screen_TimelineOptions_PC // (Final|UbergraphFunction) // @ game+0x1af5410
};

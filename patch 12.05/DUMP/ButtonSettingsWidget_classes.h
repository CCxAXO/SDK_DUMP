...
struct UButtonSettingsWidget_C : UBaseSettingsWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function ButtonSettingsWidget.ButtonSettingsWidget_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void OnMouseEnter(struct FGeometry MyGeometry, struct FPointerEvent& MouseEvent); // Function ButtonSettingsWidget.ButtonSettingsWidget_C.OnMouseEnter // (BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // @ game+0x1af5410
	void OnMouseLeave(struct FPointerEvent& MouseEvent); // Function ButtonSettingsWidget.ButtonSettingsWidget_C.OnMouseLeave // (BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_ButtonSettingsWidget(int32_t EntryPoint); // Function ButtonSettingsWidget.ButtonSettingsWidget_C.ExecuteUbergraph_ButtonSettingsWidget // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
	void OnButtonClicked__DelegateSignature(struct UButtonSettingsWidget_C* Widget); // Function ButtonSettingsWidget.ButtonSettingsWidget_C.OnButtonClicked__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

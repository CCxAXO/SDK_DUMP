...
struct UCommunicationControls_VOSettings_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function CommunicationControls_VOSettings.CommunicationControls_VOSettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_CommunicationControls_VOSettings(int32_t EntryPoint); // Function CommunicationControls_VOSettings.CommunicationControls_VOSettings_C.ExecuteUbergraph_CommunicationControls_VOSettings // (Final|UbergraphFunction) // @ game+0x1af5410
};

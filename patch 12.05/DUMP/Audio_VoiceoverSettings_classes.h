...
struct UAudio_VoiceoverSettings_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function Audio_VoiceoverSettings.Audio_VoiceoverSettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_Audio_VoiceoverSettings(int32_t EntryPoint); // Function Audio_VoiceoverSettings.Audio_VoiceoverSettings_C.ExecuteUbergraph_Audio_VoiceoverSettings // (Final|UbergraphFunction) // @ game+0x1af5410
};

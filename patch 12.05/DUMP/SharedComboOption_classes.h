...
struct USharedComboOption_C : UUserWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function SharedComboOption.SharedComboOption_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function SharedComboOption.SharedComboOption_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_SharedComboOption(int32_t EntryPoint); // Function SharedComboOption.SharedComboOption_C.ExecuteUbergraph_SharedComboOption // (Final|UbergraphFunction) // @ game+0x1af5410
};

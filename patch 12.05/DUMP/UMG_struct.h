...
struct FWidgetChild {
	...
	struct TWeakObjectPtr<struct UWidget> WidgetPtr; // 0x0c(0x08)
};
...
struct FDelegateRuntimeBinding {
	...
	struct FDynamicPropertyPath SourcePath; // 0x28(0x38)
	enum class EBindingKind Kind; // 0x60(0x01)

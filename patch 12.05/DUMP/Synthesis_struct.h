...
struct FSourceEffectBitCrusherSettings {
	...
	struct FSoundModulationDestinationSettings SampleRateModulation; // 0x08(0x58)
	float CrushedBits; // 0x60(0x04)
	char pad_64[0x4]; // 0x64(0x04)
	struct FSoundModulationDestinationSettings BitModulation; // 0x68(0x58)
};
...
struct FSourceEffectChorusSettings {
	...
	float DryLevel; // 0x10(0x04)
	float Spread; // 0x14(0x04)
	struct FSoundModulationDestinationSettings DepthModulation; // 0x18(0x58)
	struct FSoundModulationDestinationSettings FrequencyModulation; // 0x70(0x58)
	struct FSoundModulationDestinationSettings FeedbackModulation; // 0xc8(0x58)
	struct FSoundModulationDestinationSettings WetModulation; // 0x120(0x58)
	struct FSoundModulationDestinationSettings DryModulation; // 0x178(0x58)
	struct FSoundModulationDestinationSettings SpreadModulation; // 0x1d0(0x58)
};
...
struct FSourceEffectConvolutionReverbSettings {
	...
	float WetVolumeDb; // 0x04(0x04)
	float DryVolumeDb; // 0x08(0x04)
	bool bBypass; // 0x0c(0x01)
	char pad_D[0x3]; // 0x0d(0x03)
};
...
struct FSourceEffectIndividualFilterSettings {
	enum class ESourceEffectMotionFilterCircuit FilterCircuit; // 0x00(0x01)
	enum class ESourceEffectMotionFilterType FilterType; // 0x01(0x01)
	char pad_2[0x2]; // 0x02(0x02)
	float CutoffFrequency; // 0x04(0x04)
	float FilterQ; // 0x08(0x04)
};
...
struct FSourceEffectMotionFilterModulationSettings {
	enum class ESourceEffectMotionFilterModSource ModulationSource; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct FVector2D ModulationInputRange; // 0x08(0x10)
	struct FVector2D ModulationOutputMinimumRange; // 0x18(0x10)
	struct FVector2D ModulationOutputMaximumRange; // 0x28(0x10)
	float UpdateEaseMS; // 0x38(0x04)
...
struct FSourceEffectMotionFilterSettings {
	enum class ESourceEffectMotionFilterTopology MotionFilterTopology; // 0x00(0x01)
	char pad_1[0x3]; // 0x01(0x03)
	float MotionFilterMix; // 0x04(0x04)
	struct FSourceEffectIndividualFilterSettings FilterASettings; // 0x08(0x0c)
	struct FSourceEffectIndividualFilterSettings FilterBSettings; // 0x14(0x0c)
	struct TMap<enum class ESourceEffectMotionFilterModDestination, struct FSourceEffectMotionFilterModulationSettings> ModulationMappings; // 0x20(0x50)
	float DryVolumeDb; // 0x70(0x04)
...
struct FSourceEffectSimpleDelaySettings {
	...
	char bUseDistanceOverride : 1; // 0x14(0x01)
...
struct FSubmixEffectConvolutionReverbSettings {
	...
	float DryVolumeDb; // 0x08(0x04)
	bool bBypass; // 0x0c(0x01)
	bool bMixInputChannelFormatToImpulseResponseFormat; // 0x0d(0x01)
	bool bMixReverbOutputToOutputChannelFormat; // 0x0e(0x01)
	char pad_F[0x1]; // 0x0f(0x01)
	float SurroundRearChannelBleedDb; // 0x10(0x04)
	bool bInvertRearChannelBleedPhase; // 0x14(0x01)
	bool bSurroundRearChannelFlip; // 0x15(0x01)
	char pad_16[0x2]; // 0x16(0x02)
	float SurroundRearChannelBleedAmount; // 0x18(0x04)
	char pad_1C[0x4]; // 0x1c(0x04)
	struct UAudioImpulseResponse* ImpulseResponse; // 0x20(0x08)
	bool AllowHardwareAcceleration; // 0x28(0x01)
...
struct FSubmixEffectMultibandCompressorSettings {
	...
	float LookAheadMsec; // 0x04(0x04)
	bool bAnalogMode; // 0x08(0x01)
	bool bFourPole; // 0x09(0x01)
	bool bBypass; // 0x0a(0x01)
	enum class ESubmixEffectDynamicsKeySource KeySource; // 0x0b(0x01)
	char pad_C[0x4]; // 0x0c(0x04)
	struct UAudioBus* ExternalAudioBus; // 0x10(0x08)
	struct USoundSubmix* ExternalSubmix; // 0x18(0x08)
	float KeyGainDb; // 0x20(0x04)
	bool bKeyAudition; // 0x24(0x01)
	char pad_25[0x3]; // 0x25(0x03)
...
struct FSubmixEffectStereoToQuadSettings {
	bool bFlipChannels; // 0x00(0x01)
	char pad_1[0x3]; // 0x01(0x03)
	float RearChannelGain; // 0x04(0x04)
};
...
struct FSynth2DSliderStyle : FSlateWidgetStyle {
	...
	struct FSlateBrush NormalThumbImage; // 0x10(0xd0)
	struct FSlateBrush DisabledThumbImage; // 0xe0(0xd0)
	struct FSlateBrush NormalBarImage; // 0x1b0(0xd0)
	struct FSlateBrush DisabledBarImage; // 0x280(0xd0)
	struct FSlateBrush BackgroundImage; // 0x350(0xd0)
	float BarThickness; // 0x420(0x04)
	char pad_424[0xc]; // 0x424(0x0c)
};

// ScriptStruct Synthesis.SynthKnobStyle
// Size: 0x360 (Inherited: 0x08)
struct FSynthKnobStyle : FSlateWidgetStyle {
	char pad_8[0x8]; // 0x08(0x08)
	struct FSlateBrush LargeKnob; // 0x10(0xd0)
	struct FSlateBrush LargeKnobOverlay; // 0xe0(0xd0)
	struct FSlateBrush MediumKnob; // 0x1b0(0xd0)
	struct FSlateBrush MediumKnobOverlay; // 0x280(0xd0)
	float MinValueAngle; // 0x350(0x04)
	float MaxValueAngle; // 0x354(0x04)
	enum class ESynthKnobSize KnobSize; // 0x358(0x01)

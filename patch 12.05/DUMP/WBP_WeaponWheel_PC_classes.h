...
struct UWBP_WeaponWheel_PC_C : UCoordinatedHUDElement {
	...
	void SetHUDModel(struct UCoordinatedHUDModel* HUDModel); // Function WBP_WeaponWheel_PC.WBP_WeaponWheel_PC_C.SetHUDModel // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_WBP_WeaponWheel_PC(int32_t EntryPoint); // Function WBP_WeaponWheel_PC.WBP_WeaponWheel_PC_C.ExecuteUbergraph_WBP_WeaponWheel_PC // (Final|UbergraphFunction) // @ game+0x1af5410
};

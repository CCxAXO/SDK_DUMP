...
struct ABP_RopeAscender_C : AActor {
	...
	void On Hide Outlines Setting Changed(enum class EAresBoolSettingName SettingName, bool OldValue, bool NewValue); // Function BP_RopeAscender.BP_RopeAscender_C.On Hide Outlines Setting Changed // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void HandleForceModuleRemoved(struct AShooterCharacter* Character); // Function BP_RopeAscender.BP_RopeAscender_C.HandleForceModuleRemoved // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void HandleForceModuleAdded(struct AShooterCharacter* Character); // Function BP_RopeAscender.BP_RopeAscender_C.HandleForceModuleAdded // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ShouldRepelActor(struct AActor* ActorOnRope, struct AActor* CollidingActor, bool& bShouldRepel); // Function BP_RopeAscender.BP_RopeAscender_C.ShouldRepelActor // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void RecordAscenderUse(struct AShooterCharacter* Character); // Function BP_RopeAscender.BP_RopeAscender_C.RecordAscenderUse // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ReceiveBeginPlay(); // Function BP_RopeAscender.BP_RopeAscender_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0x1af5410
	void OnRoundBegin_Event_1(int32_t RoundNumberBeginning); // Function BP_RopeAscender.BP_RopeAscender_C.OnRoundBegin_Event_1 // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void HandleCharacterCollision(struct UPrimitiveComponent* HitComponent, struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, struct FVector NormalImpulse, struct FHitResult& Hit); // Function BP_RopeAscender.BP_RopeAscender_C.HandleCharacterCollision // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnTeleported_Event_1(struct AShooterCharacter* Character); // Function BP_RopeAscender.BP_RopeAscender_C.OnTeleported_Event_1 // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void OnResetHighlighting(); // Function BP_RopeAscender.BP_RopeAscender_C.OnResetHighlighting // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_BP_RopeAscender(int32_t EntryPoint); // Function BP_RopeAscender.BP_RopeAscender_C.ExecuteUbergraph_BP_RopeAscender // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

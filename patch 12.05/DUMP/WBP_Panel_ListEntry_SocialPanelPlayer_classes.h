...
struct UWBP_Panel_ListEntry_SocialPanelPlayer_C : UWBP_Panel_ListEntry_Social_Base_C {
	...
	void RemoveAllUpdateLocks(); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.RemoveAllUpdateLocks // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	struct UUserWidget* OnGetUserMenuContent_EditFriendNote(); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.OnGetUserMenuContent_EditFriendNote // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OpenEditFriendNote(); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.OpenEditFriendNote // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void InitializeListEntry(struct UObject* InListItemObject); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.InitializeListEntry // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	struct UWidget* BP_GetDesiredFocusTarget(); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.BP_GetDesiredFocusTarget // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1af5410
	void UpdateInteractionAppearance(); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.UpdateInteractionAppearance // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void PreConstruct(bool IsDesignTime); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void Destruct(); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.Destruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void OnMouseLeave(struct FPointerEvent& MouseEvent); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.OnMouseLeave // (BlueprintCosmetic|Event|Public|HasOutParms|BlueprintEvent) // @ game+0x1af5410
	void OnPartyIDChanged(struct FString PartyId); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.OnPartyIDChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnPrimaryIdentitySourceChanged(enum class EAresIdentitySource PrimaryIdentitySource); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.OnPrimaryIdentitySourceChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnPlayerNameIdentitySourceChanged(enum class EAresIdentitySource PlayerNameIdentitySource); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.OnPlayerNameIdentitySourceChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnIsLocalPlayerChanged(bool bIsLocalPlayer); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.OnIsLocalPlayerChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnSocialExperienceLatestTransitionChanged(struct FSocialExperienceTransition InLatestTransition); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.OnSocialExperienceLatestTransitionChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnCanEditFriendNoteChanged(bool bCanEditFriendNote); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.OnCanEditFriendNoteChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnEditFriendNoteRequested(bool bEditFriendNoteRequested); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.OnEditFriendNoteRequested // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnEditFriendNoteCloseRequested(); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.OnEditFriendNoteCloseRequested // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void OnVoiceIndicatorVisibilityChanged(enum class ESlateVisibility InVisibility); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.OnVoiceIndicatorVisibilityChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void OnInitialized(); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_WBP_Panel_ListEntry_SocialPanelPlayer(int32_t EntryPoint); // Function WBP_Panel_ListEntry_SocialPanelPlayer.WBP_Panel_ListEntry_SocialPanelPlayer_C.ExecuteUbergraph_WBP_Panel_ListEntry_SocialPanelPlayer // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

...
struct USettingsNotificationBannerStateWidget_C : USettingsNotificationBannerWidget_C {
	...
	void PlayNotification(struct FText Message, enum class SettingsNotificationState NotifyState); // Function SettingsNotificationBannerStateWidget.SettingsNotificationBannerStateWidget_C.PlayNotification // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

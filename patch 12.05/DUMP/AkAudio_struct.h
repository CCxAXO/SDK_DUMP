...
struct FAkAdvancedInitializationSettingsWithMultiCoreRendering : FAkAdvancedInitializationSettings {
	bool EnableMultiCoreRendering; // 0x30(0x01)
	char pad_31[0x3]; // 0x31(0x03)
	uint32_t MaxNumJobWorkers; // 0x34(0x04)
	uint32_t JobWorkerMaxExecutionTimeUSec; // 0x38(0x04)
};

// ScriptStruct AkAudio.AkAndroidAdvancedInitializationSettings
// Size: 0x44 (Inherited: 0x3c)
struct FAkAndroidAdvancedInitializationSettings : FAkAdvancedInitializationSettingsWithMultiCoreRendering {
	uint32_t AudioAPI; // 0x3c(0x04)
	bool RoundFrameSizeToHardwareSize; // 0x40(0x01)
	bool bVerboseSink; // 0x41(0x01)
...
struct FAkOutputSettings {
	struct UAkAudioDeviceShareSet* AudioDeviceShareSet; // 0x00(0x08)
	int32_t IdDevice; // 0x08(0x04)
	enum class PanningRule PanRule; // 0x0c(0x01)
	enum class AkChannelConfiguration ChannelConfig; // 0x0d(0x01)
...
struct FAkGeometrySurfaceOverride {
	...
	bool bEnableOcclusionOverride; // 0x08(0x01)
...
struct FAkSpatialAudioSettings {
	...
	uint32_t DiffractionOrder; // 0x10(0x04)
	uint32_t DiffractionOnReflectionsOrder; // 0x14(0x04)
	float MaximumPathLength; // 0x18(0x04)
	float CPULimitPercentage; // 0x1c(0x04)
	uint32_t LoadBalancingSpread; // 0x20(0x04)
	bool EnableGeometricDiffractionAndTransmission; // 0x24(0x01)
	bool CalcEmitterVirtualPosition; // 0x25(0x01)
...
struct FAkCommunicationSettings {
	...
	struct FString NetworkName; // 0x08(0x10)
};
...
struct FAkCommunicationSettingsWithSystemInitialization : FAkCommunicationSettings {
	bool InitializeSystemComms; // 0x18(0x01)
...
struct FAkCommunicationSettingsWithCommSelection : FAkCommunicationSettings {
	enum class EAkCommSystem CommunicationSystem; // 0x18(0x04)
...
struct FAkCommonInitializationSettings {
	...
	struct FAkSpatialAudioSettings SpatialAudioSettings; // 0x40(0x28)
};
...
struct FAkPS4AdvancedInitializationSettings : FAkAdvancedInitializationSettingsWithMultiCoreRendering {
	uint32_t ACPBatchBufferSize; // 0x3c(0x04)
	bool UseHardwareCodecLowLatencyMode; // 0x40(0x01)
	bool bPlotQueueLevel; // 0x41(0x01)
	char pad_42[0x2]; // 0x42(0x02)
};
...
struct FAkPS5AdvancedInitializationSettings : FAkAdvancedInitializationSettingsWithMultiCoreRendering {
	...
	bool bVorbisHwAcceleration; // 0x3d(0x01)
	bool bEnable3DAudioSync; // 0x3e(0x01)
	char pad_3F[0x1]; // 0x3f(0x01)
	uint32_t uNumOperationsForHwMixing; // 0x40(0x04)
	bool bPlotQueueLevel; // 0x44(0x01)
	char pad_45[0x3]; // 0x45(0x03)
	uint32_t NumAudioOut2Ports; // 0x48(0x04)
	uint32_t NumAudioOut2ObjectPorts; // 0x4c(0x04)
};
...
struct FAkReverbDescriptor {
	...
	struct UPrimitiveComponent* Primitive; // 0x18(0x08)
...
struct FAkAcousticTextureParams {
	struct FVector4 AbsorptionValues; // 0x00(0x20)
...
struct FAkWindowsAdvancedInitializationSettings : FAkAdvancedInitializationSettingsWithMultiCoreRendering {
	bool UseHeadMountedDisplayAudioDevice; // 0x3c(0x01)
	char pad_3D[0x3]; // 0x3d(0x03)
	uint32_t MaxSystemAudioObjects; // 0x40(0x04)
};
...
struct FAkWinGDKAdvancedInitializationSettings : FAkAdvancedInitializationSettingsWithMultiCoreRendering {
	bool UseHeadMountedDisplayAudioDevice; // 0x3c(0x01)
	char pad_3D[0x3]; // 0x3d(0x03)
	uint32_t uMaxSystemAudioObjects; // 0x40(0x04)
};
...
struct FAkXboxOneGDKAdvancedInitializationSettings : FAkAdvancedInitializationSettingsWithMultiCoreRendering {
	uint16_t MaximumNumberOfXMAVoices; // 0x3c(0x02)
	bool UseHardwareCodecLowLatencyMode; // 0x3e(0x01)
	char pad_3F[0x1]; // 0x3f(0x01)
};
...
struct FAkXSXAdvancedInitializationSettings : FAkAdvancedInitializationSettingsWithMultiCoreRendering {
	...
	bool UseHardwareCodecLowLatencyMode; // 0x3e(0x01)
	char pad_3F[0x1]; // 0x3f(0x01)
	uint16_t MaximumNumberOfOpusVoices; // 0x40(0x02)
	char pad_42[0x2]; // 0x42(0x02)
	uint32_t uMaxSystemAudioObjects; // 0x44(0x04)
};

...
struct UPremierCrestDescription_C : UAresScreenBase {
	...
	void PreConstruct(bool IsDesignTime); // Function PremierCrestDescription.PremierCrestDescription_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function PremierCrestDescription.PremierCrestDescription_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_PremierCrestDescription(int32_t EntryPoint); // Function PremierCrestDescription.PremierCrestDescription_C.ExecuteUbergraph_PremierCrestDescription // (Final|UbergraphFunction) // @ game+0x1af5410
};

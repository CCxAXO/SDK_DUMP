...
struct UPregameParentWidgetBP_C : UPregameParentWidgetBase_C {
	...
	void AddScreen(struct UWidget* Screen); // Function PregameParentWidgetBP.PregameParentWidgetBP_C.AddScreen // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetScreen(struct UWidget* Screen); // Function PregameParentWidgetBP.PregameParentWidgetBP_C.SetScreen // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_PregameParentWidgetBP(int32_t EntryPoint); // Function PregameParentWidgetBP.PregameParentWidgetBP_C.ExecuteUbergraph_PregameParentWidgetBP // (Final|UbergraphFunction) // @ game+0x1af5410
};

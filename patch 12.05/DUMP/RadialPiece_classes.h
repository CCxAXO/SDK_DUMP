...
struct URadialPiece_C : UUserWidget {
	...
	bool IsHighlighted(double InMouseAngle, double InMouseDist); // Function RadialPiece.RadialPiece_C.IsHighlighted // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function RadialPiece.RadialPiece_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function RadialPiece.RadialPiece_C.Tick // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_RadialPiece(int32_t EntryPoint); // Function RadialPiece.RadialPiece_C.ExecuteUbergraph_RadialPiece // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

...
struct FClothCollisionPrim_Sphere {
	...
	struct FVector LocalPosition; // 0x08(0x18)
};
...
struct FClothCollisionPrim_Convex {
	struct TArray<struct FClothCollisionPrim_ConvexFace> Faces; // 0x00(0x10)
...
struct FClothCollisionPrim_Box {
	struct FVector LocalPosition; // 0x00(0x18)
	char pad_18[0x8]; // 0x18(0x08)
	struct FQuat LocalRotation; // 0x20(0x20)
	struct FVector HalfExtents; // 0x40(0x18)
	int32_t BoneIndex; // 0x58(0x04)

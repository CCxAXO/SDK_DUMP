...
struct FNamedPlateCropPreset {
	struct FString Name; // 0x00(0x10)
	struct FPlateCropSettings CropSettings; // 0x10(0x04)
...
struct FCameraTrackingFocusSettings {
	...
	char bDrawDebugTrackingFocusPoint : 1; // 0x48(0x01)
...
struct FCameraFocusSettings {
	...
	struct FCameraTrackingFocusSettings TrackingFocusSettings; // 0x08(0x50)
	char bSmoothFocusChanges : 1; // 0x58(0x01)
	char pad_58_1 : 7; // 0x58(0x01)
	char pad_59[0x3]; // 0x59(0x03)
	float FocusSmoothingInterpSpeed; // 0x5c(0x04)
	float FocusOffset; // 0x60(0x04)

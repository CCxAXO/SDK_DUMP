...
struct UWBP_EsportsPickemBracketTemplate_C : UAresScreenBase {
	...
	void StyleForGCC(); // Function WBP_EsportsPickemBracketTemplate.WBP_EsportsPickemBracketTemplate_C.StyleForGCC // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void StyleForChamps(); // Function WBP_EsportsPickemBracketTemplate.WBP_EsportsPickemBracketTemplate_C.StyleForChamps // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void StyleForMasters(); // Function WBP_EsportsPickemBracketTemplate.WBP_EsportsPickemBracketTemplate_C.StyleForMasters // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void StyleForPickemEvent(enum class E2024VCTEvent event); // Function WBP_EsportsPickemBracketTemplate.WBP_EsportsPickemBracketTemplate_C.StyleForPickemEvent // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void PreConstruct(bool IsDesignTime); // Function WBP_EsportsPickemBracketTemplate.WBP_EsportsPickemBracketTemplate_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	...
	void Construct(); // Function WBP_EsportsPickemBracketTemplate.WBP_EsportsPickemBracketTemplate_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_WBP_EsportsPickemBracketTemplate(int32_t EntryPoint); // Function WBP_EsportsPickemBracketTemplate.WBP_EsportsPickemBracketTemplate_C.ExecuteUbergraph_WBP_EsportsPickemBracketTemplate // (Final|UbergraphFunction) // @ game+0x1af5410
};

...
struct UWBP_Panel_CrosshairBarWrapper_C : UAresCommonUserWidget {
	...
	struct UWBP_CPanel_Setting_Bool_Toggle_C* WBP_CPanel_Setting_Bool_Toggle; // 0x430(0x08)

	void SetScreenElementVisibilities(struct FSettingsScreenElementVisibilities Element Visibilities); // Function WBP_Panel_CrosshairBarWrapper.WBP_Panel_CrosshairBarWrapper_C.SetScreenElementVisibilities // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void OnInitialized(); // Function WBP_Panel_CrosshairBarWrapper.WBP_Panel_CrosshairBarWrapper_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_WBP_Panel_CrosshairBarWrapper(int32_t EntryPoint); // Function WBP_Panel_CrosshairBarWrapper.WBP_Panel_CrosshairBarWrapper_C.ExecuteUbergraph_WBP_Panel_CrosshairBarWrapper // (Final|UbergraphFunction) // @ game+0x1af5410
};

...
struct UEOGRankCeremony_C : UUserWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function EOGRankCeremony.EOGRankCeremony_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void InitCeremony(int32_t Tier, int32_t LeaderboardRank, bool Placement); // Function EOGRankCeremony.EOGRankCeremony_C.InitCeremony // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_EOGRankCeremony(int32_t EntryPoint); // Function EOGRankCeremony.EOGRankCeremony_C.ExecuteUbergraph_EOGRankCeremony // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

...
struct UWBP_Panel_HovercardSection_OtherPlayerDetails_C : UWBP_Panel_HovercardSection_SocialPanelPlayer_Base_C {
	...
	void SetObservedPlayer(struct FString InPlayerSubject); // Function WBP_Panel_HovercardSection_OtherPlayerDetails.WBP_Panel_HovercardSection_OtherPlayerDetails_C.SetObservedPlayer // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void UpdateVisibility(); // Function WBP_Panel_HovercardSection_OtherPlayerDetails.WBP_Panel_HovercardSection_OtherPlayerDetails_C.UpdateVisibility // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_WBP_Panel_HovercardSection_OtherPlayerDetails(int32_t EntryPoint); // Function WBP_Panel_HovercardSection_OtherPlayerDetails.WBP_Panel_HovercardSection_OtherPlayerDetails_C.ExecuteUbergraph_WBP_Panel_HovercardSection_OtherPlayerDetails // (Final|UbergraphFunction) // @ game+0x1af5410
};

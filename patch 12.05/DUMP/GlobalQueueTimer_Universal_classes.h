...
struct UGlobalQueueTimer_Universal_C : UDesignableUserWidget {
	...
	void UpdateWidgetState(); // Function GlobalQueueTimer_Universal.GlobalQueueTimer_Universal_C.UpdateWidgetState // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function GlobalQueueTimer_Universal.GlobalQueueTimer_Universal_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void BndEvt__CloseButton_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature(); // Function GlobalQueueTimer_Universal.GlobalQueueTimer_Universal_C.BndEvt__CloseButton_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature // (BlueprintEvent) // @ game+0x1af5410
	void MM Changed(bool NewValue); // Function GlobalQueueTimer_Universal.GlobalQueueTimer_Universal_C.MM Changed // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnPartryStateChanged(enum class EPartyViewState PartyState); // Function GlobalQueueTimer_Universal.GlobalQueueTimer_Universal_C.OnPartryStateChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_GlobalQueueTimer_Universal(int32_t EntryPoint); // Function GlobalQueueTimer_Universal.GlobalQueueTimer_Universal_C.ExecuteUbergraph_GlobalQueueTimer_Universal // (Final|UbergraphFunction) // @ game+0x1af5410
};

...
struct UPremierEOG_WinLossCons_C : UPremierEOG_WinLossCons_Base_C {
	...
	void TriggerCeremony(); // Function PremierEOG_WinLossCons.PremierEOG_WinLossCons_C.TriggerCeremony // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void InitData(enum class EMatchupNextSteps NextSteps); // Function PremierEOG_WinLossCons.PremierEOG_WinLossCons_C.InitData // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

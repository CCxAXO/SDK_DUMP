...
struct UOnKillEffect_Base_C : UActorComponent {
	...
	void ReceiveBeginPlay(); // Function OnKillEffect_Base.OnKillEffect_Base_C.ReceiveBeginPlay // (Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ReceiveEndPlay(enum class EEndPlayReason EndPlayReason); // Function OnKillEffect_Base.OnKillEffect_Base_C.ReceiveEndPlay // (Event|Public|BlueprintEvent) // @ game+0x1af5410
	void AuthOnPlayerKilled(struct AOwnerExclusivePlayerInfo* KillerPlayerInfo, struct AOwnerExclusivePlayerInfo* VictimPlayerInfo, struct APawn* KilledPawn, struct UDamageResponse* Response, struct TArray<struct FAresAssist>& AssistList, struct UDamageType* DamageType); // Function OnKillEffect_Base.OnKillEffect_Base_C.AuthOnPlayerKilled // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_OnKillEffect_Base(int32_t EntryPoint); // Function OnKillEffect_Base.OnKillEffect_Base_C.ExecuteUbergraph_OnKillEffect_Base // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

...
struct UInterfaceControls_GeneralSettings_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function InterfaceControls_GeneralSettings.InterfaceControls_GeneralSettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void OnOptionsScreenToggled_Event_1(bool IsVisible); // Function InterfaceControls_GeneralSettings.InterfaceControls_GeneralSettings_C.OnOptionsScreenToggled_Event_1 // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ClientConfigUpdated(struct FName& ConfigName); // Function InterfaceControls_GeneralSettings.InterfaceControls_GeneralSettings_C.ClientConfigUpdated // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_InterfaceControls_GeneralSettings(int32_t EntryPoint); // Function InterfaceControls_GeneralSettings.InterfaceControls_GeneralSettings_C.ExecuteUbergraph_InterfaceControls_GeneralSettings // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

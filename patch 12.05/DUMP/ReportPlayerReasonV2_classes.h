...
struct UReportPlayerReasonV2_C : UReportPlayerOptionV2_C {
	...
	void UpdateDisplay(); // Function ReportPlayerReasonV2.ReportPlayerReasonV2_C.UpdateDisplay // (Protected|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

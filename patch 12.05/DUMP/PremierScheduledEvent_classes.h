...
struct UPremierScheduledEvent_C : UUserWidget {
	...
	void AdjustDataDisplaysForProEvent(int32_t EventNumber); // Function PremierScheduledEvent.PremierScheduledEvent_C.AdjustDataDisplaysForProEvent // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetModalStyle(bool IsModal); // Function PremierScheduledEvent.PremierScheduledEvent_C.SetModalStyle // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetCurrentEventStyleV2(enum class BPE_UpcomingEventStatus entryStatus); // Function PremierScheduledEvent.PremierScheduledEvent_C.SetCurrentEventStyleV2 // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void UpdateStates(); // Function PremierScheduledEvent.PremierScheduledEvent_C.UpdateStates // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void IsEventLive(bool& Is LIve, bool& IsPast); // Function PremierScheduledEvent.PremierScheduledEvent_C.IsEventLive // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1af5410
	void UpdateDataDisplays(); // Function PremierScheduledEvent.PremierScheduledEvent_C.UpdateDataDisplays // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function PremierScheduledEvent.PremierScheduledEvent_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void Init(struct UPremierScheduledEventModelOld* ScheduledEventModel); // Function PremierScheduledEvent.PremierScheduledEvent_C.Init // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void PreConstruct(bool IsDesignTime); // Function PremierScheduledEvent.PremierScheduledEvent_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void Select Event(); // Function PremierScheduledEvent.PremierScheduledEvent_C.Select Event // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void UpdateIsCurrentOrNextEvent(bool IsCurrentOrNext); // Function PremierScheduledEvent.PremierScheduledEvent_C.UpdateIsCurrentOrNextEvent // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Deselect Event(); // Function PremierScheduledEvent.PremierScheduledEvent_C.Deselect Event // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_PremierScheduledEvent(int32_t EntryPoint); // Function PremierScheduledEvent.PremierScheduledEvent_C.ExecuteUbergraph_PremierScheduledEvent // (Final|UbergraphFunction) // @ game+0x1af5410
	void OnScheduledEventSelected__DelegateSignature(struct UPremierScheduledEventModelOld* Scheduled Event Model); // Function PremierScheduledEvent.PremierScheduledEvent_C.OnScheduledEventSelected__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

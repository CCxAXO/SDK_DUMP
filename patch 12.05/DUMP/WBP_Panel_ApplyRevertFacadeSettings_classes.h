...
struct UWBP_Panel_ApplyRevertFacadeSettings_C : UAresCommonUserWidget {
	...
	void OnModalRevert(struct FGuid& ModalID); // Function WBP_Panel_ApplyRevertFacadeSettings.WBP_Panel_ApplyRevertFacadeSettings_C.OnModalRevert // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnModalConfirm(struct FGuid& ModalID); // Function WBP_Panel_ApplyRevertFacadeSettings.WBP_Panel_ApplyRevertFacadeSettings_C.OnModalConfirm // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OpenConfirmModal(); // Function WBP_Panel_ApplyRevertFacadeSettings.WBP_Panel_ApplyRevertFacadeSettings_C.OpenConfirmModal // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void Destruct(); // Function WBP_Panel_ApplyRevertFacadeSettings.WBP_Panel_ApplyRevertFacadeSettings_C.Destruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_WBP_Panel_ApplyRevertFacadeSettings(int32_t EntryPoint); // Function WBP_Panel_ApplyRevertFacadeSettings.WBP_Panel_ApplyRevertFacadeSettings_C.ExecuteUbergraph_WBP_Panel_ApplyRevertFacadeSettings // (Final|UbergraphFunction) // @ game+0x1af5410
};

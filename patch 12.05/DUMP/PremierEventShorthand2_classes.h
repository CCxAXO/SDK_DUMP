...
struct UPremierEventShorthand2_C : UTournamentsScreenV1 {
	...
	void Set WS_InPatientWaitingQueue(bool InPatientQueue); // Function PremierEventShorthand2.PremierEventShorthand2_C.Set WS_InPatientWaitingQueue // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void UpdateIsLive(); // Function PremierEventShorthand2.PremierEventShorthand2_C.UpdateIsLive // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void UpdateTimer(); // Function PremierEventShorthand2.PremierEventShorthand2_C.UpdateTimer // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Set WS_InTournamentWaitingQueue(bool InTournamentQueue); // Function PremierEventShorthand2.PremierEventShorthand2_C.Set WS_InTournamentWaitingQueue // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Set WS_Time__RestPeriod(bool IsRestPeriod); // Function PremierEventShorthand2.PremierEventShorthand2_C.Set WS_Time__RestPeriod // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Set WS_Live__QueueOpens_Label(bool IsLive); // Function PremierEventShorthand2.PremierEventShorthand2_C.Set WS_Live__QueueOpens_Label // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Set WS_Enrollment__Event_Info(bool IsEvent); // Function PremierEventShorthand2.PremierEventShorthand2_C.Set WS_Enrollment__Event_Info // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Set WS Match Info  VS(bool IsMatchInfo); // Function PremierEventShorthand2.PremierEventShorthand2_C.Set WS Match Info  VS // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Set WS_Match__Tournament(enum class EPremierEventType PremierEventType); // Function PremierEventShorthand2.PremierEventShorthand2_C.Set WS_Match__Tournament // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Set WS_Info__Waiting(bool IsInfo); // Function PremierEventShorthand2.PremierEventShorthand2_C.Set WS_Info__Waiting // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ResetRestPeriodTimer(); // Function PremierEventShorthand2.PremierEventShorthand2_C.ResetRestPeriodTimer // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void UpdateTournamentInfoWithEnemy(struct UMatchupParticipantModel* EnemyMatchupParticipantModel); // Function PremierEventShorthand2.PremierEventShorthand2_C.UpdateTournamentInfoWithEnemy // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void UpdateMatchInfo(struct FText MatchName); // Function PremierEventShorthand2.PremierEventShorthand2_C.UpdateMatchInfo // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void UpdateEventTimes(); // Function PremierEventShorthand2.PremierEventShorthand2_C.UpdateEventTimes // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void UpdateIsLiveInfo(bool IsLive); // Function PremierEventShorthand2.PremierEventShorthand2_C.UpdateIsLiveInfo // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void UpdateEnrollmentLockinInfo(int32_t DaysRemaining); // Function PremierEventShorthand2.PremierEventShorthand2_C.UpdateEnrollmentLockinInfo // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ShowEnrollmentWarning(bool IsEnrolled); // Function PremierEventShorthand2.PremierEventShorthand2_C.ShowEnrollmentWarning // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ShowTournamentBracketButton(bool ShouldDisplay); // Function PremierEventShorthand2.PremierEventShorthand2_C.ShowTournamentBracketButton // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void PreConstruct(bool IsDesignTime); // Function PremierEventShorthand2.PremierEventShorthand2_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function PremierEventShorthand2.PremierEventShorthand2_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	...
	void SetScheduledEvent(struct UPremierScheduledEventModelOld* ScheduledEventModel); // Function PremierEventShorthand2.PremierEventShorthand2_C.SetScheduledEvent // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function PremierEventShorthand2.PremierEventShorthand2_C.Tick // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_PremierEventShorthand2(int32_t EntryPoint); // Function PremierEventShorthand2.PremierEventShorthand2_C.ExecuteUbergraph_PremierEventShorthand2 // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
	void OnViewBracketButtonClicked__DelegateSignature(); // Function PremierEventShorthand2.PremierEventShorthand2_C.OnViewBracketButtonClicked__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

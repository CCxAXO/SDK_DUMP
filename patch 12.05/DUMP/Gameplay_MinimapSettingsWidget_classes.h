...
struct UGameplay_MinimapSettingsWidget_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function Gameplay_MinimapSettingsWidget.Gameplay_MinimapSettingsWidget_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void CustomEvent_4(enum class EAresBoolSettingName SettingName, bool OldValue, bool NewValue); // Function Gameplay_MinimapSettingsWidget.Gameplay_MinimapSettingsWidget_C.CustomEvent_4 // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_Gameplay_MinimapSettingsWidget(int32_t EntryPoint); // Function Gameplay_MinimapSettingsWidget.Gameplay_MinimapSettingsWidget_C.ExecuteUbergraph_Gameplay_MinimapSettingsWidget // (Final|UbergraphFunction) // @ game+0x1af5410
};

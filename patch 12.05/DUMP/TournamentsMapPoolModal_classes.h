...
struct UTournamentsMapPoolModal_C : UUserWidget {
	...
	void UpdateMapWidgets(); // Function TournamentsMapPoolModal.TournamentsMapPoolModal_C.UpdateMapWidgets // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SwapContentOrder(); // Function TournamentsMapPoolModal.TournamentsMapPoolModal_C.SwapContentOrder // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnLoaded_7FF3F9034BAE2001869E949D124FC77F(struct UObject* Loaded); // Function TournamentsMapPoolModal.TournamentsMapPoolModal_C.OnLoaded_7FF3F9034BAE2001869E949D124FC77F // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void Init(struct UPremierSeasonModelOld* PremierSeasonModel); // Function TournamentsMapPoolModal.TournamentsMapPoolModal_C.Init // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnInitialized(); // Function TournamentsMapPoolModal.TournamentsMapPoolModal_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_TournamentsMapPoolModal(int32_t EntryPoint); // Function TournamentsMapPoolModal.TournamentsMapPoolModal_C.ExecuteUbergraph_TournamentsMapPoolModal // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

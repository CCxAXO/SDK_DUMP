...
struct AShortyShellCasing_C : ABaseShellCasing_C {
	...
	void ReceiveTick(float DeltaSeconds); // Function ShortyShellCasing.ShortyShellCasing_C.ReceiveTick // (Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ReceiveHit(struct UPrimitiveComponent* MyComp, struct AActor* Other, struct UPrimitiveComponent* OtherComp, bool bSelfMoved, struct FVector HitLocation, struct FVector HitNormal, struct FVector NormalImpulse, struct FHitResult& Hit); // Function ShortyShellCasing.ShortyShellCasing_C.ReceiveHit // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_ShortyShellCasing(int32_t EntryPoint); // Function ShortyShellCasing.ShortyShellCasing_C.ExecuteUbergraph_ShortyShellCasing // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

...
struct ULeaderboardFirstPlayerViewEntry_C : UUserWidget {
	...
	void InitContextMenuAnchor(); // Function LeaderboardFirstPlayerViewEntry.LeaderboardFirstPlayerViewEntry_C.InitContextMenuAnchor // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetPlayer(struct ULeaderboardPlayerModel* Player, struct ULeaderboardViewModel* LeaderboardModel); // Function LeaderboardFirstPlayerViewEntry.LeaderboardFirstPlayerViewEntry_C.SetPlayer // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_LeaderboardFirstPlayerViewEntry(int32_t EntryPoint); // Function LeaderboardFirstPlayerViewEntry.LeaderboardFirstPlayerViewEntry_C.ExecuteUbergraph_LeaderboardFirstPlayerViewEntry // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

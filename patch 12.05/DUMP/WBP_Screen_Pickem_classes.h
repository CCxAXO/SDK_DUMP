...
struct UWBP_Screen_Pickem_C : UEsportsHubScreenV2 {
	...
	void On Pickem Overview Info Loaded(bool IsPickemOverviewInfoLoaded); // Function WBP_Screen_Pickem.WBP_Screen_Pickem_C.On Pickem Overview Info Loaded // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Setup Community Leaderboard(); // Function WBP_Screen_Pickem.WBP_Screen_Pickem_C.Setup Community Leaderboard // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Style For Pickem Events(); // Function WBP_Screen_Pickem.WBP_Screen_Pickem_C.Style For Pickem Events // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Style Widgets(); // Function WBP_Screen_Pickem.WBP_Screen_Pickem_C.Style Widgets // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetRewardsEnabled(bool IsRewardsPanelEnabled); // Function WBP_Screen_Pickem.WBP_Screen_Pickem_C.SetRewardsEnabled // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void On Playoffs Pick Block Changed(struct UPickemBlockModel* PlayoffsPickBlock); // Function WBP_Screen_Pickem.WBP_Screen_Pickem_C.On Playoffs Pick Block Changed // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void On Groups Pick Block Changed(struct UPickemBlockModel* GroupsPickBlock); // Function WBP_Screen_Pickem.WBP_Screen_Pickem_C.On Groups Pick Block Changed // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnRegistrationStatusChanged(enum class EPickemRegistrationStatus& RegistrationStatus); // Function WBP_Screen_Pickem.WBP_Screen_Pickem_C.OnRegistrationStatusChanged // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void BindToOrUnbindFromModelEvents(bool ShouldBind); // Function WBP_Screen_Pickem.WBP_Screen_Pickem_C.BindToOrUnbindFromModelEvents // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void On Is Registered Changed(bool NewValue); // Function WBP_Screen_Pickem.WBP_Screen_Pickem_C.On Is Registered Changed // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void Destruct(); // Function WBP_Screen_Pickem.WBP_Screen_Pickem_C.Destruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function WBP_Screen_Pickem.WBP_Screen_Pickem_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	...
	void OnScreenReady(); // Function WBP_Screen_Pickem.WBP_Screen_Pickem_C.OnScreenReady // (Event|Public|BlueprintEvent) // @ game+0x1af5410
	void K2_BindToViewModel(); // Function WBP_Screen_Pickem.WBP_Screen_Pickem_C.K2_BindToViewModel // (Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_WBP_Screen_Pickem(int32_t EntryPoint); // Function WBP_Screen_Pickem.WBP_Screen_Pickem_C.ExecuteUbergraph_WBP_Screen_Pickem // (Final|UbergraphFunction) // @ game+0x1af5410
};

...
struct UWBP_AbilityInfoButton_C : UAresCommonUserWidget {
	...
	void SetIconPromptText(struct FText Text); // Function WBP_AbilityInfoButton.WBP_AbilityInfoButton_C.SetIconPromptText // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void PreConstruct(bool IsDesignTime); // Function WBP_AbilityInfoButton.WBP_AbilityInfoButton_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function WBP_AbilityInfoButton.WBP_AbilityInfoButton_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	...
	void SetEntryData(struct FWildcard Data); // Function WBP_AbilityInfoButton.WBP_AbilityInfoButton_C.SetEntryData // (Event|Public|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_WBP_AbilityInfoButton(int32_t EntryPoint); // Function WBP_AbilityInfoButton.WBP_AbilityInfoButton_C.ExecuteUbergraph_WBP_AbilityInfoButton // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
	void OnButtonBaseClickChanged__DelegateSignature(struct UWBP_AbilityInfoButton_C* Button); // Function WBP_AbilityInfoButton.WBP_AbilityInfoButton_C.OnButtonBaseClickChanged__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

...
struct UCommunicationControls_RadioCommandWheelSettings_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function CommunicationControls_RadioCommandWheelSettings.CommunicationControls_RadioCommandWheelSettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_CommunicationControls_RadioCommandWheelSettings(int32_t EntryPoint); // Function CommunicationControls_RadioCommandWheelSettings.CommunicationControls_RadioCommandWheelSettings_C.ExecuteUbergraph_CommunicationControls_RadioCommandWheelSettings // (Final|UbergraphFunction) // @ game+0x1af5410
};

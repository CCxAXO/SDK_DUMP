...
struct UControlPointMeshComponent : UStaticMeshComponent {
	float VirtualTextureMainPassMaxDrawDistance; // 0x768(0x04)
};
...
struct ALandscapeProxy : APartitionActor {
	...
	void SetVirtualTextureRenderPassType(enum class ERuntimeVirtualTextureMainPassType InType); // Function Landscape.LandscapeProxy.SetVirtualTextureRenderPassType // (Final|Native|Public|BlueprintCallable) // @ game+0x34f63f0
	void SetLandscapeMaterialVectorParameterValue(struct FName ParameterName, struct FLinearColor Value); // Function Landscape.LandscapeProxy.SetLandscapeMaterialVectorParameterValue // (Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x34f53d0
	void SetLandscapeMaterialTextureParameterValue(struct FName ParameterName, struct UTexture* Value); // Function Landscape.LandscapeProxy.SetLandscapeMaterialTextureParameterValue // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x34f5630
	void SetLandscapeMaterialScalarParameterValue(struct FName ParameterName, float Value); // Function Landscape.LandscapeProxy.SetLandscapeMaterialScalarParameterValue // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x34f5160
	bool LandscapeExportHeightmapToRenderTarget(struct UTextureRenderTarget2d* InRenderTarget, bool InExportHeightIntoRGChannel, bool InExportLandscapeProxies); // Function Landscape.LandscapeProxy.LandscapeExportHeightmapToRenderTarget // (Final|Native|Public|BlueprintCallable) // @ game+0x34f4f10
	struct ALandscape* GetLandscapeActor(); // Function Landscape.LandscapeProxy.GetLandscapeActor // (Native|Public|BlueprintCallable) // @ game+0x34f5120
	void EditorSetLandscapeMaterial(struct UMaterialInterface* NewLandscapeMaterial); // Function Landscape.LandscapeProxy.EditorSetLandscapeMaterial // (Final|Native|Public|BlueprintCallable) // @ game+0x34f6120
	void EditorApplySpline(struct USplineComponent* InSplineComponent, float StartWidth, float EndWidth, float StartSideFalloff, float EndSideFalloff, float StartRoll, float EndRoll, int32_t NumSubdivisions, bool bRaiseHeights, bool bLowerHeights, struct ULandscapeLayerInfoObject* PaintLayer, struct FName EditLayerName); // Function Landscape.LandscapeProxy.EditorApplySpline // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x34f5a00
	void ChangeLODDistanceFactor(float InLODDistanceFactor); // Function Landscape.LandscapeProxy.ChangeLODDistanceFactor // (Native|Public|BlueprintCallable) // @ game+0x34f62f0
	void ChangeComponentScreenSizeToUseSubSections(float InComponentScreenSizeToUseSubSections); // Function Landscape.LandscapeProxy.ChangeComponentScreenSizeToUseSubSections // (Native|Public|BlueprintCallable) // @ game+0x34f61f0
};
...
struct ALandscape : ALandscapeProxy {
	...
	void RenderHeightmap(struct FTransform& InWorldTransform, struct FBox2D& InExtents, struct UTextureRenderTarget2d* OutRenderTarget); // Function Landscape.Landscape.RenderHeightmap // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x34b5d90
};
...
struct ULandscapeComponent : UPrimitiveComponent {
	int32_t SectionBaseX; // 0x690(0x04)
	int32_t SectionBaseY; // 0x694(0x04)
	int32_t ComponentSizeQuads; // 0x698(0x04)
	int32_t SubsectionSizeQuads; // 0x69c(0x04)
	int32_t NumSubsections; // 0x6a0(0x04)
	char pad_6A4[0x4]; // 0x6a4(0x04)
	struct UMaterialInterface* OverrideMaterial; // 0x6a8(0x08)
	struct UMaterialInterface* OverrideHoleMaterial; // 0x6b0(0x08)
	...
	struct UTexture2D* XYOffsetmapTexture; // 0x6e8(0x08)
	...
	void SetLODBias(int32_t InLODBias); // Function Landscape.LandscapeComponent.SetLODBias // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x34b6ed0
	void SetForcedLOD(int32_t InForcedLOD); // Function Landscape.LandscapeComponent.SetForcedLOD // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x34b7010
	struct UMaterialInstanceDynamic* GetMaterialInstanceDynamic(int32_t InIndex); // Function Landscape.LandscapeComponent.GetMaterialInstanceDynamic // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x34b7470
	float EditorGetPaintLayerWeightByNameAtLocation(struct FVector& InLocation, struct FName InPaintLayerName); // Function Landscape.LandscapeComponent.EditorGetPaintLayerWeightByNameAtLocation // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x34b7160
	float EditorGetPaintLayerWeightAtLocation(struct FVector& InLocation, struct ULandscapeLayerInfoObject* PaintLayer); // Function Landscape.LandscapeComponent.EditorGetPaintLayerWeightAtLocation // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x34b72f0
};
...
// Size: 0x780 (Inherited: 0x690)
struct ULandscapeHeightfieldCollisionComponent : UPrimitiveComponent {
	struct TArray<struct ULandscapeLayerInfoObject*> ComponentLayerInfos; // 0x690(0x10)
	int32_t SectionBaseX; // 0x6a0(0x04)
	int32_t SectionBaseY; // 0x6a4(0x04)
	int32_t CollisionSizeQuads; // 0x6a8(0x04)
	float CollisionScale; // 0x6ac(0x04)
	int32_t SimpleCollisionSizeQuads; // 0x6b0(0x04)
	char pad_6B4[0x4]; // 0x6b4(0x04)
	struct TArray<char> CollisionQuadFlags; // 0x6b8(0x10)
	struct FGuid HeightfieldGuid; // 0x6c8(0x10)
	struct FBox CachedLocalBox; // 0x6d8(0x38)
	struct ULandscapeComponent* RenderComponentRef; // 0x710(0x08)
	char pad_718[0x10]; // 0x718(0x10)
	struct TArray<struct UPhysicalMaterial*> CookedPhysicalMaterials; // 0x728(0x10)
	char pad_738[0x48]; // 0x738(0x48)

	struct ULandscapeComponent* GetRenderComponent(); // Function Landscape.LandscapeHeightfieldCollisionComponent.GetRenderComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x34b8920
};
...
struct ULandscapeMeshCollisionComponent : ULandscapeHeightfieldCollisionComponent {
	struct FGuid MeshGuid; // 0x778(0x10)
};
...
struct ULandscapeMeshProxyComponent : UStaticMeshComponent {
	struct FGuid LandscapeGuid; // 0x768(0x10)
	struct TArray<struct FIntPoint> ProxyComponentBases; // 0x778(0x10)
	int8_t ProxyLOD; // 0x788(0x01)
	uint32_t LODGroupKey; // 0x78c(0x04)
};
...
struct ULandscapeSplinesComponent : UPrimitiveComponent {
	struct TArray<struct ULandscapeSplineControlPoint*> ControlPoints; // 0x690(0x10)
	struct TArray<struct ULandscapeSplineSegment*> Segments; // 0x6a0(0x10)
	struct TArray<struct UMeshComponent*> CookedForeignMeshComponents; // 0x6b0(0x10)

	struct TArray<struct USplineMeshComponent*> GetSplineMeshComponents(); // Function Landscape.LandscapeSplinesComponent.GetSplineMeshComponents // (Final|Native|Public|BlueprintCallable) // @ game+0x34bb740
};
...
struct ALandscapeBlueprintBrushBase : AActor {
	...
	void RequestLandscapeUpdate(bool bInUserTriggered); // Function Landscape.LandscapeBlueprintBrushBase.RequestLandscapeUpdate // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x34c85e0
	struct UTextureRenderTarget2d* RenderLayer(struct FLandscapeBrushParameters& InParameters); // Function Landscape.LandscapeBlueprintBrushBase.RenderLayer // (RequiredAPI|Native|Event|Public|HasOutParms|BlueprintEvent) // @ game+0x34c8980
	struct UTextureRenderTarget2d* Render(bool InIsHeightmap, struct UTextureRenderTarget2d* InCombinedResult, struct FName& InWeightmapLayerName); // Function Landscape.LandscapeBlueprintBrushBase.Render // (RequiredAPI|Native|Event|Public|HasOutParms|BlueprintEvent) // @ game+0x34c8aa0
	void Initialize(struct FTransform& InLandscapeTransform, struct FIntPoint& InLandscapeSize, struct FIntPoint& InLandscapeRenderTargetSize); // Function Landscape.LandscapeBlueprintBrushBase.Initialize // (RequiredAPI|Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent) // @ game+0x34c86b0
	void GetBlueprintRenderDependencies(struct TArray<struct UObject*>& OutStreamableAssets); // Function Landscape.LandscapeBlueprintBrushBase.GetBlueprintRenderDependencies // (RequiredAPI|Event|Public|HasOutParms|BlueprintEvent) // @ game+0x1af5410
};
...
struct ULandscapeNaniteComponent : UStaticMeshComponent {
	struct FGuid ProxyContentId; // 0x768(0x10)
	bool bEnabled; // 0x778(0x01)
};

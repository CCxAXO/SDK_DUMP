...
struct UMapIntroV4_C : UMapIntro_Base_C {
	...
	void Init(struct UMapDataAsset* MapDataAsset, struct FString QueueID, struct UGameModeDataAsset* ModeDataAsset, struct FString GamePodID); // Function MapIntroV4.MapIntroV4_C.Init // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void UpdateQueueText(); // Function MapIntroV4.MapIntroV4_C.UpdateQueueText // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void HandleMapLoaded(struct UMapHandle* Map); // Function MapIntroV4.MapIntroV4_C.HandleMapLoaded // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void HandleModeLoaded(struct UGameModeHandle* ModeHandle); // Function MapIntroV4.MapIntroV4_C.HandleModeLoaded // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void HandleQueueLoaded(struct UMatchmakingQueueHandle* QueueHandle); // Function MapIntroV4.MapIntroV4_C.HandleQueueLoaded // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void PreConstruct(bool IsDesignTime); // Function MapIntroV4.MapIntroV4_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_MapIntroV4(int32_t EntryPoint); // Function MapIntroV4.MapIntroV4_C.ExecuteUbergraph_MapIntroV4 // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

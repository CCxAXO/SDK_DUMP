...
struct UHoudiniAssetComponent : UPrimitiveComponent {
	...
	struct UHoudiniAsset* HoudiniAsset; // 0x698(0x08)
	bool bCookOnParameterChange; // 0x6a0(0x01)
	bool bUploadTransformsToHoudiniEngine; // 0x6a1(0x01)
	bool bCookOnTransformChange; // 0x6a2(0x01)
	bool bCookOnAssetInputCook; // 0x6a3(0x01)
	bool bOutputless; // 0x6a4(0x01)
	bool bOutputTemplateGeos; // 0x6a5(0x01)
	bool bUseOutputNodes; // 0x6a6(0x01)
	char pad_6A7[0x1]; // 0x6a7(0x01)
	struct FDirectoryPath TemporaryCookFolder; // 0x6a8(0x10)
	struct FDirectoryPath BakeFolder; // 0x6b8(0x10)
	enum class EHoudiniStaticMeshMethod StaticMeshMethod; // 0x6c8(0x01)
	char pad_6C9[0x7]; // 0x6c9(0x07)
	struct FHoudiniStaticMeshGenerationProperties StaticMeshGenerationProperties; // 0x6d0(0x1e0)
	struct FMeshBuildSettings StaticMeshBuildSettings; // 0x8b0(0x48)
	bool bOverrideGlobalProxyStaticMeshSettings; // 0x8f8(0x01)
	bool bEnableProxyStaticMeshOverride; // 0x8f9(0x01)
	bool bEnableProxyStaticMeshRefinementByTimerOverride; // 0x8fa(0x01)
	char pad_8FB[0x1]; // 0x8fb(0x01)
	float ProxyMeshAutoRefineTimeoutSecondsOverride; // 0x8fc(0x04)
	bool bEnableProxyStaticMeshRefinementOnPreSaveWorldOverride; // 0x900(0x01)
	bool bEnableProxyStaticMeshRefinementOnPreBeginPIEOverride; // 0x901(0x01)
	bool bLandscapeUseTempLayers; // 0x902(0x01)
	char pad_903[0x1]; // 0x903(0x01)
	int32_t AssetID; // 0x904(0x04)
	struct TArray<int32_t> NodeIdsToCook; // 0x908(0x10)
	struct TMap<int32_t, int32_t> OutputNodeCookCounts; // 0x918(0x50)
	struct TSet<struct UHoudiniAssetComponent*> DownstreamHoudiniAssets; // 0x968(0x50)
	struct FGuid ComponentGUID; // 0x9b8(0x10)
	struct FGuid HapiGUID; // 0x9c8(0x10)
	struct FString HapiAssetName; // 0x9d8(0x10)
	enum class EHoudiniAssetState AssetState; // 0x9e8(0x01)
	enum class EHoudiniAssetState DebugLastAssetState; // 0x9e9(0x01)
	enum class EHoudiniAssetStateResult AssetStateResult; // 0x9ea(0x01)
	char pad_9EB[0x5]; // 0x9eb(0x05)
...
struct UHoudiniAssetBlueprintComponent : UHoudiniAssetComponent {
	...
	void SetToggleValueAt(struct FString Name, bool Value, int32_t Index); // Function HoudiniEngineRuntime.HoudiniAssetBlueprintComponent.SetToggleValueAt // (Final|Native|Public|BlueprintCallable) // @ game+0x7171db0
	void SetFloatParameter(struct FString Name, float Value, int32_t Index); // Function HoudiniEngineRuntime.HoudiniAssetBlueprintComponent.SetFloatParameter // (Final|Native|Public|BlueprintCallable) // @ game+0x7172060
	bool HasParameter(struct FString Name); // Function HoudiniEngineRuntime.HoudiniAssetBlueprintComponent.HasParameter // (Final|Native|Public|BlueprintCallable) // @ game+0x71723a0
};
...
struct UHoudiniAssetComponent_V1 : UPrimitiveComponent {
	char bGeneratedDoubleSidedGeometry : 1; // 0x690(0x01)
	char pad_690_1 : 7; // 0x690(0x01)
	char pad_691[0x7]; // 0x691(0x07)
	struct UPhysicalMaterial* GeneratedPhysMaterial; // 0x698(0x08)
	struct FBodyInstance DefaultBodyInstance; // 0x6a0(0x190)
	enum class ECollisionTraceFlag GeneratedCollisionTraceFlag; // 0x830(0x01)
	char pad_831[0x3]; // 0x831(0x03)
	int32_t GeneratedLightMapResolution; // 0x834(0x04)
	float GeneratedDistanceFieldResolutionScale; // 0x838(0x04)
	struct FWalkableSlopeOverride GeneratedWalkableSlopeOverride; // 0x83c(0x10)
	int32_t GeneratedLightMapCoordinateIndex; // 0x84c(0x04)
	char bGeneratedUseMaximumStreamingTexelRatio : 1; // 0x850(0x01)
	char pad_850_1 : 7; // 0x850(0x01)
	char pad_851[0x3]; // 0x851(0x03)
	float GeneratedStreamingDistanceMultiplier; // 0x854(0x04)
	struct UFoliageType_InstancedStaticMesh* GeneratedFoliageDefaultSettings; // 0x858(0x08)
	struct TArray<struct UAssetUserData*> GeneratedAssetUserData; // 0x860(0x10)
	struct FText BakeFolder; // 0x870(0x18)
	struct FText TempCookFolder; // 0x888(0x18)
	char pad_8A0[0x340]; // 0x8a0(0x340)
};
...
struct UHoudiniStaticMesh : UObject {
	...
	void SetVertexPosition(uint32_t InVertexIndex, struct FVector3f& InPosition); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetVertexPosition // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x718dc60
	void SetTriangleVertexVTangent(uint32_t InTriangleIndex, char InTriangleVertexIndex, struct FVector3f& InVTangent); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexVTangent // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x718d3a0
	void SetTriangleVertexUV(uint32_t InTriangleIndex, char InTriangleVertexIndex, char InUVLayer, struct FVector2f& InUV); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexUV // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x718ce60
	void SetTriangleVertexUTangent(uint32_t InTriangleIndex, char InTriangleVertexIndex, struct FVector3f& InUTangent); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexUTangent // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x718d600
	void SetTriangleVertexNormal(uint32_t InTriangleIndex, char InTriangleVertexIndex, struct FVector3f& InNormal); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexNormal // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x718d860
	void SetTriangleVertexIndices(uint32_t InTriangleIndex, struct FIntVector& InTriangleVertexIndices); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexIndices // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x718dac0
	void SetTriangleVertexColor(uint32_t InTriangleIndex, char InTriangleVertexIndex, struct FColor& InColor); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexColor // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x718d150
	void SetTriangleMaterialID(uint32_t InTriangleIndex, int32_t InMaterialID); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleMaterialID // (Final|Native|Public) // @ game+0x718ccb0
	void SetStaticMaterial(uint32_t InMaterialIndex, struct FStaticMaterial& InStaticMaterial); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetStaticMaterial // (Final|Native|Public|HasOutParms) // @ game+0x718cab0
	void SetNumUVLayers(uint32_t InNumUVLayers); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetNumUVLayers // (Final|Native|Public) // @ game+0x718dfd0
	void SetNumStaticMaterials(uint32_t InNumStaticMaterials); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetNumStaticMaterials // (Final|Native|Public) // @ game+0x718de20
	void SetHasTangents(bool bInHasTangents); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetHasTangents // (Final|Native|Public) // @ game+0x718e260
	void SetHasPerFaceMaterials(bool bInHasPerFaceMaterials); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetHasPerFaceMaterials // (Final|Native|Public) // @ game+0x718e460
	void SetHasNormals(bool bInHasNormals); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetHasNormals // (Final|Native|Public) // @ game+0x718e360
	void SetHasColors(bool bInHasColors); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetHasColors // (Final|Native|Public) // @ game+0x718e160
	void Optimize(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.Optimize // (Final|Native|Public) // @ game+0x718c580
	bool IsValid(bool bInSkipVertexIndicesCheck); // Function HoudiniEngineRuntime.HoudiniStaticMesh.IsValid // (Final|Native|Public|Const) // @ game+0x718bf90
	void Initialize(uint32_t InNumVertices, uint32_t InNumTriangles, uint32_t InNumUVLayers, uint32_t InInitialNumStaticMaterials, bool bInHasNormals, bool bInHasTangents, bool bInHasColors, bool bInHasPerFaceMaterials); // Function HoudiniEngineRuntime.HoudiniStaticMesh.Initialize // (Final|Native|Public) // @ game+0x718e560
	bool HasTangents(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.HasTangents // (Final|Native|Public|Const) // @ game+0x5ccbb80
	bool HasPerFaceMaterials(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.HasPerFaceMaterials // (Final|Native|Public|Const) // @ game+0x5998db0
	bool HasNormals(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.HasNormals // (Final|Native|Public|Const) // @ game+0x4283560
	bool HasColors(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.HasColors // (Final|Native|Public|Const) // @ game+0x5ccbb60
	struct TArray<struct FVector3f> GetVertexPositions(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexPositions // (Final|Native|Public|Const) // @ game+0x718c500
	struct TArray<struct FVector3f> GetVertexInstanceVTangents(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexInstanceVTangents // (Final|Native|Public|Const) // @ game+0x718c410
	struct TArray<struct FVector2f> GetVertexInstanceUVs(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexInstanceUVs // (Final|Native|Public|Const) // @ game+0x718c3e0
	struct TArray<struct FVector3f> GetVertexInstanceUTangents(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexInstanceUTangents // (Final|Native|Public|Const) // @ game+0x718c440
	struct TArray<struct FVector3f> GetVertexInstanceNormals(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexInstanceNormals // (Final|Native|Public|Const) // @ game+0x718c470
	struct TArray<struct FColor> GetVertexInstanceColors(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexInstanceColors // (Final|Native|Public|Const) // @ game+0x718c4a0
	struct TArray<struct FIntVector> GetTriangleIndices(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetTriangleIndices // (Final|Native|Public|Const) // @ game+0x718c4d0
	struct TArray<struct FStaticMaterial> GetStaticMaterials(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetStaticMaterials // (Final|Native|Public|Const) // @ game+0x718c380
	uint32_t GetNumVertices(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetNumVertices // (Final|Native|Public|Const) // @ game+0x4282880
	uint32_t GetNumVertexInstances(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetNumVertexInstances // (Final|Native|Public|Const) // @ game+0x718de00
	uint32_t GetNumUVLayers(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetNumUVLayers // (Final|Native|Public|Const) // @ game+0x4b7a370
	uint32_t GetNumTriangles(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetNumTriangles // (Final|Native|Public|Const) // @ game+0x42823e0
	uint32_t GetNumStaticMaterials(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetNumStaticMaterials // (Final|Native|Public|Const) // @ game+0x59bc190
	int32_t GetMaterialIndex(struct FName InMaterialSlotName); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetMaterialIndex // (Final|Native|Public|Const) // @ game+0x718c140
	struct TArray<int32_t> GetMaterialIDsPerTriangle(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetMaterialIDsPerTriangle // (Final|Native|Public|Const) // @ game+0x718c3b0
	struct UMaterialInterface* GetMaterial(int32_t InMaterialIndex); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetMaterial // (Final|Native|Public) // @ game+0x718c280
	void CalculateTangents(bool bInComputeWeightedNormals); // Function HoudiniEngineRuntime.HoudiniStaticMesh.CalculateTangents // (Final|Native|Public) // @ game+0x718c660
	void CalculateNormals(bool bInComputeWeightedNormals); // Function HoudiniEngineRuntime.HoudiniStaticMesh.CalculateNormals // (Final|Native|Public) // @ game+0x718c840
	struct FBox CalcBounds(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.CalcBounds // (Final|Native|Public|HasDefaults|Const) // @ game+0x718c530
	uint32_t AddStaticMaterial(struct FStaticMaterial& InStaticMaterial); // Function HoudiniEngineRuntime.HoudiniStaticMesh.AddStaticMaterial // (Final|Native|Public|HasOutParms) // @ game+0x718c940
};
...
struct UHoudiniStaticMeshComponent : UMeshComponent {
	struct UHoudiniStaticMesh* Mesh; // 0x6d8(0x08)
	struct FBox LocalBounds; // 0x6e0(0x38)
	bool bHoudiniIconVisible; // 0x718(0x01)

	void SetMesh(struct UHoudiniStaticMesh* InMesh); // Function HoudiniEngineRuntime.HoudiniStaticMeshComponent.SetMesh // (Final|Native|Public) // @ game+0x718f960
	void SetHoudiniIconVisible(bool bInHoudiniIconVisible); // Function HoudiniEngineRuntime.HoudiniStaticMeshComponent.SetHoudiniIconVisible // (Final|Native|Public) // @ game+0x718f830
	void NotifyMeshUpdated(); // Function HoudiniEngineRuntime.HoudiniStaticMeshComponent.NotifyMeshUpdated // (Final|Native|Public) // @ game+0x718f940
	bool IsHoudiniIconVisible(); // Function HoudiniEngineRuntime.HoudiniStaticMeshComponent.IsHoudiniIconVisible // (Final|Native|Public|Const) // @ game+0x718f920
	struct UHoudiniStaticMesh* GetMesh(); // Function HoudiniEngineRuntime.HoudiniStaticMeshComponent.GetMesh // (Final|Native|Public) // @ game+0x583dca0
};

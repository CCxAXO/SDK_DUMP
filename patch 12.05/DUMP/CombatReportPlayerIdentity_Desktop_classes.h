...
struct UCombatReportPlayerIdentity_Desktop_C : UWBP_CombatReportPlayerIdentity_Base_C {
	...
	void InitPremier(); // Function CombatReportPlayerIdentity_Desktop.CombatReportPlayerIdentity_Desktop_C.InitPremier // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Initialize(bool Ally, bool Me, bool IsCompetitiveMatch, struct UCharacterDataAsset* Character, struct AShooterPlayerState* PlayerState, struct FString Subject); // Function CombatReportPlayerIdentity_Desktop.CombatReportPlayerIdentity_Desktop_C.Initialize // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetHideAccountLevel(bool HideAccountLevel); // Function CombatReportPlayerIdentity_Desktop.CombatReportPlayerIdentity_Desktop_C.SetHideAccountLevel // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Init(bool Ally, bool Me, bool IsCompetitiveMatch, struct UCharacterDataAsset* Character, struct AShooterPlayerState* PlayerState, struct FString Subject); // Function CombatReportPlayerIdentity_Desktop.CombatReportPlayerIdentity_Desktop_C.Init // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void InitFromLoadingPlayer(bool IsCompetitiveMatch, bool Ally, struct FLoadingScreenPlayer Player); // Function CombatReportPlayerIdentity_Desktop.CombatReportPlayerIdentity_Desktop_C.InitFromLoadingPlayer // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void InitInternal(); // Function CombatReportPlayerIdentity_Desktop.CombatReportPlayerIdentity_Desktop_C.InitInternal // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void UpdateAllyAndMe(bool Me); // Function CombatReportPlayerIdentity_Desktop.CombatReportPlayerIdentity_Desktop_C.UpdateAllyAndMe // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void UpdateName(struct FString Name); // Function CombatReportPlayerIdentity_Desktop.CombatReportPlayerIdentity_Desktop_C.UpdateName // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void PreConstruct(bool IsDesignTime); // Function CombatReportPlayerIdentity_Desktop.CombatReportPlayerIdentity_Desktop_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_CombatReportPlayerIdentity_Desktop(int32_t EntryPoint); // Function CombatReportPlayerIdentity_Desktop.CombatReportPlayerIdentity_Desktop_C.ExecuteUbergraph_CombatReportPlayerIdentity_Desktop // (Final|UbergraphFunction) // @ game+0x1af5410
};

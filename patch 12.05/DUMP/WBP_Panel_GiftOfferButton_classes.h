...
struct UWBP_Panel_GiftOfferButton_C : UAresCommonUserWidget {
	...
	void UpdateSecondaryThumbnailVisuals(); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.UpdateSecondaryThumbnailVisuals // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void HandleGiftingEligibleStatusChanged(enum class EGiftingEligibleStatus GiftingEligibleStatus); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.HandleGiftingEligibleStatusChanged // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void BindEvents(bool Bind); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.BindEvents // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void InitViewModels(); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.InitViewModels // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetSelectedSubOfferDTO(struct UOfferDTO* SelectedSubOfferDTO); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.SetSelectedSubOfferDTO // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetBundleOfferDTO(struct UBundleViewModel* BundleOfferDTO); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.SetBundleOfferDTO // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void HandleClicked(); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.HandleClicked // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void K2_BindToViewModel(); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.K2_BindToViewModel // (Event|Public|BlueprintEvent) // @ game+0x1af5410
	void PreConstruct(bool IsDesignTime); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_WBP_Panel_GiftOfferButton(int32_t EntryPoint); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.ExecuteUbergraph_WBP_Panel_GiftOfferButton // (Final|UbergraphFunction) // @ game+0x1af5410
	void OnClicked__DelegateSignature(struct UOfferDTOList* GiftOfferDTOList); // Function WBP_Panel_GiftOfferButton.WBP_Panel_GiftOfferButton_C.OnClicked__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

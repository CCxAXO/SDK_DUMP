...
struct FCharacterAbilityCastInfo {
	...
	struct FVector CastLocation_21_61F4B6BC47A10FE8CD34D29141FC9B88; // 0x20(0x18)
	struct TArray<struct FVector> EffectLocations_43_87E1E5154C2FB9C8A2D7FABF07AB5AF2; // 0x38(0x10)
	int32_t DestroyedCount_36_5936AB33418F8A2AB3A52DBF4492CF7F; // 0x48(0x04)
	char pad_4C[0x4]; // 0x4c(0x04)
	struct TArray<struct FCharacterAbilityEffectInfo> Effects_16_261D1D464B8B155AEE02A58E843AACB8; // 0x50(0x10)
};

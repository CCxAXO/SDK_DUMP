...
struct UPlayerCardImageSet_C : UAresBasePrimaryDataAsset {
	...
	void GetCardImageDefinition(enum class EPlayerCardImageType ImageType, struct FPlayerCardImageDefinition& Image Definition); // Function PlayerCardImageSet.PlayerCardImageSet_C.GetCardImageDefinition // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1af5410
};

...
struct UWBP_Panel_SwissAdvance_C : UUserWidget {
	...
	void SetText(bool bIsAdvancing, int32_t NumGamesNeeded, struct FString StageName); // Function WBP_Panel_SwissAdvance.WBP_Panel_SwissAdvance_C.SetText // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Style Card(bool IsAdvancing); // Function WBP_Panel_SwissAdvance.WBP_Panel_SwissAdvance_C.Style Card // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void InitWithViewModels(struct TArray<struct UEsportsMatchupTeamViewModel*>& InTeamViewModels, bool IsAdvancing, int32_t NumGamesNeeded, struct FString StageName); // Function WBP_Panel_SwissAdvance.WBP_Panel_SwissAdvance_C.InitWithViewModels // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void PreConstruct(bool IsDesignTime); // Function WBP_Panel_SwissAdvance.WBP_Panel_SwissAdvance_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void OnInitialized(); // Function WBP_Panel_SwissAdvance.WBP_Panel_SwissAdvance_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_WBP_Panel_SwissAdvance(int32_t EntryPoint); // Function WBP_Panel_SwissAdvance.WBP_Panel_SwissAdvance_C.ExecuteUbergraph_WBP_Panel_SwissAdvance // (Final|UbergraphFunction) // @ game+0x1af5410
};

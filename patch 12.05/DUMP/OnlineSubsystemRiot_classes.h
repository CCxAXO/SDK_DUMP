...
struct URGIOPRiotGamesApiEditorSettings : UDeveloperSettings {
	...
	struct TArray<struct FString> GetPatchlineOptions(); // Function OnlineSubsystemRiot.RGIOPRiotGamesApiEditorSettings.GetPatchlineOptions // (Final|Native|Public|Const) // @ game+0x55047c0
};

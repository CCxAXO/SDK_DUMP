...
struct UWeaponStats_DamageFalloffEntry_C : UUserWidget {
	...
	void SetSeparatorVisibility(int32_t NumberIndex, enum class ESlateVisibility NewVisibility); // Function WeaponStats_DamageFalloffEntry.WeaponStats_DamageFalloffEntry_C.SetSeparatorVisibility // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetContent(struct TArray<double>& DamageValues); // Function WeaponStats_DamageFalloffEntry.WeaponStats_DamageFalloffEntry_C.SetContent // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void InitializeChildren(); // Function WeaponStats_DamageFalloffEntry.WeaponStats_DamageFalloffEntry_C.InitializeChildren // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void PreConstruct(bool IsDesignTime); // Function WeaponStats_DamageFalloffEntry.WeaponStats_DamageFalloffEntry_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_WeaponStats_DamageFalloffEntry(int32_t EntryPoint); // Function WeaponStats_DamageFalloffEntry.WeaponStats_DamageFalloffEntry_C.ExecuteUbergraph_WeaponStats_DamageFalloffEntry // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

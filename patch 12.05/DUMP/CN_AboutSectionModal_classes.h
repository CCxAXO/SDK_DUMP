...
struct UCN_AboutSectionModal_C : UUserWidget {
	...
	struct FAresMainMenuNavBarData GetNavBarData(); // Function CN_AboutSectionModal.CN_AboutSectionModal_C.GetNavBarData // (Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1af5410
	bool HandleBackRequest(); // Function CN_AboutSectionModal.CN_AboutSectionModal_C.HandleBackRequest // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

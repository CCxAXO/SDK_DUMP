...
struct URoundOutcomeIcon_C : UDesignableUserWidget {
	...
	void Initialize(int32_t RoundIndex, struct FProcessedMatchDetails ProcessMatchDetailsDTO, struct FString TargetSubject); // Function RoundOutcomeIcon.RoundOutcomeIcon_C.Initialize // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_RoundOutcomeIcon(int32_t EntryPoint); // Function RoundOutcomeIcon.RoundOutcomeIcon_C.ExecuteUbergraph_RoundOutcomeIcon // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

...
struct UWBP_Misc_Esports_EventDots_C : UAresCommonUserWidget {
	...
	void DisplayProgressLine(bool bShowLine); // Function WBP_Misc_Esports_EventDots.WBP_Misc_Esports_EventDots_C.DisplayProgressLine // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void StyleDotsFromStatus(enum class EEsportsMatchStatus InMatchStatus); // Function WBP_Misc_Esports_EventDots.WBP_Misc_Esports_EventDots_C.StyleDotsFromStatus // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

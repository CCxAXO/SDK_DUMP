...
struct UMainMenuNavBar_BackButton_PC_C : UUserWidget {
	...
	void ExecuteUbergraph_MainMenuNavBar_BackButton_PC(int32_t EntryPoint); // Function MainMenuNavBar_BackButton_PC.MainMenuNavBar_BackButton_PC_C.ExecuteUbergraph_MainMenuNavBar_BackButton_PC // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
	void OnClicked__DelegateSignature(); // Function MainMenuNavBar_BackButton_PC.MainMenuNavBar_BackButton_PC_C.OnClicked__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

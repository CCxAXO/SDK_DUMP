...
struct UMovieSceneTransformOrigin : UInterface {
	...
	struct FTransform BP_GetTransformOrigin(); // Function MovieSceneTracks.MovieSceneTransformOrigin.BP_GetTransformOrigin // (RequiredAPI|Event|Protected|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1af5410
};
...
struct UMovieScene3DConstraintSection : UMovieSceneSection {
	...
	void SetConstraintBindingID(struct FMovieSceneObjectBindingID& InConstraintBindingID); // Function MovieSceneTracks.MovieScene3DConstraintSection.SetConstraintBindingID // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x37507c0
	struct FMovieSceneObjectBindingID GetConstraintBindingID(); // Function MovieSceneTracks.MovieScene3DConstraintSection.GetConstraintBindingID // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x37508e0
};
...
struct UMovieSceneAudioSection : UMovieSceneSection {
	...
	void SetSuppressSubtitles(bool bInSuppressSubtitles); // Function MovieSceneTracks.MovieSceneAudioSection.SetSuppressSubtitles // (Final|Native|Public|BlueprintCallable) // @ game+0x3758000
	void SetStartOffset(struct FFrameNumber InStartOffset); // Function MovieSceneTracks.MovieSceneAudioSection.SetStartOffset // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x3758240
	void SetSound(struct USoundBase* InSound); // Function MovieSceneTracks.MovieSceneAudioSection.SetSound // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x3758350
	void SetOverrideAttenuation(bool bInOverrideAttenuation); // Function MovieSceneTracks.MovieSceneAudioSection.SetOverrideAttenuation // (Final|Native|Public|BlueprintCallable) // @ game+0x3757ef0
	void SetLooping(bool bInLooping); // Function MovieSceneTracks.MovieSceneAudioSection.SetLooping // (Final|Native|Public|BlueprintCallable) // @ game+0x3758110
	void SetAttenuationSettings(struct USoundAttenuation* InAttenuationSettings); // Function MovieSceneTracks.MovieSceneAudioSection.SetAttenuationSettings // (Final|Native|Public|BlueprintCallable) // @ game+0x3757de0
	bool GetSuppressSubtitles(); // Function MovieSceneTracks.MovieSceneAudioSection.GetSuppressSubtitles // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x37580f0
	struct FFrameNumber GetStartOffset(); // Function MovieSceneTracks.MovieSceneAudioSection.GetStartOffset // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x3758220
	struct USoundBase* GetSound(); // Function MovieSceneTracks.MovieSceneAudioSection.GetSound // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x3758330
	bool GetOverrideAttenuation(); // Function MovieSceneTracks.MovieSceneAudioSection.GetOverrideAttenuation // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x3757fe0
	bool GetLooping(); // Function MovieSceneTracks.MovieSceneAudioSection.GetLooping // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x3758200
	struct USoundAttenuation* GetAttenuationSettings(); // Function MovieSceneTracks.MovieSceneAudioSection.GetAttenuationSettings // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x3757ed0
};
...
struct UMovieSceneCameraCutSection : UMovieSceneSection {
	...
	void SetCameraBindingID(struct FMovieSceneObjectBindingID& InCameraBindingID); // Function MovieSceneTracks.MovieSceneCameraCutSection.SetCameraBindingID // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x375d150
	struct FMovieSceneObjectBindingID GetCameraBindingID(); // Function MovieSceneTracks.MovieSceneCameraCutSection.GetCameraBindingID // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x375d270
};
...
struct UMovieSceneCinematicShotSection : UMovieSceneSubSection {
	...
	void SetShotDisplayName(struct FString InShotDisplayName); // Function MovieSceneTracks.MovieSceneCinematicShotSection.SetShotDisplayName // (Final|Native|Public|BlueprintCallable) // @ game+0x375df20
	struct FString GetShotDisplayName(); // Function MovieSceneTracks.MovieSceneCinematicShotSection.GetShotDisplayName // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x375e0b0
};
...
struct UMovieSceneCVarSection : UMovieSceneSection {
	...
	void SetFromString(struct FString InString); // Function MovieSceneTracks.MovieSceneCVarSection.SetFromString // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x375f9c0
	struct FString GetString(); // Function MovieSceneTracks.MovieSceneCVarSection.GetString // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x375f920
};
...
struct UMovieSceneDataLayerSection : UMovieSceneSection {
	...
	void SetPrerollState(enum class EDataLayerRuntimeState InPrerollState); // Function MovieSceneTracks.MovieSceneDataLayerSection.SetPrerollState // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x3760dc0
	void SetFlushOnUnload(bool bFlushOnUnload); // Function MovieSceneTracks.MovieSceneDataLayerSection.SetFlushOnUnload // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x3760cb0
	void SetDesiredState(enum class EDataLayerRuntimeState InDesiredState); // Function MovieSceneTracks.MovieSceneDataLayerSection.SetDesiredState // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x3760ed0
	void SetDataLayers(struct TArray<struct FActorDataLayer>& InDataLayers); // Function MovieSceneTracks.MovieSceneDataLayerSection.SetDataLayers // (Final|Native|Private|HasOutParms|BlueprintCallable) // @ game+0x3760940
	void SetDataLayerAssets(struct TArray<struct UDataLayerAsset*>& InDataLayerAssets); // Function MovieSceneTracks.MovieSceneDataLayerSection.SetDataLayerAssets // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x3760aa0
	enum class EDataLayerRuntimeState GetPrerollState(); // Function MovieSceneTracks.MovieSceneDataLayerSection.GetPrerollState // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x3760eb0
	bool GetFlushOnUnload(); // Function MovieSceneTracks.MovieSceneDataLayerSection.GetFlushOnUnload // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x3760da0
	enum class EDataLayerRuntimeState GetDesiredState(); // Function MovieSceneTracks.MovieSceneDataLayerSection.GetDesiredState // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x3760fc0
	struct TArray<struct FActorDataLayer> GetDataLayers(); // Function MovieSceneTracks.MovieSceneDataLayerSection.GetDataLayers // (Final|Native|Private|BlueprintCallable|BlueprintPure|Const) // @ game+0x3760a70
	struct TArray<struct UDataLayerAsset*> GetDataLayerAssets(); // Function MovieSceneTracks.MovieSceneDataLayerSection.GetDataLayerAssets // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x3760c20
};
...
struct UMovieSceneLevelVisibilitySection : UMovieSceneSection {
	...
	void SetVisibility(enum class ELevelVisibility InVisibility); // Function MovieSceneTracks.MovieSceneLevelVisibilitySection.SetVisibility // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x37fcc20
	void SetLevelNames(struct TArray<struct FName>& InLevelNames); // Function MovieSceneTracks.MovieSceneLevelVisibilitySection.SetLevelNames // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x37fcac0
	enum class ELevelVisibility GetVisibility(); // Function MovieSceneTracks.MovieSceneLevelVisibilitySection.GetVisibility // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x37fcd10
	struct TArray<struct FName> GetLevelNames(); // Function MovieSceneTracks.MovieSceneLevelVisibilitySection.GetLevelNames // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x37fcbf0
};
...
struct UMovieSceneParameterSection : UMovieSceneSection {
	...
	bool RemoveVectorParameter(struct FName InParameterName); // Function MovieSceneTracks.MovieSceneParameterSection.RemoveVectorParameter // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x37fe610
	bool RemoveVector2DParameter(struct FName InParameterName); // Function MovieSceneTracks.MovieSceneParameterSection.RemoveVector2DParameter // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x37fe760
	bool RemoveTransformParameter(struct FName InParameterName); // Function MovieSceneTracks.MovieSceneParameterSection.RemoveTransformParameter // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x37fe370
	bool RemoveScalarParameter(struct FName InParameterName); // Function MovieSceneTracks.MovieSceneParameterSection.RemoveScalarParameter // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x37fea00
	bool RemoveColorParameter(struct FName InParameterName); // Function MovieSceneTracks.MovieSceneParameterSection.RemoveColorParameter // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x37fe4c0
	bool RemoveBoolParameter(struct FName InParameterName); // Function MovieSceneTracks.MovieSceneParameterSection.RemoveBoolParameter // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x37fe8b0
	void GetParameterNames(struct TSet<struct FName>& ParameterNames); // Function MovieSceneTracks.MovieSceneParameterSection.GetParameterNames // (Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x37fe0b0
	void AddVectorParameterKey(struct FName InParameterName, struct FFrameNumber InTime, struct FVector InValue); // Function MovieSceneTracks.MovieSceneParameterSection.AddVectorParameterKey // (Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x37ff060
	void AddVector2DParameterKey(struct FName InParameterName, struct FFrameNumber InTime, struct FVector2D InValue); // Function MovieSceneTracks.MovieSceneParameterSection.AddVector2DParameterKey // (Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x37ff2c0
	void AddTransformParameterKey(struct FName InParameterName, struct FFrameNumber InTime, struct FTransform& InValue); // Function MovieSceneTracks.MovieSceneParameterSection.AddTransformParameterKey // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x37feb50
	void AddScalarParameterKey(struct FName InParameterName, struct FFrameNumber InTime, float InValue); // Function MovieSceneTracks.MovieSceneParameterSection.AddScalarParameterKey // (Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x37ff760
	void AddColorParameterKey(struct FName InParameterName, struct FFrameNumber InTime, struct FLinearColor InValue); // Function MovieSceneTracks.MovieSceneParameterSection.AddColorParameterKey // (Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x37fee10
	void AddBoolParameterKey(struct FName InParameterName, struct FFrameNumber InTime, bool InValue); // Function MovieSceneTracks.MovieSceneParameterSection.AddBoolParameterKey // (Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x37ff510
};
...
struct UMovieSceneSkeletalAnimationTrack : UMovieSceneNameableTrack {
	...
	void SetSwapRootBone(enum class ESwapRootBone InValue); // Function MovieSceneTracks.MovieSceneSkeletalAnimationTrack.SetSwapRootBone // (Final|RequiredAPI|Native|Public) // @ game+0x38de990
	enum class ESwapRootBone GetSwapRootBone(); // Function MovieSceneTracks.MovieSceneSkeletalAnimationTrack.GetSwapRootBone // (Final|RequiredAPI|Native|Public|Const) // @ game+0x38de970
};

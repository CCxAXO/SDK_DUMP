...
struct FCameraAnimationParams {
	...
	int32_t StartOffset; // 0x1c(0x04)
	bool bRandomStartTime; // 0x20(0x01)
	char pad_21[0x3]; // 0x21(0x03)
	float DurationOverride; // 0x24(0x04)
	enum class ECameraAnimationPlaySpace Playspace; // 0x28(0x01)
	char pad_29[0x7]; // 0x29(0x07)
	struct FRotator UserPlaySpaceRot; // 0x30(0x18)
};
...
struct FActiveCameraAnimationInfo {
	...
	struct FCameraAnimationParams Params; // 0x08(0x48)
	struct FCameraAnimationHandle Handle; // 0x50(0x04)
	char pad_54[0x4]; // 0x54(0x04)
	struct UCameraAnimationSequencePlayer* Player; // 0x58(0x08)
	struct UCameraAnimationSequenceCameraStandIn* CameraStandIn; // 0x60(0x08)
	float EaseInCurrentTime; // 0x68(0x04)
	float EaseOutCurrentTime; // 0x6c(0x04)
	bool bIsEasingIn; // 0x70(0x01)
	bool bIsEasingOut; // 0x71(0x01)

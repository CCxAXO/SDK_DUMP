...
struct UGN_Core_SpecOps_AnimGraph_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function GN_Core_SpecOps_AnimGraph.GN_Core_SpecOps_AnimGraph_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_GN_Core_SpecOps_AnimGraph(int32_t EntryPoint); // Function GN_Core_SpecOps_AnimGraph.GN_Core_SpecOps_AnimGraph_C.ExecuteUbergraph_GN_Core_SpecOps_AnimGraph // (Final|UbergraphFunction) // @ game+0x1af5410
};

...
struct UDetailedCombatInteraction_C : UUserWidget {
	...
	void Construct(); // Function DetailedCombatInteraction.DetailedCombatInteraction_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void PreConstruct(bool IsDesignTime); // Function DetailedCombatInteraction.DetailedCombatInteraction_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_DetailedCombatInteraction(int32_t EntryPoint); // Function DetailedCombatInteraction.DetailedCombatInteraction_C.ExecuteUbergraph_DetailedCombatInteraction // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

...
struct UPremierAwards_InfoModal_C : UUserWidget {
	...
	void UpdateAwardStatus(struct UPremierAwardHubViewModel* AwardsViewModel); // Function PremierAwards_InfoModal.PremierAwards_InfoModal_C.UpdateAwardStatus // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SwapContentOrder(); // Function PremierAwards_InfoModal.PremierAwards_InfoModal_C.SwapContentOrder // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void BndEvt__PremierAwards_InfoModal_CustomCloseButton_K2Node_ComponentBoundEvent_1_OnClicked__DelegateSignature(); // Function PremierAwards_InfoModal.PremierAwards_InfoModal_C.BndEvt__PremierAwards_InfoModal_CustomCloseButton_K2Node_ComponentBoundEvent_1_OnClicked__DelegateSignature // (BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_PremierAwards_InfoModal(int32_t EntryPoint); // Function PremierAwards_InfoModal.PremierAwards_InfoModal_C.ExecuteUbergraph_PremierAwards_InfoModal // (Final|UbergraphFunction) // @ game+0x1af5410
};

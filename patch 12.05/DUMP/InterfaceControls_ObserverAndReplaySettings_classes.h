...
struct UInterfaceControls_ObserverAndReplaySettings_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function InterfaceControls_ObserverAndReplaySettings.InterfaceControls_ObserverAndReplaySettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_InterfaceControls_ObserverAndReplaySettings(int32_t EntryPoint); // Function InterfaceControls_ObserverAndReplaySettings.InterfaceControls_ObserverAndReplaySettings_C.ExecuteUbergraph_InterfaceControls_ObserverAndReplaySettings // (Final|UbergraphFunction) // @ game+0x1af5410
};

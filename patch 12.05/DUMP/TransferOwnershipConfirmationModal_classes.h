...
struct UTransferOwnershipConfirmationModal_C : UUserWidget {
	...
	void Construct(); // Function TransferOwnershipConfirmationModal.TransferOwnershipConfirmationModal_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void Post-Init(); // Function TransferOwnershipConfirmationModal.TransferOwnershipConfirmationModal_C.Post-Init // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Transfer Successful(struct FRoster& Roster); // Function TransferOwnershipConfirmationModal.TransferOwnershipConfirmationModal_C.Transfer Successful // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Transfer Failed(); // Function TransferOwnershipConfirmationModal.TransferOwnershipConfirmationModal_C.Transfer Failed // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_TransferOwnershipConfirmationModal(int32_t EntryPoint); // Function TransferOwnershipConfirmationModal.TransferOwnershipConfirmationModal_C.ExecuteUbergraph_TransferOwnershipConfirmationModal // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

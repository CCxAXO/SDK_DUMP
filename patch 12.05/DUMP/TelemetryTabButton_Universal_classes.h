...
struct UTelemetryTabButton_Universal_C : UTelemetryTabButton_C {
	...
	void SetTabButtonIsEnabled(bool IsEnabled); // Function TelemetryTabButton_Universal.TelemetryTabButton_Universal_C.SetTabButtonIsEnabled // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void UpdateMinDesiredWidth(double MinDesiredWidth); // Function TelemetryTabButton_Universal.TelemetryTabButton_Universal_C.UpdateMinDesiredWidth // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetVisuals(struct FText Text, struct UTexture* Image); // Function TelemetryTabButton_Universal.TelemetryTabButton_Universal_C.SetVisuals // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetActionTarget(struct FString ActionTarget); // Function TelemetryTabButton_Universal.TelemetryTabButton_Universal_C.SetActionTarget // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void PreConstruct(bool IsDesignTime); // Function TelemetryTabButton_Universal.TelemetryTabButton_Universal_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	...
	void SetIsActive(bool IsActive); // Function TelemetryTabButton_Universal.TelemetryTabButton_Universal_C.SetIsActive // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function TelemetryTabButton_Universal.TelemetryTabButton_Universal_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_TelemetryTabButton_Universal(int32_t EntryPoint); // Function TelemetryTabButton_Universal.TelemetryTabButton_Universal_C.ExecuteUbergraph_TelemetryTabButton_Universal // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

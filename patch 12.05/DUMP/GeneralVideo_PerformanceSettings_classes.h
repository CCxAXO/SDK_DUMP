...
struct UGeneralVideo_PerformanceSettings_C : USettingsSubsectionBase_C {
	...
	void OnNvidiaReflexLowLatencyChanged(enum class EAresIntSettingName SettingName, int32_t OldValue, int32_t NewValue); // Function GeneralVideo_PerformanceSettings.GeneralVideo_PerformanceSettings_C.OnNvidiaReflexLowLatencyChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Destruct(); // Function GeneralVideo_PerformanceSettings.GeneralVideo_PerformanceSettings_C.Destruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function GeneralVideo_PerformanceSettings.GeneralVideo_PerformanceSettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_GeneralVideo_PerformanceSettings(int32_t EntryPoint); // Function GeneralVideo_PerformanceSettings.GeneralVideo_PerformanceSettings_C.ExecuteUbergraph_GeneralVideo_PerformanceSettings // (Final|UbergraphFunction) // @ game+0x1af5410
};

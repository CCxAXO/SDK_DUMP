...
struct UWBP_Panel_TextBox_EditFriendNote_C : UAresCommonUserWidget {
	...
	void Initialize(struct FString InPlayerSubject); // Function WBP_Panel_TextBox_EditFriendNote.WBP_Panel_TextBox_EditFriendNote_C.Initialize // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SaveFriendNote(); // Function WBP_Panel_TextBox_EditFriendNote.WBP_Panel_TextBox_EditFriendNote_C.SaveFriendNote // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function WBP_Panel_TextBox_EditFriendNote.WBP_Panel_TextBox_EditFriendNote_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void OnInitialized(); // Function WBP_Panel_TextBox_EditFriendNote.WBP_Panel_TextBox_EditFriendNote_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_WBP_Panel_TextBox_EditFriendNote(int32_t EntryPoint); // Function WBP_Panel_TextBox_EditFriendNote.WBP_Panel_TextBox_EditFriendNote_C.ExecuteUbergraph_WBP_Panel_TextBox_EditFriendNote // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
	void OnCloseRequested__DelegateSignature(); // Function WBP_Panel_TextBox_EditFriendNote.WBP_Panel_TextBox_EditFriendNote_C.OnCloseRequested__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

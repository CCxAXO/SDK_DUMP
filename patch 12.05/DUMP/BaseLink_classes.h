...
struct ABaseLink_C : ABaseEjectable_C {
	...
	void ExecuteUbergraph_BaseLink(int32_t EntryPoint); // Function BaseLink.BaseLink_C.ExecuteUbergraph_BaseLink // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

...
struct UWBP_Screen_VoiceChatSettings_Desktop_C : UAresScreenBase {
	...
	void Close Self(); // Function WBP_Screen_VoiceChatSettings_Desktop.WBP_Screen_VoiceChatSettings_Desktop_C.Close Self // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetSettingsScreenClass(); // Function WBP_Screen_VoiceChatSettings_Desktop.WBP_Screen_VoiceChatSettings_Desktop_C.SetSettingsScreenClass // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void CreateSettingsScreen(struct USettingsScreen*& SettingScreen); // Function WBP_Screen_VoiceChatSettings_Desktop.WBP_Screen_VoiceChatSettings_Desktop_C.CreateSettingsScreen // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void OnInitialized(); // Function WBP_Screen_VoiceChatSettings_Desktop.WBP_Screen_VoiceChatSettings_Desktop_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_WBP_Screen_VoiceChatSettings_Desktop(int32_t EntryPoint); // Function WBP_Screen_VoiceChatSettings_Desktop.WBP_Screen_VoiceChatSettings_Desktop_C.ExecuteUbergraph_WBP_Screen_VoiceChatSettings_Desktop // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

...
struct UAdHocPopup_C : UWBP_Screen_CustomModal_Base_C {
	...
	bool BP_OnHandleBackAction(); // Function AdHocPopup.AdHocPopup_C.BP_OnHandleBackAction // (Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnInitialized(); // Function AdHocPopup.AdHocPopup_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function AdHocPopup.AdHocPopup_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void BndEvt__AdHocPopup_Accept_K2Node_ComponentBoundEvent_1_OnUniversalButtonVoidEvent__DelegateSignature(); // Function AdHocPopup.AdHocPopup_C.BndEvt__AdHocPopup_Accept_K2Node_ComponentBoundEvent_1_OnUniversalButtonVoidEvent__DelegateSignature // (BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_AdHocPopup(int32_t EntryPoint); // Function AdHocPopup.AdHocPopup_C.ExecuteUbergraph_AdHocPopup // (Final|UbergraphFunction) // @ game+0x1af5410
};

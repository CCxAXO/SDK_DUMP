...
struct URCBehaviourBindNode : URCBehaviourNode {
	...
	void OnPassed(struct URCBehaviour* InBehaviour); // Function RemoteControlLogic.RCBehaviourBindNode.OnPassed // (Native|Event|Public|BlueprintCallable|BlueprintEvent|Const) // @ game+0x3ba2170
	bool IsSupported(struct URCBehaviour* InBehaviour); // Function RemoteControlLogic.RCBehaviourBindNode.IsSupported // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x6feb260
	bool Execute(struct URCBehaviour* InBehaviour); // Function RemoteControlLogic.RCBehaviourBindNode.Execute // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x6feb370
};
...
struct URCBehaviourBlueprintNode : URCBehaviourNode {
	...
	void PreExecute(struct URCBehaviour* InBehaviour); // Function RemoteControlLogic.RCBehaviourBlueprintNode.PreExecute // (Native|Event|Public|BlueprintCallable|BlueprintEvent|Const) // @ game+0x4fd8830
	void OnPassed(struct URCBehaviour* InBehaviour); // Function RemoteControlLogic.RCBehaviourBlueprintNode.OnPassed // (Native|Event|Public|BlueprintCallable|BlueprintEvent|Const) // @ game+0x3ba2170
	bool IsSupported(struct URCBehaviour* InBehaviour); // Function RemoteControlLogic.RCBehaviourBlueprintNode.IsSupported // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x5903610
	bool Execute(struct URCBehaviour* InBehaviour); // Function RemoteControlLogic.RCBehaviourBlueprintNode.Execute // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x6feb370
};
...
struct URCBehaviourConditionalNode : URCBehaviourNode {
	...
	void OnPassed(struct URCBehaviour* InBehaviour); // Function RemoteControlLogic.RCBehaviourConditionalNode.OnPassed // (Native|Event|Public|BlueprintCallable|BlueprintEvent|Const) // @ game+0x3ba2170
	bool IsSupported(struct URCBehaviour* InBehaviour); // Function RemoteControlLogic.RCBehaviourConditionalNode.IsSupported // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x6feb260
	bool Execute(struct URCBehaviour* InBehaviour); // Function RemoteControlLogic.RCBehaviourConditionalNode.Execute // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x6feb370
};
...
struct URCBehaviourOnValueChangedNode : URCBehaviourNode {
	...
	bool IsSupported(struct URCBehaviour* InBehaviour); // Function RemoteControlLogic.RCBehaviourOnValueChangedNode.IsSupported // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x6fec5c0
	bool Execute(struct URCBehaviour* InBehaviour); // Function RemoteControlLogic.RCBehaviourOnValueChangedNode.Execute // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x6feb260
};
...
struct URCBehaviourRangeMapNode : URCBehaviourNode {
	...
	void OnPassed(struct URCBehaviour* InBehaviour); // Function RemoteControlLogic.RCBehaviourRangeMapNode.OnPassed // (Native|Event|Public|BlueprintCallable|BlueprintEvent|Const) // @ game+0x3ba2170
	bool IsSupported(struct URCBehaviour* InBehaviour); // Function RemoteControlLogic.RCBehaviourRangeMapNode.IsSupported // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x6feb260
	bool Execute(struct URCBehaviour* InBehaviour); // Function RemoteControlLogic.RCBehaviourRangeMapNode.Execute // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x6feb370
};
...
struct URCBehaviourSetAssetByPathNode : URCBehaviourNode {
	...
	bool IsSupported(struct URCBehaviour* InBehaviour); // Function RemoteControlLogic.RCBehaviourSetAssetByPathNode.IsSupported // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x6fec5c0
	bool Execute(struct URCBehaviour* InBehaviour); // Function RemoteControlLogic.RCBehaviourSetAssetByPathNode.Execute // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x6feb260
};
...
struct URemoteControlLogicTestData : UObject {
	...
	void TestIntFunction(); // Function RemoteControlLogic.RemoteControlLogicTestData.TestIntFunction // (Final|Native|Public|BlueprintCallable) // @ game+0x6fedda0
};

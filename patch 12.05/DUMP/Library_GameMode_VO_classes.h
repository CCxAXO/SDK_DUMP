...
struct ULibrary_GameMode_VO_C : UBlueprintFunctionLibrary {
	...
	void PlayAnnouncementForAll(struct UAkAudioEvent* event, enum class VOPriorityEnum Priority, double QueueTimeout, struct UObject* __WorldContext); // Function Library_GameMode_VO.Library_GameMode_VO_C.PlayAnnouncementForAll // (Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410

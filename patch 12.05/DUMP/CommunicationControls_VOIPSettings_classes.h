...
struct UCommunicationControls_VOIPSettings_C : USettingsSubsectionBase_C {
	...
	void DisableVoiceIfNeeded(); // Function CommunicationControls_VOIPSettings.CommunicationControls_VOIPSettings_C.DisableVoiceIfNeeded // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function CommunicationControls_VOIPSettings.CommunicationControls_VOIPSettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_CommunicationControls_VOIPSettings(int32_t EntryPoint); // Function CommunicationControls_VOIPSettings.CommunicationControls_VOIPSettings_C.ExecuteUbergraph_CommunicationControls_VOIPSettings // (Final|UbergraphFunction) // @ game+0x1af5410
};

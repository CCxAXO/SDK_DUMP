...
struct URGIFriendsRiotGamesApiDataStore : UObject {
	...
	void SubscribeToSocialPluginEvents(int32_t Code, struct FString Message); // Function RGIFriendsRiotGamesApi.RGIFriendsRiotGamesApiDataStore.SubscribeToSocialPluginEvents // (Final|Native|Public) // @ game+0x532cb60
	void SendPresenceRepeatingFunction(); // Function RGIFriendsRiotGamesApi.RGIFriendsRiotGamesApiDataStore.SendPresenceRepeatingFunction // (Final|Native|Protected) // @ game+0x532ca10
	void OnCustomPrivateDataUpdated(struct FString SerializedData); // Function RGIFriendsRiotGamesApi.RGIFriendsRiotGamesApiDataStore.OnCustomPrivateDataUpdated // (Final|Native|Public) // @ game+0x532ca30
};

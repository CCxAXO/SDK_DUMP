...
struct UAudio_TeamVoiceSettings_C : USettingsSubsectionBase_C {
	...
	void SetTeamVoiceChatBindPreview(); // Function Audio_TeamVoiceSettings.Audio_TeamVoiceSettings_C.SetTeamVoiceChatBindPreview // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function Audio_TeamVoiceSettings.Audio_TeamVoiceSettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_Audio_TeamVoiceSettings(int32_t EntryPoint); // Function Audio_TeamVoiceSettings.Audio_TeamVoiceSettings_C.ExecuteUbergraph_Audio_TeamVoiceSettings // (Final|UbergraphFunction) // @ game+0x1af5410
};

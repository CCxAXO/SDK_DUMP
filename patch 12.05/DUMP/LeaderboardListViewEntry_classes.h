...
struct ULeaderboardListViewEntry_C : UUserWidget {
	...
	void InitContextMenuAnchor(); // Function LeaderboardListViewEntry.LeaderboardListViewEntry_C.InitContextMenuAnchor // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetPlayer(struct ULeaderboardPlayerModel* Player, struct ULeaderboardViewModel* LeaderboardModel); // Function LeaderboardListViewEntry.LeaderboardListViewEntry_C.SetPlayer // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_LeaderboardListViewEntry(int32_t EntryPoint); // Function LeaderboardListViewEntry.LeaderboardListViewEntry_C.ExecuteUbergraph_LeaderboardListViewEntry // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

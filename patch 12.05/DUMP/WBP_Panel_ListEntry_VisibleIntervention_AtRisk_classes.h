...
struct UWBP_Panel_ListEntry_VisibleIntervention_AtRisk_C : UWBP_Panel_ListEntry_Social_Base_C {
	...
	void CloseHoverMessage(); // Function WBP_Panel_ListEntry_VisibleIntervention_AtRisk.WBP_Panel_ListEntry_VisibleIntervention_AtRisk_C.CloseHoverMessage // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OpenHoverMessage(); // Function WBP_Panel_ListEntry_VisibleIntervention_AtRisk.WBP_Panel_ListEntry_VisibleIntervention_AtRisk_C.OpenHoverMessage // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void HandleExperimentAssignmentChanged(struct UGroupExperimentAssignment* Group); // Function WBP_Panel_ListEntry_VisibleIntervention_AtRisk.WBP_Panel_ListEntry_VisibleIntervention_AtRisk_C.HandleExperimentAssignmentChanged // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	struct UWidget* BP_GetDesiredFocusTarget(); // Function WBP_Panel_ListEntry_VisibleIntervention_AtRisk.WBP_Panel_ListEntry_VisibleIntervention_AtRisk_C.BP_GetDesiredFocusTarget // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1af5410
	struct UWidget* OnHoverMessageMenuAnchorGetMenuContent(); // Function WBP_Panel_ListEntry_VisibleIntervention_AtRisk.WBP_Panel_ListEntry_VisibleIntervention_AtRisk_C.OnHoverMessageMenuAnchorGetMenuContent // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1af5410
	void InitializeListEntry(struct UObject* InListItemObject); // Function WBP_Panel_ListEntry_VisibleIntervention_AtRisk.WBP_Panel_ListEntry_VisibleIntervention_AtRisk_C.InitializeListEntry // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnListItemObjectSet(struct UObject* ListItemObject); // Function WBP_Panel_ListEntry_VisibleIntervention_AtRisk.WBP_Panel_ListEntry_VisibleIntervention_AtRisk_C.OnListItemObjectSet // (Event|Protected|BlueprintEvent) // @ game+0x1af5410
	...
	void Construct(); // Function WBP_Panel_ListEntry_VisibleIntervention_AtRisk.WBP_Panel_ListEntry_VisibleIntervention_AtRisk_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_WBP_Panel_ListEntry_VisibleIntervention_AtRisk(int32_t EntryPoint); // Function WBP_Panel_ListEntry_VisibleIntervention_AtRisk.WBP_Panel_ListEntry_VisibleIntervention_AtRisk_C.ExecuteUbergraph_WBP_Panel_ListEntry_VisibleIntervention_AtRisk // (Final|UbergraphFunction) // @ game+0x1af5410
};

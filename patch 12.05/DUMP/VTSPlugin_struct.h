...
struct FVTSTVALDataPoint {
	float XAxisPoint; // 0x00(0x04)
	float YAxisPoint; // 0x04(0x04)
};

// ScriptStruct VTSPlugin.VTSTValTestTrackingData
// Size: 0x40 (Inherited: 0x00)
struct FVTSTValTestTrackingData {
	struct TArray<struct FVTSTVALDataPoint> ServerSimulationTickTimeVsAppTickTimeGraph; // 0x00(0x10)
	struct TArray<struct FVTSTVALDataPoint> ServerSimulationTickTimeVsTransportDelayGraph; // 0x10(0x10)
	struct TArray<struct FVTSTVALDataPoint> ClientSimulationTickTimeVsAppTickTimeGraph; // 0x20(0x10)
	struct TArray<struct FVTSTVALDataPoint> ClientSimulationTickTimeVsTransportDelayGraph; // 0x30(0x10)
};

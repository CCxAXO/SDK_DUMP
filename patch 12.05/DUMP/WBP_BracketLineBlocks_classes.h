...
struct UWBP_BracketLineBlocks_C : UUserWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function WBP_BracketLineBlocks.WBP_BracketLineBlocks_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void Refresh(); // Function WBP_BracketLineBlocks.WBP_BracketLineBlocks_C.Refresh // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Clear(); // Function WBP_BracketLineBlocks.WBP_BracketLineBlocks_C.Clear // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_WBP_BracketLineBlocks(int32_t EntryPoint); // Function WBP_BracketLineBlocks.WBP_BracketLineBlocks_C.ExecuteUbergraph_WBP_BracketLineBlocks // (Final|UbergraphFunction) // @ game+0x1af5410
};

...
struct UMeshTopologySelectionMechanicProperties : UInteractiveToolPropertySet {
	...
	void SelectAll(); // Function ModelingComponents.MeshTopologySelectionMechanicProperties.SelectAll // (Final|Native|Public) // @ game+0x560efc0
	void InvertSelection(); // Function ModelingComponents.MeshTopologySelectionMechanicProperties.InvertSelection // (Final|Native|Public) // @ game+0x560f010
};
...
// Size: 0x860 (Inherited: 0x740)
struct UOctreeDynamicMeshComponent : UBaseDynamicMeshComponent {
	char pad_740[0x60]; // 0x740(0x60)
	struct UDynamicMesh* MeshObject; // 0x7a0(0x08)
	char pad_7A8[0xb8]; // 0x7a8(0xb8)

	void SetDynamicMesh(struct UDynamicMesh* NewMesh); // Function ModelingComponents.OctreeDynamicMeshComponent.SetDynamicMesh // (Final|Native|Public|BlueprintCallable) // @ game+0x561cdc0
};

// Class ModelingComponents.LineSetComponent
// Size: 0x760 (Inherited: 0x6e0)
struct ULineSetComponent : UMeshComponent {
	struct UMaterialInterface* LineMaterial; // 0x6d8(0x08)
	struct FBoxSphereBounds Bounds; // 0x6e0(0x38)
	bool bBoundsDirty; // 0x718(0x01)
	char pad_721[0x3f]; // 0x721(0x3f)
};
...
struct UPreviewGeometry : UObject {
	...
	bool SetPointSetVisibility(struct FString PointSetIdentifier, bool bVisible); // Function ModelingComponents.PreviewGeometry.SetPointSetVisibility // (Final|Native|Public) // @ game+0x563b3d0
	bool SetPointSetMaterial(struct FString PointSetIdentifier, struct UMaterialInterface* NewMaterial); // Function ModelingComponents.PreviewGeometry.SetPointSetMaterial // (Final|Native|Public) // @ game+0x563b180
	bool SetLineSetVisibility(struct FString LineSetIdentifier, bool bVisible); // Function ModelingComponents.PreviewGeometry.SetLineSetVisibility // (Final|Native|Public) // @ game+0x563bfc0
	bool SetLineSetMaterial(struct FString LineSetIdentifier, struct UMaterialInterface* NewMaterial); // Function ModelingComponents.PreviewGeometry.SetLineSetMaterial // (Final|Native|Public) // @ game+0x563bd70
	void SetAllPointSetsMaterial(struct UMaterialInterface* Material); // Function ModelingComponents.PreviewGeometry.SetAllPointSetsMaterial // (Final|Native|Public) // @ game+0x563b090
	void SetAllLineSetsMaterial(struct UMaterialInterface* Material); // Function ModelingComponents.PreviewGeometry.SetAllLineSetsMaterial // (Final|Native|Public) // @ game+0x563bc80
	bool RemovePointSet(struct FString PointSetIdentifier, bool bDestroy); // Function ModelingComponents.PreviewGeometry.RemovePointSet // (Final|Native|Public) // @ game+0x563b720
	bool RemoveLineSet(struct FString LineSetIdentifier, bool bDestroy); // Function ModelingComponents.PreviewGeometry.RemoveLineSet // (Final|Native|Public) // @ game+0x563c310
	void RemoveAllPointSets(bool bDestroy); // Function ModelingComponents.PreviewGeometry.RemoveAllPointSets // (Final|Native|Public) // @ game+0x563b620
	void RemoveAllLineSets(bool bDestroy); // Function ModelingComponents.PreviewGeometry.RemoveAllLineSets // (Final|Native|Public) // @ game+0x563c210
	struct APreviewGeometryActor* GetActor(); // Function ModelingComponents.PreviewGeometry.GetActor // (Final|Native|Public|Const) // @ game+0x563cb30
	struct UTriangleSetComponent* FindTriangleSet(struct FString TriangleSetIdentifier); // Function ModelingComponents.PreviewGeometry.FindTriangleSet // (Final|Native|Public) // @ game+0x563c870
	struct UPointSetComponent* FindPointSet(struct FString PointSetIdentifier); // Function ModelingComponents.PreviewGeometry.FindPointSet // (Final|Native|Public) // @ game+0x563b9b0
	struct ULineSetComponent* FindLineSet(struct FString LineSetIdentifier); // Function ModelingComponents.PreviewGeometry.FindLineSet // (Final|Native|Public) // @ game+0x563c5a0
	void Disconnect(); // Function ModelingComponents.PreviewGeometry.Disconnect // (Final|Native|Public) // @ game+0x563cb50
	void CreateInWorld(struct UWorld* World, struct FTransform& WithTransform); // Function ModelingComponents.PreviewGeometry.CreateInWorld // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x563cba0
	struct UTriangleSetComponent* AddTriangleSet(struct FString TriangleSetIdentifier); // Function ModelingComponents.PreviewGeometry.AddTriangleSet // (Final|Native|Public) // @ game+0x563c9f0
	struct UPointSetComponent* AddPointSet(struct FString PointSetIdentifier); // Function ModelingComponents.PreviewGeometry.AddPointSet // (Final|Native|Public) // @ game+0x563bb40
	struct ULineSetComponent* AddLineSet(struct FString LineSetIdentifier); // Function ModelingComponents.PreviewGeometry.AddLineSet // (Final|Native|Public) // @ game+0x563c730
};
...
struct UMeshWireframeComponent : UMeshComponent {
	float LineDepthBias; // 0x6d8(0x04)
	float LineDepthBiasSizeScale; // 0x6dc(0x04)
	float ThicknessScale; // 0x6e0(0x04)
	bool bEnableWireframe; // 0x6e4(0x01)
	struct FColor WireframeColor; // 0x6e8(0x04)
	float WireframeThickness; // 0x6ec(0x04)
	bool bEnableBoundaryEdges; // 0x6f0(0x01)
	struct FColor BoundaryEdgeColor; // 0x6f4(0x04)
	float BoundaryEdgeThickness; // 0x6f8(0x04)
	bool bEnableUVSeams; // 0x6fc(0x01)
	char pad_6FF[0x1]; // 0x6ff(0x01)
	struct FColor UVSeamColor; // 0x700(0x04)
	float UVSeamThickness; // 0x704(0x04)
	bool bEnableNormalSeams; // 0x708(0x01)
	char pad_709[0x3]; // 0x709(0x03)
	struct FColor NormalSeamColor; // 0x70c(0x04)
	float NormalSeamThickness; // 0x710(0x04)
	bool bEnableTangentSeams; // 0x714(0x01)
	char pad_715[0x3]; // 0x715(0x03)
	struct FColor TangentSeamColor; // 0x718(0x04)
	float TangentSeamThickness; // 0x71c(0x04)
	bool bEnableColorSeams; // 0x720(0x01)
	char pad_721[0x3]; // 0x721(0x03)
	struct FColor ColorSeamColor; // 0x724(0x04)
	float ColorSeamThickness; // 0x728(0x04)
	char pad_72C[0x4]; // 0x72c(0x04)
	struct UMaterialInterface* LineMaterial; // 0x730(0x08)
	struct FBoxSphereBounds LocalBounds; // 0x738(0x38)
...
struct UPointSetComponent : UMeshComponent {
	struct UMaterialInterface* PointMaterial; // 0x6d8(0x08)
	struct FBoxSphereBounds Bounds; // 0x6e0(0x38)
	bool bBoundsDirty; // 0x718(0x01)
	char pad_721[0x3f]; // 0x721(0x3f)
};
...
struct UModelingObjectsCreationAPI : UObject {
	...
	struct FCreateTextureObjectResult CreateTextureObject(struct FCreateTextureObjectParams& CreateTexParams); // Function ModelingComponents.ModelingObjectsCreationAPI.CreateTextureObject // (Native|Public|HasOutParms|BlueprintCallable) // @ game+0x56686a0
	struct FCreateActorResult CreateNewActor(struct FCreateActorParams& CreateActorParams); // Function ModelingComponents.ModelingObjectsCreationAPI.CreateNewActor // (Native|Public|HasOutParms|BlueprintCallable) // @ game+0x5668370
	struct FCreateMeshObjectResult CreateMeshObject(struct FCreateMeshObjectParams& CreateMeshParams); // Function ModelingComponents.ModelingObjectsCreationAPI.CreateMeshObject // (Native|Public|HasOutParms|BlueprintCallable) // @ game+0x5668800
	struct FCreateMaterialObjectResult CreateMaterialObject(struct FCreateMaterialObjectParams& CreateMaterialParams); // Function ModelingComponents.ModelingObjectsCreationAPI.CreateMaterialObject // (Native|Public|HasOutParms|BlueprintCallable) // @ game+0x5668540
};
...
struct UCreateMeshObjectTypeProperties : UInteractiveToolPropertySet {
	...
	bool ShouldShowPropertySet(); // Function ModelingComponents.CreateMeshObjectTypeProperties.ShouldShowPropertySet // (Final|Native|Public|Const) // @ game+0x566f340
	struct TArray<struct FString> GetOutputTypeNamesFunc(); // Function ModelingComponents.CreateMeshObjectTypeProperties.GetOutputTypeNamesFunc // (Final|Native|Public) // @ game+0x566f390
	enum class ECreateObjectTypeHint GetCurrentCreateMeshType(); // Function ModelingComponents.CreateMeshObjectTypeProperties.GetCurrentCreateMeshType // (Final|Native|Public|Const) // @ game+0x566f310
};
...
struct UPolygroupLayersProperties : UInteractiveToolPropertySet {
	...
	struct TArray<struct FString> GetGroupLayersFunc(); // Function ModelingComponents.PolygroupLayersProperties.GetGroupLayersFunc // (Final|Native|Public) // @ game+0x56702f0
};
...
struct UWeightMapSetProperties : UInteractiveToolPropertySet {
	...
	struct TArray<struct FString> GetWeightMapsFunc(); // Function ModelingComponents.WeightMapSetProperties.GetWeightMapsFunc // (Final|Native|Public) // @ game+0x56702f0
};

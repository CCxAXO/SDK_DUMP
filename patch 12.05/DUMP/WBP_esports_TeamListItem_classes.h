...
struct UWBP_esports_TeamListItem_C : UUserWidget {
	...
	void SetSelectedState(bool SetIsSelected); // Function WBP_esports_TeamListItem.WBP_esports_TeamListItem_C.SetSelectedState // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetItemPadding(); // Function WBP_esports_TeamListItem.WBP_esports_TeamListItem_C.SetItemPadding // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetTeamInfo(struct FTeamDTO TeamDTO); // Function WBP_esports_TeamListItem.WBP_esports_TeamListItem_C.SetTeamInfo // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetTeamName(struct FText TeamName); // Function WBP_esports_TeamListItem.WBP_esports_TeamListItem_C.SetTeamName // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Set Entry Selected(bool SkipAudio); // Function WBP_esports_TeamListItem.WBP_esports_TeamListItem_C.Set Entry Selected // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void PreConstruct(bool IsDesignTime); // Function WBP_esports_TeamListItem.WBP_esports_TeamListItem_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_WBP_esports_TeamListItem(int32_t EntryPoint); // Function WBP_esports_TeamListItem.WBP_esports_TeamListItem_C.ExecuteUbergraph_WBP_esports_TeamListItem // (Final|UbergraphFunction) // @ game+0x1af5410
};

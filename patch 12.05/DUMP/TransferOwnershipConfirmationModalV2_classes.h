...
struct UTransferOwnershipConfirmationModalV2_C : UUserWidget {
	...
	void Init(struct UPremierRosterListFunctionsVM* FunctionsVM, struct FString Subject, struct FString Game Name, struct FString Tag Line, struct FString RosterID); // Function TransferOwnershipConfirmationModalV2.TransferOwnershipConfirmationModalV2_C.Init // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function TransferOwnershipConfirmationModalV2.TransferOwnershipConfirmationModalV2_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void Post-Init(); // Function TransferOwnershipConfirmationModalV2.TransferOwnershipConfirmationModalV2_C.Post-Init // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void Success(struct FPremierRosterV2& Roster); // Function TransferOwnershipConfirmationModalV2.TransferOwnershipConfirmationModalV2_C.Success // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void On Error(struct FString ReasonStringInDebugOnly); // Function TransferOwnershipConfirmationModalV2.TransferOwnershipConfirmationModalV2_C.On Error // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_TransferOwnershipConfirmationModalV2(int32_t EntryPoint); // Function TransferOwnershipConfirmationModalV2.TransferOwnershipConfirmationModalV2_C.ExecuteUbergraph_TransferOwnershipConfirmationModalV2 // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

...
struct UDefusedtUsableHUDComponent_C : UBaseUsableHUDComponent_C {
	...
	void UpdateTouchPrompts(bool InUse); // Function DefusedtUsableHUDComponent.DefusedtUsableHUDComponent_C.UpdateTouchPrompts // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function DefusedtUsableHUDComponent.DefusedtUsableHUDComponent_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void HandleCurrentlyInUseUpdate(bool CurrentlyInUse); // Function DefusedtUsableHUDComponent.DefusedtUsableHUDComponent_C.HandleCurrentlyInUseUpdate // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void HandleUsingTimeUpdate(double CurrentUsingTime, double MaxUsingTime); // Function DefusedtUsableHUDComponent.DefusedtUsableHUDComponent_C.HandleUsingTimeUpdate // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_DefusedtUsableHUDComponent(int32_t EntryPoint); // Function DefusedtUsableHUDComponent.DefusedtUsableHUDComponent_C.ExecuteUbergraph_DefusedtUsableHUDComponent // (Final|UbergraphFunction) // @ game+0x1af5410
};

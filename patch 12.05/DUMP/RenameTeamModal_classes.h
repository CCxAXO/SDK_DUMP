...
struct URenameTeamModal_C : UUserWidget {
	...
	struct FAresMainMenuNavBarData GetNavBarData(); // Function RenameTeamModal.RenameTeamModal_C.GetNavBarData // (Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1af5410
	bool HandleBackRequest(); // Function RenameTeamModal.RenameTeamModal_C.HandleBackRequest // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnSuccess(struct FRoster& Roster); // Function RenameTeamModal.RenameTeamModal_C.OnSuccess // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Construct(); // Function RenameTeamModal.RenameTeamModal_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void BndEvt__TeamTag_K2Node_ComponentBoundEvent_2_OnEditableTextBoxChangedEvent__DelegateSignature(struct FText& Text); // Function RenameTeamModal.RenameTeamModal_C.BndEvt__TeamTag_K2Node_ComponentBoundEvent_2_OnEditableTextBoxChangedEvent__DelegateSignature // (HasOutParms|BlueprintEvent) // @ game+0x1af5410
	...
	void OnError(enum class ERosterCreateErrorType& ErrorType); // Function RenameTeamModal.RenameTeamModal_C.OnError // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_RenameTeamModal(int32_t EntryPoint); // Function RenameTeamModal.RenameTeamModal_C.ExecuteUbergraph_RenameTeamModal // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

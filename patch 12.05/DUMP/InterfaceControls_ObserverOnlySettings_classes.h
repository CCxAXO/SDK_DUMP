...
struct UInterfaceControls_ObserverOnlySettings_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function InterfaceControls_ObserverOnlySettings.InterfaceControls_ObserverOnlySettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_InterfaceControls_ObserverOnlySettings(int32_t EntryPoint); // Function InterfaceControls_ObserverOnlySettings.InterfaceControls_ObserverOnlySettings_C.ExecuteUbergraph_InterfaceControls_ObserverOnlySettings // (Final|UbergraphFunction) // @ game+0x1af5410
};

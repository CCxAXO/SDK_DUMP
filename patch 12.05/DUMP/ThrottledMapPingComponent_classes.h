...
struct UThrottledMapPingComponent_C : UMapPingComponent {
	...
	bool ShouldCallTryConsumeBroadcastPing(struct FMapPingData PingData, struct FVector Location, struct TArray<struct FActivePingData>& ActivePings); // Function ThrottledMapPingComponent.ThrottledMapPingComponent_C.ShouldCallTryConsumeBroadcastPing // (Private|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	bool ValidateNewPing(struct FMapPingData& PingData, struct FVector& Location, struct TArray<struct FActivePingData>& ActivePings, struct FEffectData& NewPingEffectData); // Function ThrottledMapPingComponent.ThrottledMapPingComponent_C.ValidateNewPing // (Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnNewPing(enum class EMapPingType PingType, int32_t PingIndex, struct FVector& Location); // Function ThrottledMapPingComponent.ThrottledMapPingComponent_C.OnNewPing // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_ThrottledMapPingComponent(int32_t EntryPoint); // Function ThrottledMapPingComponent.ThrottledMapPingComponent_C.ExecuteUbergraph_ThrottledMapPingComponent // (Final|UbergraphFunction) // @ game+0x1af5410
};

...
struct UCharacterAbilitiesTooltip_C : UCharacterAbilitiesTooltip_Base_C {
	...
	void OnInitialized(); // Function CharacterAbilitiesTooltip.CharacterAbilitiesTooltip_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void OnWidgetVisibilityChanged(enum class ESlateVisibility NewVisibility); // Function CharacterAbilitiesTooltip.CharacterAbilitiesTooltip_C.OnWidgetVisibilityChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_CharacterAbilitiesTooltip(int32_t EntryPoint); // Function CharacterAbilitiesTooltip.CharacterAbilitiesTooltip_C.ExecuteUbergraph_CharacterAbilitiesTooltip // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

...
struct UWBP_Template_SideScreenContent_C : UUserWidget {
	...
	void SetDescription(struct FText NewDescription); // Function WBP_Template_SideScreenContent.WBP_Template_SideScreenContent_C.SetDescription // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void SetTitle(struct FText NewTitle); // Function WBP_Template_SideScreenContent.WBP_Template_SideScreenContent_C.SetTitle // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void PreConstruct(bool IsDesignTime); // Function WBP_Template_SideScreenContent.WBP_Template_SideScreenContent_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_WBP_Template_SideScreenContent(int32_t EntryPoint); // Function WBP_Template_SideScreenContent.WBP_Template_SideScreenContent_C.ExecuteUbergraph_WBP_Template_SideScreenContent // (Final|UbergraphFunction) // @ game+0x1af5410
};

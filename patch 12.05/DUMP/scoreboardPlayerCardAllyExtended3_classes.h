...
struct UscoreboardPlayerCardAllyExtended3_C : UWBP_ScoreboardPlayerCardBase_C {
	...
	void Deprecated_setPoints(); // Function scoreboardPlayerCardAllyExtended3.scoreboardPlayerCardAllyExtended3_C.Deprecated_setPoints // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void UpdatePing(bool ForceUpdate); // Function scoreboardPlayerCardAllyExtended3.scoreboardPlayerCardAllyExtended3_C.UpdatePing // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void setAlive(); // Function scoreboardPlayerCardAllyExtended3.scoreboardPlayerCardAllyExtended3_C.setAlive // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void setDead(); // Function scoreboardPlayerCardAllyExtended3.scoreboardPlayerCardAllyExtended3_C.setDead // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Update Information(); // Function scoreboardPlayerCardAllyExtended3.scoreboardPlayerCardAllyExtended3_C.Update Information // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void InitializeVoiceIcon(); // Function scoreboardPlayerCardAllyExtended3.scoreboardPlayerCardAllyExtended3_C.InitializeVoiceIcon // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
};

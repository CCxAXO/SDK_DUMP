...
struct UWBP_Panel_BattlepassTimer_C : UAresCommonUserWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function WBP_Panel_BattlepassTimer.WBP_Panel_BattlepassTimer_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_WBP_Panel_BattlepassTimer(int32_t EntryPoint); // Function WBP_Panel_BattlepassTimer.WBP_Panel_BattlepassTimer_C.ExecuteUbergraph_WBP_Panel_BattlepassTimer // (Final|UbergraphFunction) // @ game+0x1af5410
};

...
struct UCombatReportBorder_C : UCombatReportBorder_Base_C {
	...
	void UpdatePremier(bool ShowPremier, enum class EPremierPrestigePlating Plating, bool ShowChampsAura); // Function CombatReportBorder.CombatReportBorder_C.UpdatePremier // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Premier_ShowBorder(bool ShowBorder); // Function CombatReportBorder.CombatReportBorder_C.Premier_ShowBorder // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Premier_SetLevel(enum class EPremierPrestigePlating Plating); // Function CombatReportBorder.CombatReportBorder_C.Premier_SetLevel // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void Premier_ShowAura(bool ShowAura); // Function CombatReportBorder.CombatReportBorder_C.Premier_ShowAura // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void PreConstruct(bool IsDesignTime); // Function CombatReportBorder.CombatReportBorder_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_CombatReportBorder(int32_t EntryPoint); // Function CombatReportBorder.CombatReportBorder_C.ExecuteUbergraph_CombatReportBorder // (Final|UbergraphFunction) // @ game+0x1af5410
};

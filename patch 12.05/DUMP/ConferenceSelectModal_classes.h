...
struct UConferenceSelectModal_C : UUserWidget {
	...
	void Construct(); // Function ConferenceSelectModal.ConferenceSelectModal_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void OnEnrollSuccess(); // Function ConferenceSelectModal.ConferenceSelectModal_C.OnEnrollSuccess // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void OnEnrollError(enum class EPremierRosterEnrollErrorTypeOld& ErrorType); // Function ConferenceSelectModal.ConferenceSelectModal_C.OnEnrollError // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	void ConfirmEnroll(); // Function ConferenceSelectModal.ConferenceSelectModal_C.ConfirmEnroll // (BlueprintCallable|BlueprintEvent) // @ game+0x1af5410
	...
	void ExecuteUbergraph_ConferenceSelectModal(int32_t EntryPoint); // Function ConferenceSelectModal.ConferenceSelectModal_C.ExecuteUbergraph_ConferenceSelectModal // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};

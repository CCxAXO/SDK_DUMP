...
struct FRemoteControlActor : FRemoteControlEntity {
	struct FSoftObjectPath Path; // 0xa0(0x28)
};

// ScriptStruct RemoteControl.RemoteControlInitialBindingContext
// Size: 0x90 (Inherited: 0x00)
struct FRemoteControlInitialBindingContext {
	struct TSoftClassPtr<UObject> SupportedClass; // 0x00(0x30)
	struct FName ComponentName; // 0x30(0x0c)
	char pad_3C[0x4]; // 0x3c(0x04)
	struct FString SubObjectPath; // 0x40(0x10)
	struct TSoftClassPtr<UObject> OwnerActorClass; // 0x50(0x30)
	struct FName OwnerActorName; // 0x80(0x0c)
...
struct FRemoteControlDeltaAPITestStruct {
	struct FLinearColor ColorValue; // 0x00(0x10)
};
...
struct FRemoteControlField : FRemoteControlEntity {
	enum class EExposedFieldType FieldType; // 0xa0(0x01)
	char pad_A1[0x3]; // 0xa1(0x03)
	struct FName FieldName; // 0xa4(0x0c)
	struct FRCFieldPathInfo FieldPathInfo; // 0xb0(0x18)
	struct TSet<struct FRemoteControlProtocolBinding> ProtocolBindings; // 0xc8(0x50)
	struct FSoftClassPath OwnerClass; // 0x118(0x28)
	bool bIsEditorOnly; // 0x140(0x01)
	char ActiveMasks; // 0x141(0x01)
...
struct FRemoteControlProtocolBinding {
	...
	struct FName ProtocolName; // 0x10(0x0c)
	struct FGuid PropertyID; // 0x1c(0x10)
	struct FName MappingPropertyName; // 0x2c(0x0c)
...
struct FRemoteControlProperty : FRemoteControlField {
	bool bIsEditableInPackaged; // 0x148(0x01)
...
struct FRemoteControlFunction : FRemoteControlField {
	...
	bool bIsCallableInPackaged; // 0x158(0x01)
	char pad_159[0x7]; // 0x159(0x07)
	struct FSoftObjectPath FunctionPath; // 0x160(0x28)
...
struct FRCMetadata_FName : FRCFieldMetadata {
	struct FName DefaultValue; // 0x08(0x0c)
	char pad_14[0x4]; // 0x14(0x04)
};
...
struct FRCMetadata_FVector : FRCFieldMetadata {
	struct FVector DefaultValue; // 0x08(0x18)
	struct FVector MinimumValue; // 0x20(0x18)
	struct FVector MaximumValue; // 0x38(0x18)
};
...
struct FRemoteControlInstanceMaterial : FRemoteControlProperty {
	ClassPtrProperty OriginalClass; // 0x150(0x08)
	struct FMaterialParameterInfo ParameterInfo; // 0x158(0x14)
	char pad_16C[0x4]; // 0x16c(0x04)
	struct FRCFieldPathInfo OriginalFieldPathInfo; // 0x170(0x18)
	struct FSoftObjectPath InstancePath; // 0x188(0x28)
};
...
struct FRemoteControlPresetGroup {
	...
	struct FLinearColor TagColor; // 0x1c(0x10)
	char pad_2C[0x4]; // 0x2c(0x04)
	struct TArray<struct FGuid> Fields; // 0x30(0x10)
};
...
struct FRemoteControlTestStructInner {
	...
	struct FRemoteControlTestStructInnerSimple InnerSimple; // 0x04(0x04)
...
struct FRemoteControlProtocolEntity {
	...
	enum class ERCMask OverridenMasks; // 0x78(0x01)
	enum class ERCBindingStatus BindingStatus; // 0x79(0x01)
...
struct FRemoteControlTestStruct {
	...
	struct FVector SomeVector; // 0x10(0x18)
	struct FRotator SomeRotator; // 0x28(0x18)
	int32_t SomeClampedInt; // 0x40(0x04)
	float SomeClampedFloat; // 0x44(0x04)
};

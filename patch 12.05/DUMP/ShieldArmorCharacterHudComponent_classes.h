...
struct UShieldArmorCharacterHudComponent_C : UCharacterHudComponent {
	...
	void GetCharacterHudDrawValuesImplV2(int32_t& OutValue, struct FLinearColor& SpecifiedColor, int32_t& OutMaxValue, struct UTexture*& ArmorIcon); // Function ShieldArmorCharacterHudComponent.ShieldArmorCharacterHudComponent_C.GetCharacterHudDrawValuesImplV2 // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1af5410
	void GetCharacterHudDrawValues(struct FCharacterHudDrawValues& Out); // Function ShieldArmorCharacterHudComponent.ShieldArmorCharacterHudComponent_C.GetCharacterHudDrawValues // (Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1af5410
};

...
struct UCommunicationControls_PingSettings_C : USettingsSubsectionBase_C {
	...
	void Construct(); // Function CommunicationControls_PingSettings.CommunicationControls_PingSettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_CommunicationControls_PingSettings(int32_t EntryPoint); // Function CommunicationControls_PingSettings.CommunicationControls_PingSettings_C.ExecuteUbergraph_CommunicationControls_PingSettings // (Final|UbergraphFunction) // @ game+0x1af5410
};

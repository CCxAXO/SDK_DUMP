...
struct URegionalDamageInteraction_C : UUserWidget {
	...
	void Construct(); // Function RegionalDamageInteraction.RegionalDamageInteraction_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1af5410
	void ExecuteUbergraph_RegionalDamageInteraction(int32_t EntryPoint); // Function RegionalDamageInteraction.RegionalDamageInteraction_C.ExecuteUbergraph_RegionalDamageInteraction // (Final|UbergraphFunction|HasDefaults) // @ game+0x1af5410
};
